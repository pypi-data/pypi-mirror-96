...
class CfnChannel(
    ...
    class HlsIngestProperty:
        ...
        def ingest_endpoints(
            ...
            return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnChannel.IngestEndpointProperty"]]]], result)
