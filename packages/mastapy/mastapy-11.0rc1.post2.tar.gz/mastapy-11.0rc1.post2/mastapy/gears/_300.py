...
class PlanetaryDetail(_0.APIBase):
    ...
    @property
    def planet_delta_angles(self) -> 'List[_299.NamedPlanetAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetDeltaAngles, constructor.new(_299.NamedPlanetAngle))
        return value
