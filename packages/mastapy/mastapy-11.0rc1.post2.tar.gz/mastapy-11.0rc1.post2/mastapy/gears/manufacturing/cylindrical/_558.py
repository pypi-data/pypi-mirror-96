...
from mastapy.gears.manufacturing.cylindrical import _570, _569, _557
...
from mastapy.gears.gear_designs.cylindrical import _970, _941, _967
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import (
    _657, _654, _662, _651,
    _660
)
from mastapy.gears.manufacturing.cylindrical.process_simulation import _585, _586, _587
...
class CylindricalGearManufacturingConfig(_1128.GearImplementationDetail):
    '''CylindricalGearManufacturingConfig
    ...
    @property
    def rough_cutter(self) -> '_677.CylindricalGearRealCutterDesign':
        ...
        if _677.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_671.CylindricalGearFormGrindingWheel':
        ...
        if _671.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_672.CylindricalGearGrindingWorm':
        ...
        if _672.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_hob_design(self) -> '_673.CylindricalGearHobDesign':
        ...
        if _673.CylindricalGearHobDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_674.CylindricalGearPlungeShaver':
        ...
        if _674.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_676.CylindricalGearRackDesign':
        ...
        if _676.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_678.CylindricalGearShaper':
        ...
        if _678.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_679.CylindricalGearShaver':
        ...
        if _679.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_involute_cutter_design(self) -> '_682.InvoluteCutterDesign':
        ...
        if _682.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter(self) -> '_677.CylindricalGearRealCutterDesign':
        ...
        if _677.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_671.CylindricalGearFormGrindingWheel':
        ...
        if _671.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_672.CylindricalGearGrindingWorm':
        ...
        if _672.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_hob_design(self) -> '_673.CylindricalGearHobDesign':
        ...
        if _673.CylindricalGearHobDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_674.CylindricalGearPlungeShaver':
        ...
        if _674.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_676.CylindricalGearRackDesign':
        ...
        if _676.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_678.CylindricalGearShaper':
        ...
        if _678.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_679.CylindricalGearShaver':
        ...
        if _679.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_involute_cutter_design(self) -> '_682.InvoluteCutterDesign':
        ...
        if _682.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation(self) -> '_657.GearCutterSimulation':
        ...
        if _657.GearCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_654.FinishCutterSimulation':
        ...
        if _654.FinishCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_662.RoughCutterSimulation':
        ...
        if _662.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation(self) -> '_585.CutterProcessSimulation':
        ...
        if _585.CutterProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_586.FormWheelGrindingProcessSimulation':
        ...
        if _586.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_shaping_process_simulation(self) -> '_587.ShapingProcessSimulation':
        ...
        if _587.ShapingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation(self) -> '_657.GearCutterSimulation':
        ...
        if _657.GearCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_654.FinishCutterSimulation':
        ...
        if _654.FinishCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_662.RoughCutterSimulation':
        ...
        if _662.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation(self) -> '_585.CutterProcessSimulation':
        ...
        if _585.CutterProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_586.FormWheelGrindingProcessSimulation':
        ...
        if _586.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_shaping_process_simulation(self) -> '_587.ShapingProcessSimulation':
        ...
        if _587.ShapingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def design(self) -> '_941.CylindricalGearDesign':
        ...
        if _941.CylindricalGearDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def rough_gear_specification(self) -> '_651.CylindricalGearSpecification':
        ...
        return constructor.new(_651.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification else None

    @property
    def finished_gear_specification(self) -> '_651.CylindricalGearSpecification':
        ...
        return constructor.new(_651.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification else None

    @property
    def gear_blank(self) -> '_557.CylindricalGearBlank':
        ...
        return constructor.new(_557.CylindricalGearBlank)(self.wrapped.GearBlank) if self.wrapped.GearBlank else None
