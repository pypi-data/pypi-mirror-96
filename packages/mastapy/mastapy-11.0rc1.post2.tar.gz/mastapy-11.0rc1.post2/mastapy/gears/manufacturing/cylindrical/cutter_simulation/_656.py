...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _649
...
class FormWheelGrindingSimulationCalculator(_649.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_688.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_688.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
