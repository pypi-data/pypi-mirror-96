...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _702, _716, _701
...
class PlungeShavingDynamicsViewModel(_716.ShavingDynamicsViewModel['_701.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_702.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_702.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
