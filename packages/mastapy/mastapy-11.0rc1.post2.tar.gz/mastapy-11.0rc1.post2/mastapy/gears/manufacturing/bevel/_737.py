...
from mastapy.gears.gear_designs.conical import _1068, _1067
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _722, _731, _739
...
class ConicalSetManufacturingConfig(_739.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_722.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_722.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_731.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_731.ConicalMeshManufacturingConfig))
        return value
