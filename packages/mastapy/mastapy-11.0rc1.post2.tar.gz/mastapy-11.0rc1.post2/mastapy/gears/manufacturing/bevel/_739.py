...
class ConicalSetMicroGeometryConfigBase(_1138.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_285.DeflectionFromBendingOption':
        ...
        return constructor.new(_285.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_285.DeflectionFromBendingOption'):
