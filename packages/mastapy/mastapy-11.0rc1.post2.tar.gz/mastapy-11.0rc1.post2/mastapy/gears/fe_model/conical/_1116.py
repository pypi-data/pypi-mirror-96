...
class ConicalSetFEModel(_1110.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1117.FlankDataSource':
        ...
        return constructor.new(_1117.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1117.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
