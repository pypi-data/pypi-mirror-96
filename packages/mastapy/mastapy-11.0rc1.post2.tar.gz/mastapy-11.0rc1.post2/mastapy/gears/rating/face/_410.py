...
from mastapy.gears.rating.face import _407, _408
...
class FaceGearSetRating(_323.GearSetRating):
    '''FaceGearSetRating
    ...
    @property
    def face_mesh_ratings(self) -> 'List[_407.FaceGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshRatings, constructor.new(_407.FaceGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_408.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_408.FaceGearRating))
        return value
