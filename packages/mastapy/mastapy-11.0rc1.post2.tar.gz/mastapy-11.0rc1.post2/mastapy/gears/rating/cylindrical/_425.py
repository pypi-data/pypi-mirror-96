...
from mastapy.gears.gear_designs.cylindrical import _996, _995
from mastapy.materials import _232
from mastapy.gears.rating.cylindrical import _420, _419, _423
...
class CylindricalMeshSingleFlankRating(_326.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_281.ContactRatioDataSource':
        ...
        return constructor.new(_281.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_996.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_996.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    @property
    def sorted_scuffing_results(self) -> '_420.CylindricalGearScuffingResults':
        ...
        return constructor.new(_420.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_420.CylindricalGearScuffingResults':
        ...
        return constructor.new(_420.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_423.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_423.CylindricalGearSingleFlankRating))
        return value
