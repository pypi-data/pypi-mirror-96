...
class CylindricalMeshDutyCycleRating(_325.MeshDutyCycleRating):
    '''CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self) -> '_415.CylindricalGearMeshRating':
        ...
        return constructor.new(_415.CylindricalGearMeshRating)(self.wrapped.HighestTorqueLoadCase) if self.wrapped.HighestTorqueLoadCase else None
