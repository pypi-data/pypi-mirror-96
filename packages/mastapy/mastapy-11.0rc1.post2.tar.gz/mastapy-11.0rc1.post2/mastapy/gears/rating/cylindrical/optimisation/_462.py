...
from mastapy.gears.rating.cylindrical.optimisation import _459
...
class SafetyFactorOptimisationStepResultShortLength(_459.SafetyFactorOptimisationStepResult):
    '''SafetyFactorOptimisationStepResultShortLength
