...
from mastapy.materials import _248, _249
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_471.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_317.FlankLoadingState':
        ...
        return constructor.new(_317.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_450.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_450.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None
