...
from mastapy.gears.rating.spiral_bevel import _362, _363
...
class SpiralBevelGearSetRating(_503.BevelGearSetRating):
    '''SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_mesh_ratings(self) -> 'List[_362.SpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshRatings, constructor.new(_362.SpiralBevelGearMeshRating))
        return value
