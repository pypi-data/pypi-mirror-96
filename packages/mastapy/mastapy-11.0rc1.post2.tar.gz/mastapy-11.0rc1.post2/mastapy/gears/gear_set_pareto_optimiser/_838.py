...
from mastapy.math_utility.optimisation import _1312, _1303, _1309
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1312.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1312.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None
    ...
    @property
    def input_setters(self) -> 'List[_1303.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1303.InputSetter)[TAnalysis])
        return value
    ...
    @property
    def filters(self) -> 'List[_1309.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1309.ParetoOptimisationFilter))
        return value
