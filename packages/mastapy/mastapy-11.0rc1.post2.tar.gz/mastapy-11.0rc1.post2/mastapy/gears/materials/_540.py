...
from mastapy.materials import _244, _234
...
class GearMaterial(_234.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_244.SNCurve':
        ...
        return constructor.new(_244.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_244.SNCurve':
        ...
        return constructor.new(_244.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
