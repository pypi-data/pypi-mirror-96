...
from mastapy.gears.gear_designs.straight_bevel import _896, _894, _897
...
class StraightBevelGearMeshDesign(_1091.BevelGearMeshDesign):
    '''StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_meshed_gears(self) -> 'List[_897.StraightBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshedGears, constructor.new(_897.StraightBevelMeshedGearDesign))
        return value
