...
from mastapy.gears.gear_designs.cylindrical import _1008, _928
...
class CylindricalMeshLinearBacklashSpecification(_1008.TolerancedValueSpecification['_928.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
