...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_941.CylindricalGearDesign':
        ...
        if _941.CylindricalGearDesign.TYPE not in self.wrapped.Gear.__class__.__mro__:
    ...
    @property
    def shaper_for_agma_rating(self) -> '_678.CylindricalGearShaper':
        ...
        return constructor.new(_678.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None

    @property
    def left_flank(self) -> '_936.CylindricalGearAbstractRackFlank':
        ...
        if _936.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_938.CylindricalGearBasicRackFlank':
        ...
        if _938.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_951.CylindricalGearPinionTypeCutterFlank':
        ...
        if _951.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_standard_rack_flank(self) -> '_1002.StandardRackFlank':
        ...
        if _1002.StandardRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_936.CylindricalGearAbstractRackFlank':
        ...
        if _936.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_938.CylindricalGearBasicRackFlank':
        ...
        if _938.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_951.CylindricalGearPinionTypeCutterFlank':
        ...
        if _951.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_standard_rack_flank(self) -> '_1002.StandardRackFlank':
        ...
        if _1002.StandardRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def flanks(self) -> 'List[_936.CylindricalGearAbstractRackFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_936.CylindricalGearAbstractRackFlank))
        return value

    @property
    def both_flanks(self) -> '_936.CylindricalGearAbstractRackFlank':
        ...
        if _936.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_basic_rack_flank(self) -> '_938.CylindricalGearBasicRackFlank':
        ...
        if _938.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_951.CylindricalGearPinionTypeCutterFlank':
        ...
        if _951.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_standard_rack_flank(self) -> '_1002.StandardRackFlank':
        ...
        if _1002.StandardRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
