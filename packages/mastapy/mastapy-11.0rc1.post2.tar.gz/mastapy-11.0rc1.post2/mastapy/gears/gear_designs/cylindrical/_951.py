...
from mastapy.gears.gear_designs.cylindrical import _950, _936
...
class CylindricalGearPinionTypeCutterFlank(_936.CylindricalGearAbstractRackFlank):
    '''CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self) -> '_950.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_950.CylindricalGearPinionTypeCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
