...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_1029.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_1029.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_1029.DrawDefiningGearOrBoth'):
