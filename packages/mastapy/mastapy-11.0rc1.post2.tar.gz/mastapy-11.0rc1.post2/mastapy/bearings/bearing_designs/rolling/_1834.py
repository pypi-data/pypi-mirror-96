...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1835.BearingProtectionLevel':
        ...
        return constructor.new(_1835.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1835.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1835.BearingProtectionLevel'):
