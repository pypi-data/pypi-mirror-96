...
from mastapy.bearings.bearing_designs.rolling import _1831, _1849
...
class BallBearing(_1849.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1831.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1831.BallBearingShoulderDefinition))
        return value
