...
from mastapy.bearings.bearing_designs.rolling import _1847, _1848, _1846
...
class NonBarrelRollerBearing(_1846.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1847.RollerEndShape':
        ...
        return constructor.new(_1847.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1847.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1848.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1848.RollerRibDetail))
        return value
