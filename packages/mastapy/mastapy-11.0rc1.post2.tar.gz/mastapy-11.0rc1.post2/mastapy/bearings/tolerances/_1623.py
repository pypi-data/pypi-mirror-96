...
from mastapy.bearings.tolerances import _1619, _1611
...
class SupportDetail(_1611.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1619.RadialSpecificationMethod':
        ...
        return constructor.new(_1619.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1619.RadialSpecificationMethod'):
