...
from mastapy.bearings.tolerances import _1607, _1604
...
class InterferenceTolerance(_1604.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1607.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1607.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1593.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1593.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1593.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
