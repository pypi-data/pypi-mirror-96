...
from mastapy.bearings.bearing_results.fluid_film import _1813, _1809
...
class LoadedPlainJournalBearingResults(_1809.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1813.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1813.LoadedPlainJournalBearingRow))
        return value
