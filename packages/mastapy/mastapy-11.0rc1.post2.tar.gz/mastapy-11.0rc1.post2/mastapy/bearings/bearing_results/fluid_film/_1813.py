...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_7192.SMTBitmap':
        ...
        return constructor.new(_7192.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
