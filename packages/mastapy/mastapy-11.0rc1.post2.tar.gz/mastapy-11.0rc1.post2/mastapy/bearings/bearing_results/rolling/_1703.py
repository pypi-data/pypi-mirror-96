...
from mastapy.bearings.bearing_results.rolling import _1765, _1718
...
class LoadedCylindricalRollerBearingResults(_1718.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1765.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1765.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
