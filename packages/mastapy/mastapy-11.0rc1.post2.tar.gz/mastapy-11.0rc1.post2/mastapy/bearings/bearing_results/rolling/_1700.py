...
from mastapy.bearings.bearing_results.rolling import _1699, _1724
...
class LoadedCrossedRollerBearingRow(_1724.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1699.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1699.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
