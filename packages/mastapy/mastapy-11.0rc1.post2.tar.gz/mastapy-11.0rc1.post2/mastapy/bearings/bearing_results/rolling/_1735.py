...
from mastapy.bearings.bearing_results.rolling import _1734, _1724
...
class LoadedSphericalRollerRadialBearingRow(_1724.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1734.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1734.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
