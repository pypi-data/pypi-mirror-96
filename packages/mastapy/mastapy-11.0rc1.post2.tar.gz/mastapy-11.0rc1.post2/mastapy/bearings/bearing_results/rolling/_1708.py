...
from mastapy.bearings.bearing_results.rolling import _1671, _1768, _1767
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1671.InternalClearance':
        ...
        if _1671.InternalClearance.TYPE not in self.wrapped.OperatingInternalClearance.__class__.__mro__:
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1767.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1767.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1767.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1767.StressAtPosition))
        return value
