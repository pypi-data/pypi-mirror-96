...
from mastapy.bearings.bearing_results.rolling.skf_module import _1785, _1787
...
class Viscosities(_1787.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1785.OperatingViscosity':
        ...
        return constructor.new(_1785.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
