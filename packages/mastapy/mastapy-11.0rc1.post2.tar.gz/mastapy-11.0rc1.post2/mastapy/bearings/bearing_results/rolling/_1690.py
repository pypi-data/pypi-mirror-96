...
from mastapy.bearings.bearing_results.rolling import _1687
...
class LoadedAxialThrustNeedleRollerBearingElement(_1687.LoadedAxialThrustCylindricalRollerBearingElement):
    '''LoadedAxialThrustNeedleRollerBearingElement
