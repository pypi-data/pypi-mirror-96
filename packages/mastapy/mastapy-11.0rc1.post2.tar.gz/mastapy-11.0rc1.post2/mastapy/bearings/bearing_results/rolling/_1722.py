...
from mastapy.bearings.bearing_results.rolling import _1761, _1708
...
class LoadedRollerBearingElement(_1708.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1761.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1761.ResultsAtRollerOffset))
        return value
