...
from mastapy.bearings.bearing_results.rolling import _1680, _1678
...
class LoadedAngularContactThrustBallBearingRow(_1678.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1680.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1680.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
