...
class SteadyStateSynchronousResponseOnAShaft(_7180.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3271.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3271.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
