...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_3045.BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed
