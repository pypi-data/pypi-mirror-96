...
class CylindricalGearSystemDeflectionWithLTCAResults(_2409.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_791.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_791.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
