...
class StraightBevelSunGearSystemDeflection(_2477.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3807.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3807.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
