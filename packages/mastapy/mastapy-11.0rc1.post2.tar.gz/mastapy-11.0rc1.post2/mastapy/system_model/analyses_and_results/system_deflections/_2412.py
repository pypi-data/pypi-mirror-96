...
class CylindricalPlanetGearSystemDeflection(_2409.CylindricalGearSystemDeflection):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3743.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3743.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
