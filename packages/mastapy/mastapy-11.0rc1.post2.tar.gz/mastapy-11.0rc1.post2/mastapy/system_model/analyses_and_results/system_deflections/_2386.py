...
class ConceptGearSystemDeflection(_2423.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3722.ConceptGearPowerFlow':
        ...
        return constructor.new(_3722.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
