...
class CylindricalGearMeshSystemDeflection(_2421.GearMeshSystemDeflection):
    ...
    @property
    def chart_of_effective_change_in_operating_centre_distance(self) -> '_7192.SMTBitmap':
        ...
        return constructor.new(_7192.SMTBitmap)(self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance) if self.wrapped.ChartOfEffectiveChangeInOperatingCentreDistance else None
