...
from mastapy.system_model.analyses_and_results.power_flows import _3701, _3732
...
class BeltConnectionSystemDeflection(_2429.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3701.BeltConnectionPowerFlow':
