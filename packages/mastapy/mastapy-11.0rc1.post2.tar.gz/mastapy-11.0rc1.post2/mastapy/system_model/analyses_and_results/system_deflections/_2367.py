...
from mastapy.system_model.analyses_and_results.power_flows import _3704, _3706, _3707
...
class BevelDifferentialGearSystemDeflection(_2372.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3704.BevelDifferentialGearPowerFlow':
