...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2432.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3763.KlingelnbergCycloPalloidHypoidGearPowerFlow':
        ...
        return constructor.new(_3763.KlingelnbergCycloPalloidHypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
