...
from mastapy.system_model.analyses_and_results.power_flows import _3716, _3736
...
class CoaxialConnectionSystemDeflection(_2467.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3716.CoaxialConnectionPowerFlow':
