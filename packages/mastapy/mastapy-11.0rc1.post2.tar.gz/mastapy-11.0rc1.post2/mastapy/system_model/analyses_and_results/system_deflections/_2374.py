...
class BoltSystemDeflection(_2379.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3712.BoltPowerFlow':
        ...
        return constructor.new(_3712.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
