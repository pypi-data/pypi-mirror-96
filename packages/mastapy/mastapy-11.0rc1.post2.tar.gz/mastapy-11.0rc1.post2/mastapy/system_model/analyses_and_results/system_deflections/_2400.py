...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2378.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3736.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3736.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
