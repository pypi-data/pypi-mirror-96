...
class ConicalGearCompoundSystemDeflection(_2572.GearCompoundSystemDeflection):
    '''ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_485.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_485.ConicalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating else None

    @property
    def conical_duty_cycle_rating(self) -> '_485.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_485.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating else None
