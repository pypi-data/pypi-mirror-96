...
from mastapy.system_model.analyses_and_results.power_flows import _3741, _3743
...
class CylindricalGearSystemDeflection(_2423.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3741.CylindricalGearPowerFlow':
    ...
    @property
    def manufacturing_analysis(self) -> '_563.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_563.CylindricalManufacturedGearLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None
