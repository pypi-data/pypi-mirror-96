...
class BevelGearSetSystemDeflection(_2359.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3710.BevelGearSetPowerFlow':
