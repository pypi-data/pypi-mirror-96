...
class FaceGearSystemDeflection(_2423.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3747.FaceGearPowerFlow':
        ...
        return constructor.new(_3747.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
