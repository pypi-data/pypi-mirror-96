...
class StraightBevelGearHarmonicAnalysis(_5606.BevelGearHarmonicAnalysis):
    '''StraightBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2480.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2480.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
