...
class BevelDifferentialSunGearHarmonicAnalysis(_5601.BevelDifferentialGearHarmonicAnalysis):
    '''BevelDifferentialSunGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2189.BevelDifferentialSunGear':
        ...
        return constructor.new(_2189.BevelDifferentialSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2369.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2369.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
