...
class CouplingConnectionHarmonicAnalysis(_5679.InterMountableComponentConnectionHarmonicAnalysis):
    '''CouplingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2393.CouplingConnectionSystemDeflection':
