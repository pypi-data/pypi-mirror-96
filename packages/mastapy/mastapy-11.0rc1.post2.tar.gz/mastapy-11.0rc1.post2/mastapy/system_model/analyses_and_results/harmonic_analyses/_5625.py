...
class ConicalGearSetHarmonicAnalysis(_5667.GearSetHarmonicAnalysis):
    '''ConicalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2389.ConicalGearSetSystemDeflection':
