...
from mastapy.system_model.analyses_and_results.system_deflections import _2403, _2404, _2405
...
class CylindricalGearMeshHarmonicAnalysis(_5664.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6952.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6952.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2403.CylindricalGearMeshSystemDeflection':
