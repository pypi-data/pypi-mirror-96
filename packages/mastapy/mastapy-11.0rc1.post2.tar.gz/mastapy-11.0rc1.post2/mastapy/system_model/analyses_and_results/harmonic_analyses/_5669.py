...
class GuideDxfModelHarmonicAnalysis(_5616.ComponentHarmonicAnalysis):
    '''GuideDxfModelHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2424.GuideDxfModelSystemDeflection':
        ...
        return constructor.new(_2424.GuideDxfModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
