...
class CycloidalDiscHarmonicAnalysis(_5591.AbstractShaftHarmonicAnalysis):
    '''CycloidalDiscHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2402.CycloidalDiscSystemDeflection':
        ...
        return constructor.new(_2402.CycloidalDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
