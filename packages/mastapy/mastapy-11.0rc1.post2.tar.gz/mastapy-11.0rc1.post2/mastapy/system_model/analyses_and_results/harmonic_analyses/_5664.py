...
class GearMeshHarmonicAnalysis(_5679.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3812.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3812.ToothPassingHarmonic))
        return value
