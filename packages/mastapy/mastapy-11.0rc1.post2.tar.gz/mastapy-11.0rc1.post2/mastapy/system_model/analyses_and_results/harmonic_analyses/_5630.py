...
class CouplingHarmonicAnalysis(_5714.SpecialisedAssemblyHarmonicAnalysis):
    '''CouplingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2395.CouplingSystemDeflection':
