...
class ConnectionParametricStudyTool(_7168.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4046.ParametricStudyTool':
        ...
        return constructor.new(_4046.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
