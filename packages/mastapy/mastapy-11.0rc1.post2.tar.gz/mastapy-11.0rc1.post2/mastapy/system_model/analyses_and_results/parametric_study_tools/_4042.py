...
class ParametricStudyDOEResultVariable(_1316.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1318.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1318.PropertyTargetForDominantCandidateSearch'):
