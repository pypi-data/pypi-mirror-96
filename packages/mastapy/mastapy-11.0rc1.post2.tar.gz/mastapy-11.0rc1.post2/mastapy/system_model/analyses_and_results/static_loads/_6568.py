...
from mastapy.system_model import _1896, _1897, _1898
from mastapy.system_model.analyses_and_results.mbd_analyses import _5168
from mastapy.system_model.analyses_and_results.static_loads import _6609, _6504, _6613
from mastapy.system_model.fe import _2049
from mastapy.system_model.part_model import _2145
from mastapy.math_utility.control import _1334
...
class PowerLoadLoadCase(_6613.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1896.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1896.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1896.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5168.WheelSlipType':
        ...
        return constructor.new(_5168.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5168.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1898.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1898.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1898.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1334.PIDControlSettings':
        ...
        return constructor.new(_1334.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None
    ...
    @property
    def pid_control_settings(self) -> '_1334.PIDControlSettings':
        ...
        return constructor.new(_1334.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6504.ElectricMachineHarmonicLoadData':
