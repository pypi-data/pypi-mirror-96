...
from mastapy.system_model.analyses_and_results.static_loads import _6476, _6520
...
class ConicalGearLoadCase(_6520.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6476.ConicalGearManufactureError':
        ...
        return constructor.new(_6476.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
