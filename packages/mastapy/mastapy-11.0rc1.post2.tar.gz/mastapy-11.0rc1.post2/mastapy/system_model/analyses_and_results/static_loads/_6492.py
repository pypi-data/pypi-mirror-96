...
from mastapy.system_model.analyses_and_results.static_loads import _6493, _6520
...
class CylindricalGearLoadCase(_6520.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6493.CylindricalGearManufactureError':
        ...
        return constructor.new(_6493.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
