...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    @property
    def all_pins_roundness_chart(self) -> '_7192.SMTBitmap':
        ...
        return constructor.new(_7192.SMTBitmap)(self.wrapped.AllPinsRoundnessChart) if self.wrapped.AllPinsRoundnessChart else None
