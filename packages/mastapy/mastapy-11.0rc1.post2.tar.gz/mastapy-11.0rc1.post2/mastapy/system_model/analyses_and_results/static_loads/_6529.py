...
from mastapy.system_model.analyses_and_results.static_loads import _6554, _6530, _6509
...
class HarmonicLoadDataExcelImport(_6530.HarmonicLoadDataImportBase['_6509.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6554.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6554.NamedSpeed))
        return value
