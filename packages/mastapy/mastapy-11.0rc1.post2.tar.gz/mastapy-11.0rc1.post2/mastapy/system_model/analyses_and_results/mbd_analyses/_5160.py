...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5164, _5069
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5069.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5164.TorqueConverterStatus':
        ...
        return constructor.new(_5164.TorqueConverterStatus)(value) if value else None
