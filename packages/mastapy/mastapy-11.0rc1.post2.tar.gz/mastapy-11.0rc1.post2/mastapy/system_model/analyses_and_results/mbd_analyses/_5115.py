...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5101, _5140, _5135
...
class MBDRunUpAnalysisOptions(_7166.AbstractAnalysisOptions['_6603.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5101.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5101.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5101.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5140.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5140.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5140.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5135.RunUpDrivingMode':
        ...
        return constructor.new(_5135.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5135.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
