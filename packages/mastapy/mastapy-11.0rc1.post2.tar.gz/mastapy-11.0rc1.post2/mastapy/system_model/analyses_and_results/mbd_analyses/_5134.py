...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2309, _5037
...
class RootAssemblyMultibodyDynamicsAnalysis(_5037.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2309.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2309.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs else None
