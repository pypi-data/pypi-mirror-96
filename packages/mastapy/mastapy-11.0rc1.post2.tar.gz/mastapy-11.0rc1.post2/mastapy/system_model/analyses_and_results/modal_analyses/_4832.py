...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _2308
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4899, _4896, _4898
...
class PartModalAnalysis(_7178.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    def modal_analysis(self) -> '_2305.ModalAnalysis':
        ...
        if _2305.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    @property
    def results_for_modes(self) -> 'List[_4899.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4899.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4896.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4896.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4896.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4896.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_4898.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4898.SingleExcitationResultsModalAnalysis))
        return value
    ...
    def create_viewable(self) -> '_1926.ModalAnalysisViewable':
