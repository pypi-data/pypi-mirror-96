...
from mastapy.system_model.analyses_and_results.system_deflections import _2484, _2483, _2485
...
class SynchroniserPartModalAnalysis(_4786.CouplingHalfModalAnalysis):
    '''SynchroniserPartModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2484.SynchroniserPartSystemDeflection':
