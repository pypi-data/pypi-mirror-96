...
class PerModeResultsReport(_1489.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1547.TableAndChartOptions':
    ...
    def display_option(self, value: '_1547.TableAndChartOptions'):
