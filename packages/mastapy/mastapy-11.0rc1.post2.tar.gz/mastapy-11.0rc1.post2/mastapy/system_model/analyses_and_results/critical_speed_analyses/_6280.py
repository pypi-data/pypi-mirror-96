...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6278, _6279, _6195
...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6195.BevelGearSetCriticalSpeedAnalysis):
    '''SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6278.SpiralBevelGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCriticalSpeedAnalysis, constructor.new(_6278.SpiralBevelGearCriticalSpeedAnalysis))
        return value

    @property
    def spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6279.SpiralBevelGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCriticalSpeedAnalysis, constructor.new(_6279.SpiralBevelGearMeshCriticalSpeedAnalysis))
        return value
