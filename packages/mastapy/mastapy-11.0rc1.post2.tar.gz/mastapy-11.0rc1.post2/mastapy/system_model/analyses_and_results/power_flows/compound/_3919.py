...
class RootAssemblyCompoundPowerFlow(_3832.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_5312.AbstractStaticLoadCaseGroup':
        ...
        if _5312.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5310.AbstractDesignStateLoadCaseGroup':
        ...
        if _5310.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_5315.DesignState':
        ...
        if _5315.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5316.DutyCycle':
        ...
        if _5316.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5320.SubGroupInSingleDesignState':
        ...
        if _5320.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
