...
from mastapy.system_model.analyses_and_results.stability_analyses import _3456, _3454, _3485
...
class ConceptGearSetStabilityAnalysis(_3485.GearSetStabilityAnalysis):
    '''ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3456.ConceptGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsStabilityAnalysis, constructor.new(_3456.ConceptGearStabilityAnalysis))
        return value

    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3454.ConceptGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesStabilityAnalysis, constructor.new(_3454.ConceptGearMeshStabilityAnalysis))
        return value
