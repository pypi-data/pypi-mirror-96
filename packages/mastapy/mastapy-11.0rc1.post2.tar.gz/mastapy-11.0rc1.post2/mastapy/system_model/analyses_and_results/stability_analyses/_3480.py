...
from mastapy.system_model.analyses_and_results.stability_analyses import _3481, _3479, _3485
...
class FaceGearSetStabilityAnalysis(_3485.GearSetStabilityAnalysis):
    '''FaceGearSetStabilityAnalysis
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3481.FaceGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsStabilityAnalysis, constructor.new(_3481.FaceGearStabilityAnalysis))
        return value

    @property
    def face_meshes_stability_analysis(self) -> 'List[_3479.FaceGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesStabilityAnalysis, constructor.new(_3479.FaceGearMeshStabilityAnalysis))
        return value
