...
from mastapy.system_model.fe import _2078, _2077
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2078.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2078.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2077.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2077.PerLinkExportOptions))
        return value
