...
from mastapy.system_model.part_model.couplings import _2277, _2275
...
class Synchroniser(_2149.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2277.SynchroniserSleeve':
        ...
        return constructor.new(_2277.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2275.SynchroniserHalf':
        ...
        return constructor.new(_2275.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2275.SynchroniserHalf':
        ...
        return constructor.new(_2275.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_2018.ClutchConnection':
        ...
        return constructor.new(_2018.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_2018.ClutchConnection':
        ...
        return constructor.new(_2018.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
