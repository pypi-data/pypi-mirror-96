...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1299.IndividualContactPosition':
        ...
        return constructor.new(_1299.IndividualContactPosition)(value) if value else None
    ...
    @property
    def crowning(self) -> '_2256.CrowningSpecification':
        ...
        return constructor.new(_2256.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning else None
