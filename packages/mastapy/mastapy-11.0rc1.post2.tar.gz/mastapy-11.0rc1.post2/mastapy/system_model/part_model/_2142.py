...
from mastapy.system_model.part_model import _2134, _2137
...
class PlanetCarrier(_2137.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_1964.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1964.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2154.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2154.Shaft', offset: Optional['float'] = float('nan')):
