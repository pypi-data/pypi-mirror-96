...
from mastapy.system_model.part_model.gears import _2196, _2203
...
class CylindricalGearSet(_2203.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2234.SuperchargerRotorSet':
        ...
        return constructor.new(_2234.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2196.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2196.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1985.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1985.CylindricalGearMesh))
        return value
