...
class Gear(_2137.MountableComponent):
    '''Gear
    ...
    @property
    def gear_set(self) -> '_2203.GearSet':
        ...
        if _2203.GearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_agma_gleason_conical_gear_set(self) -> '_2185.AGMAGleasonConicalGearSet':
        ...
        if _2185.AGMAGleasonConicalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_bevel_differential_gear_set(self) -> '_2187.BevelDifferentialGearSet':
        ...
        if _2187.BevelDifferentialGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_bevel_gear_set(self) -> '_2191.BevelGearSet':
        ...
        if _2191.BevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to BevelGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_concept_gear_set(self) -> '_2193.ConceptGearSet':
        ...
        if _2193.ConceptGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_conical_gear_set(self) -> '_2195.ConicalGearSet':
        ...
        if _2195.ConicalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_cylindrical_gear_set(self) -> '_2197.CylindricalGearSet':
        ...
        if _2197.CylindricalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_face_gear_set(self) -> '_2200.FaceGearSet':
        ...
        if _2200.FaceGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to FaceGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_hypoid_gear_set(self) -> '_2206.HypoidGearSet':
        ...
        if _2206.HypoidGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to HypoidGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> '_2208.KlingelnbergCycloPalloidConicalGearSet':
        ...
        if _2208.KlingelnbergCycloPalloidConicalGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> '_2210.KlingelnbergCycloPalloidHypoidGearSet':
        ...
        if _2210.KlingelnbergCycloPalloidHypoidGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> '_2212.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ...
        if _2212.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_planetary_gear_set(self) -> '_2213.PlanetaryGearSet':
        ...
        if _2213.PlanetaryGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_spiral_bevel_gear_set(self) -> '_2215.SpiralBevelGearSet':
        ...
        if _2215.SpiralBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_diff_gear_set(self) -> '_2217.StraightBevelDiffGearSet':
        ...
        if _2217.StraightBevelDiffGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_gear_set(self) -> '_2219.StraightBevelGearSet':
        ...
        if _2219.StraightBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_worm_gear_set(self) -> '_2223.WormGearSet':
        ...
        if _2223.WormGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
            raise CastException('Failed to cast gear_set to WormGearSet. Expected: {}.'.format(self.wrapped.GearSet.__class__.__qualname__))

        return constructor.new_override(self.wrapped.GearSet.__class__)(self.wrapped.GearSet) if self.wrapped.GearSet else None

    @property
    def gear_set_of_type_zerol_bevel_gear_set(self) -> '_2225.ZerolBevelGearSet':
        ...
        if _2225.ZerolBevelGearSet.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    def shaft(self) -> '_2154.Shaft':
        ...
        return constructor.new(_2154.Shaft)(self.wrapped.Shaft) if self.wrapped.Shaft else None
