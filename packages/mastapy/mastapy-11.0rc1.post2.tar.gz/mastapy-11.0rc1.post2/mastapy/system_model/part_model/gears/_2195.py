...
from mastapy.system_model.part_model.gears import _2194, _2203
...
class ConicalGearSet(_2203.GearSet):
    '''ConicalGearSet
    ...
    @property
    def conical_gears(self) -> 'List[_2194.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2194.ConicalGear))
        return value
