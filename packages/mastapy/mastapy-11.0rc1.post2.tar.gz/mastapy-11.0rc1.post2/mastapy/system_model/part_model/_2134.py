...
from mastapy.system_model.part_model import _2112, _2133
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2112.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2112.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2112.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2133.LoadSharingModes':
        ...
        return constructor.new(_2133.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2133.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
