...
from mastapy.bearings.tolerances import _1624, _1610, _1616
...
class InterferenceFitHalfDesign(_1151.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1210.StressRegions':
        ...
        return constructor.new(_1210.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1624.SupportTolerance':
        ...
        if _1624.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1610.InnerSupportTolerance':
        ...
        if _1610.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1616.OuterSupportTolerance':
        ...
        if _1616.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
