...
from mastapy.detailed_rigid_connectors.splines import (
    _1157, _1168, _1180, _1172,
    _1169, _1176, _1177, _1152,
    _1155, _1159, _1162, _1170,
    _1182
)
...
class SplineJointDesign(_1150.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def root_type(self) -> '_1168.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_1168.RootTypes)(value) if value else None

    @root_type.setter
    def root_type(self, value: '_1168.RootTypes'):
    ...
    @property
    def torque_cycles(self) -> '_1172.SAETorqueCycles':
        ...
        return constructor.new(_1172.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_1172.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_1169.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_1169.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_1169.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1176.SplineFixtureTypes':
        ...
        return constructor.new(_1176.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1176.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1177.SplineHalfDesign':
        ...
        if _1177.SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_1152.CustomSplineHalfDesign':
        ...
        if _1152.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_1155.DIN5480SplineHalfDesign':
        ...
        if _1155.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_1159.GBT3478SplineHalfDesign':
        ...
        if _1159.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_1162.ISO4156SplineHalfDesign':
        ...
        if _1162.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_1170.SAESplineHalfDesign':
        ...
        if _1170.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1182.StandardSplineHalfDesign':
        ...
        if _1182.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half(self) -> '_1177.SplineHalfDesign':
        ...
        if _1177.SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_1152.CustomSplineHalfDesign':
        ...
        if _1152.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_1155.DIN5480SplineHalfDesign':
        ...
        if _1155.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_1159.GBT3478SplineHalfDesign':
        ...
        if _1159.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_1162.ISO4156SplineHalfDesign':
        ...
        if _1162.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_1170.SAESplineHalfDesign':
        ...
        if _1170.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1182.StandardSplineHalfDesign':
        ...
        if _1182.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
