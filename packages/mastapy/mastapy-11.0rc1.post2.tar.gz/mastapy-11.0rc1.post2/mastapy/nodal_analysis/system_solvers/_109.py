...
from mastapy.nodal_analysis.system_solvers import _94
...
class TransientSolver(_94.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_80.TransientSolverStatus':
        ...
        return constructor.new(_80.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_80.TransientSolverStatus'):
