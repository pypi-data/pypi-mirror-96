...
class FEMeshingOptions(_0.APIBase):
    ...
    @property
    def element_shape(self) -> '_83.VolumeElementShape':
        ...
        return constructor.new(_83.VolumeElementShape)(value) if value else None

    @element_shape.setter
    def element_shape(self, value: '_83.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def meshing_diameter_for_gear(self) -> '_69.MeshingDiameterForGear':
        ...
        return constructor.new(_69.MeshingDiameterForGear)(value) if value else None

    @meshing_diameter_for_gear.setter
    def meshing_diameter_for_gear(self, value: '_69.MeshingDiameterForGear'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
