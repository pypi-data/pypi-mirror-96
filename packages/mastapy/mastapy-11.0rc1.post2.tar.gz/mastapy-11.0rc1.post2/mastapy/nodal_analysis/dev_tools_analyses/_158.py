...
from mastapy.nodal_analysis.dev_tools_analyses import _149
...
class FEModelInstanceDrawStyle(_0.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_149.DrawStyleForFE':
        ...
        return constructor.new(_149.DrawStyleForFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
