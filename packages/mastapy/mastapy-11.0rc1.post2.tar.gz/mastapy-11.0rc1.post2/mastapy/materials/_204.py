...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_205.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_205.AcousticRadiationEfficiencyInputType)(value) if value else None

    @input_type.setter
    def input_type(self, value: '_205.AcousticRadiationEfficiencyInputType'):
