...
from mastapy.utility.databases import _1555, _1557, _1556
...
TValue = TypeVar('TValue', bound='_1555.NamedDatabaseItem')


class NamedDatabase(_1557.SQLDatabase['_1556.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1555.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1555.NamedDatabaseItem') -> '_1555.NamedDatabaseItem':
