...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1352.RoundingMethods':
        ...
        return constructor.new(_1352.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1352.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1364.Unit':
        ...
        if _1364.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
