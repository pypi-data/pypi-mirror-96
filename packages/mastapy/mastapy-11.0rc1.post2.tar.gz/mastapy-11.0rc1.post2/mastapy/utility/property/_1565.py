...
from mastapy.utility.units_and_measurements.measurements import _1369
...
class DutyCyclePropertySummarySmallAngle(_1562.DutyCyclePropertySummary['_1369.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
