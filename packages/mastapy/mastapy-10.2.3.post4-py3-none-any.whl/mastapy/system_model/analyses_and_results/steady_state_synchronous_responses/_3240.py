...
class SteadyStateSynchronousResponse(_7134.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3242.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3242.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
