...
class ConnectionSteadyStateSynchronousResponse(_7138.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3240.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3240.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
