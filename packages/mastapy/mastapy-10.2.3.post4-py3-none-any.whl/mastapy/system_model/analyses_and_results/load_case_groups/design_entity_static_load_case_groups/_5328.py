...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5325, _5326, _5329
from mastapy.system_model.part_model.gears import _2203, _2201
from mastapy.system_model.analyses_and_results.static_loads import _6520, _6522, _6525
...
TGearSet = TypeVar('TGearSet', bound='_2203.GearSet')
TGear = TypeVar('TGear', bound='_2201.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6520.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1989.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6522.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6525.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5329.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5325.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5325.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5326.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5326.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
