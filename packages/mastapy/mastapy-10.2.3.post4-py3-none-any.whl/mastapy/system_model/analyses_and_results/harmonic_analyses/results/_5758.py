...
class ResultLocationSelectionGroup(_0.APIBase):
    ...
    @property
    def response_locations(self) -> 'List[_5760.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResponseLocations, constructor.new(_5760.ResultNodeSelection))
        return value
