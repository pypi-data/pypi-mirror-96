...
class HypoidGearMeshHarmonicAnalysis(_5566.AGMAGleasonConicalGearMeshHarmonicAnalysis):
    '''HypoidGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2396.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2396.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
