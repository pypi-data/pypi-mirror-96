...
from mastapy.system_model.analyses_and_results.system_deflections import _2448, _2452, _2453
...
class StraightBevelDiffGearHarmonicAnalysis(_5577.BevelGearHarmonicAnalysis):
    '''StraightBevelDiffGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2448.StraightBevelDiffGearSystemDeflection':
