...
class PointLoadHarmonicAnalysis(_5707.VirtualComponentHarmonicAnalysis):
    '''PointLoadHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2424.PointLoadSystemDeflection':
        ...
        return constructor.new(_2424.PointLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
