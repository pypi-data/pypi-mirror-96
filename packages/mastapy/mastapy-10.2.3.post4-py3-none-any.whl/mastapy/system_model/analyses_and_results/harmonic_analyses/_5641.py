...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5642, _5682, _5631
...
class HarmonicAnalysisFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_options(self) -> '_5642.HarmonicAnalysisOptions':
        ...
        if _5642.HarmonicAnalysisOptions.TYPE not in self.wrapped.AnalysisOptions.__class__.__mro__:
