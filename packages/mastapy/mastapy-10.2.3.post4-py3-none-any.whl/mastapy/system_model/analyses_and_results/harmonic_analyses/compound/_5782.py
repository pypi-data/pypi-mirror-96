...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5751
...
class CVTCompoundHarmonicAnalysis(_5751.BeltDriveCompoundHarmonicAnalysis):
    '''CVTCompoundHarmonicAnalysis
