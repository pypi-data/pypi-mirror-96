...
class SpringDamperCompoundHarmonicAnalysis(_5778.CouplingCompoundHarmonicAnalysis):
    '''SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5688.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5688.SpringDamperHarmonicAnalysis))
        return value

    @property
    def assembly_harmonic_analysis_load_cases(self) -> 'List[_5688.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyHarmonicAnalysisLoadCases, constructor.new(_5688.SpringDamperHarmonicAnalysis))
        return value
