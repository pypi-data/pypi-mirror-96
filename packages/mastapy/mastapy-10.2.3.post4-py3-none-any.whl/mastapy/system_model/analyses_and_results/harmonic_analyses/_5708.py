...
class WormGearHarmonicAnalysis(_5632.GearHarmonicAnalysis):
    '''WormGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2471.WormGearSystemDeflection':
        ...
        return constructor.new(_2471.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
