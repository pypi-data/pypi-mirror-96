...
class PowerLoadHarmonicAnalysis(_5707.VirtualComponentHarmonicAnalysis):
    '''PowerLoadHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2425.PowerLoadSystemDeflection':
        ...
        return constructor.new(_2425.PowerLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
