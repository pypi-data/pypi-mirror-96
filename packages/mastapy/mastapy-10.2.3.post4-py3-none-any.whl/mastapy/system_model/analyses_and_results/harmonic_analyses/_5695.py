...
class StraightBevelPlanetGearHarmonicAnalysis(_5689.StraightBevelDiffGearHarmonicAnalysis):
    '''StraightBevelPlanetGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2195.StraightBevelPlanetGear':
        ...
        return constructor.new(_2195.StraightBevelPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2452.StraightBevelPlanetGearSystemDeflection':
        ...
        return constructor.new(_2452.StraightBevelPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
