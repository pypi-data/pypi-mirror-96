...
class GearMeshHarmonicAnalysis(_5646.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2392.GearMeshSystemDeflection':
