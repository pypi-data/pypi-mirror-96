...
class RollingRingHarmonicAnalysis(_5600.CouplingHalfHarmonicAnalysis):
    '''RollingRingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2432.RollingRingSystemDeflection':
        ...
        return constructor.new(_2432.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
