...
class KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis(_5647.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2409.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2409.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
