...
class StraightBevelPlanetGearHarmonicAnalysis(_5722.StraightBevelDiffGearHarmonicAnalysis):
    '''StraightBevelPlanetGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2481.StraightBevelPlanetGearSystemDeflection':
        ...
        return constructor.new(_2481.StraightBevelPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
