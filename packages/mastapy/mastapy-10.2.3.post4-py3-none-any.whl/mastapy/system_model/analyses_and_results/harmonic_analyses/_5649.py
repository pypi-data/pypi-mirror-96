...
from mastapy.system_model.analyses_and_results.system_deflections import _2402, _2405, _2408
...
class KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis(_5596.ConicalGearSetHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2402.KlingelnbergCycloPalloidConicalGearSetSystemDeflection':
