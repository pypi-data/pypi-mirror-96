...
class MassDiscHarmonicAnalysis(_5707.VirtualComponentHarmonicAnalysis):
    '''MassDiscHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2412.MassDiscSystemDeflection':
        ...
        return constructor.new(_2412.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
