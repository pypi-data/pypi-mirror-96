...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2562, _2598, _2521
...
class FlexiblePinAnalysisGearAndBearingRating(_5904.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2562.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2562.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2521.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2521.BearingCompoundSystemDeflection))
        return value
