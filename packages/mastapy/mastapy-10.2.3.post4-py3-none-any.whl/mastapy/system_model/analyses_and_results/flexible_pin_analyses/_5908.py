...
class FlexiblePinAnalysisManufactureLevel(_5904.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4001.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4001.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
