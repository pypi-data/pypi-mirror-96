...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4017, _4019, _3932
...
class RootAssemblyParametricStudyTool(_3932.AssemblyParametricStudyTool):
    '''RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_4017.ParametricStudyTool':
        ...
        return constructor.new(_4017.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> 'List[_2536.DutyCycleEfficiencyResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RootAssemblyDutyCycleResults, constructor.new(_2536.DutyCycleEfficiencyResults))
        return value
