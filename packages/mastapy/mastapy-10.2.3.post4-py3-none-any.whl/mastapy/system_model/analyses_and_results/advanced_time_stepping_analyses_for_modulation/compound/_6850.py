...
class StraightBevelSunGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6843.StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelSunGearCompoundAdvancedTimeSteppingAnalysisForModulation
