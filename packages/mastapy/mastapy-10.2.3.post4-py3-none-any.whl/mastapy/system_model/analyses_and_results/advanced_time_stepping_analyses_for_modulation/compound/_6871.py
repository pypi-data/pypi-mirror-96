...
class SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_6788.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6742.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6742.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_advanced_time_stepping_analysis_for_modulation_load_cases(self) -> 'List[_6742.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedTimeSteppingAnalysisForModulationLoadCases, constructor.new(_6742.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value
