...
from mastapy.system_model.analyses_and_results.analysis_cases import _7143
...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.PartCompoundAnalysis):
    '''PartCompoundAdvancedTimeSteppingAnalysisForModulation
