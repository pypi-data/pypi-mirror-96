...
from mastapy.nodal_analysis import _1381, _1380
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1380.BarModelAnalysisType':
        ...
        return constructor.new(_1380.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1380.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1476.EigenvalueOptions':
        ...
        return constructor.new(_1476.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
    ...
    def set_fe_file_to_include(self, file_path: 'str', format_: '_1474.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
