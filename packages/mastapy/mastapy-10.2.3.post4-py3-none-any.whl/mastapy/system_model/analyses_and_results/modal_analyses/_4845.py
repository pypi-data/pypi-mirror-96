...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4910, _4907, _4909
...
from mastapy.system_model.drawing import _1876
...
class PartModalAnalysis(_6564.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_4838.ModalAnalysis':
        ...
        if _4838.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    @property
    def results_for_modes(self) -> 'List[_4910.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4910.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4907.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4907.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4907.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4907.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def excited_modes_summary(self) -> 'List[_4909.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4909.SingleExcitationResultsModalAnalysis))
        return value
    ...
    def create_viewable(self) -> '_1876.ModalAnalysisViewable':
