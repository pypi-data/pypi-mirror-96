...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4909
...
class ConnectionModalAnalysis(_6557.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
