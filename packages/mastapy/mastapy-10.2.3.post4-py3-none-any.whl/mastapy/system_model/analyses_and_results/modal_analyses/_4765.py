...
from mastapy.system_model.analyses_and_results.modal_analyses import _4788, _4818, _4845
...
class AbstractAssemblyModalAnalysis(_4845.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4788.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4788.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4818.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4818.GearMeshModalAnalysis))
        return value
