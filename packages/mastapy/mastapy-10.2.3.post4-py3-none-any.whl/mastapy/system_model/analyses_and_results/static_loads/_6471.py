...
from mastapy.system_model.analyses_and_results.static_loads import _6575, _6501, _6549
...
class ElectricMachineHarmonicLoadData(_6549.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_7157.SMTBitmap':
        ...
        return constructor.new(_7157.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
