...
from mastapy.system_model import _1890, _1891, _1892
from mastapy.system_model.analyses_and_results.mbd_analyses import _5139
from mastapy.system_model.analyses_and_results.static_loads import _6576, _6471, _6580
from mastapy.system_model.fe import _2025
from mastapy.system_model.part_model import _2120
from mastapy.math_utility.control import _1570
...
class PowerLoadLoadCase(_6580.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1890.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1890.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1890.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5139.WheelSlipType':
        ...
        return constructor.new(_5139.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5139.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1892.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1892.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1892.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1570.PIDControlSettings':
        ...
        return constructor.new(_1570.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None
    ...
    @property
    def pid_control_settings(self) -> '_1570.PIDControlSettings':
        ...
        return constructor.new(_1570.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6471.ElectricMachineHarmonicLoadData':
