...
from mastapy.system_model.analyses_and_results.static_loads import _6614, _6615, _6525
...
class WormGearSetLoadCase(_6525.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6614.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6614.WormGearLoadCase))
        return value

    @property
    def worm_gears_load_case(self) -> 'List[_6614.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6614.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6615.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6615.WormGearMeshLoadCase))
        return value
