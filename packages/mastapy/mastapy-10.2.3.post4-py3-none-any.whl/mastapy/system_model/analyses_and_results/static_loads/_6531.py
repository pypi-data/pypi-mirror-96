...
from mastapy.system_model.analyses_and_results.static_loads import _6530, _6520
...
class PlanetCarrierLoadCase(_6520.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6530.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6530.PlanetarySocketManufactureError))
        return value
