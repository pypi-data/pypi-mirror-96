...
from mastapy.system_model.analyses_and_results.static_loads import _6460, _6487
...
class CylindricalGearLoadCase(_6487.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6460.CylindricalGearManufactureError':
        ...
        return constructor.new(_6460.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
