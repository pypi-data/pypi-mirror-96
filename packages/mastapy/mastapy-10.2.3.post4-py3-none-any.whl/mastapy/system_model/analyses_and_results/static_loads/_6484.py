...
from mastapy.system_model.fe import _2011, _2034
...
class FEPartLoadCase(_6407.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2011.AngleSource':
        ...
        return constructor.new(_2011.AngleSource)(value) if value else None
