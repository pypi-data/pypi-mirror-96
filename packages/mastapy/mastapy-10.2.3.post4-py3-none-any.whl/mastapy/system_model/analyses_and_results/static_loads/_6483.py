...
from mastapy.system_model.analyses_and_results.static_loads import _6481, _6482, _6492
...
class FaceGearSetLoadCase(_6492.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6481.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6481.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6481.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6481.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6482.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6482.FaceGearMeshLoadCase))
        return value
