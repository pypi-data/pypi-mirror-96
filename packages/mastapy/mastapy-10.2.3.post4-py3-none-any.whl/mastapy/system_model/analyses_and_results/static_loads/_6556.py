...
from mastapy.system_model.analyses_and_results.load_case_groups import _5284, _5285, _5286
...
class StaticLoadCase(_6404.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2323.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2323.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5642.HarmonicAnalysisOptions':
        ...
        if _5642.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptionsForATSAM.__class__.__mro__:
    ...
    @property
    def clutch_engagements(self) -> 'List[_5284.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5284.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5285.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5285.ConceptSynchroGearEngagementStatus))
        return value
    ...
    def duplicate(self, new_design_state_group: '_5286.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
