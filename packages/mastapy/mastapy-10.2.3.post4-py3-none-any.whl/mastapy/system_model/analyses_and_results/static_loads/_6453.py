...
from mastapy.system_model.analyses_and_results.static_loads import _6454, _6420
...
class CVTLoadCase(_6420.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def assembly_design(self) -> '_2232.CVT':
        ...
        return constructor.new(_2232.CVT)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def pulleys(self) -> 'List[_6454.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6454.CVTPulleyLoadCase))
        return value
