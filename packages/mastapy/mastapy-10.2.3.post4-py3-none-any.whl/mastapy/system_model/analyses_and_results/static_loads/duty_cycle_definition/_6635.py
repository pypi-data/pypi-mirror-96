...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6636, _6630
...
class TorqueInputOptions(_6630.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6636.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6636.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6636.TorqueValuesObtainedFrom'):
