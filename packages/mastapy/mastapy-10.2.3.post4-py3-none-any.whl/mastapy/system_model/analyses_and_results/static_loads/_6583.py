...
from mastapy.system_model.analyses_and_results.static_loads import _6581, _6582, _6492
...
class WormGearSetLoadCase(_6492.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6581.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6581.WormGearLoadCase))
        return value

    @property
    def worm_gears_load_case(self) -> 'List[_6581.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6581.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6582.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6582.WormGearMeshLoadCase))
        return value
