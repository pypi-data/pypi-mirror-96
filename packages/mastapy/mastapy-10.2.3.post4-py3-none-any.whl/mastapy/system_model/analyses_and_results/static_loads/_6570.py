...
class TimeSeriesLoadCase(_6404.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5085.MBDAnalysisOptions':
        ...
        return constructor.new(_5085.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
