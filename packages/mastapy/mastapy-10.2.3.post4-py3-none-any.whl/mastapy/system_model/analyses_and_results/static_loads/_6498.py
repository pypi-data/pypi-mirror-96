...
from mastapy.system_model.analyses_and_results.static_loads import _6501, _6497, _6477
...
class HarmonicLoadDataImportFromMotorPackages(_6497.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
