...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6285
...
class CVTCompoundCriticalSpeedAnalysis(_6285.BeltDriveCompoundCriticalSpeedAnalysis):
    '''CVTCompoundCriticalSpeedAnalysis
