...
class SynchroniserHalfCompoundCriticalSpeedAnalysis(_6390.SynchroniserPartCompoundCriticalSpeedAnalysis):
    '''SynchroniserHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6260.SynchroniserHalfCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6260.SynchroniserHalfCriticalSpeedAnalysis))
        return value

    @property
    def component_critical_speed_analysis_load_cases(self) -> 'List[_6260.SynchroniserHalfCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentCriticalSpeedAnalysisLoadCases, constructor.new(_6260.SynchroniserHalfCriticalSpeedAnalysis))
        return value
