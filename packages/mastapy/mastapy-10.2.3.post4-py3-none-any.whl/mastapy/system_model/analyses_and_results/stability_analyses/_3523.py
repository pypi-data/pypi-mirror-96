...
from mastapy.system_model.analyses_and_results.stability_analyses import _3524, _3522, _3456
...
class WormGearSetStabilityAnalysis(_3456.GearSetStabilityAnalysis):
    '''WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3524.WormGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsStabilityAnalysis, constructor.new(_3524.WormGearStabilityAnalysis))
        return value

    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3522.WormGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesStabilityAnalysis, constructor.new(_3522.WormGearMeshStabilityAnalysis))
        return value
