...
from mastapy.system_model.analyses_and_results.stability_analyses import _3535, _3533, _3442
...
class StraightBevelDiffGearSetStabilityAnalysis(_3442.BevelGearSetStabilityAnalysis):
    '''StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3535.StraightBevelDiffGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsStabilityAnalysis, constructor.new(_3535.StraightBevelDiffGearStabilityAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3533.StraightBevelDiffGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesStabilityAnalysis, constructor.new(_3533.StraightBevelDiffGearMeshStabilityAnalysis))
        return value
