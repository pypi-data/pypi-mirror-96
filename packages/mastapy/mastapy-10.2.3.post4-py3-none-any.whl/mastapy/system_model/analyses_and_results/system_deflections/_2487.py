...
from mastapy.system_model.analyses_and_results.system_deflections import _2439, _2489
...
class SystemDeflection(_7174.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2439.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2439.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2489.SystemDeflectionOptions':
        ...
        return constructor.new(_2489.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
