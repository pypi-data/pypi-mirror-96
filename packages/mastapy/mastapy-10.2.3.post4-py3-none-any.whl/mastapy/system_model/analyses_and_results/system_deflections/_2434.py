...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2483
...
class ShaftHubConnectionSystemDeflection(_2363.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_design(self) -> '_2244.ShaftHubConnection':
        ...
        return constructor.new(_2244.ShaftHubConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def component_load_case(self) -> '_6545.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_6545.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3761.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3761.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1638.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1638.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1638.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1638.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2483.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2483.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2483.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2483.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2483.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2483.SplineFlankContactReporting))
        return value
