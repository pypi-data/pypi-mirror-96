...
class ShaftToMountableComponentConnectionSystemDeflection(_2328.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3763.ShaftToMountableComponentConnectionPowerFlow':
