...
class SpringDamperHalfSystemDeflection(_2307.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3378.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3378.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
