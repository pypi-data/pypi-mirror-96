...
class TorqueConverterConnectionSystemDeflection(_2306.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3393.TorqueConverterConnectionPowerFlow':
        ...
        return constructor.new(_3393.TorqueConverterConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
