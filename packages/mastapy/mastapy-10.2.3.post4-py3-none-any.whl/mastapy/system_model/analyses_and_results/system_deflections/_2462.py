...
class TorqueConverterPumpSystemDeflection(_2365.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3786.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3786.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
