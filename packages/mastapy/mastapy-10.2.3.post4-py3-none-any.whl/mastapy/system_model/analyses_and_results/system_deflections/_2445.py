...
class SpringDamperSystemDeflection(_2366.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3770.SpringDamperPowerFlow':
        ...
        return constructor.new(_3770.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
