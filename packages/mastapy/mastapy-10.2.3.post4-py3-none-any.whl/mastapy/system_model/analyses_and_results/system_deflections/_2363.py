...
from mastapy.system_model.analyses_and_results.power_flows import _3365, _3320
...
class PulleySystemDeflection(_2307.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3365.PulleyPowerFlow':
