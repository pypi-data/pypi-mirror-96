...
class UnbalancedMassSystemDeflection(_2402.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3397.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3397.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
