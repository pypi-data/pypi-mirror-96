...
class PartToPartShearCouplingConnectionSystemDeflection(_2364.CouplingConnectionSystemDeflection):
    '''PartToPartShearCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3744.PartToPartShearCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3744.PartToPartShearCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
