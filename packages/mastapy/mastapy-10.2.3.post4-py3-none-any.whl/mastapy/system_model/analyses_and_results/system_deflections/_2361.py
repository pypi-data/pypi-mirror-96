...
class PointLoadSystemDeflection(_2402.VirtualComponentSystemDeflection):
    '''PointLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3361.PointLoadPowerFlow':
        ...
        return constructor.new(_3361.PointLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
