...
from mastapy.system_model.analyses_and_results.power_flows import _3389, _3388, _3391
...
class SynchroniserPartSystemDeflection(_2307.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3389.SynchroniserPartPowerFlow':
