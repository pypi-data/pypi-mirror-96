...
from mastapy.system_model.analyses_and_results.system_deflections import _2483, _2468
...
class SynchroniserSystemDeflection(_2468.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3810.SynchroniserPowerFlow':
        ...
        return constructor.new(_3810.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def cones(self) -> 'List[_2483.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2483.SynchroniserHalfSystemDeflection))
        return value
