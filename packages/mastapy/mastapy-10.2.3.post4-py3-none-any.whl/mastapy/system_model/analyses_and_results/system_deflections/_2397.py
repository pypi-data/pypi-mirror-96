...
class TorqueConverterSystemDeflection(_2308.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3394.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3394.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
