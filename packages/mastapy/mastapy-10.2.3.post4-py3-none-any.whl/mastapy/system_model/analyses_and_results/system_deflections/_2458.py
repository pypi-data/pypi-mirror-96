...
from mastapy.system_model.analyses_and_results.system_deflections import _2410, _2460
...
class SystemDeflection(_7141.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2410.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2410.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2460.SystemDeflectionOptions':
        ...
        return constructor.new(_2460.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
