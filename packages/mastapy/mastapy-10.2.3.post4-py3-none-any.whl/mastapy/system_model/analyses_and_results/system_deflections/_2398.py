...
class TorqueConverterTurbineSystemDeflection(_2307.CouplingHalfSystemDeflection):
    '''TorqueConverterTurbineSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3396.TorqueConverterTurbinePowerFlow':
        ...
        return constructor.new(_3396.TorqueConverterTurbinePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
