...
class ZerolBevelGearSystemDeflection(_2285.BevelGearSystemDeflection):
    '''ZerolBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3403.ZerolBevelGearPowerFlow':
        ...
        return constructor.new(_3403.ZerolBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
