...
from mastapy.system_model.analyses_and_results.system_deflections import _2390, _2350
from mastapy.system_model.fe import _2036
from mastapy.system_model.analyses_and_results.power_flows import (
    _3741, _3668, _3671, _3675,
    _3677, _3678, _3680, _3685,
    _3690, _3693, _3696, _3699,
    _3701, _3705, _3712, _3714,
    _3718, _3723, _3727, _3731,
    _3734, _3737, _3739, _3740,
    _3742, _3745, _3749, _3750,
    _3753, _3754, _3755, _3759,
    _3761, _3766, _3769, _3772,
    _3775, _3777, _3778, _3779,
    _3780, _3782, _3786, _3787,
    _3788, _3789, _3791, _3794
)
...
class MountableComponentSystemDeflection(_2350.ComponentSystemDeflection):
    '''MountableComponentSystemDeflection
    ...
    @property
    def component_design(self) -> '_2112.MountableComponent':
    ...
    @property
    def inner_fe_part(self) -> '_2390.FEPartSystemDeflection':
        ...
        return constructor.new(_2390.FEPartSystemDeflection)(self.wrapped.InnerFEPart) if self.wrapped.InnerFEPart else None

    @property
    def inner_fe_substructure_nodes(self) -> 'List[_2036.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerFESubstructureNodes, constructor.new(_2036.FESubstructureNode))
        return value

    @property
    def power_flow_results(self) -> '_3741.MountableComponentPowerFlow':
