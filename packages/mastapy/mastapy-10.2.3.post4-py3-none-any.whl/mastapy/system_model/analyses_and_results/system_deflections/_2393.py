...
from mastapy.system_model.drawing import _1881, _1870
...
class SystemDeflectionDrawStyle(_1870.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1881.ScalingDrawStyle':
        ...
        return constructor.new(_1881.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
