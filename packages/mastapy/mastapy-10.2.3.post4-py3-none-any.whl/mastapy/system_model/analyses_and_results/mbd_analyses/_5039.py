...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5173
...
class BearingMultiBodyDynamicsAnalysis(_5069.ConnectorMultiBodyDynamicsAnalysis):
    '''BearingMultiBodyDynamicsAnalysis
