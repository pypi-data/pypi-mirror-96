...
class PulleyMultiBodyDynamicsAnalysis(_5071.CouplingHalfMultiBodyDynamicsAnalysis):
    '''PulleyMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self) -> 'List[_5174.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakPulleyTorque, constructor.new(_5174.DynamicTorqueResultAtTime))
        return value
