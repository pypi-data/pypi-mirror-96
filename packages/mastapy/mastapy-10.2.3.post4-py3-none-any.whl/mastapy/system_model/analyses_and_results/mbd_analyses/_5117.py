...
from mastapy.system_model.drawing import _1873
from mastapy.system_model.analyses_and_results.analysis_cases import _6565
...
class PartMultiBodyDynamicsAnalysis(_6565.PartTimeSeriesLoadAnalysisCase):
    '''PartMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis(self) -> '_5115.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5115.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysis) if self.wrapped.MultiBodyDynamicsAnalysis else None

    def create_viewable(self) -> '_1873.MBDAnalysisViewable':
