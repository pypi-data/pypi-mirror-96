...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5363, _5308
...
class RootAssemblyHarmonicAnalysisOfSingleExcitation(_5308.AssemblyHarmonicAnalysisOfSingleExcitation):
    '''RootAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def harmonic_analysis_of_single_excitation_inputs(self) -> '_5363.HarmonicAnalysisOfSingleExcitation':
        ...
        return constructor.new(_5363.HarmonicAnalysisOfSingleExcitation)(self.wrapped.HarmonicAnalysisOfSingleExcitationInputs) if self.wrapped.HarmonicAnalysisOfSingleExcitationInputs else None
