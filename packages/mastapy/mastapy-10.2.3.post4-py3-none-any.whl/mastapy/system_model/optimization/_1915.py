...
from mastapy.system_model.optimization import _1916, _1914
...
TStep = TypeVar('TStep', bound='_1914.OptimizationStep')


class OptimizationStrategy(_1916.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
