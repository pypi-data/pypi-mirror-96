...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self) -> '_3686.RotorDynamicsDrawStyle':
        ...
        if _3686.RotorDynamicsDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_steady_state_synchronous_response_draw_style(self) -> '_3270.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3270.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_stability_analysis_draw_style(self) -> '_3531.StabilityAnalysisDrawStyle':
        ...
        if _3531.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_critical_speed_analysis_draw_style(self) -> '_6217.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6217.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
