...
from mastapy.system_model.part_model import _2128, _2126
...
class PowerLoad(_2126.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2128.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2128.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6469.ElectricMachineDetail':
        ...
        return constructor.new(_6469.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
