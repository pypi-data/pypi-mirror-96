...
from mastapy.system_model.part_model import _2109, _2112
...
class PlanetCarrier(_2112.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_1941.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1941.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2129.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2129.Shaft', offset: Optional['float'] = float('nan')):
