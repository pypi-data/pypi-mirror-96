...
from mastapy.system_model.part_model.gears import _2191, _2166
...
class StraightBevelDiffGearSet(_2166.BevelGearSet):
    '''StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2191.StraightBevelDiffGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_2191.StraightBevelDiffGear))
        return value

    @property
    def straight_bevel_diff_meshes(self) -> 'List[_1979.StraightBevelDiffGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_1979.StraightBevelDiffGearMesh))
        return value
