...
from mastapy.system_model.part_model.gears import _2189, _2166
...
class SpiralBevelGearSet(_2166.BevelGearSet):
    '''SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2189.SpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_2189.SpiralBevelGear))
        return value

    @property
    def spiral_bevel_meshes(self) -> 'List[_1977.SpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_1977.SpiralBevelGearMesh))
        return value
