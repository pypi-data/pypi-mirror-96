...
from mastapy.system_model.part_model.couplings import _2248, _2250
...
class SynchroniserHalf(_2250.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2248.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2248.SynchroniserCone))
        return value
