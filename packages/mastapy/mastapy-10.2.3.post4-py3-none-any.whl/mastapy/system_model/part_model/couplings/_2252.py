...
from mastapy.system_model.part_model.couplings import _2253, _2255, _2229
...
class TorqueConverter(_2229.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2253.TorqueConverterPump':
        ...
        return constructor.new(_2253.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2255.TorqueConverterTurbine':
        ...
        return constructor.new(_2255.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
