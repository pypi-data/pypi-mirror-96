...
from mastapy.system_model.part_model.couplings import _2279, _2281, _2254
...
class TorqueConverter(_2254.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2279.TorqueConverterPump':
        ...
        return constructor.new(_2279.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2281.TorqueConverterTurbine':
        ...
        return constructor.new(_2281.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
