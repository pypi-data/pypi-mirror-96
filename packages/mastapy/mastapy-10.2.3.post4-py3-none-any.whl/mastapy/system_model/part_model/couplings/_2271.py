...
class SpringDamper(_2254.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2026.SpringDamperConnection':
        ...
        return constructor.new(_2026.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection else None
