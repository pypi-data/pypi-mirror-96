...
class FESubstructureWithSelection(_2012.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2034.FESubstructure':
        ...
        return constructor.new(_2034.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure else None

    @property
    def element_face_groups(self) -> 'List[_2027.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2027.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2050.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2050.NodeGroupWithSelection))
        return value
