...
from mastapy.system_model.fe import _2033, _2040
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2033.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2033.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2033.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2040.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2040.BearingRaceNodeLink))
        return value
