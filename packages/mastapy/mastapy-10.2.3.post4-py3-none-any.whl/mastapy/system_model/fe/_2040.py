...
from mastapy.system_model.fe.links import _2069
from mastapy.system_model.fe import (
    _2028, _2048, _2020, _2019,
    _2039
)
...
class FESubstructureWithSelectionComponents(_2039.FESubstructureWithSelection):
    '''FESubstructureWithSelectionComponents
    ...
    @property
    def component_links(self) -> 'List[_2069.FELinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentLinks, constructor.new(_2069.FELinkWithSelection))
        return value

    @property
    def links_for_selected_component(self) -> 'List[_2069.FELinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForSelectedComponent, constructor.new(_2069.FELinkWithSelection))
        return value

    @property
    def links_for_electric_machine(self) -> 'List[_2069.FELinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForElectricMachine, constructor.new(_2069.FELinkWithSelection))
        return value

    @property
    def rigid_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_181.ElementPropertiesRigid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_181.ElementPropertiesRigid])
        return value

    @property
    def solid_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_183.ElementPropertiesSolid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_183.ElementPropertiesSolid])
        return value

    @property
    def shell_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_182.ElementPropertiesShell]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_182.ElementPropertiesShell])
        return value

    @property
    def beam_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_178.ElementPropertiesBeam]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_178.ElementPropertiesBeam])
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_184.ElementPropertiesSpringDashpot]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_184.ElementPropertiesSpringDashpot])
        return value

    @property
    def mass_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_180.ElementPropertiesMass]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_180.ElementPropertiesMass])
        return value

    @property
    def interface_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_179.ElementPropertiesInterface]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_179.ElementPropertiesInterface])
        return value

    @property
    def other_element_properties(self) -> 'List[_2028.ElementPropertiesWithSelection[_177.ElementPropertiesBase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_2028.ElementPropertiesWithSelection)[_177.ElementPropertiesBase])
        return value

    @property
    def materials(self) -> 'List[_2048.MaterialPropertiesWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_2048.MaterialPropertiesWithSelection))
        return value

    @property
    def coordinate_systems(self) -> 'List[_2020.CoordinateSystemWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CoordinateSystems, constructor.new(_2020.CoordinateSystemWithSelection))
        return value

    @property
    def contact_pairs(self) -> 'List[_2019.ContactPairWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_2019.ContactPairWithSelection))
        return value
