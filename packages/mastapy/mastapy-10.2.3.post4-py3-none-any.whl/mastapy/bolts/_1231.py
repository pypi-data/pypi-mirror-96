...
from mastapy.bolts import _1246, _1227
...
class BoltMaterial(_1227.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1246.StrengthGrades':
        ...
        return constructor.new(_1246.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1246.StrengthGrades'):
