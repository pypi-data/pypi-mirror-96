...
from mastapy.utility.report import _1518, _1511
...
class UserTextRow(_1511.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1518.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1518.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1518.HeadingSize'):
