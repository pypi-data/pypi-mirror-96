...
from mastapy.utility.report import _1499, _1500
...
T = TypeVar('T', bound='_1500.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1499.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
