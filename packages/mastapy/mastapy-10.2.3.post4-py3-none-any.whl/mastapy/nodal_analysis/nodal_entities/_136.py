...
class LineContactStiffnessEntity(_121.ArbitraryNodalComponent):
    ...
    @property
    def stiffness_in_local_coordinate_system(self) -> '_71.NodalMatrix':
        ...
        return constructor.new(_71.NodalMatrix)(self.wrapped.StiffnessInLocalCoordinateSystem) if self.wrapped.StiffnessInLocalCoordinateSystem else None
