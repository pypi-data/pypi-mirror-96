...
class SurfaceToSurfaceContactStiffnessEntity(_121.ArbitraryNodalComponent):
    ...
    @property
    def contact(self) -> '_1536.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1536.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
