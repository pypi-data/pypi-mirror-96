...
from mastapy.nodal_analysis.component_mode_synthesis import _197, _193
...
class CMSModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_155.FEModel':
        ...
        return constructor.new(_155.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_197.CMSOptions':
        ...
        return constructor.new(_197.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_193.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_193.CMSElementFaceGroup))
        return value
