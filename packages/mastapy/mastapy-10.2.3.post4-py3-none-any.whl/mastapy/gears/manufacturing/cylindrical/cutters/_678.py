...
class CylindricalGearShaper(_682.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_999.ShaperEdgeTypes':
        ...
        return constructor.new(_999.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_999.ShaperEdgeTypes'):
