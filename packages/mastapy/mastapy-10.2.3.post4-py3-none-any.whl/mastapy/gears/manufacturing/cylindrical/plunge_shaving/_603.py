...
class VirtualPlungeShaverOutputs(_597.PlungeShaverOutputs):
    ...
    @property
    def lead_modification_on_conjugate_shaver_chart_left_flank(self) -> '_7157.SMTBitmap':
        ...
        return constructor.new(_7157.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank) if self.wrapped.LeadModificationOnConjugateShaverChartLeftFlank else None

    @property
    def lead_modification_on_conjugate_shaver_chart_right_flank(self) -> '_7157.SMTBitmap':
        ...
        return constructor.new(_7157.SMTBitmap)(self.wrapped.LeadModificationOnConjugateShaverChartRightFlank) if self.wrapped.LeadModificationOnConjugateShaverChartRightFlank else None
