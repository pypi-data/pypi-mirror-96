...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _631, _618, _645
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_631.ProcessSimulationInput':
        ...
        if _631.ProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_618.HobbingProcessSimulationInput':
        ...
        if _618.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_645.WormGrindingProcessSimulationInput':
        ...
        if _645.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
