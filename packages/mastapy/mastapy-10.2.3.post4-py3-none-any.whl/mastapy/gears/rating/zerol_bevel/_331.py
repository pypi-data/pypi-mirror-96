...
from mastapy.gears.rating.zerol_bevel import _329, _330
...
class ZerolBevelGearSetRating(_503.BevelGearSetRating):
    '''ZerolBevelGearSetRating
    ...
    @property
    def zerol_bevel_mesh_ratings(self) -> 'List[_329.ZerolBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshRatings, constructor.new(_329.ZerolBevelGearMeshRating))
        return value
