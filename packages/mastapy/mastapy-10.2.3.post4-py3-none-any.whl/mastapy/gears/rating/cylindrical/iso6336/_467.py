...
from mastapy.gears.rating.cylindrical.iso6336 import _463, _473
...
class ISO63362006GearSingleFlankRating(_473.ISO6336AbstractMetalGearSingleFlankRating):
    '''ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_463.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_463.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults else None
