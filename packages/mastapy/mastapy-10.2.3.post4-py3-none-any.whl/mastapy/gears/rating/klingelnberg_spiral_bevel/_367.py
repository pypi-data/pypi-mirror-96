...
from mastapy.gears.rating.klingelnberg_spiral_bevel import _365, _366
...
class KlingelnbergCycloPalloidSpiralBevelGearSetRating(_373.KlingelnbergCycloPalloidConicalGearSetRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_mesh_ratings(self) -> 'List[_365.KlingelnbergCycloPalloidSpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshRatings, constructor.new(_365.KlingelnbergCycloPalloidSpiralBevelGearMeshRating))
        return value
