...
class StraightBevelGearRating(_502.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_894.StraightBevelGearDesign':
        ...
        return constructor.new(_894.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
