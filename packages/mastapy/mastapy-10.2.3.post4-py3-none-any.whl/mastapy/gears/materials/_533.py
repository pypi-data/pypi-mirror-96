...
from mastapy.gears.materials import _554, _540
...
class BevelGearMaterial(_540.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_554.SNCurveDefinition':
        ...
        return constructor.new(_554.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_554.SNCurveDefinition'):
