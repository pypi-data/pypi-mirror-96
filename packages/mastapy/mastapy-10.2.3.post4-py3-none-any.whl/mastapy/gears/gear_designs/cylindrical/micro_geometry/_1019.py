...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1018
...
class CylindricalGearLeadModificationAtProfilePosition(_1018.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_952.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_952.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
