...
from mastapy.gears.gear_designs.cylindrical import _941, _967, _952
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1017, _1037
...
class CylindricalGearMicroGeometry(_1128.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    @property
    def cylindrical_gear(self) -> '_941.CylindricalGearDesign':
        ...
        if _941.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGear.__class__.__mro__:
    ...
    @property
    def left_flank(self) -> '_1017.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1017.CylindricalGearFlankMicroGeometry)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_1017.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1017.CylindricalGearFlankMicroGeometry)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
    ...
    @property
    def flanks(self) -> 'List[_1017.CylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1017.CylindricalGearFlankMicroGeometry))
        return value

    @property
    def meshed_gears(self) -> 'List[_1037.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_1037.MeshedCylindricalGearMicroGeometry))
        return value

    @property
    def both_flanks(self) -> '_1017.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1017.CylindricalGearFlankMicroGeometry)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None
