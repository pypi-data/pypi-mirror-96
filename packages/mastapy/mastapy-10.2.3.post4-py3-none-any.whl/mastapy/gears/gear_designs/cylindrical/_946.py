...
from mastapy.utility.units_and_measurements import _1276
...
class CylindricalGearDesignSettings(_1263.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def tolerance_rounding_system(self) -> '_1276.MeasurementSystem':
        ...
        return constructor.new(_1276.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1276.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
