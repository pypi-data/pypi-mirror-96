...
class BevelGearDesign(_1103.AGMAGleasonConicalGearDesign):
    ...
    @property
    def finishing_method(self) -> '_1096.FinishingMethods':
        ...
        return constructor.new(_1096.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1096.FinishingMethods'):
