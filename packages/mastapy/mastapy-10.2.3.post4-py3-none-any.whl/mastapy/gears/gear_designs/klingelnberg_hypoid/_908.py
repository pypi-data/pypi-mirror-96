...
from mastapy.gears.gear_designs.klingelnberg_hypoid import _906, _907
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(_912.KlingelnbergConicalGearSetDesign):
    '''KlingelnbergCycloPalloidHypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_906.KlingelnbergCycloPalloidHypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_906.KlingelnbergCycloPalloidHypoidGearDesign))
        return value
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_907.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_907.KlingelnbergCycloPalloidHypoidGearMeshDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_907.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshes, constructor.new(_907.KlingelnbergCycloPalloidHypoidGearMeshDesign))
        return value
