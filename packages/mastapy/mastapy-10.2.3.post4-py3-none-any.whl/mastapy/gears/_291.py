...
class GearSetOptimisationResults(_0.APIBase):
    ...
    @property
    def results(self) -> 'List[_290.GearSetOptimisationResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Results, constructor.new(_290.GearSetOptimisationResult))
        return value
