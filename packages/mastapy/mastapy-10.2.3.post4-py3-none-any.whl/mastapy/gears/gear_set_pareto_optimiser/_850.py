...
class MicroGeometryDesignSpaceSearchChartInformation(_836.ChartInfoBase['_795.CylindricalGearSetLoadDistributionAnalysis', '_849.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_848.MicroGeometryDesignSpaceSearch':
