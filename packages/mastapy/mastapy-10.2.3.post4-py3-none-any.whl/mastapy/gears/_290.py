...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    def optimisation_history(self) -> '_1542.OptimisationHistory':
        '''OptimisationHistory: 'OptimisationHistory' is the original name of this property.'''

        return constructor.new(_1542.OptimisationHistory)(self.wrapped.OptimisationHistory) if self.wrapped.OptimisationHistory else None

    @optimisation_history.setter
    def optimisation_history(self, value: '_1542.OptimisationHistory'):
