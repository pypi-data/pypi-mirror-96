...
class GearFEModel(_1128.GearImplementationDetail):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_286.GearFlanks', progress: '_7153.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7153.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
