...
from mastapy.gears import _284, _283
...
class CylindricalMeshLoadCase(_810.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_284.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_284.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_284.CylindricalMisalignmentDataSource'):
