...
class ShaftPointStressCycleReporting(_0.APIBase):
    ...
    @property
    def nominal_stress(self) -> '_26.ShaftPointStressCycle':
        ...
        return constructor.new(_26.ShaftPointStressCycle)(self.wrapped.NominalStress) if self.wrapped.NominalStress else None

    @property
    def stress(self) -> '_26.ShaftPointStressCycle':
        ...
        return constructor.new(_26.ShaftPointStressCycle)(self.wrapped.Stress) if self.wrapped.Stress else None
