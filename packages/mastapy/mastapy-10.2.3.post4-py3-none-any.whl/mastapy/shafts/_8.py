...
class DesignShaftSection(_0.APIBase):
    ...
    @property
    def left(self) -> '_9.DesignShaftSectionEnd':
        ...
        return constructor.new(_9.DesignShaftSectionEnd)(self.wrapped.Left) if self.wrapped.Left else None

    @property
    def right(self) -> '_9.DesignShaftSectionEnd':
        ...
        return constructor.new(_9.DesignShaftSectionEnd)(self.wrapped.Right) if self.wrapped.Right else None
