...
class ShaftProfilePoint(_0.APIBase):
    ...
    @property
    def stress_concentration_factors(self) -> '_14.ProfilePointFilletStressConcentrationFactors':
        ...
        return constructor.new(_14.ProfilePointFilletStressConcentrationFactors)(self.wrapped.StressConcentrationFactors) if self.wrapped.StressConcentrationFactors else None
