...
from mastapy.math_utility import _1106, _1097
from mastapy.shafts import _35, _36, _34
...
class ShaftDamageResults(_0.APIBase):
    ...
    @property
    def displacement_linear(self) -> 'List[_1106.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementLinear, constructor.new(_1106.Vector4D))
        return value

    @property
    def displacement_angular(self) -> 'List[_1106.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementAngular, constructor.new(_1106.Vector4D))
        return value
    ...
    @property
    def force_linear(self) -> 'List[_1106.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceLinear, constructor.new(_1106.Vector4D))
        return value

    @property
    def force_angular(self) -> 'List[_1106.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceAngular, constructor.new(_1106.Vector4D))
        return value
    ...
    @property
    def cyclic_degrees_of_utilisation(self) -> 'List[_1097.RealVector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CyclicDegreesOfUtilisation, constructor.new(_1097.RealVector))
        return value
    ...
    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_35.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_35.ShaftSectionEndDamageResults)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_35.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_35.ShaftSectionEndDamageResults)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_35.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_35.ShaftSectionEndDamageResults)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_damage_results(self) -> 'List[_34.ShaftSectionDamageResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionDamageResults, constructor.new(_34.ShaftSectionDamageResults))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_35.ShaftSectionEndDamageResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_35.ShaftSectionEndDamageResults))
        return value
