...
from mastapy.math_utility.optimisation import _1318, _1316
...
class ParetoOptimistaionVariable(_1316.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1318.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1318.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1318.PropertyTargetForDominantCandidateSearch'):
