...
from mastapy.bearings.bearing_designs.rolling import _1842, _1843, _1841
...
class NonBarrelRollerBearing(_1841.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1842.RollerEndShape':
        ...
        return constructor.new(_1842.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1842.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1843.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1843.RollerRibDetail))
        return value
