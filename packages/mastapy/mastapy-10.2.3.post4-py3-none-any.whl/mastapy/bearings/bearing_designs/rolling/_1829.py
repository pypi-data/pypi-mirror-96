...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1830.BearingProtectionLevel':
        ...
        return constructor.new(_1830.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1830.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1830.BearingProtectionLevel'):
