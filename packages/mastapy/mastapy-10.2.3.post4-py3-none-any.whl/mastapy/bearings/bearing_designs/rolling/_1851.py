...
class ThrustBallBearing(_1825.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1589.OuterRingMounting':
        ...
        return constructor.new(_1589.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1589.OuterRingMounting'):
