...
from mastapy.bearings.bearing_designs.rolling import _1826, _1844
...
class BallBearing(_1844.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1826.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1826.BallBearingShoulderDefinition))
        return value
