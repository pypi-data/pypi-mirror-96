...
from mastapy.bearings.bearing_designs.rolling import _1848, _1845
...
class TaperRollerBearing(_1845.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1583.BearingMeasurementType':
        ...
        return constructor.new(_1583.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1583.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1848.RollerRibDetail':
        ...
        return constructor.new(_1848.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
