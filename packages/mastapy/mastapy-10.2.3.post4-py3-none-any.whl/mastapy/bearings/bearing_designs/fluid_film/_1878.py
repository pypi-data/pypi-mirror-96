...
class TiltingPadThrustBearing(_1870.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1603.TiltingPadTypes':
        ...
        return constructor.new(_1603.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1603.TiltingPadTypes'):
