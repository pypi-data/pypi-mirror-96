...
from mastapy.bearings.bearing_results.rolling import _1747, _1719
...
class LoadedToroidalRollerBearingRow(_1719.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1747.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1747.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
