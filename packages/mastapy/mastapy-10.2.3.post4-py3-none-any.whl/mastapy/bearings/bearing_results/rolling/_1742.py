...
from mastapy.bearings.bearing_results.rolling import _1741, _1692
...
class LoadedThreePointContactBallBearingRow(_1692.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1741.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1741.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
