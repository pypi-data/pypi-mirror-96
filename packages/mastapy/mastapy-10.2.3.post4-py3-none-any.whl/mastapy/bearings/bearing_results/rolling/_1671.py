...
from mastapy.bearings.bearing_results.rolling import _1670, _1659
...
class LoadedNeedleRollerBearingRow(_1659.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1670.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1670.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
