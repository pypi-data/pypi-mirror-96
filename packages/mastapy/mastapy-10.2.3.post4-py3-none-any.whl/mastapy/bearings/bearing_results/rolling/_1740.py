...
from mastapy.bearings.bearing_results.rolling import _1708
...
class LoadedThreePointContactBallBearingElement(_1708.LoadedMultiPointContactBallBearingElement):
    '''LoadedThreePointContactBallBearingElement
