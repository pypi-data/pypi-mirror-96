...
from mastapy.bearings.bearing_results.rolling import (
    _1678, _1638, _1643, _1646,
    _1654, _1658, _1670, _1673,
    _1689, _1692, _1698, _1707,
    _1624, _1683
)
...
class LoadedRollerBearingRow(_1683.LoadedRollingBearingRow):
    '''LoadedRollerBearingRow
    ...
    @property
    def shear_stress_chart_inner(self) -> '_6574.SMTBitmap':
        ...
        return constructor.new(_6574.SMTBitmap)(self.wrapped.ShearStressChartInner) if self.wrapped.ShearStressChartInner else None

    @property
    def shear_stress_chart_outer(self) -> '_6574.SMTBitmap':
        ...
        return constructor.new(_6574.SMTBitmap)(self.wrapped.ShearStressChartOuter) if self.wrapped.ShearStressChartOuter else None

    @property
    def depth_of_maximum_shear_stress_chart_inner(self) -> '_6574.SMTBitmap':
        ...
        return constructor.new(_6574.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartInner) if self.wrapped.DepthOfMaximumShearStressChartInner else None

    @property
    def depth_of_maximum_shear_stress_chart_outer(self) -> '_6574.SMTBitmap':
        ...
        return constructor.new(_6574.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartOuter) if self.wrapped.DepthOfMaximumShearStressChartOuter else None

    @property
    def loaded_bearing(self) -> '_1678.LoadedRollerBearingResults':
    ...
    @property
    def lamina_dynamic_equivalent_loads(self) -> 'List[_1624.ForceAtLaminaGroupReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LaminaDynamicEquivalentLoads, constructor.new(_1624.ForceAtLaminaGroupReportable))
        return value
