...
from mastapy.bearings.bearing_results.rolling import _1685, _1652
...
class LoadedSelfAligningBallBearingRow(_1652.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1685.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1685.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
