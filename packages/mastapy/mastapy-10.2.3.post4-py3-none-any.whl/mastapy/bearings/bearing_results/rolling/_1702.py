...
from mastapy.bearings.bearing_results.rolling import _1701, _1652
...
class LoadedThreePointContactBallBearingRow(_1652.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1701.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1701.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
