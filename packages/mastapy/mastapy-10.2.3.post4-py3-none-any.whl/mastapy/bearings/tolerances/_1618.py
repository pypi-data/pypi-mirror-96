...
from mastapy.bearings.tolerances import _1614, _1606
...
class SupportDetail(_1606.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1614.RadialSpecificationMethod':
        ...
        return constructor.new(_1614.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1614.RadialSpecificationMethod'):
