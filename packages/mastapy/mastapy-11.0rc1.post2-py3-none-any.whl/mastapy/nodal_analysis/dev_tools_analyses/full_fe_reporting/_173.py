...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1139
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1139.CoordinateSystemType':
        ...
        return constructor.new(_1139.CoordinateSystemType)(value) if value else None
