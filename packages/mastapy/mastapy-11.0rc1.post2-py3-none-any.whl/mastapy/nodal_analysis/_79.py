...
class TransientSolverOptions(_0.APIBase):
    ...
    @property
    def solver_tolerance_input_method(self) -> '_81.TransientSolverToleranceInputMethod':
        ...
        return constructor.new(_81.TransientSolverToleranceInputMethod)(value) if value else None

    @solver_tolerance_input_method.setter
    def solver_tolerance_input_method(self, value: '_81.TransientSolverToleranceInputMethod'):
    ...
    @property
    def result_logging_frequency(self) -> '_75.ResultLoggingFrequency':
        ...
        return constructor.new(_75.ResultLoggingFrequency)(value) if value else None

    @result_logging_frequency.setter
    def result_logging_frequency(self, value: '_75.ResultLoggingFrequency'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
