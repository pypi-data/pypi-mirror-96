...
from mastapy.bearings.bearing_results.rolling import _1691, _1689
...
class LoadedAxialThrustNeedleRollerBearingRow(_1689.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1691.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1691.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
