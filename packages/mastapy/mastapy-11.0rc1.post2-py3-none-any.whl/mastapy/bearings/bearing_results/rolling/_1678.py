...
from mastapy.bearings.bearing_results.rolling import _1677, _1680, _1697
...
class LoadedAngularContactBallBearingRow(_1697.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1677.LoadedAngularContactBallBearingResults':
