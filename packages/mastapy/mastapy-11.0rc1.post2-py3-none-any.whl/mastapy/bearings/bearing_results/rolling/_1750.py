...
from mastapy.bearings.bearing_results.rolling import _1749, _1697
...
class LoadedThrustBallBearingRow(_1697.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1749.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1749.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
