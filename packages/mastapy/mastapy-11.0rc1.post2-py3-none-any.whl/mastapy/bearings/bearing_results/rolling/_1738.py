...
from mastapy.bearings.bearing_results.rolling import _1737, _1724
...
class LoadedSphericalRollerThrustBearingRow(_1724.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1737.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1737.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
