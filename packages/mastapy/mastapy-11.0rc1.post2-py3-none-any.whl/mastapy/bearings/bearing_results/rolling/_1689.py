...
from mastapy.bearings.bearing_results.rolling import _1688, _1691, _1719
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1719.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1688.LoadedAxialThrustCylindricalRollerBearingResults':
