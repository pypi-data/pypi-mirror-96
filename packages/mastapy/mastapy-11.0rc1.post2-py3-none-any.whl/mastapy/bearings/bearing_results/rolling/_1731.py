...
from mastapy.bearings.bearing_results.rolling import _1730, _1697
...
class LoadedSelfAligningBallBearingRow(_1697.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1730.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1730.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
