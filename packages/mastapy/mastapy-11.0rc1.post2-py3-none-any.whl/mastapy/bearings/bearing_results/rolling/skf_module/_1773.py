...
from mastapy.bearings.bearing_results.rolling.skf_module import _1783, _1787
...
class BearingRatingLife(_1787.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1783.LifeModel':
        ...
        return constructor.new(_1783.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
