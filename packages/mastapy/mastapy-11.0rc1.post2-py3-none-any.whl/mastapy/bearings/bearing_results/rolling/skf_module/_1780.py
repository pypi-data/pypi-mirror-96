...
class GreaseLifeAndRelubricationInterval(_1787.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1779.Grease':
        ...
        return constructor.new(_1779.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1782.InitialFill':
        ...
        return constructor.new(_1782.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1781.GreaseQuantity':
        ...
        return constructor.new(_1781.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
