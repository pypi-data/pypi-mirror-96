...
from mastapy.bearings.bearing_results.rolling import _1706, _1697
...
class LoadedDeepGrooveBallBearingRow(_1697.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1706.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1706.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
