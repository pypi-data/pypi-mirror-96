...
class ISO14179SettingsPerBearingType(_1343.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1601.RollingBearingType':
        ...
        return constructor.new(_1601.RollingBearingType)(value) if value else None
