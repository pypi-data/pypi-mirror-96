...
from mastapy.bearings.bearing_results.rolling import _1683, _1724
...
class LoadedAsymmetricSphericalRollerBearingRow(_1724.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1683.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1683.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
