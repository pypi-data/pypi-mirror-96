...
class ThrustBallBearing(_1830.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1594.OuterRingMounting':
        ...
        return constructor.new(_1594.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1594.OuterRingMounting'):
