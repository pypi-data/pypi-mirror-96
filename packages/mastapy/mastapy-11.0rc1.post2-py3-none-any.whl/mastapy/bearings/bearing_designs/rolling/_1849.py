...
class RollingBearing(_1821.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1576.BearingCatalog':
        ...
        return constructor.new(_1576.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1836.BearingTypeExtraInformation':
        ...
        return constructor.new(_1836.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1579.BearingCageMaterial':
        ...
        return constructor.new(_1579.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1579.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1851.SleeveType':
        ...
        return constructor.new(_1851.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1340.FileHistory':
        ...
        return constructor.new(_1340.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1833.BearingProtection':
        ...
        return constructor.new(_1833.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
