...
from mastapy.detailed_rigid_connectors.splines import (
    _1161, _1178, _1153, _1156,
    _1160, _1163, _1164, _1171,
    _1183
)
...
class SplineHalfDesign(_1151.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1161.HeatTreatmentTypes':
        ...
        return constructor.new(_1161.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1161.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1184.FitAndTolerance':
        ...
        return constructor.new(_1184.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
