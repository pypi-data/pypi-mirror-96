...
from mastapy.detailed_rigid_connectors.splines import _1165, _1174, _1182
...
class DIN5480SplineHalfDesign(_1182.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1165.ManufacturingTypes':
        ...
        return constructor.new(_1165.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1165.ManufacturingTypes'):
    ...
    def finishing_method(self) -> '_1174.FinishingMethods':
        ...
        return constructor.new(_1174.FinishingMethods)(value) if value else None
