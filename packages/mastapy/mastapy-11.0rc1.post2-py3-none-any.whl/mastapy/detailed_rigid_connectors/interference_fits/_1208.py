...
from mastapy.detailed_rigid_connectors.interference_fits import _1207, _1206, _1211
...
class InterferenceFitDesign(_1150.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1207.CalculationMethods':
        ...
        return constructor.new(_1207.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1207.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1206.AssemblyMethods':
        ...
        return constructor.new(_1206.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1206.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
