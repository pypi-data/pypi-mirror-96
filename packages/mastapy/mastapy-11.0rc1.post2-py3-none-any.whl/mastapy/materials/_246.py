...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_247.SoundPressureEnclosureType':
        ...
        return constructor.new(_247.SoundPressureEnclosureType)(value) if value else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_247.SoundPressureEnclosureType'):
