...
from mastapy.math_utility.measured_vectors import _1327, _1322
...
class ForceAndDisplacementResults(_1322.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1327.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1327.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
