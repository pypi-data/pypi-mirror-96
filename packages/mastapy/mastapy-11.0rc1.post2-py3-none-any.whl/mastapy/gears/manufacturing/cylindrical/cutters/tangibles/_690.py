...
class CylindricalGearShaperTangible(_687.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_678.CylindricalGearShaper':
        ...
        return constructor.new(_678.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design else None
