...
class ShavingDynamics(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_934.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_934.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
