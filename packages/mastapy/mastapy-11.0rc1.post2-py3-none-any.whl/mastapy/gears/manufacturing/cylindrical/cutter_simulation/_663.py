...
class ShaperSimulationCalculator(_649.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_690.CylindricalGearShaperTangible':
        ...
        return constructor.new(_690.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
