...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_293.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_293.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_650.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_650.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry else None

    @property
    def tooth_thickness(self) -> '_1010.ToothThicknessSpecificationBase':
        ...
        if _1010.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_971.FinishToothThicknessDesignSpecification':
        ...
        if _971.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_readonly_tooth_thickness_specification(self) -> '_992.ReadonlyToothThicknessSpecification':
        ...
        if _992.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_1009.ToothThicknessSpecification':
        ...
        if _1009.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
