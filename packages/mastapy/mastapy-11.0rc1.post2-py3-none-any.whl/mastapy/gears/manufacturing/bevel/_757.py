...
from mastapy.gears.manufacturing.bevel.cutters import _761
from mastapy._internal import constructor
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _767, _768, _769
...
class Wheel(_0.APIBase):
    ...
    @property
    def basic_conical_gear_machine_settings(self) -> '_767.BasicConicalGearMachineSettings':
        ...
        if _767.BasicConicalGearMachineSettings.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_768.BasicConicalGearMachineSettingsFormate':
        ...
        if _768.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
    ...
    @property
    def basic_conical_gear_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_769.BasicConicalGearMachineSettingsGenerated':
        ...
        if _769.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.BasicConicalGearMachineSettings.__class__.__mro__:
