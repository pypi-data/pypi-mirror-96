...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _767
...
class BasicConicalGearMachineSettingsGenerated(_767.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
