...
class GearMeshLoadDistributionAnalysis(_1130.GearMeshImplementationAnalysis):
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1275.FourierSeries':
        ...
        return constructor.new(_1275.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None
