...
from mastapy.gears.rating.straight_bevel_diff import _355, _356
...
class StraightBevelDiffGearSetRating(_489.ConicalGearSetRating):
    '''StraightBevelDiffGearSetRating
    ...
    @property
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_355.StraightBevelDiffGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshRatings, constructor.new(_355.StraightBevelDiffGearMeshRating))
        return value
