...
from mastapy.gears.rating.hypoid import _398, _399
...
class HypoidGearSetRating(_514.AGMAGleasonConicalGearSetRating):
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_398.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_398.HypoidGearMeshRating))
        return value
