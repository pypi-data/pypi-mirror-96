...
class ToothFlankFractureAnalysisContactPoint(_0.APIBase):
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_479.ToothFlankFractureAnalysisPoint':
        ...
        return constructor.new(_479.ToothFlankFractureAnalysisPoint)(self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure) if self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure else None

    @property
    def watch_points(self) -> 'List[_479.ToothFlankFractureAnalysisPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WatchPoints, constructor.new(_479.ToothFlankFractureAnalysisPoint))
        return value
