...
class CylindricalGearScuffingResults(_0.APIBase):
    ...
    @property
    def scuffing_results_row(self) -> 'List[_439.ScuffingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ScuffingResultsRow, constructor.new(_439.ScuffingResultsRow))
        return value
