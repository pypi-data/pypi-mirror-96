...
from mastapy.gears.rating.virtual_cylindrical_gears import _346
...
class KlingelnbergSpiralBevelVirtualCylindricalGear(_346.KlingelnbergVirtualCylindricalGear):
    '''KlingelnbergSpiralBevelVirtualCylindricalGear
