...
from mastapy.gears.materials import _533
...
class BevelGearISOMaterial(_533.BevelGearMaterial):
    '''BevelGearISOMaterial
    ...
    @property
    def quality_grade(self) -> '_241.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_241.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_241.QualityGrade'):
