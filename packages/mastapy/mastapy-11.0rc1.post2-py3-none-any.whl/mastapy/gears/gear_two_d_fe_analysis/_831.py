...
class CylindricalGearTIFFAnalysis(_1125.GearDesignAnalysis):
    '''CylindricalGearTIFFAnalysis
    ...
    @property
    def analysis(self) -> '_832.CylindricalGearTwoDimensionalFEAnalysis':
        ...
        return constructor.new(_832.CylindricalGearTwoDimensionalFEAnalysis)(self.wrapped.Analysis) if self.wrapped.Analysis else None
