...
from mastapy.gears.gear_designs.conical import _1078, _1066
...
class KlingelnbergConicalGearSetDesign(_1066.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1078.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1078.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1078.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_911.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_911.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_911.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_911.KlingelnbergConicalGearMeshDesign))
        return value
