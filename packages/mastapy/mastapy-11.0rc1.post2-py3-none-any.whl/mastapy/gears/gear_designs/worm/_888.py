...
from mastapy.gears.gear_designs.worm import _886, _887
...
class WormGearSetDesign(_879.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_886.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_886.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_886.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_886.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_887.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_887.WormGearMeshDesign))
        return value
