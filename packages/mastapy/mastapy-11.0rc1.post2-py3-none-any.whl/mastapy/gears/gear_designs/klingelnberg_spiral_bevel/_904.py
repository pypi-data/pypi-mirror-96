...
from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _902, _903
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDesign(_912.KlingelnbergConicalGearSetDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_902.KlingelnbergCycloPalloidSpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_902.KlingelnbergCycloPalloidSpiralBevelGearDesign))
        return value
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_903.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_903.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_903.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshes, constructor.new(_903.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value
