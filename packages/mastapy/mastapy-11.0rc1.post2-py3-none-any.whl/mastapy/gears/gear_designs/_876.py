...
class GearDesign(_877.GearDesignComponent):
    '''GearDesign
    ...
    @property
    def tifffe_model(self) -> '_1107.GearFEModel':
        ...
        if _1107.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1111.CylindricalGearFEModel':
        ...
        if _1111.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1114.ConicalGearFEModel':
        ...
        if _1114.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
