...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1047, _1051, _1055
...
class AGMAGleasonConicalGearDesign(_1064.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_1074.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_1074.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_1074.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_1063.ConicalGearCutter':
        ...
        if _1063.ConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_759.PinionFinishCutter':
        ...
        if _759.PinionFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_760.PinionRoughCutter':
        ...
        if _760.PinionRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_761.WheelFinishCutter':
        ...
        if _761.WheelFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_762.WheelRoughCutter':
        ...
        if _762.WheelRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
            raise CastException('Failed to cast cutter to WheelRoughCutter. Expected: {}.'.format(self.wrapped.Cutter.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Cutter.__class__)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_1073.DummyConicalGearCutter':
        ...
        if _1073.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def accuracy_grades(self) -> '_274.AccuracyGrades':
        ...
        if _274.AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_1051.CylindricalAccuracyGrades':
    ...
    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1102.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1102.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def bevel_gear_material(self) -> '_540.GearMaterial':
        ...
        if _540.GearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_529.AGMACylindricalGearMaterial':
        ...
        if _529.AGMACylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_531.BevelGearISOMaterial':
        ...
        if _531.BevelGearISOMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_533.BevelGearMaterial':
        ...
        if _533.BevelGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_537.CylindricalGearMaterial':
        ...
        if _537.CylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_543.ISOCylindricalGearMaterial':
        ...
        if _543.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_547.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _547.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_549.PlasticCylindricalGearMaterial':
        ...
        if _549.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
