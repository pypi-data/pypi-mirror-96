...
from mastapy.utility.model_validation import _1523, _1524
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def component_design(self) -> '_1887.DesignEntity':
        ...
        if _1887.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1948.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2141.Part':
    ...
    @property
    def all_status_errors(self) -> 'List[_1524.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1524.StatusItem))
        return value
