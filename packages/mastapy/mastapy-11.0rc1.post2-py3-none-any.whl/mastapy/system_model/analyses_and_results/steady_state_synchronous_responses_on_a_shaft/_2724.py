...
class PartSteadyStateSynchronousResponseOnAShaft(_7178.PartStaticLoadAnalysisCase):
    '''PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self) -> '_1934.SteadyStateSynchronousResponseViewable':
