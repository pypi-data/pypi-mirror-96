...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3825
...
class SpecialisedAssemblyCompoundPowerFlow(_3825.AbstractAssemblyCompoundPowerFlow):
    '''SpecialisedAssemblyCompoundPowerFlow
