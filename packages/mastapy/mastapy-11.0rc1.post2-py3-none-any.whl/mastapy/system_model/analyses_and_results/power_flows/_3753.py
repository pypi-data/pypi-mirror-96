...
from mastapy.system_model.analyses_and_results.power_flows import _3751, _3752, _3793
...
class GearSetPowerFlow(_3793.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3751.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3751.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3752.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3752.GearPowerFlow))
        return value
