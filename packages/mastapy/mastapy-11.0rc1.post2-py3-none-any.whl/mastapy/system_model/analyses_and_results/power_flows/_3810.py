...
from mastapy.system_model.analyses_and_results.power_flows import _3808, _3793
...
class SynchroniserPowerFlow(_3793.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3808.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3808.SynchroniserHalfPowerFlow))
        return value
