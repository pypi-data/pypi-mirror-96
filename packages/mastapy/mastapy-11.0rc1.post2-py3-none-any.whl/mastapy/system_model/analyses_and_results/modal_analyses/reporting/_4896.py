...
from mastapy.utility.modal_analysis import _1526
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2322.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1526.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1526.DesignEntityExcitationDescription))
        return value
