...
class ConnectorModalAnalysis(_4829.MountableComponentModalAnalysis):
    '''ConnectorModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2392.ConnectorSystemDeflection':
