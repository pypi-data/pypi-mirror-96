...
TMeasurement = TypeVar('TMeasurement', bound='_1359.MeasurementBase')


class WhineWaterfallReferenceValues(_4880.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
