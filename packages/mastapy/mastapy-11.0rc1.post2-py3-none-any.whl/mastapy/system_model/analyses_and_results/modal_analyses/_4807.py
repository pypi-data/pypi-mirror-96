...
class GearMeshModalAnalysis(_4814.InterMountableComponentConnectionModalAnalysis):
    '''GearMeshModalAnalysis
    ...
    @property
    def connection_design(self) -> '_1989.GearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2421.GearMeshSystemDeflection':
