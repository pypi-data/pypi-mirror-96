...
class VirtualComponentModalAnalysis(_4829.MountableComponentModalAnalysis):
    '''VirtualComponentModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2497.VirtualComponentSystemDeflection':
