...
class PlanetaryGearSetLoadCase(_6496.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1346.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1346.LoadCaseOverrideOption'):
