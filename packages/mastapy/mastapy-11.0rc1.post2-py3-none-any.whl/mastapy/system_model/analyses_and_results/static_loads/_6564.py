...
from mastapy.system_model.analyses_and_results.static_loads import _6563, _6553
...
class PlanetCarrierLoadCase(_6553.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6563.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6563.PlanetarySocketManufactureError))
        return value
