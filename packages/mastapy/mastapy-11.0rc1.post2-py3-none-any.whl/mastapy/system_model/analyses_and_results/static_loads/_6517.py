...
from mastapy.system_model.fe import _2035, _2058
...
class FEPartLoadCase(_6440.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2035.AngleSource':
        ...
        return constructor.new(_2035.AngleSource)(value) if value else None
