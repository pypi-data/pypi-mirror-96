...
from mastapy.system_model.analyses_and_results.static_loads import _6472, _6473, _6525
...
class ConceptGearSetLoadCase(_6525.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6472.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6472.ConceptGearLoadCase))
        return value

    @property
    def concept_gears_load_case(self) -> 'List[_6472.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6472.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6473.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6473.ConceptGearMeshLoadCase))
        return value
