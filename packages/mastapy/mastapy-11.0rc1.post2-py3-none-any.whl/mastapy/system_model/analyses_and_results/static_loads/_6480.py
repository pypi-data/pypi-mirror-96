...
from mastapy.system_model.analyses_and_results.static_loads import _6589, _6443, _6603
...
class ConnectionLoadCase(_2319.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6589.StaticLoadCase':
        ...
        if _6589.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
