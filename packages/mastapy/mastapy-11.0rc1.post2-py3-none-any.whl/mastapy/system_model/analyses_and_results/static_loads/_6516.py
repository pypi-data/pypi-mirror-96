...
from mastapy.system_model.analyses_and_results.static_loads import _6514, _6515, _6525
...
class FaceGearSetLoadCase(_6525.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6514.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6514.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6514.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6514.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6515.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6515.FaceGearMeshLoadCase))
        return value
