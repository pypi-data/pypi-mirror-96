...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6623, _6634, _6625, _6622,
    _6626, _6628, _6635, _6632,
    _6624, _6627, _6621
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6538.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6538.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6538.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6634.TimeStepInputOptions':
        ...
        return constructor.new(_6634.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6625.GearRatioInputOptions':
        ...
        return constructor.new(_6625.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6622.DesignStateOptions':
        ...
        return constructor.new(_6622.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6626.LoadCaseNameOptions':
        ...
        return constructor.new(_6626.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6628.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6628.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6635.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6635.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6632.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6632.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6624.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6624.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6627.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6627.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6621.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6621.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1545.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1545.ColumnTitle))
        return value
