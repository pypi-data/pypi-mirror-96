...
from mastapy.system_model.analyses_and_results.static_loads import _6534, _6530, _6510
...
class HarmonicLoadDataImportFromMotorPackages(_6530.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
