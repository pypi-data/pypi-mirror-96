...
from mastapy.system_model.analyses_and_results.static_loads import _6487, _6453
...
class CVTLoadCase(_6453.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6487.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6487.CVTPulleyLoadCase))
        return value
