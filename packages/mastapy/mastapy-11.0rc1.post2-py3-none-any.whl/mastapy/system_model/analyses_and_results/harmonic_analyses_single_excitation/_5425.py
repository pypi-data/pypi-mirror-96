...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5392, _5337
...
class RootAssemblyHarmonicAnalysisOfSingleExcitation(_5337.AssemblyHarmonicAnalysisOfSingleExcitation):
    '''RootAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def harmonic_analysis_of_single_excitation_inputs(self) -> '_5392.HarmonicAnalysisOfSingleExcitation':
        ...
        return constructor.new(_5392.HarmonicAnalysisOfSingleExcitation)(self.wrapped.HarmonicAnalysisOfSingleExcitationInputs) if self.wrapped.HarmonicAnalysisOfSingleExcitationInputs else None
