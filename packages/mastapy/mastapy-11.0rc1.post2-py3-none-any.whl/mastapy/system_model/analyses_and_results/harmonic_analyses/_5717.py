...
class SpiralBevelGearMeshHarmonicAnalysis(_5607.BevelGearMeshHarmonicAnalysis):
    '''SpiralBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2469.SpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2469.SpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
