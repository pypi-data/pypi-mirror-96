...
from mastapy.system_model.analyses_and_results.static_loads import _6454, _6457, _6458
from mastapy.system_model.analyses_and_results.system_deflections import _2367, _2368, _2369
...
class BevelDifferentialGearHarmonicAnalysis(_5606.BevelGearHarmonicAnalysis):
    '''BevelDifferentialGearHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6454.BevelDifferentialGearLoadCase':
        ...
        if _6454.BevelDifferentialGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2367.BevelDifferentialGearSystemDeflection':
