...
class FaceGearMeshHarmonicAnalysis(_5664.GearMeshHarmonicAnalysis):
    '''FaceGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2416.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2416.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
