...
from mastapy.system_model.analyses_and_results.system_deflections import _2364, _2398
...
class BeltDriveHarmonicAnalysis(_5714.SpecialisedAssemblyHarmonicAnalysis):
    '''BeltDriveHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2364.BeltDriveSystemDeflection':
