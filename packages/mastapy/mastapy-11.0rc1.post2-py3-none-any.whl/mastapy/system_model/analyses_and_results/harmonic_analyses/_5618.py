...
class ConceptCouplingHalfHarmonicAnalysis(_5629.CouplingHalfHarmonicAnalysis):
    '''ConceptCouplingHalfHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2382.ConceptCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2382.ConceptCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
