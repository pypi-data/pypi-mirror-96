...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5751
from mastapy.system_model.analyses_and_results.modal_analyses import _4828
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5715, _5661
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5751.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5751.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4828.ModalAnalysisOptions':
        ...
        return constructor.new(_4828.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
