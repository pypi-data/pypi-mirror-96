...
class ShaftToMountableComponentConnectionHarmonicAnalysis(_5593.AbstractShaftToMountableComponentConnectionHarmonicAnalysis):
    '''ShaftToMountableComponentConnectionHarmonicAnalysis
    ...
    @property
    def connection_design(self) -> '_1971.ShaftToMountableComponentConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2467.ShaftToMountableComponentConnectionSystemDeflection':
