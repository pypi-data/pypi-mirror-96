...
class SteadyStateSynchronousResponse(_7167.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3271.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3271.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
