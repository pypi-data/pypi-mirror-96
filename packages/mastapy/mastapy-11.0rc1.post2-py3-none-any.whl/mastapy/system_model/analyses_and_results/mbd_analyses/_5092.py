...
class GearMultibodyDynamicsAnalysis(_5117.MountableComponentMultibodyDynamicsAnalysis):
    '''GearMultibodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5178.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5178.DynamicTorqueResultAtTime))
        return value
