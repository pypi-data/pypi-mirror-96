...
from mastapy.system_model.analyses_and_results.static_loads import _6492, _6497
from mastapy.gears.rating.cylindrical import _417
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6952, _6954, _6963
...
class CylindricalGearAdvancedSystemDeflection(_6963.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6492.CylindricalGearLoadCase':
        ...
        if _6492.CylindricalGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_6952.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_6952.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_6954.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_6954.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_6954.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_6954.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
