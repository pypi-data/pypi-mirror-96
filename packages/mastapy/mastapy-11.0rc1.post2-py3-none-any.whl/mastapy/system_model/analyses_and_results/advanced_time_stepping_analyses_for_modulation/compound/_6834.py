...
class HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_6776.AGMAGleasonConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6705.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6705.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_advanced_time_stepping_analysis_for_modulation_load_cases(self) -> 'List[_6705.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAdvancedTimeSteppingAnalysisForModulationLoadCases, constructor.new(_6705.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value
