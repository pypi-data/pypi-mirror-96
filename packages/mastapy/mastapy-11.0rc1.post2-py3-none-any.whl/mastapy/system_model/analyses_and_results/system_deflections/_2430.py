...
from mastapy.system_model.analyses_and_results.power_flows import _3759, _3762, _3765
...
class KlingelnbergCycloPalloidConicalGearMeshSystemDeflection(_2388.ConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3759.KlingelnbergCycloPalloidConicalGearMeshPowerFlow':
