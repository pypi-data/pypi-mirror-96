...
class MassDiscSystemDeflection(_2497.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3768.MassDiscPowerFlow':
        ...
        return constructor.new(_3768.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
