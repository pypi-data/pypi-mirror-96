...
class SpiralBevelGearSystemDeflection(_2372.BevelGearSystemDeflection):
    '''SpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3795.SpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3795.SpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
