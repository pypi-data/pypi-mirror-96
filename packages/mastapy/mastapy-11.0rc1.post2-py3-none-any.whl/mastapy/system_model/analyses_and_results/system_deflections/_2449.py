...
class PartToPartShearCouplingHalfSystemDeflection(_2394.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3774.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3774.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
