...
class BevelGearMeshSystemDeflection(_2358.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3708.BevelGearMeshPowerFlow':
