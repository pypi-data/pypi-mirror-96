...
from mastapy.math_utility.measured_vectors import _1325, _1324
from mastapy.system_model.analyses_and_results.power_flows import (
    _3717, _3693, _3694, _3697,
    _3700, _3704, _3706, _3707,
    _3709, _3712, _3714, _3719,
    _3722, _3725, _3728, _3730,
    _3734, _3738, _3741, _3743,
    _3744, _3745, _3747, _3749,
    _3752, _3754, _3756, _3760,
    _3763, _3766, _3768, _3769,
    _3770, _3771, _3774, _3778,
    _3779, _3782, _3783, _3784,
    _3788, _3790, _3791, _3795,
    _3798, _3801, _3804, _3806,
    _3807, _3808, _3809, _3811,
...
class ComponentSystemDeflection(_2447.PartSystemDeflection):
    '''ComponentSystemDeflection
    ...
    @property
    def rigidly_connected_components(self) -> '_2510.RigidlyConnectedComponentGroupSystemDeflection':
        ...
        return constructor.new(_2510.RigidlyConnectedComponentGroupSystemDeflection)(self.wrapped.RigidlyConnectedComponents) if self.wrapped.RigidlyConnectedComponents else None

    @property
    def mass_properties_in_local_coordinate_system_from_node_model(self) -> '_1280.MassProperties':
        ...
        return constructor.new(_1280.MassProperties)(self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel) if self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel else None

    @property
    def node_results(self) -> 'List[_1325.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1325.NodeResults))
        return value

    @property
    def connected_components_forces_in_lcs(self) -> 'List[_1324.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInLCS, constructor.new(_1324.ForceResults))
        return value

    @property
    def connected_components_forces_in_wcs(self) -> 'List[_1324.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInWCS, constructor.new(_1324.ForceResults))
        return value

    @property
    def power_flow_results(self) -> '_3717.ComponentPowerFlow':
