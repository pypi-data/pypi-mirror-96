...
class SynchroniserSleeveSystemDeflection(_2484.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3811.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3811.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
