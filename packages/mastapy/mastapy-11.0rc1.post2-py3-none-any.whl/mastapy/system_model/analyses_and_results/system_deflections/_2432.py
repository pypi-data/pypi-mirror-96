...
from mastapy.system_model.analyses_and_results.power_flows import _3760, _3763, _3766
...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2390.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3760.KlingelnbergCycloPalloidConicalGearPowerFlow':
