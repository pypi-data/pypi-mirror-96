...
class TorqueConverterPumpSystemDeflection(_2394.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3815.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3815.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
