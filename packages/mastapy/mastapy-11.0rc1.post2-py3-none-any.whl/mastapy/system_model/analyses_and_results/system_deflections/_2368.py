...
class BevelDifferentialPlanetGearSystemDeflection(_2367.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3706.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3706.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
