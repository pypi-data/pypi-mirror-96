...
class BevelDifferentialSunGearSystemDeflection(_2367.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3707.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3707.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
