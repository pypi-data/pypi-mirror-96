...
class PartSystemDeflection(_7177.PartFEAnalysis):
    ...
    @property
    def two_d_drawing_showing_axial_forces(self) -> '_7192.SMTBitmap':
        ...
        return constructor.new(_7192.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForces) if self.wrapped.TwoDDrawingShowingAxialForces else None
