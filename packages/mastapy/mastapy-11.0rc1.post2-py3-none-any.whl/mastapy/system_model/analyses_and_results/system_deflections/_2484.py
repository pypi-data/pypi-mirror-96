...
from mastapy.system_model.analyses_and_results.power_flows import _3809, _3808, _3811
...
class SynchroniserPartSystemDeflection(_2394.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3809.SynchroniserPartPowerFlow':
