...
class SpiralBevelGearMeshSystemDeflection(_2370.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3794.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3794.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
