...
class BoltedJointSystemDeflection(_2468.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3711.BoltedJointPowerFlow':
        ...
        return constructor.new(_3711.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
