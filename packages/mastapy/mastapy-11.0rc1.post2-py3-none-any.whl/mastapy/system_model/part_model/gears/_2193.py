...
from mastapy.system_model.part_model.gears import _2192, _2203
...
class ConceptGearSet(_2203.GearSet):
    '''ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2192.ConceptGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_2192.ConceptGear))
        return value

    @property
    def concept_meshes(self) -> 'List[_1981.ConceptGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1981.ConceptGearMesh))
        return value
