...
class ConicalGear(_2201.Gear):
    ...
    @property
    def orientation(self) -> '_2202.GearOrientations':
        ...
        return constructor.new(_2202.GearOrientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_2202.GearOrientations'):
