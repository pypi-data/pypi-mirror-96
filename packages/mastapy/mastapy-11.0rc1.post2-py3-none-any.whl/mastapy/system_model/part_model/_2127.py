...
class FlexiblePinAssembly(_2149.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2196.CylindricalGear':
        ...
        if _2196.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
