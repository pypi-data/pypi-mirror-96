...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5590, _5670
from mastapy.utility.generics import _1538
...
class HarmonicAnalysisViewable(_1923.DynamicAnalysisViewable):
    '''HarmonicAnalysisViewable
    ...
    @property
    def dynamic_analysis_draw_style(self) -> '_5964.DynamicAnalysisDrawStyle':
        ...
        if _5964.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_modal_analysis_draw_style(self) -> '_4827.ModalAnalysisDrawStyle':
        ...
        if _4827.ModalAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5670.HarmonicAnalysisDrawStyle':
        ...
        if _5670.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
