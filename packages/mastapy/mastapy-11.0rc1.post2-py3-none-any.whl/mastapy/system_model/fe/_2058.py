...
class FESubstructure(_59.FEStiffness):
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7187.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_148.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7187.TaskProgress'] = None):
