...
class SpringDamperConnection(_2022.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1885.ComponentDampingOption':
        ...
        return constructor.new(_1885.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1885.ComponentDampingOption'):
