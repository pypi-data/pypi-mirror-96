...
from mastapy.system_model.part_model.gears import _2197, _2213, _2196
...
class CylindricalGearMesh(_1989.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2197.CylindricalGearSet':
        ...
        if _2197.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1328.ShortLengthRange':
        ...
        return constructor.new(_1328.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
