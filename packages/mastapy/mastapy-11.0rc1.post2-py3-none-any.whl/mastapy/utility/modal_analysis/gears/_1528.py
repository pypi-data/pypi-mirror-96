...
from mastapy.utility.modal_analysis.gears import _1529, _1532, _1534
...
class GearOrderForTE(_1534.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1529.GearPositions':
        ...
        return constructor.new(_1529.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1532.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1532.OrderForTE))
        return value
