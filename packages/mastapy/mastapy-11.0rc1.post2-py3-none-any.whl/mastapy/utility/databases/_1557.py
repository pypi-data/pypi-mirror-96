...
from mastapy.utility.databases import _1555, _1552, _1551
...
class SQLDatabase(_1551.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1555.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1552.DatabaseKey'):
