...
class ConnectionParametricStudyTool(_7135.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4017.ParametricStudyTool':
        ...
        return constructor.new(_4017.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
