...
from mastapy.system_model.analyses_and_results.static_loads import _6416, _6523
from mastapy.system_model import _1885
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4020, _4021
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6523.ParametricStudyType':
        ...
        return constructor.new(_6523.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6523.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1885.ExternalFullFELoader':
        ...
        return constructor.new(_1885.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4020.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4020.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4021.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4021.ParametricStudyVariable))
        return value
