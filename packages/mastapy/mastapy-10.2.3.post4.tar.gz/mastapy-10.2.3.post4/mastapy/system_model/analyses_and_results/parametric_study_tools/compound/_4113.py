...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4082
...
class CVTCompoundParametricStudyTool(_4082.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
