...
from mastapy.system_model.analyses_and_results.static_loads import _6560, _6561, _6428
...
class StraightBevelGearSetLoadCase(_6428.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6560.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6560.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6560.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6560.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6561.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6561.StraightBevelGearMeshLoadCase))
        return value
