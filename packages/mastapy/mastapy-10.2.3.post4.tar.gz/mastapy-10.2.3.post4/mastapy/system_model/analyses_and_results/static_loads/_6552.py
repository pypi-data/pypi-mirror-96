...
from mastapy.system_model.analyses_and_results.static_loads import _6550, _6551, _6428
...
class SpiralBevelGearSetLoadCase(_6428.BevelGearSetLoadCase):
    '''SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6550.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6550.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6550.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsLoadCase, constructor.new(_6550.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6551.SpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesLoadCase, constructor.new(_6551.SpiralBevelGearMeshLoadCase))
        return value
