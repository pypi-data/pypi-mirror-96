...
class RingPinManufacturingError(_0.APIBase):
    ...
    @property
    def pin_roundness_chart(self) -> '_7157.SMTBitmap':
        ...
        return constructor.new(_7157.SMTBitmap)(self.wrapped.PinRoundnessChart) if self.wrapped.PinRoundnessChart else None
