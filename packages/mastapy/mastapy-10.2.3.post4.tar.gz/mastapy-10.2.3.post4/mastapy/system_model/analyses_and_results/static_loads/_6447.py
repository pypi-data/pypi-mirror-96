...
from mastapy.system_model.analyses_and_results.static_loads import _6556, _6410, _6570
...
class ConnectionLoadCase(_2293.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6556.StaticLoadCase':
        ...
        if _6556.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    @property
    def time_series_load_case(self) -> '_6570.TimeSeriesLoadCase':
        ...
        return constructor.new(_6570.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None
