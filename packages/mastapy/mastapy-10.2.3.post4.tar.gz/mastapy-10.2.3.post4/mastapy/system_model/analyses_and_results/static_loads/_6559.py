...
from mastapy.system_model.analyses_and_results.static_loads import _6557, _6558, _6428
...
class StraightBevelDiffGearSetLoadCase(_6428.BevelGearSetLoadCase):
    '''StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6557.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6557.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6557.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsLoadCase, constructor.new(_6557.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6558.StraightBevelDiffGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesLoadCase, constructor.new(_6558.StraightBevelDiffGearMeshLoadCase))
        return value
