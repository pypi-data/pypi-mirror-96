...
class RootAssemblyLoadCase(_6417.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1570.PIDControlSettings':
        ...
        return constructor.new(_1570.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6463.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6463.CylindricalGearSetLoadCase))
        return value
