...
from mastapy.system_model.analyses_and_results.static_loads import _6521, _6497, _6476
...
class HarmonicLoadDataExcelImport(_6497.HarmonicLoadDataImportBase['_6476.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6521.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6521.NamedSpeed))
        return value
