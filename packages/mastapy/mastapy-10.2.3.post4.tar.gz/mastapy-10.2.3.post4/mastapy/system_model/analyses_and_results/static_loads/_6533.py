...
from mastapy.math_utility import _1503, _1513
...
class PointLoadHarmonicLoadData(_6549.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1503.DegreesOfFreedom':
        ...
        return constructor.new(_1503.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1503.DegreesOfFreedom'):
