...
from mastapy.system_model.analyses_and_results.static_loads import _6443, _6487
...
class ConicalGearLoadCase(_6487.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6443.ConicalGearManufactureError':
        ...
        return constructor.new(_6443.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
