...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2270
...
class ConnectionCriticalSpeedAnalysis(_7138.ConnectionStaticLoadAnalysisCase):
    '''ConnectionCriticalSpeedAnalysis
