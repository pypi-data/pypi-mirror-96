...
from mastapy.system_model.drawing import _1914, _1912
...
class SystemDeflectionDrawStyle(_1912.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1914.ScalingDrawStyle':
        ...
        return constructor.new(_1914.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
