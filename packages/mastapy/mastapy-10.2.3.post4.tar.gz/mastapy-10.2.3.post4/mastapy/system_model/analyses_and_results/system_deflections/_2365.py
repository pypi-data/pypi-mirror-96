...
class RollingRingConnectionSystemDeflection(_2337.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3367.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3367.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
