...
class SpiralBevelGearMeshSystemDeflection(_2341.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3765.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3765.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
