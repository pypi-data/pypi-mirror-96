...
from mastapy.system_model.analyses_and_results.power_flows import _3754, _3705
...
class PulleySystemDeflection(_2365.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3754.PulleyPowerFlow':
