...
class StraightBevelPlanetGearSystemDeflection(_2448.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3777.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3777.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
