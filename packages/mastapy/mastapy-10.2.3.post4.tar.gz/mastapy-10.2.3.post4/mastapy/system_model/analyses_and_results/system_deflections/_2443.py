...
class SpringDamperConnectionSystemDeflection(_2364.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3768.SpringDamperConnectionPowerFlow':
        ...
        return constructor.new(_3768.SpringDamperConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
