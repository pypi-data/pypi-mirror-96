...
from mastapy.system_model.analyses_and_results.system_deflections import _2347, _2394
...
class SystemDeflection(_6560.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2347.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2347.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2394.SystemDeflectionOptions':
        ...
        return constructor.new(_2394.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
