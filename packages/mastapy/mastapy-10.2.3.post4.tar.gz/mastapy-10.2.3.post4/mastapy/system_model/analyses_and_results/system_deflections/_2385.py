...
class StraightBevelGearSystemDeflection(_2285.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3384.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3384.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
