...
class PartToPartShearCouplingHalfSystemDeflection(_2307.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3356.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3356.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
