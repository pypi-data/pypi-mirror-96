...
class TorqueConverterSystemDeflection(_2366.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3785.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3785.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
