...
class StraightBevelPlanetGearSystemDeflection(_2382.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3386.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3386.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
