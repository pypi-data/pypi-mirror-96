...
class MassDiscSystemDeflection(_2468.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3739.MassDiscPowerFlow':
        ...
        return constructor.new(_3739.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
