...
class PartToPartShearCouplingHalfSystemDeflection(_2365.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3745.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3745.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
