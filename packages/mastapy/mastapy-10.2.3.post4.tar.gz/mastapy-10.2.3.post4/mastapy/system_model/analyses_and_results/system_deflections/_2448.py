...
from mastapy.system_model.analyses_and_results.power_flows import _3772, _3777, _3778
...
class StraightBevelDiffGearSystemDeflection(_2343.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3772.StraightBevelDiffGearPowerFlow':
