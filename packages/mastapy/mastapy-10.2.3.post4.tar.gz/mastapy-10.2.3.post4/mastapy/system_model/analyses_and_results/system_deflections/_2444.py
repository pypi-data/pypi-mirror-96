...
class SpringDamperHalfSystemDeflection(_2365.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3769.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3769.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
