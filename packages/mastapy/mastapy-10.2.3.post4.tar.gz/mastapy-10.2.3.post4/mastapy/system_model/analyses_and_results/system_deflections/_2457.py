...
from mastapy.system_model.analyses_and_results.system_deflections import _2454, _2439
...
class SynchroniserSystemDeflection(_2439.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3781.SynchroniserPowerFlow':
        ...
        return constructor.new(_3781.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def cones(self) -> 'List[_2454.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2454.SynchroniserHalfSystemDeflection))
        return value
