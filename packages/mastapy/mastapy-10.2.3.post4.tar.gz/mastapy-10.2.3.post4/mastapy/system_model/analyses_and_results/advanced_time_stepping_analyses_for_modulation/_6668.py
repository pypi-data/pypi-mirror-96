...
class GearSetAdvancedTimeSteppingAnalysisForModulation(_6707.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''GearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self) -> 'List[_1508.Eigenmodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.EignenmodesIndexedByModeId, constructor.new(_1508.Eigenmodes))
        return value
