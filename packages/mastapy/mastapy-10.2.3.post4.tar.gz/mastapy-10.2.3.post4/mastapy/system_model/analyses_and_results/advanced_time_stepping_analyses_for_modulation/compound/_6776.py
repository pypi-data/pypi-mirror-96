...
class CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6803.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
