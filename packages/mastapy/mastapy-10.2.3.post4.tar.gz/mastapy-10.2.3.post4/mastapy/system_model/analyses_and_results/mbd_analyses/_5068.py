...
from mastapy.system_model.analyses_and_results.analysis_cases import _6558
...
class ConnectionMultiBodyDynamicsAnalysis(_6558.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultiBodyDynamicsAnalysis
