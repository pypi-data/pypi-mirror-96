...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _5040, _5087, _5037, _5132,
    _5095, _5096, _5112
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.part_model import _2072
from mastapy.nodal_analysis import _1410
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5176
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_5037.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_5037.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_5037.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5095.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5095.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5095.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5096.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5096.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5096.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transient_solver_options(self) -> '_1410.TransientSolverOptions':
        ...
        return constructor.new(_1410.TransientSolverOptions)(self.wrapped.TransientSolverOptions) if self.wrapped.TransientSolverOptions else None

    @property
    def external_interface_options(self) -> '_5176.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5176.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_5112.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5112.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_4817.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4817.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
