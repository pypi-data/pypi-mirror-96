...
class BeltConnectionMultiBodyDynamicsAnalysis(_5099.InterMountableComponentConnectionMultiBodyDynamicsAnalysis):
    '''BeltConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def loading_status(self) -> '_1399.LoadingStatus':
        ...
        return constructor.new(_1399.LoadingStatus)(value) if value else None
