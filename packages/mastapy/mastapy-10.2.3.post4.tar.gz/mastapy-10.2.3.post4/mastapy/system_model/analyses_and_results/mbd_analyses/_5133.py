...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5173, _5175
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_5069.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5173.DynamicForceVector3DResult':
        ...
        return constructor.new(_5173.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_5175.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5175.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
