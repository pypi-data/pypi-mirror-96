...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5115, _5038
...
class RootAssemblyMultiBodyDynamicsAnalysis(_5038.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5115.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5115.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
