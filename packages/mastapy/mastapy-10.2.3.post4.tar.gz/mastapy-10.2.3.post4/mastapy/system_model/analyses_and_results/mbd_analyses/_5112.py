...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5098, _5136, _5131
...
class MBDRunUpAnalysisOptions(_6552.AbstractAnalysisOptions['_6268.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5098.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5098.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5098.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5136.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5136.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5136.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5131.RunUpDrivingMode':
        ...
        return constructor.new(_5131.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5131.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
