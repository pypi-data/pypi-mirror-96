...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def component_design(self) -> '_1881.DesignEntity':
        ...
        if _1881.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1926.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2116.Part':
