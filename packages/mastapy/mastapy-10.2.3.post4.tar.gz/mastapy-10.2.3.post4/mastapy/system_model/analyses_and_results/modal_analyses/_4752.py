...
class ConicalGearSetModalAnalysis(_4780.GearSetModalAnalysis):
    '''ConicalGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2360.ConicalGearSetSystemDeflection':
