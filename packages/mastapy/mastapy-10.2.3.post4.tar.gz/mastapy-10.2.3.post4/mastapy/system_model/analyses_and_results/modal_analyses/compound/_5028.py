...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5026, _5027, _4964
...
class WormGearSetCompoundModalAnalysis(_4964.GearSetCompoundModalAnalysis):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4895.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4895.WormGearSetModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4895.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4895.WormGearSetModalAnalysis))
        return value
