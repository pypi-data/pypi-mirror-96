...
from mastapy.system_model.analyses_and_results.static_loads import _6536, _6454
...
class PulleyAdvancedSystemDeflection(_6910.CouplingHalfAdvancedSystemDeflection):
    '''PulleyAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6536.PulleyLoadCase':
        ...
        if _6536.PulleyLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2426.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2426.PulleySystemDeflection))
        return value
