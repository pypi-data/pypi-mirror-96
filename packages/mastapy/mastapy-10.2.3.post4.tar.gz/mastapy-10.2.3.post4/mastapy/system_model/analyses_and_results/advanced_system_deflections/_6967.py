...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6871, _6877
...
class RootAssemblyAdvancedSystemDeflection(_6877.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6871.AdvancedSystemDeflection':
        ...
        return constructor.new(_6871.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
