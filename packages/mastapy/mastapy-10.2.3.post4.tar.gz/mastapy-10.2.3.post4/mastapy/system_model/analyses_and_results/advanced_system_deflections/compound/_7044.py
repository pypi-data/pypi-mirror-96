...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7013
...
class CVTCompoundAdvancedSystemDeflection(_7013.BeltDriveCompoundAdvancedSystemDeflection):
    '''CVTCompoundAdvancedSystemDeflection
