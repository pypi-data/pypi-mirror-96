...
from mastapy.system_model.analyses_and_results.power_flows import _3791, _3790, _3724
...
class WormGearSetPowerFlow(_3724.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3791.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3791.WormGearPowerFlow))
        return value

    @property
    def worm_gears_power_flow(self) -> 'List[_3791.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_3791.WormGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3790.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3790.WormGearMeshPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_3790.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_3790.WormGearMeshPowerFlow))
        return value
