...
from mastapy.system_model.analyses_and_results.power_flows import _3783, _3729
...
class GearMeshPowerFlow(_3729.InterMountableComponentConnectionPowerFlow):
    '''GearMeshPowerFlow
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3783.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3783.ToothPassingHarmonic))
        return value
