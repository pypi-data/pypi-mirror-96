...
class UnbalancedMassHarmonicAnalysis(_5707.VirtualComponentHarmonicAnalysis):
    '''UnbalancedMassHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2467.UnbalancedMassSystemDeflection':
        ...
        return constructor.new(_2467.UnbalancedMassSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
