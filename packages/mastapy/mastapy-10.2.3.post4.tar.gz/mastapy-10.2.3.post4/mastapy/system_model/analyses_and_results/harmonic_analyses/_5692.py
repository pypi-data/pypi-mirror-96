...
class StraightBevelGearHarmonicAnalysis(_5577.BevelGearHarmonicAnalysis):
    '''StraightBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2451.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2451.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
