...
class PartToPartShearCouplingHalfHarmonicAnalysis(_5600.CouplingHalfHarmonicAnalysis):
    '''PartToPartShearCouplingHalfHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2420.PartToPartShearCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2420.PartToPartShearCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
