...
class CVTBeltConnectionHarmonicAnalysis(_5570.BeltConnectionHarmonicAnalysis):
    '''CVTBeltConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2367.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2367.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
