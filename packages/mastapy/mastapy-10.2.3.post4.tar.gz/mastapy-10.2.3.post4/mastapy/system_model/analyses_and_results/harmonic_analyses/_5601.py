...
class CouplingHarmonicAnalysis(_5681.SpecialisedAssemblyHarmonicAnalysis):
    '''CouplingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2366.CouplingSystemDeflection':
