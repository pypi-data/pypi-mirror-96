...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5718
from mastapy.system_model.analyses_and_results.modal_analyses import _4799
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5682, _5631
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5718.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5718.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None
