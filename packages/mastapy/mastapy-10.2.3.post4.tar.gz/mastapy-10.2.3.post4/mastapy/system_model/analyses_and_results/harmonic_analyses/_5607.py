...
class CycloidalDiscHarmonicAnalysis(_5562.AbstractShaftHarmonicAnalysis):
    '''CycloidalDiscHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2373.CycloidalDiscSystemDeflection':
        ...
        return constructor.new(_2373.CycloidalDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
