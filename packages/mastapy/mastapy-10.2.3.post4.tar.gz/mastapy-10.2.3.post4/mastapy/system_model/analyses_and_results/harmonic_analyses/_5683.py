...
class SpiralBevelGearHarmonicAnalysis(_5577.BevelGearHarmonicAnalysis):
    '''SpiralBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2442.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2442.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
