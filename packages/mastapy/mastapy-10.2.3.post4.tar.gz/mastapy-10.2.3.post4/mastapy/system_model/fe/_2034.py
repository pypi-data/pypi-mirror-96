...
from mastapy.system_model.fe import (
    _2014, _2037, _2060, _2008,
    _2010, _2035, _2058, _2036,
    _2032, _2044, _2045, _2043,
    _2040, _2041, _2042
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2097, _2093, _2101
...
class FESubstructure(_59.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2014.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2014.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2014.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2008.AlignmentMethod':
        ...
        return constructor.new(_2008.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2008.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_to_component(self) -> '_1894.RelativeComponentAlignment[_2093.Component]':
        ...
        return constructor.new(_1894.RelativeComponentAlignment)[_2093.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2010.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2010.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None
    ...
    @property
    def export(self) -> '_2035.FESubstructureExportOptions':
        ...
        return constructor.new(_2035.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2058.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2058.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2129.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2129.Shaft))
        return value

    @property
    def links(self) -> 'List[_2067.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2067.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1563.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1563.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1563.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1563.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2032.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2032.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2044.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2044.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2045.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2045.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2101.FEPart':
        ...
        return constructor.new(_2101.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7153.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2043.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2040.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2041.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2042.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_148.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7153.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2036.FESubstructureNode') -> 'List[_2067.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2067.FELink))
