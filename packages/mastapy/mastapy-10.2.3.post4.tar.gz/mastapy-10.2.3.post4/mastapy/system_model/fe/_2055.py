...
from mastapy.system_model.fe import _2009, _2016
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2009.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2009.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2009.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2016.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2016.BearingRaceNodeLink))
        return value
