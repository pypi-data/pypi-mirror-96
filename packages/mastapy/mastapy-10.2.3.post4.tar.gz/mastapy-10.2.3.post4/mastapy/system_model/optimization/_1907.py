...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1906.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1906.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1906.MicroGeometryOptimisationTarget'):
