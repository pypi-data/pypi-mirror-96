...
class CylindricalGearMeshFEModel(_1108.GearMeshFEModel):
    ...
    def stiffness_wrt_contacts_for_with_progress(self, gear: '_1107.GearFEModel', flank: '_286.GearFlanks', progress: '_7153.TaskProgress') -> 'List[_775.GearContactStiffness]':
        ''' 'StiffnessWrtContactsFor' is the original name of this method.
