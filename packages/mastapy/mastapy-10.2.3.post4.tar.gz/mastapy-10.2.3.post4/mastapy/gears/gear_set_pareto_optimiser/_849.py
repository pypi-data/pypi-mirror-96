...
class MicroGeometryDesignSpaceSearchCandidate(_839.DesignSpaceSearchCandidateBase['_795.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate(self) -> '_795.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _795.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_for_slider(self) -> '_1027.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1027.CylindricalGearSetMicroGeometry)(self.wrapped.CandidateForSlider) if self.wrapped.CandidateForSlider else None
