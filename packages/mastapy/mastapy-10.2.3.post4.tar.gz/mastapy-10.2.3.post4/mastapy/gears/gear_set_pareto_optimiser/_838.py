...
from mastapy.math_utility.optimisation import _1548, _1539, _1545
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1548.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1548.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None
    ...
    @property
    def input_setters(self) -> 'List[_1539.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1539.InputSetter)[TAnalysis])
        return value
    ...
    @property
    def filters(self) -> 'List[_1545.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1545.ParetoOptimisationFilter))
        return value
