...
from mastapy.gears.manufacturing.bevel.control_parameters import _763
...
class ConicalManufacturingSGMControlParameters(_763.ConicalGearManufacturingControlParameters):
    '''ConicalManufacturingSGMControlParameters
