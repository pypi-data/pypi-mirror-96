...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _708, _707, _711
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_708.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_708.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_708.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_708.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_650.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_650.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    @property
    def life_shaver(self) -> '_679.CylindricalGearShaver':
        ...
        if _679.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
    ...
    @property
    def new_cutter_start_of_shaving(self) -> '_952.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_952.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_952.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_952.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
