...
from mastapy.gears import _293, _311
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _694, _689, _692
...
class CylindricalGearRackDesign(_677.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_311.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_311.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_311.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
