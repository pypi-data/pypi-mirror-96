...
T = TypeVar('T', bound='_631.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_628.ProcessLeadCalculation':
        ...
        return constructor.new(_628.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation else None

    @property
    def profile_calculation(self) -> '_630.ProcessProfileCalculation':
        ...
        return constructor.new(_630.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation else None

    @property
    def pitch_calculation(self) -> '_629.ProcessPitchCalculation':
        ...
        return constructor.new(_629.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation else None

    @property
    def gear_tooth_shape_calculation(self) -> '_627.ProcessGearShape':
        ...
        return constructor.new(_627.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation else None

    @property
    def total_modification_calculation(self) -> '_634.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_634.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation else None
