...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_609.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_609.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_609.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_605.AnalysisMethod':
        ...
        return constructor.new(_605.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_605.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cutter_mounting_error(self) -> '_636.RackMountingError':
        ...
        return constructor.new(_636.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_611.GearMountingError':
        ...
        return constructor.new(_611.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_610.CutterHeadSlideError':
        ...
        return constructor.new(_610.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
