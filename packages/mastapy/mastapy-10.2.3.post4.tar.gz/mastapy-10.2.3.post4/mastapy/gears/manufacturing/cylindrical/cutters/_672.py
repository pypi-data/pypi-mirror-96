...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _692, _694, _689
...
class CylindricalGearGrindingWorm(_676.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_692.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_692.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
