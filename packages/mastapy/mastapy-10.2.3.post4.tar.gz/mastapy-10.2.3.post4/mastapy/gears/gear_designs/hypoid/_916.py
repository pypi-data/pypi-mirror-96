...
from mastapy.gears.gear_designs.hypoid import _914, _915
...
class HypoidGearSetDesign(_1105.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_914.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_914.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_914.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_914.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_915.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_915.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_915.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_915.HypoidGearMeshDesign))
        return value
