...
from mastapy.gears.gear_designs.face import _919, _918
...
class FaceGearWheelDesign(_918.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_919.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_919.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_919.FaceGearDiameterFaceWidthSpecificationMethod'):
