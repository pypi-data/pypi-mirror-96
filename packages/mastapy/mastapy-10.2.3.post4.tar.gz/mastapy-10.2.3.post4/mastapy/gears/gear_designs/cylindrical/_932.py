...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self) -> '_650.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_650.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver else None
