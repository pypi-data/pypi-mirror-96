...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1051, _1047, _1055
...
class CylindricalAccuracyGrader(_0.APIBase):
    ...
    @property
    def accuracy_grades(self) -> '_1051.CylindricalAccuracyGrades':
        ...
        if _1051.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_1047.AGMA20151AccuracyGrades':
        ...
        if _1047.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_1055.ISO1328AccuracyGrades':
        ...
        if _1055.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
