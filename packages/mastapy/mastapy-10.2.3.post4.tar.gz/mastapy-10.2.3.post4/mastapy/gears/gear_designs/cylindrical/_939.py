...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_935.CylindricalGearAbstractRack':
        ...
        if _935.CylindricalGearAbstractRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_937.CylindricalGearBasicRack':
        ...
        if _937.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_950.CylindricalGearPinionTypeCutter':
        ...
        if _950.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_1001.StandardRack':
        ...
        if _1001.StandardRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_958.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_958.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None

    @property
    def manufacturing_configuration(self) -> '_558.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_558.CylindricalGearManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
