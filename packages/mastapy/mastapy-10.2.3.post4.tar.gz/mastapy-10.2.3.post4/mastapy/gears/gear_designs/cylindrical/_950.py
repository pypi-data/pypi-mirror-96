...
from mastapy.gears.gear_designs.cylindrical import _951, _935
...
class CylindricalGearPinionTypeCutter(_935.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self) -> '_951.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_951.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_951.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_951.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
