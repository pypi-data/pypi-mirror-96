...
from mastapy.utility.property import _1473
...
class DesignConstraintsCollection(_1468.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1473.DeletableCollectionMember[_873.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1473.DeletableCollectionMember)[_873.DesignConstraint])
        return value
