...
class WormGearMeshDesign(_878.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    def worm(self) -> '_885.WormDesign':
        ...
        return constructor.new(_885.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_889.WormWheelDesign':
        ...
        return constructor.new(_889.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
