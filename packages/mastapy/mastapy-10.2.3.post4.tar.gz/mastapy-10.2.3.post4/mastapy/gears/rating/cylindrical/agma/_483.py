...
from mastapy.gears.gear_designs.cylindrical import _954, _997
from mastapy.materials import _220
from mastapy.gears.rating.cylindrical.agma import _482
...
class AGMA2101MeshSingleFlankRating(_425.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_997.ScuffingTemperatureMethodsAGMA':
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_482.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_482.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_482.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_482.AGMA2101GearSingleFlankRating))
        return value
