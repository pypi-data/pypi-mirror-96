...
class ISO6336AbstractMetalMeshSingleFlankRating(_472.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_rating_method_flash_temperature_method(self) -> '_436.ScuffingFlashTemperatureRatingMethod':
        ...
        return constructor.new(_436.ScuffingFlashTemperatureRatingMethod)(value) if value else None

    @property
    def scuffing_rating_method_integral_temperature_method(self) -> '_437.ScuffingIntegralTemperatureRatingMethod':
        ...
        return constructor.new(_437.ScuffingIntegralTemperatureRatingMethod)(value) if value else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_998.ScuffingTemperatureMethodsISO':
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_416.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_416.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_468.ISO63362006MeshSingleFlankRating':
        ...
        if _468.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.SingleFlankRatingOfTestGearsForMicropitting.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_473.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_473.ISO6336AbstractMetalGearSingleFlankRating))
        return value
