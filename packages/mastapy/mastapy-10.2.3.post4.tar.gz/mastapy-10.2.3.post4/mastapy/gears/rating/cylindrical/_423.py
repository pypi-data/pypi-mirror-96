...
class CylindricalGearSingleFlankRating(_324.GearSingleFlankRating):
    '''CylindricalGearSingleFlankRating
    ...
    @property
    def metal_plastic(self) -> '_238.MetalPlasticType':
        ...
        return constructor.new(_238.MetalPlasticType)(value) if value else None
    ...
    @property
    def geometry_data_source_for_rating(self) -> '_418.CylindricalGearRatingGeometryDataSource':
        ...
        return constructor.new(_418.CylindricalGearRatingGeometryDataSource)(value) if value else None
