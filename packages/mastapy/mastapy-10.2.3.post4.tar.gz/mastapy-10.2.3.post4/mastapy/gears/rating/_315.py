...
from mastapy.gears.rating import _314, _313
...
class AbstractGearSetRating(_1124.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_314.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_314.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_313.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_313.AbstractGearMeshRating))
        return value
