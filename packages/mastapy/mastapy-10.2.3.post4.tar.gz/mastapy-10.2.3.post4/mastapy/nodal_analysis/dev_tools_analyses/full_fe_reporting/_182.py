...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1144
...
class ElementPropertiesShell(_185.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_1144.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1144.ElementPropertiesShellWallType)(value) if value else None
