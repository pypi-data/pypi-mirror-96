...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1141
...
class ElementPropertiesBeam(_185.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_1141.BeamSectionType':
        ...
        return constructor.new(_1141.BeamSectionType)(value) if value else None
