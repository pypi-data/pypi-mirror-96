...
from mastapy.bearings.tolerances import _1619, _1605, _1611
...
class InterferenceFitHalfDesign(_1151.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1619.SupportTolerance':
        ...
        if _1619.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1605.InnerSupportTolerance':
        ...
        if _1605.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1611.OuterSupportTolerance':
        ...
        if _1611.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
