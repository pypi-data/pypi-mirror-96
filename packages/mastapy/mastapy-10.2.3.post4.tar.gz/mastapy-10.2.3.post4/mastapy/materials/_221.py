...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def transmission_application(self) -> '_250.TransmissionApplications':
        ...
        return constructor.new(_250.TransmissionApplications)(value) if value else None

    @transmission_application.setter
    def transmission_application(self, value: '_250.TransmissionApplications'):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_224.ISO76StaticSafetyFactorLimits':
        ...
        return constructor.new(_224.ISO76StaticSafetyFactorLimits)(value) if value else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_224.ISO76StaticSafetyFactorLimits'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wind_turbine_standard(self) -> '_253.WindTurbineStandards':
        ...
        return constructor.new(_253.WindTurbineStandards)(value) if value else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_253.WindTurbineStandards'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def driving_machine_characteristics(self) -> '_254.WorkingCharacteristics':
        ...
        return constructor.new(_254.WorkingCharacteristics)(value) if value else None

    @driving_machine_characteristics.setter
    def driving_machine_characteristics(self, value: '_254.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivingMachineCharacteristics = value

    @property
    def driven_machine_characteristics(self) -> '_254.WorkingCharacteristics':
    ...
    def driven_machine_characteristics(self, value: '_254.WorkingCharacteristics'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def gearing_type(self) -> '_220.GearingTypes':
        '''GearingTypes: 'GearingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.GearingType)
        return constructor.new(_220.GearingTypes)(value) if value else None

    @gearing_type.setter
    def gearing_type(self, value: '_220.GearingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vehicle_dynamics(self) -> '_252.VehicleDynamicsProperties':
        ...
        return constructor.new(_252.VehicleDynamicsProperties)(self.wrapped.VehicleDynamics) if self.wrapped.VehicleDynamics else None

    @property
    def air_properties(self) -> '_210.AirProperties':
        ...
        return constructor.new(_210.AirProperties)(self.wrapped.AirProperties) if self.wrapped.AirProperties else None
