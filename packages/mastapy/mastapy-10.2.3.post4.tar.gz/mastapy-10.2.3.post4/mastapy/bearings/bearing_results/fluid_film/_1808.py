...
from mastapy.bearings import _1580
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1580.BearingRow':
        ...
        return constructor.new(_1580.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_7157.SMTBitmap':
        ...
        return constructor.new(_7157.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
