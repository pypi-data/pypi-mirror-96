...
from mastapy.bearings.bearing_results.rolling import _1716, _1663
...
class LoadedRollerBearingElement(_1663.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1716.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1716.ResultsAtRollerOffset))
        return value
