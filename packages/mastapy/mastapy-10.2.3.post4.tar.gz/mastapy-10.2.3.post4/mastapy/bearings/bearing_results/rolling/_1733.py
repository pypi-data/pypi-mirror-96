...
from mastapy.bearings.bearing_results.rolling import _1732, _1719
...
class LoadedSphericalRollerThrustBearingRow(_1719.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1732.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1732.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
