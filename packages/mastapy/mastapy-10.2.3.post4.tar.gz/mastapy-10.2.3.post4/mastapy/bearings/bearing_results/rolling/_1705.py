...
from mastapy.bearings.bearing_results.rolling import _1704, _1652
...
class LoadedThrustBallBearingRow(_1652.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1704.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1704.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
