...
from mastapy.bearings.bearing_results.rolling import _1689, _1679
...
class LoadedSphericalRollerRadialBearingRow(_1679.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1689.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1689.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
