...
from mastapy.bearings import _1548
from mastapy.bearings.bearing_results.rolling.fitting import _1757, _1755, _1758
from mastapy.bearings.bearing_results.rolling import (
    _1626, _1623, _1710, _1683
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1748, _1746, _1752, _1751,
    _1747, _1753, _1749
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.skf_module import _1743
...
class LoadedRollingBearingResults(_1610.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1548.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1548.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1757.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1757.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1757.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1757.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1755.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1755.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1755.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1755.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1623.DIN732Results':
        ...
        return constructor.new(_1623.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1748.ISO2812007Results':
        ...
        if _1748.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1746.BallISO2812007Results':
        ...
        if _1746.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1752.RollerISO2812007Results':
        ...
        if _1752.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1751.ISOTS162812008Results':
        ...
        if _1751.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1747.BallISOTS162812008Results':
        ...
        if _1747.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1753.RollerISOTS162812008Results':
        ...
        if _1753.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1749.ISO762006Results':
        ...
        return constructor.new(_1749.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1710.MaximumStaticContactStress':
        ...
        return constructor.new(_1710.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1743.SKFModuleResults':
        ...
        return constructor.new(_1743.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1683.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1683.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1758.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1758.RingFittingThermalResults))
        return value
