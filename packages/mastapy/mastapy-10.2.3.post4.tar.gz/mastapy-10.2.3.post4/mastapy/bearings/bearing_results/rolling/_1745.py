...
from mastapy.bearings.bearing_results.rolling import _1744, _1692
...
class LoadedThrustBallBearingRow(_1692.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1744.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1744.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
