...
from mastapy.bearings.bearing_results.rolling import _1692, _1679
...
class LoadedSphericalRollerThrustBearingRow(_1679.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1692.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1692.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
