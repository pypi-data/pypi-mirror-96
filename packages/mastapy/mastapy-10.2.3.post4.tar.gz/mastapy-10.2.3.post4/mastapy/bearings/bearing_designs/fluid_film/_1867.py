...
class PlainGreaseFilledJournalBearing(_1869.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1868.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1868.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1868.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1870.PlainJournalHousing':
        ...
        if _1870.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1863.CylindricalHousingJournalBearing':
        ...
        if _1863.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1864.MachineryEncasedJournalBearing':
        ...
        if _1864.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1866.PedestalJournalBearing':
        ...
        if _1866.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
