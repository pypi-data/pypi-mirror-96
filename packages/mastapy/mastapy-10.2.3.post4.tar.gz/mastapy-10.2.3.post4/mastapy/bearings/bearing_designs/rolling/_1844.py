...
class RollingBearing(_1816.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1571.BearingCatalog':
        ...
        return constructor.new(_1571.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1831.BearingTypeExtraInformation':
        ...
        return constructor.new(_1831.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1574.BearingCageMaterial':
        ...
        return constructor.new(_1574.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1574.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1846.SleeveType':
        ...
        return constructor.new(_1846.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1828.BearingProtection':
        ...
        return constructor.new(_1828.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
