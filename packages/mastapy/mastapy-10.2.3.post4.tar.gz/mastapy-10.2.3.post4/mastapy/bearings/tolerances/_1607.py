...
from mastapy.bearings.tolerances import _1602, _1599
...
class InterferenceTolerance(_1599.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1602.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1602.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1588.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1588.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1588.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
