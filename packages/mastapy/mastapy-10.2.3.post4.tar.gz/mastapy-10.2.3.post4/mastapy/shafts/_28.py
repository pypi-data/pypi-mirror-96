...
from mastapy.shafts import _29
...
class ShaftProfile(_0.APIBase):
    ...
    @property
    def points(self) -> 'List[_29.ShaftProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Points, constructor.new(_29.ShaftProfilePoint))
        return value
