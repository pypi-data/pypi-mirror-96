...
from mastapy.shafts import _32, _12
...
class ShaftSettings(_1157.PerMachineSettings):
    '''ShaftSettings
    ...
    @property
    def shaft_rating_method(self) -> '_32.ShaftRatingMethod':
        ...
        return constructor.new(_32.ShaftRatingMethod)(value) if value else None
    ...
    @property
    def version_of_miners_rule(self) -> '_12.FkmVersionOfMinersRule':
        ...
        return constructor.new(_12.FkmVersionOfMinersRule)(value) if value else None

    @version_of_miners_rule.setter
    def version_of_miners_rule(self, value: '_12.FkmVersionOfMinersRule'):
