...
from mastapy.shafts import _41, _20
...
class ShaftKey(_20.ShaftFeature):
    '''ShaftKey
    ...
    @property
    def surface_finish(self) -> '_41.SurfaceFinishes':
        ...
        return constructor.new(_41.SurfaceFinishes)(value) if value else None

    @surface_finish.setter
    def surface_finish(self, value: '_41.SurfaceFinishes'):
