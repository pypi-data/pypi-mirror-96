...
class ShaftSectionDamageResults(_0.APIBase):
    ...
    @property
    def left_end(self) -> '_35.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_35.ShaftSectionEndDamageResults)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_35.ShaftSectionEndDamageResults':
        ...
        return constructor.new(_35.ShaftSectionEndDamageResults)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
