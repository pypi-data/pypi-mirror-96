...
- API version: 2021.02.26
- Package version: 1.93.1
...
*CertificatesApi* | [**replace_csr_cert**](agilicus_api/docs/CertificatesApi.md#replace_csr_cert) | **PUT** /v1/certificate_signing_requests/{csr_id}/certificate_status | Update a CertSigningReqCertificateStatus
...
*ConnectorsApi* | [**delete_csr**](agilicus_api/docs/ConnectorsApi.md#delete_csr) | **DELETE** /v1/certificate_signing_requests/{csr_id} | Delete a CertSigningReq
...
## Documentation For Models
 ...
 - [CertSigningReqCertificateStatus](agilicus_api/docs/CertSigningReqCertificateStatus.md)
