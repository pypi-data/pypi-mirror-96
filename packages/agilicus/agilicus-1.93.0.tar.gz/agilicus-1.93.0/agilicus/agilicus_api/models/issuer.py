...
class Issuer(object):
    ...
    def __init__(self, id=None, issuer=None, enabled=True, org_id=None, theme_file_id=None, upstream_redirect_uri=None, managed_upstreams=None, oidc_upstreams=None, clients=None, slug=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def slug(self):
        """Gets the slug of this Issuer.  # noqa: E501
        ...
        :return: The slug of this Issuer.  # noqa: E501
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this Issuer.

        A human readable slug to identify a resource and that is rfc1035 label compliant. The length has been restricted to 20 characters such that this name can be concatenated with other names or slugs. A slug is readOnly as it is generated by the backend resource.   # noqa: E501

        :param slug: The slug of this Issuer.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
