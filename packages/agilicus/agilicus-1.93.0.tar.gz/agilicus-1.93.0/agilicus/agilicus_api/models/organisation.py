...
class Organisation(object):
    ...
    def __init__(self, id=None, all_users_group_id=None, all_users_all_suborgs_group_id=None, all_users_direct_suborgs_group_id=None, auto_created_users_group_id=None, external_id=None, organisation=None, issuer=None, issuer_id=None, subdomain=None, slug=None, created=None, updated=None, contact_id=None, contact_email=None, parent_id=None, root_org_id=None, auto_create=False, trust_on_first_use_duration=86400, feature_flags=None, admin_state=None, status=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def slug(self):
        """Gets the slug of this Organisation.  # noqa: E501
        ...
        :return: The slug of this Organisation.  # noqa: E501
        :rtype: str
        """
        return self._slug
    ...
    @slug.setter
    def slug(self, slug):
        """Sets the slug of this Organisation.

        A human readable slug to identify a resource and that is rfc1035 label compliant. The length has been restricted to 20 characters such that this name can be concatenated with other names or slugs. A slug is readOnly as it is generated by the backend resource.   # noqa: E501

        :param slug: The slug of this Organisation.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                slug is not None and len(slug) > 20):
            raise ValueError("Invalid value for `slug`, length must be less than or equal to `20`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                slug is not None and not re.search(r'^[a-z]|[a-z0-9][a-z0-9\-]*[a-z0-9]$', slug)):  # noqa: E501
            raise ValueError(r"Invalid value for `slug`, must be a follow pattern or equal to `/^[a-z]|[a-z0-9][a-z0-9\-]*[a-z0-9]$/`")  # noqa: E501
