...
class Datapackage:
    ...
    def _create_datapackage(self, metadata: Dict, validate: str = "None") -> Dict:
        ...
        if validate == "dcat": 
            deetly.validator.validate_datapackage_dcat2(matdata)
        else:
    ...
    def publish(self, space: str = None, token: str = None, api: str = None) -> None:
        ...
        if api is None:
            msg = """The url of the api must be provided either as parameter
                    or set with environment variable: DEETLY_API
            """
            print(msg)
