...
class ChatRoomPlus:
    ...
    def recv(self,host, port):
        ...
        if list(eval(recvData))[0]==self.myhost:
            if list(eval(recvData))[1]==self.myport:
    ...
    def start(self):
        ...
        t2 = threading.Thread(target=self.send,args=("helloworld","A888-888-888-887","3"))
