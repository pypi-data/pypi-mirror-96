...
class BoostingMachineRegressor(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, num_round=100, objective='mse', learning_rate=0.1, random_state=0, colsample_bytree=1.0,
                 subsample=1.0, verbose=False, lambda_l2=0.0, early_stopping_rounds=10,
                 compress_trees=False, base_score=None, max_depth=None, min_max_depth=1, max_max_depth=5,
