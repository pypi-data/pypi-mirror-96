...
from snapml.utils import _is_mpi_enabled, _is_data_snapml_partition_type, _check_devicendarray_types
...
class RBFSampler:
    ...
    def fit(self, X_train):
        ...
        # Train the model
        out_fit = libsnapml.rbf_fit(self.gamma_,
                                    self.n_components_,
                                    self.random_state_,
                                    num_ft)
    ...
    def transform(self, X, num_threads=1):
        ...
        X_new = libsnapml.rbf_transform(num_ex,
                                        num_ft,
                                        data,
                                        self.weights_,
                                        self.weights_len_,
