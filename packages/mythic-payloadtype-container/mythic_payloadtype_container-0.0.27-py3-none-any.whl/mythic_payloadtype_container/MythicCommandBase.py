...
class CommandAttributes():
    def __init__(self,
        spawn_and_injectable: bool = None,
        supported_os: [PayloadBuilder.SupportedOS] = None,
        ):
...
class CommandParameter:
    ...
    def to_json(self):
        return {
            ...
            "choices_are_all_commands": self.choices_are_all_comands,
...
class CommandBase(metaclass=ABCMeta):
    def __init__(self, agent_code_path: Path):
        ...
        self.attributes = CommandAttributes()
    ...
    def to_json(self):
        ...
        return {
            ...
            "author": self.author,
            "injectable": self.injectable if self.injectable is not None else False,
