...
class ProducerAMQP(ProducerFactory):
    def __init__(self, producer_group_id='', lookup_address='', node_address='', access_key='', access_secret='', timeout=None, max_message_size=None, username=None, password=None, virtual_host=None, instance_id=None, **config):
        self.__parameters = []
        ...
        for address in node_address.split(";"):
