...
class SavviHubMount(AnnotatedObject):
    path: str
    mount_type: str
    read_only: bool
    size: int
    ...
    dataset: typing.Optional[SavviHubDataset]
    volume: typing.Optional[SavviHubVolume]
...
class SavviHubVolumeMount(AnnotatedObject):
    ...
    working_dir: str
    mounts: typing.List[SavviHubMount]
...
class SavviHubExperiment(AnnotatedObject):
    ...
    volume_mounts: typing.Optional[SavviHubVolumeMount]
    metrics: typing.Optional[typing.List]
    source_code_link: typing.List
    start_command: str
    git_ref: str
