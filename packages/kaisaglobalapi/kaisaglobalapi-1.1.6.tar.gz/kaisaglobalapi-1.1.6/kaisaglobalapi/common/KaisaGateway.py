...
KAISA_ROOT_URL_UAT = "uat-kgl.jt00000.com"
...
# MARKET_WS_URL = "ws://uat-stock.jt00000.com/stock"
MARKET_WS_URL = "ws://sit-stock-gateway.jt00000.com/stock-front/stock"
...
from kaisaglobalapi.common import KaisaProtoc
...
class KaisaGateway():
    ...
    def jq_user_config(self, user_id, user_pwd, account_code, account_pwd, openapi_token, ip_address=None, environment='paper'):
        ...
        if self.environment in ["simulate", "paper", "sit"]:
            self.root_url = KAISA_ROOT_URL_SIM
        elif self.environment in ["uat"]:
            self.root_url = KAISA_ROOT_URL_UAT
        else:
            self.root_url = KAISA_ROOT_URL
    ...
    def _update_urls(self):
        ...
        self.MARKET_POST_URL = update_url(MARKET_POST_URL)
        self.MARKET_WS_URL = update_url(MARKET_WS_URL)
    ...
    def query_history_kline(self, symbol='01638', market='HK', klinetype='1d', adjfactortype='0', pagenum=1, pagesize=100):
        ...
        """
        post_url = self.MARKET_POST_URL+"/quoteInfo/kLine"
    ...
    def query_history_tick(self, symbol='00700', market='HK', pagesize=10, pagenum=1):
        ...
        post_url = self.MARKET_POST_URL + "/stock/quote/tick"
        rqdata = {
            'code': symbol,
            'market': market,
            'size': str(pagesize),
    ...
    def query_detailstate(self, symbol='01638', market='HK'):
        ...
        post_url = self.MARKET_POST_URL+ "/quoteInfo/todayDetailState"
        rqdata = {
            'code': symbol,
            'market': market,
            'hasQuoteInfo': True,
    ...
    def __market_connect_ws(self):
        ...
        self._market_ws = websocket.create_connection(self.MARKET_WS_URL, header=header)
