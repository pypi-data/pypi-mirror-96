...
class CfnPortal(
    ...
    @jsii.data_type(
        jsii_type="@aws-cdk/aws-iotsitewise.CfnPortal.MonitorErrorDetailsProperty",
        jsii_struct_bases=[],
    ...
    @jsii.data_type(
        jsii_type="@aws-cdk/aws-iotsitewise.CfnPortal.PortalStatusProperty",
        jsii_struct_bases=[],
    ...
    class PortalStatusProperty:
        def __init__(
            ...
            *,
            state: builtins.str,
            error: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPortal.MonitorErrorDetailsProperty"]] = None,
        ) -> None:
            '''
        ...
        def error(
            self,
        ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPortal.MonitorErrorDetailsProperty"]]:
            ...
            return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPortal.MonitorErrorDetailsProperty"]], result)
