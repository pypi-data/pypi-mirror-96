...
class CfnStateMachine(
    ...
    def definition_s3_location(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnStateMachine.S3LocationProperty", aws_cdk.core.IResolvable]], jsii.get(self, "definitionS3Location"))
...
class CfnStateMachineProps:
    ...
    def definition_s3_location(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnStateMachine.S3LocationProperty, aws_cdk.core.IResolvable]], result)
