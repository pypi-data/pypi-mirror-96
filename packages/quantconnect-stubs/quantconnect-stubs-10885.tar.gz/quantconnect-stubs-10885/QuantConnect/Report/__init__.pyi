...
class ReportSecurityProvider(System.Object, QuantConnect.Securities.ISecurityProvider):
    """Provides a test implementation of a security provider"""

    @typing.overload
    def __init__(self, securities: System.Collections.Generic.Dictionary[QuantConnect.Symbol, QuantConnect.Securities.Security]) -> None:
        ...
...
class StrategyCapacity(System.Object):
    """Class to facilitate the calculation of the strategy capacity"""

    @property
    def Capacity(self) -> System.Collections.Generic.List[QuantConnect.ChartPoint]:
        """Capacity of the strategy at different points in time"""
        ...

    @Capacity.setter
    def Capacity(self, value: System.Collections.Generic.List[QuantConnect.ChartPoint]):
        """Capacity of the strategy at different points in time"""
        ...

    def Estimate(self, result: QuantConnect.Result) -> typing.Optional[float]:
        """
        Estimates the strategy's capacity. Can be a live or backtest result.
        
        :param result: Backtest or live result
        :returns: Estimated capacity in USD.
        """
        ...

    def OnData(self, data: QuantConnect.Data.BaseData) -> None:
        """Triggered on a new slice update"""
        ...

    def TakeCapacitySnapshot(self, time: datetime.datetime) -> None:
        ...
