...
class BulkLoadRequestModel(ModelNormal):
    ...
    def __init__(self, profile_id, load_tag, load_control_file, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            max_failed_file_loads (int): max number of failed file loads before stopping; if -1, allow any number of errors. [optional] if omitted the server will use the default value of 0  # noqa: E501
        """
