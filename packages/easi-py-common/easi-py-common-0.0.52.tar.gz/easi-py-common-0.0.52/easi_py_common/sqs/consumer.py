...
class ConsumerStart:
    def __init__(self):
        ...
        self.is_run = True
        self.log_app_name = 'delivery'

    def start(self, app, handlers, db_pool_size, db_pool_size_every, db_pool_timeout, log_app_name='delivery'):
...
class ConsumerRun:
    def __init__(self, app_cb, log_app_name='delivery'):
        self.process_list = []
        self.app_cb = app_cb
        self.log_app_name = log_app_name
