...
`pip install --upgrade JWST_FOV_plotter` (make sure that you install version 0.2.1 or newer)
...
ax.imshow(ima[0].data, cmap='Greys', origin='lower',
          vmin=0, vmax=0.01)
...
**The code shown above would generate this example image:**
