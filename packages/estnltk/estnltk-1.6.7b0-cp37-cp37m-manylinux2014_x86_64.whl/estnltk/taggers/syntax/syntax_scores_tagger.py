...
class SyntaxScoresTagger(Tagger):
    """Tag sliding las, uas, la scores"""

    conf_param = ['window']

    def __init__(self, layer_a: str, layer_b: str, output_layer: str = 'scores', window: int = 3):
        assert window > 0
        self.input_layers = [layer_a, layer_b]
        self.output_layer = output_layer
        self.output_attributes = ['deprel_sequence', 'LAS', 'UAS', 'LA']
        self.window = window
