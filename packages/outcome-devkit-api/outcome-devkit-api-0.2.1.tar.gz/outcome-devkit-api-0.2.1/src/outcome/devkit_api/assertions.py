...
class ErrorDetailsLike(Protocol):  # pragma: no cover
    key: str
    subject: str
    message: str
...
def assert_ok_response(response: ResponseLike, expected_body: object, status_code: int = status.HTTP_200_OK):  # pragma: no cover
...
def assert_response(response: ResponseLike, expected_body: object, expected_status_code: int):  # pragma: no cover
