...
class CogniteWellsClient:
    ...
    def __init__(
        ...
        self.surveys = SurveysAPI(
            wells_client=self._api_client, project=self._config.project, cluster=self._config.cluster
        )
        self.wellbores = WellboresAPI(
            wells_client=self._api_client,
            survey_api=self.surveys,
            project=self._config.project,
            cluster=self._config.cluster,
        )
        self.wells = WellsAPI(
            wells_client=self._api_client,
            wellbores_api=self.wellbores,
            project=self._config.project,
            cluster=self._config.cluster,
        )
