...
class KeyboardMavic2DJI(KeyboardControlledDrone):
    ...
    def run(self):
        ...
        temperature_sensor = TemperatureSensor('../data/temperature.txt')
        humidity_sensor = HumiditySensor('../data/humidity.txt')
        ...
        while self.step(self.basic_time_step) != -1:
            ...
            print('Humidity values', humidity_sensor.get_values())
