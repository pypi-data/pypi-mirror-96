...
setup(
    ...
    description="Ecological electivity and forage indices",  # Optional
    ...
    url="https://github.com/aazuspan/electivity",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Aaron Zuspan",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="aa.zuspan@gmail.com",  # Optional
    ...
    keywords="electivity ecology biology selectivity",  # Optional
