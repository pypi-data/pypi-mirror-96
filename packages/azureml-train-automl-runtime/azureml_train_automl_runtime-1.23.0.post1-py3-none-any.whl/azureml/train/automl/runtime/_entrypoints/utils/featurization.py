...
def _prep_input_data(
...
) -> Tuple[RawExperimentData, ExperimentObserver, AutoMLFeatureConfigManager]:
    ...
    with tracer.start_as_current_span(
        ...
        raw_experiment_data = entrypoint_util.prepare_data(
    ...
    return raw_experiment_data, experiment_observer, feature_config_manager
