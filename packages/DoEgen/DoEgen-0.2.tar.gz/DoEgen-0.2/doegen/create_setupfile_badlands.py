...
workbook = xlsxwriter.Workbook('Experiment_setup_badlands.xlsx')
worksheet = workbook.add_worksheet()

workbook.set_properties({
    'title':    'Custom Experimental Design Setup for Badlands',
    'subject':  'Template',
    'author':   'Sebastian Haan',
...
worksheet.set_column('A:G', None, unlocked)
...
worksheet.set_column('F:F', 15, unlocked)
...
worksheet.data_validation('C2:C20', {'validate': 'integer',
                                 ...
                                 'minimum': 2,
                                 'maximum': 10})
worksheet.data_validation('F2:F20', {'validate': 'list',
                                  'source':  ['Yes', 'No']})
