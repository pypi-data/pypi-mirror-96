...
class DerivedDataProcessor:
    def __init__(self):
        ...
        self._oversea_fund_nav_analysis = OverseaFundNavAnalysis(data_helper=RawDataHelper())
    ...
    def process_all(self, start_date, end_date):
        ...
        try:
            ...
            failed_tasks.extend(self._oversea_fund_nav_analysis.process_fund_ret())
            failed_tasks.extend(self._oversea_fund_nav_analysis.process_current_mdd())
            failed_tasks.extend(self._oversea_fund_nav_analysis.process_monthly_ret())
            failed_tasks.extend(self._oversea_fund_nav_analysis.process_period_ret())
            failed_tasks.extend(self._oversea_fund_nav_analysis.process_recent_ret())
            ...
            if trading_day_df.shape[0] <= 1:
                ...
                if end_date_dt.year == next_trading_dt.year and end_date_dt.month == next_trading_dt.month:
                    ...
                    failed_tasks.extend(self._oversea_fund_nav_analysis.process_indicators())
                    failed_tasks.extend(self._oversea_fund_nav_analysis.process_radar_score())
