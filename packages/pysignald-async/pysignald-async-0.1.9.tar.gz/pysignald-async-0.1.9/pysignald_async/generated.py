...
Version: '0.12.0+git2021-02-25r6192dce7.42'
"""
...
class SignaldGeneratedAPI(JSONProtocol):
    ...
    async def mark_read(
        ...
        timestamps: List of messages to mark as read. Example: 1614229539682
        """
    ...
    async def list_contacts(
        ...
        account:
        async_: return results from local store immediately, refreshing from server afterward if needed. If false (default), block until all pending profiles have been retrieved..
        """
    ...
    async def leave_group(
        ...
        account: The account to use. Example: "+12024561414"
