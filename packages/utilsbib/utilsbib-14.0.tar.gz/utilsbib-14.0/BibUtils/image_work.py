...
class Face_cropper:
    ...
    def get_input_diff_color(self,filename,nb_color = 2):
        ...
        def perform_outside_check(self,fname,nb_t,m_type,m_color, color_diff, pad = 100, show_plot=False):
            ...
            for i in range(sizes[0]*sizes[1]):
                ...
                ori[i].image = image_work.how_close_to_color(ori[i].image,[0, 0, 0],100,dif_color_mark = m_color)[-1]
   ...
   """  def perform_outside_check(self,fname,nb_t,m_type,m_color, color_diff, pad = 100, show_plot=False):
        ...
        print("tiles2 :",nb_t)
        for i in range(sizes[0]*sizes[1]):
            ori[i].image = image_work.how_close_to_color(ori[i].image,[0, 0, 0],100,dif_color_mark = m_color[::-1])[-1]
            b, g, r = ori[i].image.split()
            im = Image.merge("RGB", (r, g, b))
