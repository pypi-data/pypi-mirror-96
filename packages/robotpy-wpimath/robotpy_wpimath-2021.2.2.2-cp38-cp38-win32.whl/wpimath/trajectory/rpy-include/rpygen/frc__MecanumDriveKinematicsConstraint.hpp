...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__MecanumDriveKinematicsConstraint : PyBasefrc__MecanumDriveKinematicsConstraint<PyTrampolineBase, CxxBase> {
    using PyBasefrc__MecanumDriveKinematicsConstraint<PyTrampolineBase, CxxBase>::PyBasefrc__MecanumDriveKinematicsConstraint;
