...
class EllipticalRegionConstraint(TrajectoryConstraint):
    ...
    """
    def __init__(self, center: wpimath.geometry._geometry.Translation2d, xWidth: meters, yWidth: meters, rotation: wpimath.geometry._geometry.Rotation2d, constraint: PyTrajectoryConstraint) -> None: 
        """
        ...
        """
    @staticmethod
    def fromFeet(center: wpimath.geometry._geometry.Translation2d, xWidth: feet, yWidth: feet, rotation: wpimath.geometry._geometry.Rotation2d, constraint: PyTrajectoryConstraint) -> EllipticalRegionConstraint: ...
...
class RectangularRegionConstraint(TrajectoryConstraint):
    ...
    """
    def __init__(self, bottomLeftPoint: wpimath.geometry._geometry.Translation2d, topRightPoint: wpimath.geometry._geometry.Translation2d, constraint: PyTrajectoryConstraint) -> None: 
        """
