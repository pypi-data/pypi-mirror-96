...
#include <../../_impl/include/frc/trajectory/constraint/MaxVelocityConstraint.h>
...
using PyBasefrc__MaxVelocityConstraint = 
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__MaxVelocityConstraint : PyBasefrc__MaxVelocityConstraint<PyTrampolineBase, CxxBase> {
    using PyBasefrc__MaxVelocityConstraint<PyTrampolineBase, CxxBase>::PyBasefrc__MaxVelocityConstraint;
