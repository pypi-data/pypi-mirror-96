...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__CentripetalAccelerationConstraint : PyBasefrc__CentripetalAccelerationConstraint<PyTrampolineBase, CxxBase> {
    using PyBasefrc__CentripetalAccelerationConstraint<PyTrampolineBase, CxxBase>::PyBasefrc__CentripetalAccelerationConstraint;
