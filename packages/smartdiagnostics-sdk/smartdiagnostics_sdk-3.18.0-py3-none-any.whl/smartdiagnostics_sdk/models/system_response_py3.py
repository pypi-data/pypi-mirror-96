...
class SystemResponse(Model):
    ...
    def __init__(self, *, is_collector_dependent_system: bool, is_visible: bool, id: str, name: str, active: bool, is_paused: bool, is_snoozed: bool, created, corporation, location, children=None, description: str=None, cds_base_stations=None, cds_master_systems=None, abbreviation: str=None, **kwargs) -> None:
