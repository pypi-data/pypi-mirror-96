...
class GroupAnalyticsModelResponse(Model):
    ...
    def __init__(self, *, group, id: int, name: str, version: str, type=None, created=None, group_type=None, is_global: bool=None, is_deprecated: bool=None, indicators=None, properties=None, related_models=None, created_by=None, corporation=None, location=None, triggers=None, **kwargs) -> None:
