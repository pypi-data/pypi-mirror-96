...
#    Updated: 2021/03/01 17:13:50 by cacharle         ###   ########.fr        #
#                                                                              #
# ############################################################################ #
...
from minishell_test.test.captured import Captured, CapturedTimeout
...
class Test:
    ...
    def _run_sandboxed(self, shell_cmd: List[Union[str, Path]]) -> Union[Captured, CapturedTimeout]:
    ...
    def _run_capture(self, shell_cmd: List[Union[str, Path]]) -> Union[Captured, CapturedTimeout]:
