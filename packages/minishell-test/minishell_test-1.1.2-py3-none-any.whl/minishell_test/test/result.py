...
#    Updated: 2021/03/01 17:14:44 by cacharle         ###   ########.fr        #
#                                                                              #
# ############################################################################ #
...
class Result(BaseResult):
    def __init__(
        ...
        cmd: str,
        file_names: List[str],
        expected: Union[Captured, CapturedTimeout],
        actual:   Union[Captured, CapturedTimeout],
    ):
        """Result class
           cmd:         runned command
    ...
    def output_diff(self) -> str:
        ...
        out = ""
        if self.actual is CapturedTimeout:
            return "TIMEOUT\n"
...
class LeakResult(BaseResult):
    ...
    def passed(self):
        """Check if the result passed"""
        if self.captured is CapturedTimeout:
            return False
