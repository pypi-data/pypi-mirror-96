...
from congress import __appname__, __version__


REPO_URL = "https://github.com/The-Politico/us-congress/"
...
setup(
    ...
    license="MIT",
    description="U.S. Congressional metadata (beta; more coming soon)",
