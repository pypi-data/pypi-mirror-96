class InitCommandContext:
    def __init__(self, connectivity, resource):
        self.connectivity = (
            connectivity  # Connectivity details that can help connect to the APIs
        )
...
class ConnectivityContext:
    def __init__(
        self, server_address, cloudshell_api_port, quali_api_port, admin_auth_token
    ):
...
class ResourceContextDetails:
    def __init__(
        ...
        """:type : dict[str,str]"""
        self.appdata_json = appdata_json
        # In case of an app, a json serialized object that contains the app details, including the selected deployment and installation configuration
        """:type : str"""
        self.vmdata_json = vmdata_json
        # In case of a virtual machine (deployed app), a json serialized object that contains the host details
        """:type : str"""
...
class Connector:
    def __init__(
        ...
        """:type : str"""
        self.target_type = (
            target_type  # The type of the target resource  (Service, App, Resource)
        )
        """:type : str"""
...
class AutoLoadDetails:
    def __init__(self, resources, attributes):
        self.resources = (
            resources  # the list of resources (root and sub) that were discovered
        )
...
class ResourceRemoteCommandContext:
    def __init__(
        self, connectivity, resource, remote_reservation, ports, remote_endpoints
    ):
        self.connectivity = (
            connectivity  # Connectivity details that can help connect to the APIs
        )
        ...
        self.remote_reservation = (
            remote_reservation  # The details of the remote reservation
        )
        """:type : ReservationContextDetails"""
