...
class TestSaveAppCommand(TestCase):
    ...
    def test_create_saved_apps_folder_if_not_found_in_vcenter(self):
        ...
        self.save_command.pyvmomi_service.get_folder = Mock(
            side_effect=[
                vm_location_folder,
                None,
                None,
    ...
    def test_error_thrown_during_save(self):
        ...
        self.save_command.deployer.deploy_clone_from_vm = Mock(
    ...
    def test_save_fails_due_to_unsupported_save_type(self):
        ...
        self.assertTrue(
            result[0].errorMessage
            == "Unsupported save type {0}".format(
                save_action.actionParams.saveDeploymentModel
            )
        )
