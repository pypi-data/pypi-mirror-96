...
def run_example(device_id):
    ...
    print(f"Current range changed from {man_curr_range:0.1e} A to {auto_curr_range:0.1e} A.")
    print(f"Voltage range changed from {man_volt_range:0.1e} V to {auto_volt_range:0.1e} V.")
