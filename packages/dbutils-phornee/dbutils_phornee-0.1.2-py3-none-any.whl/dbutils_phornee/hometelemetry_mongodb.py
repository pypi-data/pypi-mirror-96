...
class homeTelemetryMongoDB:
    ...
    def openConn(self, autocommit=True):
        ...
        try:
            self.conn = pymongo.MongoClient("mongodb+srv://admin:r3v6A%2A%25%23vyM5@cluster0.cc4xm.mongodb.net/hometelemetry?retryWrites=true&w=majority")
    ...
    def insert(self, table, params):
        mycolection = self.conn["hometelemetry"][table]
        x = mycolection.insert_one(params)
