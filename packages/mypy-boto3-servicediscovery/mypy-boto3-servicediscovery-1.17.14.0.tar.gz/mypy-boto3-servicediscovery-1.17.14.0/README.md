...
[boto3.ServiceDiscovery 1.17.14](https://boto3.amazonaws.com/v1/documentation/api/1.17.14/reference/services/servicediscovery.html#ServiceDiscovery) service
compatible with
