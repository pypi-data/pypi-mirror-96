...
def message_with_context(excp):
    """
    :param excp: An Exception object
    :return: A string contains str(excp) and optionally "\nContext: " + str(excp.__context__)
    """
    from pyspark.util import _exception_message

    message = _exception_message(excp)
    if getattr(excp, "__context__"):
        message += "\nContext: " + _exception_message(excp.__context__)
    return message
