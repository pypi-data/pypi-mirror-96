...
class CompletenessDataState(Enum):
...
class Cycle:
    def __init__(self):
        self.required = ['site', 'defaultSource', 'endDate', 'cycleDuration', 'functionalUnitMeasure', 'dataCompleteness', 'dataPrivate']
        self.fields = OrderedDict()
