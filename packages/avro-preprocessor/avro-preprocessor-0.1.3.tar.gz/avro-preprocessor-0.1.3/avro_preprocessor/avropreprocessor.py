...
if __name__ == '__main__':
    ...
    PARSER.add_argument('-y', '--yaml_indent', dest='yaml_indent', type=int, default=2)

    PARSER.add_argument('-ys', '--yaml_indent_sequence_value', dest='yaml_indent_sequence_value')
    PARSER.set_defaults(yaml_indent_sequence_value=True)
    ...
    AVRO_PREPROCESSOR: AvroPreprocessor = AvroPreprocessor(
        ...
        yaml_indent_sequence_value=ARGS.yaml_indent_sequence_value,
