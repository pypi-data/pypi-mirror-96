...
class Dataset(object):
    ...
    def __init__(self, id=None, name=None, description=None, type=None, model_type=None, outcome_type=None, treatment_type=None, location=None, file_content_type=None, file_size=None, file_type=None, row_count=None, column_count=None, athena_execution_id=None, dataset_results=None, organization_id=None, status=None, model_datasets=None, dataset_columns=None, model_jobs=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
