...
class DatasetJob(object):
    ...
    def __init__(self, id=None, config=None, execution_id=None, status=None, dataset_id=None, dataset_job_statuses=None, last_updated_by=None, created_at=None, updated_at=None, version=None):  # noqa: E501
