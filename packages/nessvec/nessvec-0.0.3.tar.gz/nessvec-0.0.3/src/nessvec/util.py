...
def unzip(dim=50, zip_filepath=None, dest_filename=None):
    """ Extract txt files from ZipFile and place them all in the dest_filepath or DATA_DIR """
    zip_filepath = zip_filepath or os.path.join()
    dest_filename = dest_filename or GLOVE_FILENAME_TEMPLATE.format(dim)
