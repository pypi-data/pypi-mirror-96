...
def generate_ambassador_host_yaml(spell_domain_name, has_tls_cert):
    """ Creates a 'host' resource that broadcasts configuration settings to ambassador.
      ...
      has_tls_cert: we were successfully able to create a kube secret ambassador-cert with a LetsEncrypt cert
      """
    if has_tls_cert:
        tls_secret = r"""
  tlsSecret:
