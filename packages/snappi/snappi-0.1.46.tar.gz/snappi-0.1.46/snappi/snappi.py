...
class CaptureFilterList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureEthernet, CaptureVlan, CaptureFilter, CaptureIpv4, CaptureCustom]
        return self._getitem(key)
...
class FlowHeaderList(SnappiList):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowEthernet, FlowPfcPause, FlowGre, FlowCustom, FlowGtpv2, FlowIpv4, FlowUdp, FlowVxlan, FlowIgmpv1, FlowEthernetPause, FlowHeader, FlowIpv6, FlowArp, FlowPpp, FlowTcp, FlowGtpv1, FlowVlan]
        return self._getitem(key)
