...
class Hotwater:
    ...
    def get_hotwater(self, device):
        ...
        if device["deviceData"]["online"]:
            ...
            dev_data = {
                ...
                "status": {"current_operation": self.get_mode(device)},
    ...
    def get_state(self, device):
        ...
        try:
            ...
            mode_current = self.get_mode(device)
    ...
    def turn_boost_on(self, device, mins):
