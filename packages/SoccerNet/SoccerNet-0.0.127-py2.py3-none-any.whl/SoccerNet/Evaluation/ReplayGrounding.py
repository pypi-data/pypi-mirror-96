...
def evaluate(SoccerNet_path, Predictions_path, prediction_file="Detection-replays.json", split="test", framerate=None):
    framerate = 2
    ...
    a_AP = average_mAP(gt_list, detections_list, framerate=framerate)
    # print("a_mAP: ",a_mAP)
    return {"a_AP": a_AP}
...
def average_mAP_heuristic(targets, detections, replays, framerate=2, seconds=0, NMS_on=True):
