...
setup(
    name = 'shapley:lz',
    version = this_version("src", "__init__.py"),
    ...
    license = 'MIT',
    modules = ['shapley_lz.shapley_lz', 'shapley_lz.variants.shapley_lz_bruteforce', 'shapley_lz.variants.shapley_lz_multiproc'], # list of actual python code modules
    packages = ['shapley_lz', 'shapley_lz.variants'],
