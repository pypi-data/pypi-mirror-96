...
from valhalla.utils import handle_status, validate_image, validate_metadata, extract_skin_metadata
...
def put(uuid: UUID, kind: TextureType) -> TextureStatusResponse:
    ...
    image_metadata = validate_metadata(raw_metadata=raw_metadata)
