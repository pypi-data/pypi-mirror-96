...
g_translation.fr.put("Cordova client", "Client Cordova");
...
g_translation.fr.put("{0} on {1}", "'{0}' sur '{1}'");
g_translation.fr.put("Device client", "Dispositif client");
g_translation.fr.put("File", "Fichier");
g_translation.fr.put("Picture", "Image");
g_translation.fr.put("Take picture", "Capturer une image");
g_translation.fr.put('Browser does not support camera for this address :(', 'Ce navigateur ne supporte pas les webcams pour cette adresse :(');
g_translation.fr.put('name', 'nom');
g_translation.fr.put("address", "adresse");
g_translation.fr.put('current', 'courant');
g_translation.fr.put('add', 'ajouter');
g_translation.fr.put('delete', 'supprimer');
g_translation.fr.put('Add new server address', 'Ajouter une nouvelle adresse de serveur');
g_translation.fr.put('Manage server addresses', 'Gérer des adresses de serveurs');
g_translation.fr.put("Add server", "Ajouter un serveur");
g_translation.fr.put("Servers", "Les serveurs");
g_translation.fr.put("Client obselete", "Client obsolète <br/> Effectuer un mise à jour");
...
g_translation.en.put("Cordova client", "Cordova client");
...
g_translation.en.put("{0} on {1}", "'{0}' on '{1}'");
g_translation.en.put("Device client", "Device client");
g_translation.en.put("File", "File");
g_translation.en.put("Picture", "Picture");
g_translation.en.put("Take picture", "Take picture");
g_translation.en.put('Browser does not support camera for this address :(', 'Browser does not support camera for this address :(');
g_translation.en.put('name', 'name');
g_translation.en.put("address", "address");
g_translation.en.put('current', 'current');
g_translation.en.put('add', 'add');
g_translation.en.put('delete', 'delete');
g_translation.en.put('Add new server address', 'Add new server address');
g_translation.en.put('Manage server addresses', 'Manage server addresses');
g_translation.en.put("Add server", "Add server");
g_translation.en.put("Servers", "Servers");
g_translation.en.put("Client obselete", "Obsolete client <br/> Perform an update");
