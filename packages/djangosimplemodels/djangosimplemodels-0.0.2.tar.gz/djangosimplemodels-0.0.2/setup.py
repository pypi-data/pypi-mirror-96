...
setup(
    ...
    description = 'Package with abstract classes to facilitate the development of Django models.',
    long_description = 'Package with abstract classes to facilitate the development of Django models.',
