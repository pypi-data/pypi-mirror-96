...
class VirtualHostnameApi(object):
    ...
    def get_virtual_hostname_with_http_info(self, virtual_hostname, **kwargs):  # noqa: E501
        ...
        all_params = ['virtual_hostname', 'select']  # noqa: E501
