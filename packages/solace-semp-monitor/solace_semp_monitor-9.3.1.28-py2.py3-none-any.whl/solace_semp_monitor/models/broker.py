...
class Broker(object):
    ...
    def __init__(self, auth_client_cert_revocation_check_mode=None, tls_block_version11_enabled=None, tls_cipher_suite_management_default_list=None, tls_cipher_suite_management_list=None, tls_cipher_suite_management_supported_list=None, tls_cipher_suite_msg_backbone_default_list=None, tls_cipher_suite_msg_backbone_list=None, tls_cipher_suite_msg_backbone_supported_list=None, tls_cipher_suite_secure_shell_default_list=None, tls_cipher_suite_secure_shell_list=None, tls_cipher_suite_secure_shell_supported_list=None, tls_crime_exploit_protection_enabled=None, tls_ticket_lifetime=None, tls_version_supported_list=None):  # noqa: E501
