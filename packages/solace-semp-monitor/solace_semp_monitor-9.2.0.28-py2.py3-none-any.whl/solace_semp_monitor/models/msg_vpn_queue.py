...
class MsgVpnQueue(object):
    ...
    def egress_enabled(self):
        ...
        Enable or disable the transmission of messages from the Queue.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the reception of messages to the Queue.  # noqa: E501
    ...
    def respect_msg_priority_enabled(self):
        ...
        Indicates whether the respecting of message priority is enabled. When enabled, messages contained in the Queue are delivered in priority order, from 9 (highest) to 0 (lowest).  # noqa: E501
    ...
    def respect_ttl_enabled(self):
        ...
        Enable or disable the respecting of the time-to-live (TTL) for messages in the Queue. When enabled, expired messages are discarded or moved to the DMQ.  # noqa: E501
