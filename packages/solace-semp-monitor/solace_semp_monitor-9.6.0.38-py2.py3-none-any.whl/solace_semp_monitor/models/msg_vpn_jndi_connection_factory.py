...
class MsgVpnJndiConnectionFactory(object):
    ...
    swagger_types = {
        ...
        'guaranteed_receive_reconnect_retry_count': 'int',
        'guaranteed_receive_reconnect_retry_wait': 'int',
    ...
    attribute_map = {
        ...
        'guaranteed_receive_reconnect_retry_count': 'guaranteedReceiveReconnectRetryCount',
        'guaranteed_receive_reconnect_retry_wait': 'guaranteedReceiveReconnectRetryWait',
    ...
    def __init__(self, allow_duplicate_client_id_enabled=None, client_description=None, client_id=None, connection_factory_name=None, dto_receive_override_enabled=None, dto_receive_subscriber_local_priority=None, dto_receive_subscriber_network_priority=None, dto_send_enabled=None, dynamic_endpoint_create_durable_enabled=None, dynamic_endpoint_respect_ttl_enabled=None, guaranteed_receive_ack_timeout=None, guaranteed_receive_reconnect_retry_count=None, guaranteed_receive_reconnect_retry_wait=None, guaranteed_receive_window_size=None, guaranteed_receive_window_size_ack_threshold=None, guaranteed_send_ack_timeout=None, guaranteed_send_window_size=None, messaging_default_delivery_mode=None, messaging_default_dmq_eligible_enabled=None, messaging_default_eliding_eligible_enabled=None, messaging_jmsx_user_id_enabled=None, messaging_text_in_xml_payload_enabled=None, msg_vpn_name=None, transport_compression_level=None, transport_connect_retry_count=None, transport_connect_retry_per_host_count=None, transport_connect_timeout=None, transport_direct_transport_enabled=None, transport_keepalive_count=None, transport_keepalive_enabled=None, transport_keepalive_interval=None, transport_msg_callback_on_io_thread_enabled=None, transport_optimize_direct_enabled=None, transport_port=None, transport_read_timeout=None, transport_receive_buffer_size=None, transport_reconnect_retry_count=None, transport_reconnect_retry_wait=None, transport_send_buffer_size=None, transport_tcp_no_delay_enabled=None, xa_enabled=None):  # noqa: E501
        ...
        self._guaranteed_receive_reconnect_retry_count = None
        self._guaranteed_receive_reconnect_retry_wait = None
        ...
        if guaranteed_receive_reconnect_retry_count is not None:
            self.guaranteed_receive_reconnect_retry_count = guaranteed_receive_reconnect_retry_count
        if guaranteed_receive_reconnect_retry_wait is not None:
            self.guaranteed_receive_reconnect_retry_wait = guaranteed_receive_reconnect_retry_wait
    ...
    def allow_duplicate_client_id_enabled(self):
        ...
        Indicates whether new JMS connections can use the same Client identifier (ID) as an existing connection.  # noqa: E501
    ...
    def client_description(self):
        ...
        The description of the Client.  # noqa: E501
    ...
    def client_id(self):
        ...
        The Client identifier (ID). If not specified, a unique value for it will be generated.  # noqa: E501
    ...
    def dto_receive_override_enabled(self):
        ...
        Indicates whether overriding by the Subscriber (Consumer) of the deliver-to-one (DTO) property on messages is enabled. When enabled, the Subscriber can receive all DTO tagged messages.  # noqa: E501
    ...
    def dto_receive_subscriber_local_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer) if the messages are published on the local broker that the Subscriber is directly connected to.  # noqa: E501
    ...
    def dto_receive_subscriber_network_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer) if the messages are published on a remote broker.  # noqa: E501
    ...
    def dto_send_enabled(self):
        ...
        Indicates whether the deliver-to-one (DTO) property is enabled on messages sent by the Publisher (Producer).  # noqa: E501
    ...
    def dynamic_endpoint_create_durable_enabled(self):
        ...
        Indicates whether a durable endpoint will be dynamically created on the broker when the client calls \"Session.createDurableSubscriber()\" or \"Session.createQueue()\". The created endpoint respects the message time-to-live (TTL) according to the \"dynamicEndpointRespectTtlEnabled\" property.  # noqa: E501
    ...
    def dynamic_endpoint_respect_ttl_enabled(self):
        ...
        Indicates whether dynamically created durable and non-durable endpoints respect the message time-to-live (TTL) property.  # noqa: E501
    ...
    def guaranteed_receive_ack_timeout(self):
        ...
        The timeout for sending the acknowledgement (ACK) for guaranteed messages received by the Subscriber (Consumer), in milliseconds.  # noqa: E501
    ...
    @property
    def guaranteed_receive_reconnect_retry_count(self):
        """Gets the guaranteed_receive_reconnect_retry_count of this MsgVpnJndiConnectionFactory.  # noqa: E501

        The maximum number of attempts to reconnect to the host or list of hosts after the guaranteed  messaging connection has been lost. The value \"-1\" means to retry forever. Available since 2.14.  # noqa: E501

        :return: The guaranteed_receive_reconnect_retry_count of this MsgVpnJndiConnectionFactory.  # noqa: E501
        :rtype: int
        """
        return self._guaranteed_receive_reconnect_retry_count

    @guaranteed_receive_reconnect_retry_count.setter
    def guaranteed_receive_reconnect_retry_count(self, guaranteed_receive_reconnect_retry_count):
        """Sets the guaranteed_receive_reconnect_retry_count of this MsgVpnJndiConnectionFactory.

        The maximum number of attempts to reconnect to the host or list of hosts after the guaranteed  messaging connection has been lost. The value \"-1\" means to retry forever. Available since 2.14.  # noqa: E501

        :param guaranteed_receive_reconnect_retry_count: The guaranteed_receive_reconnect_retry_count of this MsgVpnJndiConnectionFactory.  # noqa: E501
        :type: int
        """

        self._guaranteed_receive_reconnect_retry_count = guaranteed_receive_reconnect_retry_count

    @property
    def guaranteed_receive_reconnect_retry_wait(self):
        """Gets the guaranteed_receive_reconnect_retry_wait of this MsgVpnJndiConnectionFactory.  # noqa: E501

        The amount of time to wait before making another attempt to connect or reconnect to the host after the guaranteed messaging connection has been lost, in milliseconds. Available since 2.14.  # noqa: E501

        :return: The guaranteed_receive_reconnect_retry_wait of this MsgVpnJndiConnectionFactory.  # noqa: E501
        :rtype: int
        """
        return self._guaranteed_receive_reconnect_retry_wait

    @guaranteed_receive_reconnect_retry_wait.setter
    def guaranteed_receive_reconnect_retry_wait(self, guaranteed_receive_reconnect_retry_wait):
        """Sets the guaranteed_receive_reconnect_retry_wait of this MsgVpnJndiConnectionFactory.

        The amount of time to wait before making another attempt to connect or reconnect to the host after the guaranteed messaging connection has been lost, in milliseconds. Available since 2.14.  # noqa: E501

        :param guaranteed_receive_reconnect_retry_wait: The guaranteed_receive_reconnect_retry_wait of this MsgVpnJndiConnectionFactory.  # noqa: E501
        :type: int
        """

        self._guaranteed_receive_reconnect_retry_wait = guaranteed_receive_reconnect_retry_wait
    ...
    def guaranteed_receive_window_size(self):
        ...
        The size of the window for guaranteed messages received by the Subscriber (Consumer), in messages.  # noqa: E501
    ...
    def guaranteed_receive_window_size_ack_threshold(self):
        ...
        The threshold for sending the acknowledgement (ACK) for guaranteed messages received by the Subscriber (Consumer) as a percentage of `guaranteedReceiveWindowSize`.  # noqa: E501
    ...
    def guaranteed_send_ack_timeout(self):
        ...
        The timeout for receiving the acknowledgement (ACK) for guaranteed messages sent by the Publisher (Producer), in milliseconds.  # noqa: E501
    ...
    def guaranteed_send_window_size(self):
        ...
        The size of the window for non-persistent guaranteed messages sent by the Publisher (Producer), in messages. For persistent messages the window size is fixed at 1.  # noqa: E501
    ...
    def messaging_default_dmq_eligible_enabled(self):
        ...
        Indicates whether messages sent by the Publisher (Producer) are Dead Message Queue (DMQ) eligible by default.  # noqa: E501
    ...
    def messaging_default_eliding_eligible_enabled(self):
        ...
        Indicates whether messages sent by the Publisher (Producer) are Eliding eligible by default.  # noqa: E501
    ...
    def messaging_jmsx_user_id_enabled(self):
        ...
        Indicates whether to include (add or replace) the JMSXUserID property in messages sent by the Publisher (Producer).  # noqa: E501
    ...
    def messaging_text_in_xml_payload_enabled(self):
        ...
        Indicates whether encoding of JMS text messages in Publisher (Producer) messages is as XML payload. When disabled, JMS text messages are encoded as a binary attachment.  # noqa: E501
    ...
    def transport_compression_level(self):
        ...
        The ZLIB compression level for the connection to the broker. The value \"0\" means no compression, and the value \"-1\" means the compression level is specified in the JNDI Properties file.  # noqa: E501
    ...
    def transport_connect_retry_count(self):
        ...
        The maximum number of retry attempts to establish an initial connection to the host or list of hosts. The value \"0\" means a single attempt (no retries), and the value \"-1\" means to retry forever.  # noqa: E501
    ...
    def transport_connect_retry_per_host_count(self):
        ...
        The maximum number of retry attempts to establish an initial connection to each host on the list of hosts. The value \"0\" means a single attempt (no retries), and the value \"-1\" means to retry forever.  # noqa: E501
    ...
    def transport_connect_timeout(self):
        ...
        The timeout for establishing an initial connection to the broker, in milliseconds.  # noqa: E501
    ...
    def transport_direct_transport_enabled(self):
        ...
        Indicates whether usage of the Direct Transport mode for sending non-persistent messages is enabled. When disabled, the Guaranteed Transport mode is used.  # noqa: E501
    ...
    def transport_keepalive_count(self):
        ...
        The maximum number of consecutive application-level keepalive messages sent without the broker response before the connection to the broker is closed.  # noqa: E501
    ...
    def transport_keepalive_enabled(self):
        ...
        Indicates whether application-level keepalive messages are used to maintain a connection with the Router.  # noqa: E501
    ...
    def transport_keepalive_interval(self):
        ...
        The interval between application-level keepalive messages, in milliseconds.  # noqa: E501
    ...
    def transport_msg_callback_on_io_thread_enabled(self):
        ...
        Indicates whether delivery of asynchronous messages is done directly from the I/O thread.  # noqa: E501
    ...
    def transport_optimize_direct_enabled(self):
        ...
        Indicates whether optimization for the Direct Transport delivery mode is enabled. If enabled, the client application is limited to one Publisher (Producer) and one non-durable Subscriber (Consumer).  # noqa: E501
    ...
    def transport_port(self):
        ...
        The connection port number on the broker for SMF clients. The value \"-1\" means the port is specified in the JNDI Properties file.  # noqa: E501
    ...
    def transport_read_timeout(self):
        ...
        The timeout for reading a reply from the broker, in milliseconds.  # noqa: E501
    ...
    def transport_receive_buffer_size(self):
        ...
        The size of the receive socket buffer, in bytes. It corresponds to the SO_RCVBUF socket option.  # noqa: E501
    ...
    def transport_reconnect_retry_count(self):
        ...
        The maximum number of attempts to reconnect to the host or list of hosts after the connection has been lost. The value \"-1\" means to retry forever.  # noqa: E501
    ...
    def transport_reconnect_retry_wait(self):
        ...
        The amount of time before making another attempt to connect or reconnect to the host after the connection has been lost, in milliseconds.  # noqa: E501
    ...
    def transport_send_buffer_size(self):
        ...
        The size of the send socket buffer, in bytes. It corresponds to the SO_SNDBUF socket option.  # noqa: E501
    ...
    def transport_tcp_no_delay_enabled(self):
        ...
        Indicates whether the TCP_NODELAY option is enabled, which disables Nagle's algorithm for TCP/IP congestion control (RFC 896).  # noqa: E501
    ...
    def xa_enabled(self):
        ...
        Indicates whether this is an XA Connection Factory. When enabled, the Connection Factory can be cast to \"XAConnectionFactory\", \"XAQueueConnectionFactory\" or \"XATopicConnectionFactory\".  # noqa: E501
