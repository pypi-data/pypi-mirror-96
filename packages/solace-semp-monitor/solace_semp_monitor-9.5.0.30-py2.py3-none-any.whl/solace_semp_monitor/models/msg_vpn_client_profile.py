...
class MsgVpnClientProfile(object):
    ...
    def api_queue_management_copy_from_on_create_name(self):
        ...
        The name of a queue to copy settings from when a new queue is created by a client using the Client Profile. The referenced queue must exist in the Message VPN. Deprecated since 2.16. This attribute has been replaced with `apiQueueManagementCopyFromOnCreateTemplateName`.  # noqa: E501
    ...
    def api_topic_endpoint_management_copy_from_on_create_name(self):
        ...
        The name of a topic endpoint to copy settings from when a new topic endpoint is created by a client using the Client Profile. The referenced topic endpoint must exist in the Message VPN. Deprecated since 2.16. This attribute has been replaced with `apiTopicEndpointManagementCopyFromOnCreateTemplateName`.  # noqa: E501
