...
class MsgVpnQueue(object):
    ...
    swagger_types = {
        ...
        'transport_retransmit_msg_count': 'int',
        'tx_byte_rate': 'int',
        'tx_msg_rate': 'int',
        'tx_selector': 'bool',
    ...
    attribute_map = {
        ...
        'delivery_count_enabled': 'deliveryCountEnabled',
        ...
        'redelivery_enabled': 'redeliveryEnabled',
        ...
        'transport_retransmit_msg_count': 'transportRetransmitMsgCount',
    ...
    def __init__(self, access_type=None, already_bound_bind_failure_count=None, average_rx_byte_rate=None, average_rx_msg_rate=None, average_tx_byte_rate=None, average_tx_msg_rate=None, bind_request_count=None, bind_success_count=None, bind_time_forwarding_mode=None, client_profile_denied_discarded_msg_count=None, consumer_ack_propagation_enabled=None, created_by_management=None, dead_msg_queue=None, deleted_msg_count=None, delivery_count_enabled=None, destination_group_error_discarded_msg_count=None, disabled_bind_failure_count=None, disabled_discarded_msg_count=None, durable=None, egress_enabled=None, event_bind_count_threshold=None, event_msg_spool_usage_threshold=None, event_reject_low_priority_msg_limit_threshold=None, highest_acked_msg_id=None, highest_msg_id=None, in_progress_ack_msg_count=None, ingress_enabled=None, invalid_selector_bind_failure_count=None, last_replay_complete_time=None, last_replay_failure_reason=None, last_replay_failure_time=None, last_replay_start_time=None, last_replayed_msg_tx_time=None, last_spooled_msg_id=None, low_priority_msg_congestion_discarded_msg_count=None, low_priority_msg_congestion_state=None, lowest_acked_msg_id=None, lowest_msg_id=None, max_bind_count=None, max_bind_count_exceeded_bind_failure_count=None, max_delivered_unacked_msgs_per_flow=None, max_msg_size=None, max_msg_size_exceeded_discarded_msg_count=None, max_msg_spool_usage=None, max_msg_spool_usage_exceeded_discarded_msg_count=None, max_redelivery_count=None, max_redelivery_exceeded_discarded_msg_count=None, max_redelivery_exceeded_to_dmq_failed_msg_count=None, max_redelivery_exceeded_to_dmq_msg_count=None, max_ttl=None, max_ttl_exceeded_discarded_msg_count=None, max_ttl_expired_discarded_msg_count=None, max_ttl_expired_to_dmq_failed_msg_count=None, max_ttl_expired_to_dmq_msg_count=None, msg_spool_peak_usage=None, msg_spool_usage=None, msg_vpn_name=None, network_topic=None, no_local_delivery_discarded_msg_count=None, other_bind_failure_count=None, owner=None, permission=None, queue_name=None, redelivered_msg_count=None, redelivery_enabled=None, reject_low_priority_msg_enabled=None, reject_low_priority_msg_limit=None, reject_msg_to_sender_on_discard_behavior=None, replay_failure_count=None, replay_start_count=None, replay_state=None, replay_success_count=None, replayed_acked_msg_count=None, replayed_tx_msg_count=None, replication_active_ack_prop_tx_msg_count=None, replication_standby_ack_prop_rx_msg_count=None, replication_standby_acked_by_ack_prop_msg_count=None, replication_standby_rx_msg_count=None, respect_msg_priority_enabled=None, respect_ttl_enabled=None, rx_byte_rate=None, rx_msg_rate=None, spooled_byte_count=None, spooled_msg_count=None, transport_retransmit_msg_count=None, tx_byte_rate=None, tx_msg_rate=None, tx_selector=None, tx_unacked_msg_count=None, virtual_router=None):  # noqa: E501
        ...
        self._delivery_count_enabled = None
        ...
        self._transport_retransmit_msg_count = None
        ...
        if delivery_count_enabled is not None:
            self.delivery_count_enabled = delivery_count_enabled
        ...
        if redelivery_enabled is not None:
            self.redelivery_enabled = redelivery_enabled
        ...
        if transport_retransmit_msg_count is not None:
            self.transport_retransmit_msg_count = transport_retransmit_msg_count
    ...
    def already_bound_bind_failure_count(self):
        """Gets the already_bound_bind_failure_count of this MsgVpnQueue.  # noqa: E501

        The number of Queue bind failures due to being already bound.  # noqa: E501

        :return: The already_bound_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def already_bound_bind_failure_count(self, already_bound_bind_failure_count):
        """Sets the already_bound_bind_failure_count of this MsgVpnQueue.

        The number of Queue bind failures due to being already bound.  # noqa: E501

        :param already_bound_bind_failure_count: The already_bound_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def average_rx_byte_rate(self):
        """Gets the average_rx_byte_rate of this MsgVpnQueue.  # noqa: E501

        The one minute average of the message rate received by the Queue, in bytes per second (B/sec).  # noqa: E501

        :return: The average_rx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def average_rx_byte_rate(self, average_rx_byte_rate):
        """Sets the average_rx_byte_rate of this MsgVpnQueue.

        The one minute average of the message rate received by the Queue, in bytes per second (B/sec).  # noqa: E501

        :param average_rx_byte_rate: The average_rx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def average_rx_msg_rate(self):
        """Gets the average_rx_msg_rate of this MsgVpnQueue.  # noqa: E501

        The one minute average of the message rate received by the Queue, in messages per second (msg/sec).  # noqa: E501

        :return: The average_rx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def average_rx_msg_rate(self, average_rx_msg_rate):
        """Sets the average_rx_msg_rate of this MsgVpnQueue.

        The one minute average of the message rate received by the Queue, in messages per second (msg/sec).  # noqa: E501

        :param average_rx_msg_rate: The average_rx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def average_tx_byte_rate(self):
        """Gets the average_tx_byte_rate of this MsgVpnQueue.  # noqa: E501

        The one minute average of the message rate transmitted by the Queue, in bytes per second (B/sec).  # noqa: E501

        :return: The average_tx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def average_tx_byte_rate(self, average_tx_byte_rate):
        """Sets the average_tx_byte_rate of this MsgVpnQueue.

        The one minute average of the message rate transmitted by the Queue, in bytes per second (B/sec).  # noqa: E501

        :param average_tx_byte_rate: The average_tx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def average_tx_msg_rate(self):
        """Gets the average_tx_msg_rate of this MsgVpnQueue.  # noqa: E501

        The one minute average of the message rate transmitted by the Queue, in messages per second (msg/sec).  # noqa: E501

        :return: The average_tx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def average_tx_msg_rate(self, average_tx_msg_rate):
        """Sets the average_tx_msg_rate of this MsgVpnQueue.

        The one minute average of the message rate transmitted by the Queue, in messages per second (msg/sec).  # noqa: E501

        :param average_tx_msg_rate: The average_tx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def bind_request_count(self):
        """Gets the bind_request_count of this MsgVpnQueue.  # noqa: E501

        The number of consumer requests to bind to the Queue.  # noqa: E501

        :return: The bind_request_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def bind_request_count(self, bind_request_count):
        """Sets the bind_request_count of this MsgVpnQueue.

        The number of consumer requests to bind to the Queue.  # noqa: E501

        :param bind_request_count: The bind_request_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def bind_success_count(self):
        """Gets the bind_success_count of this MsgVpnQueue.  # noqa: E501

        The number of successful consumer requests to bind to the Queue.  # noqa: E501

        :return: The bind_success_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def bind_success_count(self, bind_success_count):
        """Sets the bind_success_count of this MsgVpnQueue.

        The number of successful consumer requests to bind to the Queue.  # noqa: E501

        :param bind_success_count: The bind_success_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def bind_time_forwarding_mode(self):
        """Gets the bind_time_forwarding_mode of this MsgVpnQueue.  # noqa: E501

        The forwarding mode of the Queue at bind time. The allowed values and their meaning are:  <pre> \"store-and-forward\" - Deliver messages using the guaranteed data path. \"cut-through\" - Deliver messages using the direct and guaranteed data paths for lower latency. </pre>   # noqa: E501

        :return: The bind_time_forwarding_mode of this MsgVpnQueue.  # noqa: E501
        :rtype: str
        """
    ...
    def bind_time_forwarding_mode(self, bind_time_forwarding_mode):
        """Sets the bind_time_forwarding_mode of this MsgVpnQueue.

        The forwarding mode of the Queue at bind time. The allowed values and their meaning are:  <pre> \"store-and-forward\" - Deliver messages using the guaranteed data path. \"cut-through\" - Deliver messages using the direct and guaranteed data paths for lower latency. </pre>   # noqa: E501

        :param bind_time_forwarding_mode: The bind_time_forwarding_mode of this MsgVpnQueue.  # noqa: E501
        :type: str
        """
    ...
    def client_profile_denied_discarded_msg_count(self):
        """Gets the client_profile_denied_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to being denied by the Client Profile.  # noqa: E501

        :return: The client_profile_denied_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def client_profile_denied_discarded_msg_count(self, client_profile_denied_discarded_msg_count):
        """Sets the client_profile_denied_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to being denied by the Client Profile.  # noqa: E501

        :param client_profile_denied_discarded_msg_count: The client_profile_denied_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def consumer_ack_propagation_enabled(self):
        ...
        Indicates whether the propagation of consumer acknowledgements (ACKs) received on the active replication Message VPN to the standby replication Message VPN is enabled.  # noqa: E501
    ...
    def created_by_management(self):
        """Gets the created_by_management of this MsgVpnQueue.  # noqa: E501

        Indicates whether the Queue was created by a management API (CLI or SEMP).  # noqa: E501

        :return: The created_by_management of this MsgVpnQueue.  # noqa: E501
        :rtype: bool
        """
    ...
    def created_by_management(self, created_by_management):
        """Sets the created_by_management of this MsgVpnQueue.

        Indicates whether the Queue was created by a management API (CLI or SEMP).  # noqa: E501

        :param created_by_management: The created_by_management of this MsgVpnQueue.  # noqa: E501
        :type: bool
        """
    ...
    def dead_msg_queue(self):
        ...
        The name of the Dead Message Queue (DMQ) used by the Queue.  # noqa: E501
    ...
    def deleted_msg_count(self):
        """Gets the deleted_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages deleted from the Queue.  # noqa: E501

        :return: The deleted_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def deleted_msg_count(self, deleted_msg_count):
        """Sets the deleted_msg_count of this MsgVpnQueue.

        The number of guaranteed messages deleted from the Queue.  # noqa: E501

        :param deleted_msg_count: The deleted_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    @property
    def delivery_count_enabled(self):
        """Gets the delivery_count_enabled of this MsgVpnQueue.  # noqa: E501

        Enable or disable the ability for client applications to query the message delivery count of messages received from the Queue. This is a controlled availability feature. Please contact Solace to find out if this feature is supported for your use case. Available since 2.19.  # noqa: E501

        :return: The delivery_count_enabled of this MsgVpnQueue.  # noqa: E501
        :rtype: bool
        """
        return self._delivery_count_enabled

    @delivery_count_enabled.setter
    def delivery_count_enabled(self, delivery_count_enabled):
        """Sets the delivery_count_enabled of this MsgVpnQueue.

        Enable or disable the ability for client applications to query the message delivery count of messages received from the Queue. This is a controlled availability feature. Please contact Solace to find out if this feature is supported for your use case. Available since 2.19.  # noqa: E501

        :param delivery_count_enabled: The delivery_count_enabled of this MsgVpnQueue.  # noqa: E501
        :type: bool
        """

        self._delivery_count_enabled = delivery_count_enabled

    @property
    def destination_group_error_discarded_msg_count(self):
        """Gets the destination_group_error_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to a destination group error.  # noqa: E501

        :return: The destination_group_error_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def destination_group_error_discarded_msg_count(self, destination_group_error_discarded_msg_count):
        """Sets the destination_group_error_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to a destination group error.  # noqa: E501

        :param destination_group_error_discarded_msg_count: The destination_group_error_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def disabled_bind_failure_count(self):
        """Gets the disabled_bind_failure_count of this MsgVpnQueue.  # noqa: E501

        The number of Queue bind failures due to being disabled.  # noqa: E501

        :return: The disabled_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def disabled_bind_failure_count(self, disabled_bind_failure_count):
        """Sets the disabled_bind_failure_count of this MsgVpnQueue.

        The number of Queue bind failures due to being disabled.  # noqa: E501

        :param disabled_bind_failure_count: The disabled_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def disabled_discarded_msg_count(self):
        """Gets the disabled_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to it being disabled.  # noqa: E501

        :return: The disabled_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def disabled_discarded_msg_count(self, disabled_discarded_msg_count):
        """Sets the disabled_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to it being disabled.  # noqa: E501

        :param disabled_discarded_msg_count: The disabled_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    @property
    def durable(self):
        """Gets the durable of this MsgVpnQueue.  # noqa: E501

        Indicates whether the Queue is durable and not temporary.  # noqa: E501

        :return: The durable of this MsgVpnQueue.  # noqa: E501
        :rtype: bool
        """
    ...
    def durable(self, durable):
        """Sets the durable of this MsgVpnQueue.

        Indicates whether the Queue is durable and not temporary.  # noqa: E501

        :param durable: The durable of this MsgVpnQueue.  # noqa: E501
        :type: bool
        """
    ...
    def egress_enabled(self):
        ...
        Indicates whether the transmission of messages from the Queue is enabled.  # noqa: E501
    ...
    def highest_acked_msg_id(self):
        """Gets the highest_acked_msg_id of this MsgVpnQueue.  # noqa: E501

        The highest identifier (ID) of guaranteed messages in the Queue that were acknowledged.  # noqa: E501

        :return: The highest_acked_msg_id of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def highest_acked_msg_id(self, highest_acked_msg_id):
        """Sets the highest_acked_msg_id of this MsgVpnQueue.

        The highest identifier (ID) of guaranteed messages in the Queue that were acknowledged.  # noqa: E501

        :param highest_acked_msg_id: The highest_acked_msg_id of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def highest_msg_id(self):
        """Gets the highest_msg_id of this MsgVpnQueue.  # noqa: E501

        The highest identifier (ID) of guaranteed messages in the Queue.  # noqa: E501

        :return: The highest_msg_id of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def highest_msg_id(self, highest_msg_id):
        """Sets the highest_msg_id of this MsgVpnQueue.

        The highest identifier (ID) of guaranteed messages in the Queue.  # noqa: E501

        :param highest_msg_id: The highest_msg_id of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def in_progress_ack_msg_count(self):
        """Gets the in_progress_ack_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of acknowledgement messages received by the Queue that are in the process of updating and deleting associated guaranteed messages.  # noqa: E501

        :return: The in_progress_ack_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def in_progress_ack_msg_count(self, in_progress_ack_msg_count):
        """Sets the in_progress_ack_msg_count of this MsgVpnQueue.

        The number of acknowledgement messages received by the Queue that are in the process of updating and deleting associated guaranteed messages.  # noqa: E501

        :param in_progress_ack_msg_count: The in_progress_ack_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def ingress_enabled(self):
        ...
        Indicates whether the reception of messages to the Queue is enabled.  # noqa: E501
    ...
    def invalid_selector_bind_failure_count(self):
        """Gets the invalid_selector_bind_failure_count of this MsgVpnQueue.  # noqa: E501

        The number of Queue bind failures due to an invalid selector.  # noqa: E501

        :return: The invalid_selector_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def invalid_selector_bind_failure_count(self, invalid_selector_bind_failure_count):
        """Sets the invalid_selector_bind_failure_count of this MsgVpnQueue.

        The number of Queue bind failures due to an invalid selector.  # noqa: E501

        :param invalid_selector_bind_failure_count: The invalid_selector_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def last_replay_complete_time(self):
        """Gets the last_replay_complete_time of this MsgVpnQueue.  # noqa: E501

        The timestamp of the last completed replay for the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :return: The last_replay_complete_time of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def last_replay_complete_time(self, last_replay_complete_time):
        """Sets the last_replay_complete_time of this MsgVpnQueue.

        The timestamp of the last completed replay for the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param last_replay_complete_time: The last_replay_complete_time of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def last_replay_failure_reason(self):
        """Gets the last_replay_failure_reason of this MsgVpnQueue.  # noqa: E501

        The reason for the last replay failure for the Queue.  # noqa: E501

        :return: The last_replay_failure_reason of this MsgVpnQueue.  # noqa: E501
        :rtype: str
        """
    ...
    def last_replay_failure_reason(self, last_replay_failure_reason):
        """Sets the last_replay_failure_reason of this MsgVpnQueue.

        The reason for the last replay failure for the Queue.  # noqa: E501

        :param last_replay_failure_reason: The last_replay_failure_reason of this MsgVpnQueue.  # noqa: E501
        :type: str
        """
    ...
    def last_replay_failure_time(self):
        """Gets the last_replay_failure_time of this MsgVpnQueue.  # noqa: E501

        The timestamp of the last replay failure for the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :return: The last_replay_failure_time of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def last_replay_failure_time(self, last_replay_failure_time):
        """Sets the last_replay_failure_time of this MsgVpnQueue.

        The timestamp of the last replay failure for the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param last_replay_failure_time: The last_replay_failure_time of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def last_replay_start_time(self):
        """Gets the last_replay_start_time of this MsgVpnQueue.  # noqa: E501

        The timestamp of the last replay started for the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :return: The last_replay_start_time of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def last_replay_start_time(self, last_replay_start_time):
        """Sets the last_replay_start_time of this MsgVpnQueue.

        The timestamp of the last replay started for the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param last_replay_start_time: The last_replay_start_time of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def last_replayed_msg_tx_time(self):
        """Gets the last_replayed_msg_tx_time of this MsgVpnQueue.  # noqa: E501

        The timestamp of the last replayed message transmitted by the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :return: The last_replayed_msg_tx_time of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def last_replayed_msg_tx_time(self, last_replayed_msg_tx_time):
        """Sets the last_replayed_msg_tx_time of this MsgVpnQueue.

        The timestamp of the last replayed message transmitted by the Queue. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param last_replayed_msg_tx_time: The last_replayed_msg_tx_time of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def last_spooled_msg_id(self):
        """Gets the last_spooled_msg_id of this MsgVpnQueue.  # noqa: E501

        The identifier (ID) of the last guaranteed message spooled in the Queue.  # noqa: E501

        :return: The last_spooled_msg_id of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def last_spooled_msg_id(self, last_spooled_msg_id):
        """Sets the last_spooled_msg_id of this MsgVpnQueue.

        The identifier (ID) of the last guaranteed message spooled in the Queue.  # noqa: E501

        :param last_spooled_msg_id: The last_spooled_msg_id of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def low_priority_msg_congestion_discarded_msg_count(self):
        """Gets the low_priority_msg_congestion_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to low priority message congestion control.  # noqa: E501

        :return: The low_priority_msg_congestion_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def low_priority_msg_congestion_discarded_msg_count(self, low_priority_msg_congestion_discarded_msg_count):
        """Sets the low_priority_msg_congestion_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to low priority message congestion control.  # noqa: E501

        :param low_priority_msg_congestion_discarded_msg_count: The low_priority_msg_congestion_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def low_priority_msg_congestion_state(self):
        """Gets the low_priority_msg_congestion_state of this MsgVpnQueue.  # noqa: E501

        The state of the low priority message congestion in the Queue. The allowed values and their meaning are:  <pre> \"disabled\" - Messages are not being checked for priority. \"not-congested\" - Low priority messages are being stored and delivered. \"congested\" - Low priority messages are being discarded. </pre>   # noqa: E501

        :return: The low_priority_msg_congestion_state of this MsgVpnQueue.  # noqa: E501
        :rtype: str
        """
    ...
    def low_priority_msg_congestion_state(self, low_priority_msg_congestion_state):
        """Sets the low_priority_msg_congestion_state of this MsgVpnQueue.

        The state of the low priority message congestion in the Queue. The allowed values and their meaning are:  <pre> \"disabled\" - Messages are not being checked for priority. \"not-congested\" - Low priority messages are being stored and delivered. \"congested\" - Low priority messages are being discarded. </pre>   # noqa: E501

        :param low_priority_msg_congestion_state: The low_priority_msg_congestion_state of this MsgVpnQueue.  # noqa: E501
        :type: str
        """
    ...
    def lowest_acked_msg_id(self):
        """Gets the lowest_acked_msg_id of this MsgVpnQueue.  # noqa: E501

        The lowest identifier (ID) of guaranteed messages in the Queue that were acknowledged.  # noqa: E501

        :return: The lowest_acked_msg_id of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def lowest_acked_msg_id(self, lowest_acked_msg_id):
        """Sets the lowest_acked_msg_id of this MsgVpnQueue.

        The lowest identifier (ID) of guaranteed messages in the Queue that were acknowledged.  # noqa: E501

        :param lowest_acked_msg_id: The lowest_acked_msg_id of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def lowest_msg_id(self):
        """Gets the lowest_msg_id of this MsgVpnQueue.  # noqa: E501

        The lowest identifier (ID) of guaranteed messages in the Queue.  # noqa: E501

        :return: The lowest_msg_id of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def lowest_msg_id(self, lowest_msg_id):
        """Sets the lowest_msg_id of this MsgVpnQueue.

        The lowest identifier (ID) of guaranteed messages in the Queue.  # noqa: E501

        :param lowest_msg_id: The lowest_msg_id of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_bind_count(self):
        ...
        The maximum number of consumer flows that can bind to the Queue.  # noqa: E501
    ...
    def max_bind_count_exceeded_bind_failure_count(self):
        """Gets the max_bind_count_exceeded_bind_failure_count of this MsgVpnQueue.  # noqa: E501

        The number of Queue bind failures due to the maximum bind count being exceeded.  # noqa: E501

        :return: The max_bind_count_exceeded_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_bind_count_exceeded_bind_failure_count(self, max_bind_count_exceeded_bind_failure_count):
        """Sets the max_bind_count_exceeded_bind_failure_count of this MsgVpnQueue.

        The number of Queue bind failures due to the maximum bind count being exceeded.  # noqa: E501

        :param max_bind_count_exceeded_bind_failure_count: The max_bind_count_exceeded_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_msg_size(self):
        ...
        The maximum message size allowed in the Queue, in bytes (B).  # noqa: E501
    ...
    def max_msg_size_exceeded_discarded_msg_count(self):
        """Gets the max_msg_size_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to the maximum message size being exceeded.  # noqa: E501

        :return: The max_msg_size_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_msg_size_exceeded_discarded_msg_count(self, max_msg_size_exceeded_discarded_msg_count):
        """Sets the max_msg_size_exceeded_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to the maximum message size being exceeded.  # noqa: E501

        :param max_msg_size_exceeded_discarded_msg_count: The max_msg_size_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_msg_spool_usage(self):
        ...
        The maximum message spool usage allowed by the Queue, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking.  # noqa: E501
    ...
    def max_msg_spool_usage_exceeded_discarded_msg_count(self):
        """Gets the max_msg_spool_usage_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to the maximum message spool usage being exceeded.  # noqa: E501

        :return: The max_msg_spool_usage_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_msg_spool_usage_exceeded_discarded_msg_count(self, max_msg_spool_usage_exceeded_discarded_msg_count):
        """Sets the max_msg_spool_usage_exceeded_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to the maximum message spool usage being exceeded.  # noqa: E501

        :param max_msg_spool_usage_exceeded_discarded_msg_count: The max_msg_spool_usage_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_redelivery_exceeded_discarded_msg_count(self):
        """Gets the max_redelivery_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to the maximum redelivery attempts being exceeded.  # noqa: E501

        :return: The max_redelivery_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_redelivery_exceeded_discarded_msg_count(self, max_redelivery_exceeded_discarded_msg_count):
        """Sets the max_redelivery_exceeded_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to the maximum redelivery attempts being exceeded.  # noqa: E501

        :param max_redelivery_exceeded_discarded_msg_count: The max_redelivery_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_redelivery_exceeded_to_dmq_failed_msg_count(self):
        """Gets the max_redelivery_exceeded_to_dmq_failed_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to the maximum redelivery attempts being exceeded and failing to move to the Dead Message Queue (DMQ).  # noqa: E501

        :return: The max_redelivery_exceeded_to_dmq_failed_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_redelivery_exceeded_to_dmq_failed_msg_count(self, max_redelivery_exceeded_to_dmq_failed_msg_count):
        """Sets the max_redelivery_exceeded_to_dmq_failed_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to the maximum redelivery attempts being exceeded and failing to move to the Dead Message Queue (DMQ).  # noqa: E501

        :param max_redelivery_exceeded_to_dmq_failed_msg_count: The max_redelivery_exceeded_to_dmq_failed_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_redelivery_exceeded_to_dmq_msg_count(self):
        """Gets the max_redelivery_exceeded_to_dmq_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages moved to the Dead Message Queue (DMQ) by the Queue due to the maximum redelivery attempts being exceeded.  # noqa: E501

        :return: The max_redelivery_exceeded_to_dmq_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_redelivery_exceeded_to_dmq_msg_count(self, max_redelivery_exceeded_to_dmq_msg_count):
        """Sets the max_redelivery_exceeded_to_dmq_msg_count of this MsgVpnQueue.

        The number of guaranteed messages moved to the Dead Message Queue (DMQ) by the Queue due to the maximum redelivery attempts being exceeded.  # noqa: E501

        :param max_redelivery_exceeded_to_dmq_msg_count: The max_redelivery_exceeded_to_dmq_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_ttl(self):
        ...
        The maximum time in seconds a message can stay in the Queue when `respectTtlEnabled` is `\"true\"`. A message expires when the lesser of the sender assigned time-to-live (TTL) in the message and the `maxTtl` configured for the Queue, is exceeded. A value of 0 disables expiry.  # noqa: E501
    ...
    def max_ttl_exceeded_discarded_msg_count(self):
        """Gets the max_ttl_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to the maximum time-to-live (TTL) in hops being exceeded. The TTL hop count is incremented when the message crosses a bridge.  # noqa: E501

        :return: The max_ttl_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_ttl_exceeded_discarded_msg_count(self, max_ttl_exceeded_discarded_msg_count):
        """Sets the max_ttl_exceeded_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to the maximum time-to-live (TTL) in hops being exceeded. The TTL hop count is incremented when the message crosses a bridge.  # noqa: E501

        :param max_ttl_exceeded_discarded_msg_count: The max_ttl_exceeded_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_ttl_expired_discarded_msg_count(self):
        """Gets the max_ttl_expired_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to the maximum time-to-live (TTL) timestamp expiring.  # noqa: E501

        :return: The max_ttl_expired_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_ttl_expired_discarded_msg_count(self, max_ttl_expired_discarded_msg_count):
        """Sets the max_ttl_expired_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to the maximum time-to-live (TTL) timestamp expiring.  # noqa: E501

        :param max_ttl_expired_discarded_msg_count: The max_ttl_expired_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_ttl_expired_to_dmq_failed_msg_count(self):
        """Gets the max_ttl_expired_to_dmq_failed_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to the maximum time-to-live (TTL) timestamp expiring and failing to move to the Dead Message Queue (DMQ).  # noqa: E501

        :return: The max_ttl_expired_to_dmq_failed_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_ttl_expired_to_dmq_failed_msg_count(self, max_ttl_expired_to_dmq_failed_msg_count):
        """Sets the max_ttl_expired_to_dmq_failed_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to the maximum time-to-live (TTL) timestamp expiring and failing to move to the Dead Message Queue (DMQ).  # noqa: E501

        :param max_ttl_expired_to_dmq_failed_msg_count: The max_ttl_expired_to_dmq_failed_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def max_ttl_expired_to_dmq_msg_count(self):
        """Gets the max_ttl_expired_to_dmq_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages moved to the Dead Message Queue (DMQ) by the Queue due to the maximum time-to-live (TTL) timestamp expiring.  # noqa: E501

        :return: The max_ttl_expired_to_dmq_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def max_ttl_expired_to_dmq_msg_count(self, max_ttl_expired_to_dmq_msg_count):
        """Sets the max_ttl_expired_to_dmq_msg_count of this MsgVpnQueue.

        The number of guaranteed messages moved to the Dead Message Queue (DMQ) by the Queue due to the maximum time-to-live (TTL) timestamp expiring.  # noqa: E501

        :param max_ttl_expired_to_dmq_msg_count: The max_ttl_expired_to_dmq_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def msg_spool_peak_usage(self):
        """Gets the msg_spool_peak_usage of this MsgVpnQueue.  # noqa: E501

        The message spool peak usage by the Queue, in bytes (B).  # noqa: E501

        :return: The msg_spool_peak_usage of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def msg_spool_peak_usage(self, msg_spool_peak_usage):
        """Sets the msg_spool_peak_usage of this MsgVpnQueue.

        The message spool peak usage by the Queue, in bytes (B).  # noqa: E501

        :param msg_spool_peak_usage: The msg_spool_peak_usage of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def msg_spool_usage(self):
        """Gets the msg_spool_usage of this MsgVpnQueue.  # noqa: E501

        The message spool usage by the Queue, in bytes (B).  # noqa: E501

        :return: The msg_spool_usage of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def msg_spool_usage(self, msg_spool_usage):
        """Sets the msg_spool_usage of this MsgVpnQueue.

        The message spool usage by the Queue, in bytes (B).  # noqa: E501

        :param msg_spool_usage: The msg_spool_usage of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def network_topic(self):
        """Gets the network_topic of this MsgVpnQueue.  # noqa: E501

        The name of the network topic for the Queue.  # noqa: E501

        :return: The network_topic of this MsgVpnQueue.  # noqa: E501
        :rtype: str
        """
    ...
    def network_topic(self, network_topic):
        """Sets the network_topic of this MsgVpnQueue.

        The name of the network topic for the Queue.  # noqa: E501

        :param network_topic: The network_topic of this MsgVpnQueue.  # noqa: E501
        :type: str
        """
    ...
    def no_local_delivery_discarded_msg_count(self):
        """Gets the no_local_delivery_discarded_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages discarded by the Queue due to no local delivery being requested.  # noqa: E501

        :return: The no_local_delivery_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def no_local_delivery_discarded_msg_count(self, no_local_delivery_discarded_msg_count):
        """Sets the no_local_delivery_discarded_msg_count of this MsgVpnQueue.

        The number of guaranteed messages discarded by the Queue due to no local delivery being requested.  # noqa: E501

        :param no_local_delivery_discarded_msg_count: The no_local_delivery_discarded_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def other_bind_failure_count(self):
        """Gets the other_bind_failure_count of this MsgVpnQueue.  # noqa: E501

        The number of Queue bind failures due to other reasons.  # noqa: E501

        :return: The other_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def other_bind_failure_count(self, other_bind_failure_count):
        """Sets the other_bind_failure_count of this MsgVpnQueue.

        The number of Queue bind failures due to other reasons.  # noqa: E501

        :param other_bind_failure_count: The other_bind_failure_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def owner(self):
        ...
        The Client Username that owns the Queue and has permission equivalent to `\"delete\"`.  # noqa: E501
    ...
    def redelivered_msg_count(self):
        """Gets the redelivered_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages transmitted by the Queue for redelivery.  # noqa: E501

        :return: The redelivered_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def redelivered_msg_count(self, redelivered_msg_count):
        """Sets the redelivered_msg_count of this MsgVpnQueue.

        The number of guaranteed messages transmitted by the Queue for redelivery.  # noqa: E501

        :param redelivered_msg_count: The redelivered_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    @property
    def redelivery_enabled(self):
        """Gets the redelivery_enabled of this MsgVpnQueue.  # noqa: E501

        Enable or disable message redelivery. When enabled, the number of redelivery attempts is controlled by maxRedeliveryCount. When disabled, the message will never be delivered from the queue more than once. Available since 2.18.  # noqa: E501

        :return: The redelivery_enabled of this MsgVpnQueue.  # noqa: E501
        :rtype: bool
        """
        return self._redelivery_enabled

    @redelivery_enabled.setter
    def redelivery_enabled(self, redelivery_enabled):
        """Sets the redelivery_enabled of this MsgVpnQueue.

        Enable or disable message redelivery. When enabled, the number of redelivery attempts is controlled by maxRedeliveryCount. When disabled, the message will never be delivered from the queue more than once. Available since 2.18.  # noqa: E501

        :param redelivery_enabled: The redelivery_enabled of this MsgVpnQueue.  # noqa: E501
        :type: bool
        """

        self._redelivery_enabled = redelivery_enabled

    @property
    def reject_low_priority_msg_enabled(self):
        """Gets the reject_low_priority_msg_enabled of this MsgVpnQueue.  # noqa: E501

        Indicates whether the checking of low priority messages against the `rejectLowPriorityMsgLimit` is enabled.  # noqa: E501
    ...
    def reject_low_priority_msg_limit(self):
        ...
        The number of messages of any priority in the Queue above which low priority messages are not admitted but higher priority messages are allowed.  # noqa: E501
    ...
    def replay_failure_count(self):
        """Gets the replay_failure_count of this MsgVpnQueue.  # noqa: E501

        The number of replays that failed for the Queue.  # noqa: E501

        :return: The replay_failure_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replay_failure_count(self, replay_failure_count):
        """Sets the replay_failure_count of this MsgVpnQueue.

        The number of replays that failed for the Queue.  # noqa: E501

        :param replay_failure_count: The replay_failure_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replay_start_count(self):
        """Gets the replay_start_count of this MsgVpnQueue.  # noqa: E501

        The number of replays started for the Queue.  # noqa: E501

        :return: The replay_start_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replay_start_count(self, replay_start_count):
        """Sets the replay_start_count of this MsgVpnQueue.

        The number of replays started for the Queue.  # noqa: E501

        :param replay_start_count: The replay_start_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replay_state(self):
        """Gets the replay_state of this MsgVpnQueue.  # noqa: E501
        ...
        :return: The replay_state of this MsgVpnQueue.  # noqa: E501
        :rtype: str
        """
    ...
    def replay_state(self, replay_state):
        """Sets the replay_state of this MsgVpnQueue.

        The state of replay for the Queue. The allowed values and their meaning are:  <pre> \"initializing\" - All messages are being deleted from the endpoint before replay starts. \"active\" - Subscription matching logged messages are being replayed to the endpoint. \"pending-complete\" - Replay is complete, but final accounting is in progress. \"complete\" - Replay and all related activities are complete. \"failed\" - Replay has failed and is waiting for an unbind response. </pre>   # noqa: E501

        :param replay_state: The replay_state of this MsgVpnQueue.  # noqa: E501
        :type: str
        """
    ...
    def replay_success_count(self):
        """Gets the replay_success_count of this MsgVpnQueue.  # noqa: E501

        The number of replays that succeeded for the Queue.  # noqa: E501

        :return: The replay_success_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replay_success_count(self, replay_success_count):
        """Sets the replay_success_count of this MsgVpnQueue.

        The number of replays that succeeded for the Queue.  # noqa: E501

        :param replay_success_count: The replay_success_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replayed_acked_msg_count(self):
        """Gets the replayed_acked_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of replayed messages transmitted by the Queue and acked by all consumers.  # noqa: E501

        :return: The replayed_acked_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replayed_acked_msg_count(self, replayed_acked_msg_count):
        """Sets the replayed_acked_msg_count of this MsgVpnQueue.

        The number of replayed messages transmitted by the Queue and acked by all consumers.  # noqa: E501

        :param replayed_acked_msg_count: The replayed_acked_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replayed_tx_msg_count(self):
        """Gets the replayed_tx_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of replayed messages transmitted by the Queue.  # noqa: E501

        :return: The replayed_tx_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replayed_tx_msg_count(self, replayed_tx_msg_count):
        """Sets the replayed_tx_msg_count of this MsgVpnQueue.

        The number of replayed messages transmitted by the Queue.  # noqa: E501

        :param replayed_tx_msg_count: The replayed_tx_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replication_active_ack_prop_tx_msg_count(self):
        """Gets the replication_active_ack_prop_tx_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of acknowledgement messages propagated by the Queue to the replication standby remote Message VPN.  # noqa: E501

        :return: The replication_active_ack_prop_tx_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replication_active_ack_prop_tx_msg_count(self, replication_active_ack_prop_tx_msg_count):
        """Sets the replication_active_ack_prop_tx_msg_count of this MsgVpnQueue.

        The number of acknowledgement messages propagated by the Queue to the replication standby remote Message VPN.  # noqa: E501

        :param replication_active_ack_prop_tx_msg_count: The replication_active_ack_prop_tx_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replication_standby_ack_prop_rx_msg_count(self):
        """Gets the replication_standby_ack_prop_rx_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of propagated acknowledgement messages received by the Queue from the replication active remote Message VPN.  # noqa: E501

        :return: The replication_standby_ack_prop_rx_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replication_standby_ack_prop_rx_msg_count(self, replication_standby_ack_prop_rx_msg_count):
        """Sets the replication_standby_ack_prop_rx_msg_count of this MsgVpnQueue.

        The number of propagated acknowledgement messages received by the Queue from the replication active remote Message VPN.  # noqa: E501

        :param replication_standby_ack_prop_rx_msg_count: The replication_standby_ack_prop_rx_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replication_standby_acked_by_ack_prop_msg_count(self):
        """Gets the replication_standby_acked_by_ack_prop_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of messages acknowledged in the Queue by acknowledgement propagation from the replication active remote Message VPN.  # noqa: E501

        :return: The replication_standby_acked_by_ack_prop_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replication_standby_acked_by_ack_prop_msg_count(self, replication_standby_acked_by_ack_prop_msg_count):
        """Sets the replication_standby_acked_by_ack_prop_msg_count of this MsgVpnQueue.

        The number of messages acknowledged in the Queue by acknowledgement propagation from the replication active remote Message VPN.  # noqa: E501

        :param replication_standby_acked_by_ack_prop_msg_count: The replication_standby_acked_by_ack_prop_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def replication_standby_rx_msg_count(self):
        """Gets the replication_standby_rx_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of messages received by the Queue from the replication active remote Message VPN.  # noqa: E501

        :return: The replication_standby_rx_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def replication_standby_rx_msg_count(self, replication_standby_rx_msg_count):
        """Sets the replication_standby_rx_msg_count of this MsgVpnQueue.

        The number of messages received by the Queue from the replication active remote Message VPN.  # noqa: E501

        :param replication_standby_rx_msg_count: The replication_standby_rx_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def respect_msg_priority_enabled(self):
        ...
        Indicates whether message priorities are respected. When enabled, messages contained in the Queue are delivered in priority order, from 9 (highest) to 0 (lowest).  # noqa: E501
    ...
    def rx_byte_rate(self):
        """Gets the rx_byte_rate of this MsgVpnQueue.  # noqa: E501

        The current message rate received by the Queue, in bytes per second (B/sec).  # noqa: E501

        :return: The rx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def rx_byte_rate(self, rx_byte_rate):
        """Sets the rx_byte_rate of this MsgVpnQueue.

        The current message rate received by the Queue, in bytes per second (B/sec).  # noqa: E501

        :param rx_byte_rate: The rx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def rx_msg_rate(self):
        """Gets the rx_msg_rate of this MsgVpnQueue.  # noqa: E501

        The current message rate received by the Queue, in messages per second (msg/sec).  # noqa: E501

        :return: The rx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def rx_msg_rate(self, rx_msg_rate):
        """Sets the rx_msg_rate of this MsgVpnQueue.

        The current message rate received by the Queue, in messages per second (msg/sec).  # noqa: E501

        :param rx_msg_rate: The rx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def spooled_byte_count(self):
        """Gets the spooled_byte_count of this MsgVpnQueue.  # noqa: E501

        The amount of guaranteed messages that were spooled in the Queue, in bytes (B).  # noqa: E501

        :return: The spooled_byte_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def spooled_byte_count(self, spooled_byte_count):
        """Sets the spooled_byte_count of this MsgVpnQueue.

        The amount of guaranteed messages that were spooled in the Queue, in bytes (B).  # noqa: E501

        :param spooled_byte_count: The spooled_byte_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def spooled_msg_count(self):
        """Gets the spooled_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages that were spooled in the Queue.  # noqa: E501

        :return: The spooled_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def spooled_msg_count(self, spooled_msg_count):
        """Sets the spooled_msg_count of this MsgVpnQueue.

        The number of guaranteed messages that were spooled in the Queue.  # noqa: E501

        :param spooled_msg_count: The spooled_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    @property
    def transport_retransmit_msg_count(self):
        """Gets the transport_retransmit_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages that were retransmitted by the Queue at the transport layer as part of a single delivery attempt. Available since 2.18.  # noqa: E501

        :return: The transport_retransmit_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
        return self._transport_retransmit_msg_count

    @transport_retransmit_msg_count.setter
    def transport_retransmit_msg_count(self, transport_retransmit_msg_count):
        """Sets the transport_retransmit_msg_count of this MsgVpnQueue.

        The number of guaranteed messages that were retransmitted by the Queue at the transport layer as part of a single delivery attempt. Available since 2.18.  # noqa: E501

        :param transport_retransmit_msg_count: The transport_retransmit_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """

        self._transport_retransmit_msg_count = transport_retransmit_msg_count

    @property
    def tx_byte_rate(self):
        """Gets the tx_byte_rate of this MsgVpnQueue.  # noqa: E501

        The current message rate transmitted by the Queue, in bytes per second (B/sec).  # noqa: E501

        :return: The tx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def tx_byte_rate(self, tx_byte_rate):
        """Sets the tx_byte_rate of this MsgVpnQueue.

        The current message rate transmitted by the Queue, in bytes per second (B/sec).  # noqa: E501

        :param tx_byte_rate: The tx_byte_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def tx_msg_rate(self):
        """Gets the tx_msg_rate of this MsgVpnQueue.  # noqa: E501

        The current message rate transmitted by the Queue, in messages per second (msg/sec).  # noqa: E501

        :return: The tx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def tx_msg_rate(self, tx_msg_rate):
        """Sets the tx_msg_rate of this MsgVpnQueue.

        The current message rate transmitted by the Queue, in messages per second (msg/sec).  # noqa: E501

        :param tx_msg_rate: The tx_msg_rate of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def tx_selector(self):
        """Gets the tx_selector of this MsgVpnQueue.  # noqa: E501

        Indicates whether the Queue has consumers with selectors to filter transmitted messages.  # noqa: E501

        :return: The tx_selector of this MsgVpnQueue.  # noqa: E501
        :rtype: bool
        """
        return self._tx_selector

    @tx_selector.setter
    def tx_selector(self, tx_selector):
        """Sets the tx_selector of this MsgVpnQueue.

        Indicates whether the Queue has consumers with selectors to filter transmitted messages.  # noqa: E501

        :param tx_selector: The tx_selector of this MsgVpnQueue.  # noqa: E501
        :type: bool
        """
    ...
    def tx_unacked_msg_count(self):
        """Gets the tx_unacked_msg_count of this MsgVpnQueue.  # noqa: E501

        The number of guaranteed messages in the Queue that have been transmitted but not acknowledged by all consumers.  # noqa: E501

        :return: The tx_unacked_msg_count of this MsgVpnQueue.  # noqa: E501
        :rtype: int
        """
    ...
    def tx_unacked_msg_count(self, tx_unacked_msg_count):
        """Sets the tx_unacked_msg_count of this MsgVpnQueue.

        The number of guaranteed messages in the Queue that have been transmitted but not acknowledged by all consumers.  # noqa: E501

        :param tx_unacked_msg_count: The tx_unacked_msg_count of this MsgVpnQueue.  # noqa: E501
        :type: int
        """
    ...
    def virtual_router(self):
        """Gets the virtual_router of this MsgVpnQueue.  # noqa: E501

        The virtual router of the Queue. The allowed values and their meaning are:  <pre> \"primary\" - The endpoint belongs to the primary virtual router. \"backup\" - The endpoint belongs to the backup virtual router. </pre>   # noqa: E501

        :return: The virtual_router of this MsgVpnQueue.  # noqa: E501
        :rtype: str
        """
    ...
    def virtual_router(self, virtual_router):
        """Sets the virtual_router of this MsgVpnQueue.

        The virtual router of the Queue. The allowed values and their meaning are:  <pre> \"primary\" - The endpoint belongs to the primary virtual router. \"backup\" - The endpoint belongs to the backup virtual router. </pre>   # noqa: E501

        :param virtual_router: The virtual_router of this MsgVpnQueue.  # noqa: E501
        :type: str
        """
