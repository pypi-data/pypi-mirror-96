...
class MsgVpnClient(object):
    ...
    swagger_types = {
        ...
        'keepalive': 'bool',
        'keepalive_effective_timeout': 'int',
    ...
    attribute_map = {
        ...
        'aliased_from_msg_vpn_name': 'aliasedFromMsgVpnName',
        ...
        'keepalive': 'keepalive',
        'keepalive_effective_timeout': 'keepaliveEffectiveTimeout',
        ...
        'scheduled_disconnect_time': 'scheduledDisconnectTime',
    ...
    def __init__(self, acl_profile_name=None, aliased_from_msg_vpn_name=None, already_bound_bind_failure_count=None, authorization_group_name=None, average_rx_byte_rate=None, average_rx_msg_rate=None, average_tx_byte_rate=None, average_tx_msg_rate=None, bind_request_count=None, bind_success_count=None, client_address=None, client_id=None, client_name=None, client_profile_name=None, client_username=None, control_rx_byte_count=None, control_rx_msg_count=None, control_tx_byte_count=None, control_tx_msg_count=None, cut_through_denied_bind_failure_count=None, data_rx_byte_count=None, data_rx_msg_count=None, data_tx_byte_count=None, data_tx_msg_count=None, description=None, disabled_bind_failure_count=None, dto_local_priority=None, dto_network_priority=None, eliding=None, eliding_topic_count=None, eliding_topic_peak_count=None, guaranteed_denied_bind_failure_count=None, invalid_selector_bind_failure_count=None, keepalive=None, keepalive_effective_timeout=None, large_msg_event_raised=None, login_rx_msg_count=None, login_tx_msg_count=None, max_bind_count_exceeded_bind_failure_count=None, max_eliding_topic_count_event_raised=None, mqtt_connack_error_tx_count=None, mqtt_connack_tx_count=None, mqtt_connect_rx_count=None, mqtt_disconnect_rx_count=None, mqtt_pingreq_rx_count=None, mqtt_pingresp_tx_count=None, mqtt_puback_rx_count=None, mqtt_puback_tx_count=None, mqtt_pubcomp_tx_count=None, mqtt_publish_qos0_rx_count=None, mqtt_publish_qos0_tx_count=None, mqtt_publish_qos1_rx_count=None, mqtt_publish_qos1_tx_count=None, mqtt_publish_qos2_rx_count=None, mqtt_pubrec_tx_count=None, mqtt_pubrel_rx_count=None, mqtt_suback_error_tx_count=None, mqtt_suback_tx_count=None, mqtt_subscribe_rx_count=None, mqtt_unsuback_tx_count=None, mqtt_unsubscribe_rx_count=None, msg_spool_congestion_rx_discarded_msg_count=None, msg_spool_rx_discarded_msg_count=None, msg_vpn_name=None, no_local_delivery=None, no_subscription_match_rx_discarded_msg_count=None, original_client_username=None, other_bind_failure_count=None, platform=None, publish_topic_acl_rx_discarded_msg_count=None, rest_http_request_rx_byte_count=None, rest_http_request_rx_msg_count=None, rest_http_request_tx_byte_count=None, rest_http_request_tx_msg_count=None, rest_http_response_error_rx_msg_count=None, rest_http_response_error_tx_msg_count=None, rest_http_response_rx_byte_count=None, rest_http_response_rx_msg_count=None, rest_http_response_success_rx_msg_count=None, rest_http_response_success_tx_msg_count=None, rest_http_response_timeout_rx_msg_count=None, rest_http_response_timeout_tx_msg_count=None, rest_http_response_tx_byte_count=None, rest_http_response_tx_msg_count=None, rx_byte_count=None, rx_byte_rate=None, rx_discarded_msg_count=None, rx_msg_count=None, rx_msg_rate=None, scheduled_disconnect_time=None, slow_subscriber=None, software_date=None, software_version=None, tls_cipher_description=None, tls_downgraded_to_plain_text=None, tls_version=None, topic_parse_error_rx_discarded_msg_count=None, tx_byte_count=None, tx_byte_rate=None, tx_discarded_msg_count=None, tx_msg_count=None, tx_msg_rate=None, uptime=None, user=None, virtual_router=None, web_inactive_timeout=None, web_max_payload=None, web_parse_error_rx_discarded_msg_count=None, web_remaining_timeout=None, web_rx_byte_count=None, web_rx_encoding=None, web_rx_msg_count=None, web_rx_protocol=None, web_rx_request_count=None, web_rx_response_count=None, web_rx_tcp_state=None, web_rx_tls_cipher_description=None, web_rx_tls_version=None, web_session_id=None, web_tx_byte_count=None, web_tx_encoding=None, web_tx_msg_count=None, web_tx_protocol=None, web_tx_request_count=None, web_tx_response_count=None, web_tx_tcp_state=None, web_tx_tls_cipher_description=None, web_tx_tls_version=None):  # noqa: E501
        ...
        self._keepalive_effective_timeout = None
        ...
        self._scheduled_disconnect_time = None
        ...
        if aliased_from_msg_vpn_name is not None:
            self.aliased_from_msg_vpn_name = aliased_from_msg_vpn_name
        ...
        if keepalive_effective_timeout is not None:
            self.keepalive_effective_timeout = keepalive_effective_timeout
        ...
        if scheduled_disconnect_time is not None:
            self.scheduled_disconnect_time = scheduled_disconnect_time
    ...
    @property
    def aliased_from_msg_vpn_name(self):
        """Gets the aliased_from_msg_vpn_name of this MsgVpnClient.  # noqa: E501

        The name of the original MsgVpn which the client signaled in. Available since 2.14.  # noqa: E501

        :return: The aliased_from_msg_vpn_name of this MsgVpnClient.  # noqa: E501
        :rtype: str
        """
        return self._aliased_from_msg_vpn_name

    @aliased_from_msg_vpn_name.setter
    def aliased_from_msg_vpn_name(self, aliased_from_msg_vpn_name):
        """Sets the aliased_from_msg_vpn_name of this MsgVpnClient.

        The name of the original MsgVpn which the client signaled in. Available since 2.14.  # noqa: E501

        :param aliased_from_msg_vpn_name: The aliased_from_msg_vpn_name of this MsgVpnClient.  # noqa: E501
        :type: str
        """

        self._aliased_from_msg_vpn_name = aliased_from_msg_vpn_name
    ...
    @property
    def keepalive(self):
        """Gets the keepalive of this MsgVpnClient.  # noqa: E501

        Indicates whether keepalive messages from the Client are received by the broker. Applicable for SMF and MQTT clients only. Available since 2.19.  # noqa: E501

        :return: The keepalive of this MsgVpnClient.  # noqa: E501
        :rtype: bool
        """
    ...
    def keepalive(self, keepalive):
        """Sets the keepalive of this MsgVpnClient.

        Indicates whether keepalive messages from the Client are received by the broker. Applicable for SMF and MQTT clients only. Available since 2.19.  # noqa: E501

        :param keepalive: The keepalive of this MsgVpnClient.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def keepalive_effective_timeout(self):
        """Gets the keepalive_effective_timeout of this MsgVpnClient.  # noqa: E501

        The maximum period of time the broker will accept inactivity from the Client before disconnecting, in seconds. Available since 2.19.  # noqa: E501

        :return: The keepalive_effective_timeout of this MsgVpnClient.  # noqa: E501
        :rtype: int
        """
        return self._keepalive_effective_timeout

    @keepalive_effective_timeout.setter
    def keepalive_effective_timeout(self, keepalive_effective_timeout):
        """Sets the keepalive_effective_timeout of this MsgVpnClient.

        The maximum period of time the broker will accept inactivity from the Client before disconnecting, in seconds. Available since 2.19.  # noqa: E501

        :param keepalive_effective_timeout: The keepalive_effective_timeout of this MsgVpnClient.  # noqa: E501
        :type: int
        """

        self._keepalive_effective_timeout = keepalive_effective_timeout
    ...
    @property
    def scheduled_disconnect_time(self):
        """Gets the scheduled_disconnect_time of this MsgVpnClient.  # noqa: E501

        The timestamp of when the Client will be disconnected by the broker. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time). Available since 2.13.  # noqa: E501

        :return: The scheduled_disconnect_time of this MsgVpnClient.  # noqa: E501
        :rtype: int
        """
        return self._scheduled_disconnect_time

    @scheduled_disconnect_time.setter
    def scheduled_disconnect_time(self, scheduled_disconnect_time):
        """Sets the scheduled_disconnect_time of this MsgVpnClient.

        The timestamp of when the Client will be disconnected by the broker. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time). Available since 2.13.  # noqa: E501

        :param scheduled_disconnect_time: The scheduled_disconnect_time of this MsgVpnClient.  # noqa: E501
        :type: int
        """

        self._scheduled_disconnect_time = scheduled_disconnect_time
