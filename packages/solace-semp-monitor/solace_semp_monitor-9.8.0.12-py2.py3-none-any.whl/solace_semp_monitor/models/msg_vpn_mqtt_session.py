...
class MsgVpnMqttSession(object):
    ...
    def __init__(self, clean=None, client_name=None, counter=None, created_by_management=None, enabled=None, mqtt_connack_error_tx_count=None, mqtt_connack_tx_count=None, mqtt_connect_rx_count=None, mqtt_disconnect_rx_count=None, mqtt_pubcomp_tx_count=None, mqtt_publish_qos0_rx_count=None, mqtt_publish_qos0_tx_count=None, mqtt_publish_qos1_rx_count=None, mqtt_publish_qos1_tx_count=None, mqtt_publish_qos2_rx_count=None, mqtt_pubrec_tx_count=None, mqtt_pubrel_rx_count=None, mqtt_session_client_id=None, mqtt_session_virtual_router=None, msg_vpn_name=None, owner=None, queue_consumer_ack_propagation_enabled=None, queue_dead_msg_queue=None, queue_event_bind_count_threshold=None, queue_event_msg_spool_usage_threshold=None, queue_event_reject_low_priority_msg_limit_threshold=None, queue_max_bind_count=None, queue_max_delivered_unacked_msgs_per_flow=None, queue_max_msg_size=None, queue_max_msg_spool_usage=None, queue_max_redelivery_count=None, queue_max_ttl=None, queue_name=None, queue_reject_low_priority_msg_enabled=None, queue_reject_low_priority_msg_limit=None, queue_reject_msg_to_sender_on_discard_behavior=None, queue_respect_ttl_enabled=None, will=None):  # noqa: E501
    ...
    @property
    def clean(self):
        """Gets the clean of this MsgVpnMqttSession.  # noqa: E501

        Indicates whether the Client requested a clean (newly created) MQTT Session when connecting. If not clean (already existing), then previously stored messages for QoS 1 subscriptions are delivered.  # noqa: E501

        :return: The clean of this MsgVpnMqttSession.  # noqa: E501
        :rtype: bool
        """
        return self._clean
    ...
    def clean(self, clean):
        """Sets the clean of this MsgVpnMqttSession.

        Indicates whether the Client requested a clean (newly created) MQTT Session when connecting. If not clean (already existing), then previously stored messages for QoS 1 subscriptions are delivered.  # noqa: E501

        :param clean: The clean of this MsgVpnMqttSession.  # noqa: E501
        :type: bool
        """
    ...
    def client_name(self):
        """Gets the client_name of this MsgVpnMqttSession.  # noqa: E501

        The name of the MQTT Session Client.  # noqa: E501

        :return: The client_name of this MsgVpnMqttSession.  # noqa: E501
        :rtype: str
        """
    ...
    def client_name(self, client_name):
        """Sets the client_name of this MsgVpnMqttSession.

        The name of the MQTT Session Client.  # noqa: E501

        :param client_name: The client_name of this MsgVpnMqttSession.  # noqa: E501
        :type: str
        """
    ...
    @property
    def counter(self):
        """Gets the counter of this MsgVpnMqttSession.  # noqa: E501


        :return: The counter of this MsgVpnMqttSession.  # noqa: E501
        :rtype: MsgVpnMqttSessionCounter
        """
        return self._counter

    @counter.setter
    def counter(self, counter):
        """Sets the counter of this MsgVpnMqttSession.


        :param counter: The counter of this MsgVpnMqttSession.  # noqa: E501
        :type: MsgVpnMqttSessionCounter
        """
    ...
    def created_by_management(self):
        """Gets the created_by_management of this MsgVpnMqttSession.  # noqa: E501

        Indicates whether the MQTT Session was created by a Management API.  # noqa: E501

        :return: The created_by_management of this MsgVpnMqttSession.  # noqa: E501
        :rtype: bool
        """
    ...
    def created_by_management(self, created_by_management):
        """Sets the created_by_management of this MsgVpnMqttSession.

        Indicates whether the MQTT Session was created by a Management API.  # noqa: E501

        :param created_by_management: The created_by_management of this MsgVpnMqttSession.  # noqa: E501
        :type: bool
        """
    ...
    def enabled(self):
        ...
        Indicates whether the MQTT Session is enabled.  # noqa: E501
    ...
    def mqtt_connack_error_tx_count(self):
        """Gets the mqtt_connack_error_tx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT connect acknowledgment (CONNACK) refused response packets transmitted to the Client. Available since 2.13.  # noqa: E501

        :return: The mqtt_connack_error_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_connack_error_tx_count(self, mqtt_connack_error_tx_count):
        """Sets the mqtt_connack_error_tx_count of this MsgVpnMqttSession.

        The number of MQTT connect acknowledgment (CONNACK) refused response packets transmitted to the Client. Available since 2.13.  # noqa: E501

        :param mqtt_connack_error_tx_count: The mqtt_connack_error_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_connack_tx_count(self):
        """Gets the mqtt_connack_tx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT connect acknowledgment (CONNACK) accepted response packets transmitted to the Client. Available since 2.13.  # noqa: E501

        :return: The mqtt_connack_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_connack_tx_count(self, mqtt_connack_tx_count):
        """Sets the mqtt_connack_tx_count of this MsgVpnMqttSession.

        The number of MQTT connect acknowledgment (CONNACK) accepted response packets transmitted to the Client. Available since 2.13.  # noqa: E501

        :param mqtt_connack_tx_count: The mqtt_connack_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_connect_rx_count(self):
        """Gets the mqtt_connect_rx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT connect (CONNECT) request packets received from the Client. Available since 2.13.  # noqa: E501

        :return: The mqtt_connect_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_connect_rx_count(self, mqtt_connect_rx_count):
        """Sets the mqtt_connect_rx_count of this MsgVpnMqttSession.

        The number of MQTT connect (CONNECT) request packets received from the Client. Available since 2.13.  # noqa: E501

        :param mqtt_connect_rx_count: The mqtt_connect_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_disconnect_rx_count(self):
        """Gets the mqtt_disconnect_rx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT disconnect (DISCONNECT) request packets received from the Client. Available since 2.13.  # noqa: E501

        :return: The mqtt_disconnect_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_disconnect_rx_count(self, mqtt_disconnect_rx_count):
        """Sets the mqtt_disconnect_rx_count of this MsgVpnMqttSession.

        The number of MQTT disconnect (DISCONNECT) request packets received from the Client. Available since 2.13.  # noqa: E501

        :param mqtt_disconnect_rx_count: The mqtt_disconnect_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_pubcomp_tx_count(self):
        """Gets the mqtt_pubcomp_tx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish complete (PUBCOMP) packets transmitted to the Client in response to a PUBREL packet. These packets are the fourth and final packet of a QoS 2 protocol exchange. Available since 2.13.  # noqa: E501

        :return: The mqtt_pubcomp_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_pubcomp_tx_count(self, mqtt_pubcomp_tx_count):
        """Sets the mqtt_pubcomp_tx_count of this MsgVpnMqttSession.

        The number of MQTT publish complete (PUBCOMP) packets transmitted to the Client in response to a PUBREL packet. These packets are the fourth and final packet of a QoS 2 protocol exchange. Available since 2.13.  # noqa: E501

        :param mqtt_pubcomp_tx_count: The mqtt_pubcomp_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_publish_qos0_rx_count(self):
        """Gets the mqtt_publish_qos0_rx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 0 message delivery. Available since 2.13.  # noqa: E501

        :return: The mqtt_publish_qos0_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_publish_qos0_rx_count(self, mqtt_publish_qos0_rx_count):
        """Sets the mqtt_publish_qos0_rx_count of this MsgVpnMqttSession.

        The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 0 message delivery. Available since 2.13.  # noqa: E501

        :param mqtt_publish_qos0_rx_count: The mqtt_publish_qos0_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_publish_qos0_tx_count(self):
        """Gets the mqtt_publish_qos0_tx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish message (PUBLISH) request packets transmitted to the Client for QoS 0 message delivery. Available since 2.13.  # noqa: E501

        :return: The mqtt_publish_qos0_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_publish_qos0_tx_count(self, mqtt_publish_qos0_tx_count):
        """Sets the mqtt_publish_qos0_tx_count of this MsgVpnMqttSession.

        The number of MQTT publish message (PUBLISH) request packets transmitted to the Client for QoS 0 message delivery. Available since 2.13.  # noqa: E501

        :param mqtt_publish_qos0_tx_count: The mqtt_publish_qos0_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_publish_qos1_rx_count(self):
        """Gets the mqtt_publish_qos1_rx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 1 message delivery. Available since 2.13.  # noqa: E501

        :return: The mqtt_publish_qos1_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_publish_qos1_rx_count(self, mqtt_publish_qos1_rx_count):
        """Sets the mqtt_publish_qos1_rx_count of this MsgVpnMqttSession.

        The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 1 message delivery. Available since 2.13.  # noqa: E501

        :param mqtt_publish_qos1_rx_count: The mqtt_publish_qos1_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_publish_qos1_tx_count(self):
        """Gets the mqtt_publish_qos1_tx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish message (PUBLISH) request packets transmitted to the Client for QoS 1 message delivery. Available since 2.13.  # noqa: E501

        :return: The mqtt_publish_qos1_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_publish_qos1_tx_count(self, mqtt_publish_qos1_tx_count):
        """Sets the mqtt_publish_qos1_tx_count of this MsgVpnMqttSession.

        The number of MQTT publish message (PUBLISH) request packets transmitted to the Client for QoS 1 message delivery. Available since 2.13.  # noqa: E501

        :param mqtt_publish_qos1_tx_count: The mqtt_publish_qos1_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_publish_qos2_rx_count(self):
        """Gets the mqtt_publish_qos2_rx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 2 message delivery. Available since 2.13.  # noqa: E501

        :return: The mqtt_publish_qos2_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_publish_qos2_rx_count(self, mqtt_publish_qos2_rx_count):
        """Sets the mqtt_publish_qos2_rx_count of this MsgVpnMqttSession.

        The number of MQTT publish message (PUBLISH) request packets received from the Client for QoS 2 message delivery. Available since 2.13.  # noqa: E501

        :param mqtt_publish_qos2_rx_count: The mqtt_publish_qos2_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_pubrec_tx_count(self):
        """Gets the mqtt_pubrec_tx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish received (PUBREC) packets transmitted to the Client in response to a PUBLISH packet with QoS 2. These packets are the second packet of a QoS 2 protocol exchange. Available since 2.13.  # noqa: E501

        :return: The mqtt_pubrec_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_pubrec_tx_count(self, mqtt_pubrec_tx_count):
        """Sets the mqtt_pubrec_tx_count of this MsgVpnMqttSession.

        The number of MQTT publish received (PUBREC) packets transmitted to the Client in response to a PUBLISH packet with QoS 2. These packets are the second packet of a QoS 2 protocol exchange. Available since 2.13.  # noqa: E501

        :param mqtt_pubrec_tx_count: The mqtt_pubrec_tx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def mqtt_pubrel_rx_count(self):
        """Gets the mqtt_pubrel_rx_count of this MsgVpnMqttSession.  # noqa: E501

        The number of MQTT publish release (PUBREL) packets received from the Client in response to a PUBREC packet. These packets are the third packet of a QoS 2 protocol exchange. Available since 2.13.  # noqa: E501

        :return: The mqtt_pubrel_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :rtype: int
        """
    ...
    def mqtt_pubrel_rx_count(self, mqtt_pubrel_rx_count):
        """Sets the mqtt_pubrel_rx_count of this MsgVpnMqttSession.

        The number of MQTT publish release (PUBREL) packets received from the Client in response to a PUBREC packet. These packets are the third packet of a QoS 2 protocol exchange. Available since 2.13.  # noqa: E501

        :param mqtt_pubrel_rx_count: The mqtt_pubrel_rx_count of this MsgVpnMqttSession.  # noqa: E501
        :type: int
        """
    ...
    def owner(self):
        ...
        The Client Username which owns the MQTT Session.  # noqa: E501
    ...
    def queue_consumer_ack_propagation_enabled(self):
        ...
        Indicates whether consumer acknowledgements (ACKs) received on the active replication Message VPN are propagated to the standby replication Message VPN. Available since 2.14.  # noqa: E501
    ...
    def queue_dead_msg_queue(self):
        ...
        The name of the Dead Message Queue (DMQ) used by the MQTT Session Queue. Available since 2.14.  # noqa: E501
    ...
    def queue_max_bind_count(self):
        ...
        The maximum number of consumer flows that can bind to the MQTT Session Queue. Available since 2.14.  # noqa: E501
    ...
    def queue_max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum number of messages delivered but not acknowledged per flow for the MQTT Session Queue. Available since 2.14.  # noqa: E501
    ...
    def queue_max_msg_size(self):
        ...
        The maximum message size allowed in the MQTT Session Queue, in bytes (B). Available since 2.14.  # noqa: E501
    ...
    def queue_max_msg_spool_usage(self):
        ...
        The maximum message spool usage allowed by the MQTT Session Queue, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. Available since 2.14.  # noqa: E501
    ...
    def queue_max_redelivery_count(self):
        ...
        The maximum number of times the MQTT Session Queue will attempt redelivery of a message prior to it being discarded or moved to the DMQ. A value of 0 means to retry forever. Available since 2.14.  # noqa: E501
    ...
    def queue_max_ttl(self):
        ...
        The maximum time in seconds a message can stay in the MQTT Session Queue when `queueRespectTtlEnabled` is `\"true\"`. A message expires when the lesser of the sender assigned time-to-live (TTL) in the message and the `queueMaxTtl` configured for the MQTT Session Queue, is exceeded. A value of 0 disables expiry. Available since 2.14.  # noqa: E501
    ...
    @property
    def queue_name(self):
        """Gets the queue_name of this MsgVpnMqttSession.  # noqa: E501

        The name of the MQTT Session Queue.  # noqa: E501

        :return: The queue_name of this MsgVpnMqttSession.  # noqa: E501
        :rtype: str
        """
    ...
    def queue_name(self, queue_name):
        """Sets the queue_name of this MsgVpnMqttSession.

        The name of the MQTT Session Queue.  # noqa: E501

        :param queue_name: The queue_name of this MsgVpnMqttSession.  # noqa: E501
        :type: str
        """
    ...
    def queue_reject_low_priority_msg_enabled(self):
        ...
        Indicates whether to return negative acknowledgements (NACKs) to sending clients on message discards. Note that NACKs cause the message to not be delivered to any destination and Transacted Session commits to fail. Available since 2.14.  # noqa: E501
    ...
    def queue_reject_low_priority_msg_limit(self):
        ...
        The number of messages of any priority in the MQTT Session Queue above which low priority messages are not admitted but higher priority messages are allowed. Available since 2.14.  # noqa: E501
    ...
    def queue_reject_msg_to_sender_on_discard_behavior(self):
        ...
        Indicates whether negative acknowledgements (NACKs) are returned to sending clients on message discards. Note that NACKs cause the message to not be delivered to any destination and Transacted Session commits to fail. The allowed values and their meaning are:  <pre> \"always\" - Always return a negative acknowledgment (NACK) to the sending client on message discard. \"when-queue-enabled\" - Only return a negative acknowledgment (NACK) to the sending client on message discard when the Queue is enabled. \"never\" - Never return a negative acknowledgment (NACK) to the sending client on message discard. </pre>  Available since 2.14.  # noqa: E501
    ...
    def queue_respect_ttl_enabled(self):
        ...
        Indicates whether the time-to-live (TTL) for messages in the MQTT Session Queue is respected. When enabled, expired messages are discarded or moved to the DMQ. Available since 2.14.  # noqa: E501
    ...
    @property
    def will(self):
        """Gets the will of this MsgVpnMqttSession.  # noqa: E501

        Indicates whether the MQTT Session has the Will message specified by the Client. The Will message is published if the Client disconnects without sending the MQTT DISCONNECT packet.  # noqa: E501

        :return: The will of this MsgVpnMqttSession.  # noqa: E501
        :rtype: bool
        """
        return self._will
    ...
    @will.setter
    def will(self, will):
        """Sets the will of this MsgVpnMqttSession.

        Indicates whether the MQTT Session has the Will message specified by the Client. The Will message is published if the Client disconnects without sending the MQTT DISCONNECT packet.  # noqa: E501

        :param will: The will of this MsgVpnMqttSession.  # noqa: E501
        :type: bool
        """
