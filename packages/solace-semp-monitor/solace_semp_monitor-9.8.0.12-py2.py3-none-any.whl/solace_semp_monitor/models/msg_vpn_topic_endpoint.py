...
class MsgVpnTopicEndpoint(object):
    ...
    def delivery_count_enabled(self):
        ...
        Enable or disable the ability for client applications to query the message delivery count of messages received from the Topic Endpoint. This is a controlled availability feature. Please contact Solace to find out if this feature is supported for your use case. Available since 2.19.  # noqa: E501
    ...
    def egress_enabled(self):
        ...
        Indicates whether the transmission of messages from the Topic Endpoint is enabled.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Indicates whether the reception of messages to the Topic Endpoint is enabled.  # noqa: E501
    ...
    def respect_msg_priority_enabled(self):
        ...
        Indicates whether message priorities are respected. When enabled, messages contained in the Topic Endpoint are delivered in priority order, from 9 (highest) to 0 (lowest).  # noqa: E501
    ...
    def respect_ttl_enabled(self):
        ...
        Indicates whether the time-to-live (TTL) for messages in the Topic Endpoint is respected. When enabled, expired messages are discarded or moved to the DMQ.  # noqa: E501
    ...
    def transport_retransmit_msg_count(self):
        """Gets the transport_retransmit_msg_count of this MsgVpnTopicEndpoint.  # noqa: E501

        The number of guaranteed messages that were retransmitted by the Topic Endpoint at the transport layer as part of a single delivery attempt. Available since 2.18.  # noqa: E501

        :return: The transport_retransmit_msg_count of this MsgVpnTopicEndpoint.  # noqa: E501
        :rtype: int
        """
    ...
    def transport_retransmit_msg_count(self, transport_retransmit_msg_count):
        """Sets the transport_retransmit_msg_count of this MsgVpnTopicEndpoint.

        The number of guaranteed messages that were retransmitted by the Topic Endpoint at the transport layer as part of a single delivery attempt. Available since 2.18.  # noqa: E501

        :param transport_retransmit_msg_count: The transport_retransmit_msg_count of this MsgVpnTopicEndpoint.  # noqa: E501
        :type: int
        """
