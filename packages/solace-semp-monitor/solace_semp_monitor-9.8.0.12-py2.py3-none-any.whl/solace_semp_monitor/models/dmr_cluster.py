...
class DmrCluster(object):
    ...
    swagger_types = {
        ...
        'tls_server_cert_validate_name_enabled': 'bool',
        'up': 'bool',
        'uptime': 'int'
    }
    ...
    attribute_map = {
        ...
        'tls_server_cert_validate_name_enabled': 'tlsServerCertValidateNameEnabled',
        'up': 'up',
        'uptime': 'uptime'
    }

    def __init__(self, authentication_basic_enabled=None, authentication_basic_type=None, authentication_client_cert_enabled=None, direct_only_enabled=None, dmr_cluster_name=None, enabled=None, failure_reason=None, node_name=None, tls_server_cert_enforce_trusted_common_name_enabled=None, tls_server_cert_max_chain_depth=None, tls_server_cert_validate_date_enabled=None, tls_server_cert_validate_name_enabled=None, up=None, uptime=None):  # noqa: E501
        ...
        self._tls_server_cert_validate_name_enabled = None
        self._up = None
        self._uptime = None
        ...
        if tls_server_cert_validate_name_enabled is not None:
            self.tls_server_cert_validate_name_enabled = tls_server_cert_validate_name_enabled
        if up is not None:
            self.up = up
    ...
    def authentication_basic_enabled(self):
        ...
        Indicates whether basic authentication is enabled for Cluster Links.  # noqa: E501
    ...
    def authentication_basic_type(self):
        ...
        The type of basic authentication to use for Cluster Links. The allowed values and their meaning are:  <pre> \"internal\" - Use locally configured password. \"none\" - No authentication. </pre>   # noqa: E501
    ...
    def authentication_client_cert_enabled(self):
        ...
        Indicates whether client certificate authentication is enabled for Cluster Links.  # noqa: E501
    ...
    def direct_only_enabled(self):
        ...
        Indicates whether this cluster only supports direct messaging. If true, guaranteed messages will not be transmitted through the cluster.  # noqa: E501
    ...
    def enabled(self):
        ...
        Indicates whether the Cluster is enabled.  # noqa: E501
    ...
    def failure_reason(self):
        """Gets the failure_reason of this DmrCluster.  # noqa: E501

        The failure reason for the Cluster being down.  # noqa: E501

        :return: The failure_reason of this DmrCluster.  # noqa: E501
        :rtype: str
        """
    ...
    def failure_reason(self, failure_reason):
        """Sets the failure_reason of this DmrCluster.

        The failure reason for the Cluster being down.  # noqa: E501

        :param failure_reason: The failure_reason of this DmrCluster.  # noqa: E501
        :type: str
        """
    ...
    def tls_server_cert_max_chain_depth(self):
        ...
        The maximum allowed depth of a certificate chain. The depth of a chain is defined as the number of signing CA certificates that are present in the chain back to a trusted self-signed root CA certificate.  # noqa: E501
    ...
    def tls_server_cert_validate_date_enabled(self):
        ...
        Indicates whether validation of the \"Not Before\" and \"Not After\" validity dates in the certificate is enabled. When disabled, the certificate is accepted even if the certificate is not valid based on these dates.  # noqa: E501
    ...
    @property
    def tls_server_cert_validate_name_enabled(self):
        """Gets the tls_server_cert_validate_name_enabled of this DmrCluster.  # noqa: E501
        ...
        :return: The tls_server_cert_validate_name_enabled of this DmrCluster.  # noqa: E501
        :rtype: bool
        """
        return self._tls_server_cert_validate_name_enabled

    @tls_server_cert_validate_name_enabled.setter
    def tls_server_cert_validate_name_enabled(self, tls_server_cert_validate_name_enabled):
        """Sets the tls_server_cert_validate_name_enabled of this DmrCluster.

        Enable or disable the standard TLS authentication mechanism of verifying the name used to connect to the bridge. If enabled, the name used to connect to the bridge is checked against the names specified in the certificate returned by the remote router. Legacy Common Name validation is not performed if Server Certificate Name Validation is enabled, even if Common Name validation is also enabled. Available since 2.18.  # noqa: E501

        :param tls_server_cert_validate_name_enabled: The tls_server_cert_validate_name_enabled of this DmrCluster.  # noqa: E501
        :type: bool
        """

        self._tls_server_cert_validate_name_enabled = tls_server_cert_validate_name_enabled

    @property
    def up(self):
        """Gets the up of this DmrCluster.  # noqa: E501

        Indicates whether the Cluster is operationally up.  # noqa: E501

        :return: The up of this DmrCluster.  # noqa: E501
        :rtype: bool
        """
        return self._up
    ...
    @up.setter
    def up(self, up):
        """Sets the up of this DmrCluster.

        Indicates whether the Cluster is operationally up.  # noqa: E501

        :param up: The up of this DmrCluster.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def uptime(self):
        """Gets the uptime of this DmrCluster.  # noqa: E501

        The amount of time in seconds since the Cluster was up.  # noqa: E501

        :return: The uptime of this DmrCluster.  # noqa: E501
        :rtype: int
        """
        return self._uptime
    ...
    def uptime(self, uptime):
        """Sets the uptime of this DmrCluster.

        The amount of time in seconds since the Cluster was up.  # noqa: E501

        :param uptime: The uptime of this DmrCluster.  # noqa: E501
        :type: int
        """
