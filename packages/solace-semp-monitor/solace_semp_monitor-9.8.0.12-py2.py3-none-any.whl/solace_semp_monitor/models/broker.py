...
class Broker(object):
    ...
    def guaranteed_msging_disk_array_wwn(self):
        ...
        The WWN number to use when accessing a LUN on an external disk array. Available since 2.18.  # noqa: E501
    ...
    def tls_standard_domain_certificate_authorities_enabled(self):
        ...
        Enable or disable the standard domain certificate authority list. Available since 2.19.  # noqa: E501
