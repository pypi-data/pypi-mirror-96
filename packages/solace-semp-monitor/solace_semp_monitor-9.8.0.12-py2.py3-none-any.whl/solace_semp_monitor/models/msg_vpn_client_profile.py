...
class MsgVpnClientProfile(object):
    ...
    swagger_types = {
        ...
        'allow_guaranteed_endpoint_create_durability': 'str',
        ...
        'api_queue_management_copy_from_on_create_template_name': 'str',
        'api_topic_endpoint_management_copy_from_on_create_name': 'str',
        'api_topic_endpoint_management_copy_from_on_create_template_name': 'str',
        ...
        'service_min_keepalive_timeout': 'int',
        'service_smf_max_connection_count_per_client_username': 'int',
        'service_smf_min_keepalive_enabled': 'bool',
    ...
    attribute_map = {
        ...
        'allow_guaranteed_endpoint_create_durability': 'allowGuaranteedEndpointCreateDurability',
        ...
        'api_queue_management_copy_from_on_create_template_name': 'apiQueueManagementCopyFromOnCreateTemplateName',
        'api_topic_endpoint_management_copy_from_on_create_name': 'apiTopicEndpointManagementCopyFromOnCreateName',
        'api_topic_endpoint_management_copy_from_on_create_template_name': 'apiTopicEndpointManagementCopyFromOnCreateTemplateName',
        ...
        'service_min_keepalive_timeout': 'serviceMinKeepaliveTimeout',
        'service_smf_max_connection_count_per_client_username': 'serviceSmfMaxConnectionCountPerClientUsername',
        'service_smf_min_keepalive_enabled': 'serviceSmfMinKeepaliveEnabled',
    ...
    def __init__(self, allow_bridge_connections_enabled=None, allow_cut_through_forwarding_enabled=None, allow_guaranteed_endpoint_create_durability=None, allow_guaranteed_endpoint_create_enabled=None, allow_guaranteed_msg_receive_enabled=None, allow_guaranteed_msg_send_enabled=None, allow_shared_subscriptions_enabled=None, allow_transacted_sessions_enabled=None, api_queue_management_copy_from_on_create_name=None, api_queue_management_copy_from_on_create_template_name=None, api_topic_endpoint_management_copy_from_on_create_name=None, api_topic_endpoint_management_copy_from_on_create_template_name=None, client_profile_name=None, compression_enabled=None, eliding_delay=None, eliding_enabled=None, eliding_max_topic_count=None, event_client_provisioned_endpoint_spool_usage_threshold=None, event_connection_count_per_client_username_threshold=None, event_egress_flow_count_threshold=None, event_endpoint_count_per_client_username_threshold=None, event_ingress_flow_count_threshold=None, event_service_smf_connection_count_per_client_username_threshold=None, event_service_web_connection_count_per_client_username_threshold=None, event_subscription_count_threshold=None, event_transacted_session_count_threshold=None, event_transaction_count_threshold=None, max_connection_count_per_client_username=None, max_effective_endpoint_count=None, max_effective_rx_flow_count=None, max_effective_subscription_count=None, max_effective_transacted_session_count=None, max_effective_transaction_count=None, max_effective_tx_flow_count=None, max_egress_flow_count=None, max_endpoint_count_per_client_username=None, max_ingress_flow_count=None, max_subscription_count=None, max_transacted_session_count=None, max_transaction_count=None, msg_vpn_name=None, queue_control1_max_depth=None, queue_control1_min_msg_burst=None, queue_direct1_max_depth=None, queue_direct1_min_msg_burst=None, queue_direct2_max_depth=None, queue_direct2_min_msg_burst=None, queue_direct3_max_depth=None, queue_direct3_min_msg_burst=None, queue_guaranteed1_max_depth=None, queue_guaranteed1_min_msg_burst=None, reject_msg_to_sender_on_no_subscription_match_enabled=None, replication_allow_client_connect_when_standby_enabled=None, service_min_keepalive_timeout=None, service_smf_max_connection_count_per_client_username=None, service_smf_min_keepalive_enabled=None, service_web_inactive_timeout=None, service_web_max_connection_count_per_client_username=None, service_web_max_payload=None, tcp_congestion_window_size=None, tcp_keepalive_count=None, tcp_keepalive_idle_time=None, tcp_keepalive_interval=None, tcp_max_segment_size=None, tcp_max_window_size=None, tls_allow_downgrade_to_plain_text_enabled=None):  # noqa: E501
        ...
        self._allow_guaranteed_endpoint_create_durability = None
        ...
        self._api_queue_management_copy_from_on_create_template_name = None
        self._api_topic_endpoint_management_copy_from_on_create_name = None
        self._api_topic_endpoint_management_copy_from_on_create_template_name = None
        ...
        self._service_min_keepalive_timeout = None
        self._service_smf_max_connection_count_per_client_username = None
        self._service_smf_min_keepalive_enabled = None
        ...
        if allow_guaranteed_endpoint_create_durability is not None:
            self.allow_guaranteed_endpoint_create_durability = allow_guaranteed_endpoint_create_durability
        ...
        if api_queue_management_copy_from_on_create_template_name is not None:
            self.api_queue_management_copy_from_on_create_template_name = api_queue_management_copy_from_on_create_template_name
        ...
        if api_topic_endpoint_management_copy_from_on_create_template_name is not None:
            self.api_topic_endpoint_management_copy_from_on_create_template_name = api_topic_endpoint_management_copy_from_on_create_template_name
        ...
        if service_min_keepalive_timeout is not None:
            self.service_min_keepalive_timeout = service_min_keepalive_timeout
        ...
        if service_smf_min_keepalive_enabled is not None:
            self.service_smf_min_keepalive_enabled = service_smf_min_keepalive_enabled
    ...
    def allow_bridge_connections_enabled(self):
        ...
        Indicates whether Bridge clients using the Client Profile are allowed to connect.  # noqa: E501
    ...
    def allow_cut_through_forwarding_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to bind to endpoints with the cut-through forwarding delivery mode.  # noqa: E501
    ...
    @property
    def allow_guaranteed_endpoint_create_durability(self):
        """Gets the allow_guaranteed_endpoint_create_durability of this MsgVpnClientProfile.  # noqa: E501

        Indicates whether clients using the Client Profile are allowed to create durable and/or non-durable topic endponts or queues. The allowed values and their meaning are:  <pre> \"all\" - Client can create any type of endpoint. \"durable\" - Client can create only durable endpoints. \"non-durable\" - Client can create only non-durable endpoints. </pre>  Available since 2.14.  # noqa: E501

        :return: The allow_guaranteed_endpoint_create_durability of this MsgVpnClientProfile.  # noqa: E501
        :rtype: str
        """
        return self._allow_guaranteed_endpoint_create_durability

    @allow_guaranteed_endpoint_create_durability.setter
    def allow_guaranteed_endpoint_create_durability(self, allow_guaranteed_endpoint_create_durability):
        """Sets the allow_guaranteed_endpoint_create_durability of this MsgVpnClientProfile.

        Indicates whether clients using the Client Profile are allowed to create durable and/or non-durable topic endponts or queues. The allowed values and their meaning are:  <pre> \"all\" - Client can create any type of endpoint. \"durable\" - Client can create only durable endpoints. \"non-durable\" - Client can create only non-durable endpoints. </pre>  Available since 2.14.  # noqa: E501

        :param allow_guaranteed_endpoint_create_durability: The allow_guaranteed_endpoint_create_durability of this MsgVpnClientProfile.  # noqa: E501
        :type: str
        """
        allowed_values = ["all", "durable", "non-durable"]  # noqa: E501
        if allow_guaranteed_endpoint_create_durability not in allowed_values:
            raise ValueError(
                "Invalid value for `allow_guaranteed_endpoint_create_durability` ({0}), must be one of {1}"  # noqa: E501
                .format(allow_guaranteed_endpoint_create_durability, allowed_values)
            )

        self._allow_guaranteed_endpoint_create_durability = allow_guaranteed_endpoint_create_durability
    ...
    def allow_guaranteed_endpoint_create_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to create topic endponts or queues.  # noqa: E501
    ...
    def allow_guaranteed_msg_receive_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to receive guaranteed messages.  # noqa: E501
    ...
    def allow_guaranteed_msg_send_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to send guaranteed messages.  # noqa: E501
    ...
    def allow_shared_subscriptions_enabled(self):
        ...
        Indicates whether shared subscriptions are allowed. Changing this setting does not affect existing subscriptions.  # noqa: E501
    ...
    def allow_transacted_sessions_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to establish transacted sessions.  # noqa: E501
    ...
    def api_queue_management_copy_from_on_create_name(self):
        ...
        The name of a queue to copy settings from when a new queue is created by a client using the Client Profile. The referenced queue must exist in the Message VPN. Deprecated since 2.14. This attribute has been replaced with `apiQueueManagementCopyFromOnCreateTemplateName`.  # noqa: E501
    ...
    @property
    def api_queue_management_copy_from_on_create_template_name(self):
        """Gets the api_queue_management_copy_from_on_create_template_name of this MsgVpnClientProfile.  # noqa: E501

        The name of a queue template to copy settings from when a new queue is created by a client using the Client Profile. If the referenced queue template does not exist, queue creation will fail when it tries to resolve this template. Available since 2.14.  # noqa: E501

        :return: The api_queue_management_copy_from_on_create_template_name of this MsgVpnClientProfile.  # noqa: E501
        :rtype: str
        """
        return self._api_queue_management_copy_from_on_create_template_name

    @api_queue_management_copy_from_on_create_template_name.setter
    def api_queue_management_copy_from_on_create_template_name(self, api_queue_management_copy_from_on_create_template_name):
        """Sets the api_queue_management_copy_from_on_create_template_name of this MsgVpnClientProfile.

        The name of a queue template to copy settings from when a new queue is created by a client using the Client Profile. If the referenced queue template does not exist, queue creation will fail when it tries to resolve this template. Available since 2.14.  # noqa: E501

        :param api_queue_management_copy_from_on_create_template_name: The api_queue_management_copy_from_on_create_template_name of this MsgVpnClientProfile.  # noqa: E501
        :type: str
        """

        self._api_queue_management_copy_from_on_create_template_name = api_queue_management_copy_from_on_create_template_name
    ...
    def api_topic_endpoint_management_copy_from_on_create_name(self):
        ...
        The name of a topic endpoint to copy settings from when a new topic endpoint is created by a client using the Client Profile. The referenced topic endpoint must exist in the Message VPN. Deprecated since 2.14. This attribute has been replaced with `apiTopicEndpointManagementCopyFromOnCreateTemplateName`.  # noqa: E501
    ...
    @property
    def api_topic_endpoint_management_copy_from_on_create_template_name(self):
        """Gets the api_topic_endpoint_management_copy_from_on_create_template_name of this MsgVpnClientProfile.  # noqa: E501

        The name of a topic endpoint template to copy settings from when a new topic endpoint is created by a client using the Client Profile. If the referenced topic endpoint template does not exist, topic endpoint creation will fail when it tries to resolve this template. Available since 2.14.  # noqa: E501

        :return: The api_topic_endpoint_management_copy_from_on_create_template_name of this MsgVpnClientProfile.  # noqa: E501
        :rtype: str
        """
        return self._api_topic_endpoint_management_copy_from_on_create_template_name

    @api_topic_endpoint_management_copy_from_on_create_template_name.setter
    def api_topic_endpoint_management_copy_from_on_create_template_name(self, api_topic_endpoint_management_copy_from_on_create_template_name):
        """Sets the api_topic_endpoint_management_copy_from_on_create_template_name of this MsgVpnClientProfile.

        The name of a topic endpoint template to copy settings from when a new topic endpoint is created by a client using the Client Profile. If the referenced topic endpoint template does not exist, topic endpoint creation will fail when it tries to resolve this template. Available since 2.14.  # noqa: E501

        :param api_topic_endpoint_management_copy_from_on_create_template_name: The api_topic_endpoint_management_copy_from_on_create_template_name of this MsgVpnClientProfile.  # noqa: E501
        :type: str
        """

        self._api_topic_endpoint_management_copy_from_on_create_template_name = api_topic_endpoint_management_copy_from_on_create_template_name
    ...
    def compression_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to use compression.  # noqa: E501
    ...
    def eliding_delay(self):
        ...
        The amount of time to delay the delivery of messages to clients using the Client Profile after the initial message has been delivered (the eliding delay interval), in milliseconds. A value of 0 means there is no delay in delivering messages to clients.  # noqa: E501
    ...
    def eliding_enabled(self):
        ...
        Indicates whether message eliding is enabled for clients using the Client Profile.  # noqa: E501
    ...
    def eliding_max_topic_count(self):
        ...
        The maximum number of topics tracked for message eliding per client connection using the Client Profile.  # noqa: E501
    ...
    def max_connection_count_per_client_username(self):
        ...
        The maximum number of client connections per Client Username using the Client Profile.  # noqa: E501
    ...
    def max_effective_endpoint_count(self):
        """Gets the max_effective_endpoint_count of this MsgVpnClientProfile.  # noqa: E501

        The effective maximum number of queues and topic endpoints per Client Username using the Client Profile.  # noqa: E501

        :return: The max_effective_endpoint_count of this MsgVpnClientProfile.  # noqa: E501
        :rtype: int
        """
    ...
    def max_effective_endpoint_count(self, max_effective_endpoint_count):
        """Sets the max_effective_endpoint_count of this MsgVpnClientProfile.

        The effective maximum number of queues and topic endpoints per Client Username using the Client Profile.  # noqa: E501

        :param max_effective_endpoint_count: The max_effective_endpoint_count of this MsgVpnClientProfile.  # noqa: E501
        :type: int
        """
    ...
    def max_effective_rx_flow_count(self):
        """Gets the max_effective_rx_flow_count of this MsgVpnClientProfile.  # noqa: E501

        The effective maximum number of receive flows per client using the Client Profile.  # noqa: E501

        :return: The max_effective_rx_flow_count of this MsgVpnClientProfile.  # noqa: E501
        :rtype: int
        """
    ...
    def max_effective_rx_flow_count(self, max_effective_rx_flow_count):
        """Sets the max_effective_rx_flow_count of this MsgVpnClientProfile.

        The effective maximum number of receive flows per client using the Client Profile.  # noqa: E501

        :param max_effective_rx_flow_count: The max_effective_rx_flow_count of this MsgVpnClientProfile.  # noqa: E501
        :type: int
        """
    ...
    def max_effective_subscription_count(self):
        """Gets the max_effective_subscription_count of this MsgVpnClientProfile.  # noqa: E501

        The effective maximum number of subscriptions per client using the Client Profile.  # noqa: E501

        :return: The max_effective_subscription_count of this MsgVpnClientProfile.  # noqa: E501
        :rtype: int
        """
    ...
    def max_effective_subscription_count(self, max_effective_subscription_count):
        """Sets the max_effective_subscription_count of this MsgVpnClientProfile.

        The effective maximum number of subscriptions per client using the Client Profile.  # noqa: E501

        :param max_effective_subscription_count: The max_effective_subscription_count of this MsgVpnClientProfile.  # noqa: E501
        :type: int
        """
    ...
    def max_effective_transacted_session_count(self):
        """Gets the max_effective_transacted_session_count of this MsgVpnClientProfile.  # noqa: E501

        The effective maximum number of transacted sessions per client using the Client Profile.  # noqa: E501

        :return: The max_effective_transacted_session_count of this MsgVpnClientProfile.  # noqa: E501
        :rtype: int
        """
    ...
    def max_effective_transacted_session_count(self, max_effective_transacted_session_count):
        """Sets the max_effective_transacted_session_count of this MsgVpnClientProfile.

        The effective maximum number of transacted sessions per client using the Client Profile.  # noqa: E501

        :param max_effective_transacted_session_count: The max_effective_transacted_session_count of this MsgVpnClientProfile.  # noqa: E501
        :type: int
        """
    ...
    def max_effective_transaction_count(self):
        """Gets the max_effective_transaction_count of this MsgVpnClientProfile.  # noqa: E501

        The effective maximum number of transactions per client using the Client Profile.  # noqa: E501

        :return: The max_effective_transaction_count of this MsgVpnClientProfile.  # noqa: E501
        :rtype: int
        """
    ...
    def max_effective_transaction_count(self, max_effective_transaction_count):
        """Sets the max_effective_transaction_count of this MsgVpnClientProfile.

        The effective maximum number of transactions per client using the Client Profile.  # noqa: E501

        :param max_effective_transaction_count: The max_effective_transaction_count of this MsgVpnClientProfile.  # noqa: E501
        :type: int
        """
    ...
    def max_effective_tx_flow_count(self):
        """Gets the max_effective_tx_flow_count of this MsgVpnClientProfile.  # noqa: E501

        The effective maximum number of transmit flows per client using the Client Profile.  # noqa: E501

        :return: The max_effective_tx_flow_count of this MsgVpnClientProfile.  # noqa: E501
        :rtype: int
        """
    ...
    def max_effective_tx_flow_count(self, max_effective_tx_flow_count):
        """Sets the max_effective_tx_flow_count of this MsgVpnClientProfile.

        The effective maximum number of transmit flows per client using the Client Profile.  # noqa: E501

        :param max_effective_tx_flow_count: The max_effective_tx_flow_count of this MsgVpnClientProfile.  # noqa: E501
        :type: int
        """
    ...
    def max_egress_flow_count(self):
        ...
        The maximum number of transmit flows that can be created by one client using the Client Profile.  # noqa: E501
    ...
    def max_endpoint_count_per_client_username(self):
        ...
        The maximum number of queues and topic endpoints that can be created by clients with the same Client Username using the Client Profile.  # noqa: E501
    ...
    def max_ingress_flow_count(self):
        ...
        The maximum number of receive flows that can be created by one client using the Client Profile.  # noqa: E501
    ...
    def max_transacted_session_count(self):
        ...
        The maximum number of transacted sessions that can be created by one client using the Client Profile.  # noqa: E501
    ...
    def max_transaction_count(self):
        ...
        The maximum number of transactions that can be created by one client using the Client Profile.  # noqa: E501
    ...
    def queue_control1_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Control 1\" (C-1) priority queue, regardless of the `queueControl1MaxDepth` value.  # noqa: E501
    ...
    def queue_direct1_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Direct 1\" (D-1) priority queue, regardless of the `queueDirect1MaxDepth` value.  # noqa: E501
    ...
    def queue_direct2_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Direct 2\" (D-2) priority queue, regardless of the `queueDirect2MaxDepth` value.  # noqa: E501
    ...
    def queue_direct3_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Direct 3\" (D-3) priority queue, regardless of the `queueDirect3MaxDepth` value.  # noqa: E501
    ...
    def queue_guaranteed1_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Guaranteed 1\" (G-3) priority queue, regardless of the `queueGuaranteed1MaxDepth` value.  # noqa: E501
    ...
    def reject_msg_to_sender_on_no_subscription_match_enabled(self):
        ...
        Indicates whether to send a negative acknowledgement (NACK) to a client using the Client Profile when discarding a guaranteed message due to no matching subscription found.  # noqa: E501
    ...
    def replication_allow_client_connect_when_standby_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to connect to the Message VPN when its replication state is standby.  # noqa: E501
    ...
    @property
    def service_min_keepalive_timeout(self):
        """Gets the service_min_keepalive_timeout of this MsgVpnClientProfile.  # noqa: E501

        The minimum client keepalive timeout which will be enforced for client connections. Available since 2.19.  # noqa: E501

        :return: The service_min_keepalive_timeout of this MsgVpnClientProfile.  # noqa: E501
        :rtype: int
        """
        return self._service_min_keepalive_timeout

    @service_min_keepalive_timeout.setter
    def service_min_keepalive_timeout(self, service_min_keepalive_timeout):
        """Sets the service_min_keepalive_timeout of this MsgVpnClientProfile.

        The minimum client keepalive timeout which will be enforced for client connections. Available since 2.19.  # noqa: E501

        :param service_min_keepalive_timeout: The service_min_keepalive_timeout of this MsgVpnClientProfile.  # noqa: E501
        :type: int
        """

        self._service_min_keepalive_timeout = service_min_keepalive_timeout
    ...
    def service_smf_max_connection_count_per_client_username(self):
        ...
        The maximum number of SMF client connections per Client Username using the Client Profile.  # noqa: E501
    ...
    @property
    def service_smf_min_keepalive_enabled(self):
        """Gets the service_smf_min_keepalive_enabled of this MsgVpnClientProfile.  # noqa: E501

        Enable or disable the enforcement of a minimum keepalive timeout for SMF clients. Available since 2.19.  # noqa: E501

        :return: The service_smf_min_keepalive_enabled of this MsgVpnClientProfile.  # noqa: E501
        :rtype: bool
        """
        return self._service_smf_min_keepalive_enabled

    @service_smf_min_keepalive_enabled.setter
    def service_smf_min_keepalive_enabled(self, service_smf_min_keepalive_enabled):
        """Sets the service_smf_min_keepalive_enabled of this MsgVpnClientProfile.

        Enable or disable the enforcement of a minimum keepalive timeout for SMF clients. Available since 2.19.  # noqa: E501

        :param service_smf_min_keepalive_enabled: The service_smf_min_keepalive_enabled of this MsgVpnClientProfile.  # noqa: E501
        :type: bool
        """

        self._service_smf_min_keepalive_enabled = service_smf_min_keepalive_enabled

    @property
    def service_web_inactive_timeout(self):
        """Gets the service_web_inactive_timeout of this MsgVpnClientProfile.  # noqa: E501

        The timeout for inactive Web Transport client sessions using the Client Profile, in seconds.  # noqa: E501
    ...
    def service_web_max_connection_count_per_client_username(self):
        ...
        The maximum number of Web Transport client connections per Client Username using the Client Profile.  # noqa: E501
    ...
    def service_web_max_payload(self):
        ...
        The maximum Web Transport payload size before fragmentation occurs for clients using the Client Profile, in bytes. The size of the header is not included.  # noqa: E501
    ...
    def tcp_congestion_window_size(self):
        ...
        The TCP initial congestion window size for clients using the Client Profile, in multiples of the TCP Maximum Segment Size (MSS). Changing the value from its default of 2 results in non-compliance with RFC 2581. Contact Solace Support before changing this value.  # noqa: E501
    ...
    def tcp_keepalive_count(self):
        ...
        The number of TCP keepalive retransmissions to a client using the Client Profile before declaring that it is not available.  # noqa: E501
    ...
    def tcp_keepalive_idle_time(self):
        ...
        The amount of time a client connection using the Client Profile must remain idle before TCP begins sending keepalive probes, in seconds.  # noqa: E501
    ...
    def tcp_keepalive_interval(self):
        ...
        The amount of time between TCP keepalive retransmissions to a client using the Client Profile when no acknowledgement is received, in seconds.  # noqa: E501
    ...
    def tcp_max_segment_size(self):
        ...
        The TCP maximum segment size for clients using the Client Profile, in bytes. Changes are applied to all existing connections.  # noqa: E501
    ...
    def tcp_max_window_size(self):
        ...
        The TCP maximum window size for clients using the Client Profile, in kilobytes. Changes are applied to all existing connections.  # noqa: E501
    ...
    def tls_allow_downgrade_to_plain_text_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to downgrade an encrypted connection to plain text.  # noqa: E501
