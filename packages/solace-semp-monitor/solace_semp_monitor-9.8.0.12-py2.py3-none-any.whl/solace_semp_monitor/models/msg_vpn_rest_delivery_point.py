...
class MsgVpnRestDeliveryPoint(object):
    ...
    def __init__(self, client_name=None, client_profile_name=None, enabled=None, last_failure_reason=None, last_failure_time=None, msg_vpn_name=None, rest_delivery_point_name=None, service=None, time_connections_blocked=None, up=None, vendor=None):  # noqa: E501
    ...
    def service(self):
        ...
        The name of the service that this REST Delivery Point connects to. Internally the broker does not use this value; it is informational only. Available since 2.19.  # noqa: E501
    ...
    def vendor(self):
        ...
        The name of the vendor that this REST Delivery Point connects to. Internally the broker does not use this value; it is informational only. Available since 2.19.  # noqa: E501
