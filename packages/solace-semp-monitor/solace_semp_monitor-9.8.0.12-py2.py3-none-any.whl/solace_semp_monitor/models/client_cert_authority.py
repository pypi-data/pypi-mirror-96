...
class ClientCertAuthority(object):
    ...
    def __init__(self, cert_authority_name=None, cert_content=None, crl_day_list=None, crl_last_download_time=None, crl_last_failure_reason=None, crl_last_failure_time=None, crl_next_download_time=None, crl_time_list=None, crl_up=None, crl_url=None, ocsp_last_failure_reason=None, ocsp_last_failure_time=None, ocsp_last_failure_url=None, ocsp_non_responder_cert_enabled=None, ocsp_override_url=None, ocsp_timeout=None, revocation_check_enabled=None):  # noqa: E501
        """ClientCertAuthority - a model defined in Swagger"""  # noqa: E501
    ...
    def cert_authority_name(self):
        """Gets the cert_authority_name of this ClientCertAuthority.  # noqa: E501

        The name of the Certificate Authority.  # noqa: E501

        :return: The cert_authority_name of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def cert_authority_name(self, cert_authority_name):
        """Sets the cert_authority_name of this ClientCertAuthority.

        The name of the Certificate Authority.  # noqa: E501

        :param cert_authority_name: The cert_authority_name of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def cert_content(self):
        """Gets the cert_content of this ClientCertAuthority.  # noqa: E501

        The PEM formatted content for the trusted root certificate of a client Certificate Authority.  # noqa: E501

        :return: The cert_content of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def cert_content(self, cert_content):
        """Sets the cert_content of this ClientCertAuthority.

        The PEM formatted content for the trusted root certificate of a client Certificate Authority.  # noqa: E501

        :param cert_content: The cert_content of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def crl_day_list(self):
        """Gets the crl_day_list of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The crl_day_list of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def crl_day_list(self, crl_day_list):
        """Sets the crl_day_list of this ClientCertAuthority.

        The scheduled CRL refresh day(s), specified as \"daily\" or a comma-separated list of days. Days must be specified as \"Sun\", \"Mon\", \"Tue\", \"Wed\", \"Thu\", \"Fri\", or \"Sat\", with no spaces, and in sorted order from Sunday to Saturday.  # noqa: E501

        :param crl_day_list: The crl_day_list of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def crl_last_download_time(self):
        """Gets the crl_last_download_time of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The crl_last_download_time of this ClientCertAuthority.  # noqa: E501
        :rtype: int
        """
    ...
    def crl_last_download_time(self, crl_last_download_time):
        """Sets the crl_last_download_time of this ClientCertAuthority.

        The timestamp of the last successful CRL download. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param crl_last_download_time: The crl_last_download_time of this ClientCertAuthority.  # noqa: E501
        :type: int
        """
    ...
    def crl_last_failure_reason(self):
        """Gets the crl_last_failure_reason of this ClientCertAuthority.  # noqa: E501

        The reason for the last CRL failure.  # noqa: E501

        :return: The crl_last_failure_reason of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def crl_last_failure_reason(self, crl_last_failure_reason):
        """Sets the crl_last_failure_reason of this ClientCertAuthority.

        The reason for the last CRL failure.  # noqa: E501

        :param crl_last_failure_reason: The crl_last_failure_reason of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def crl_last_failure_time(self):
        """Gets the crl_last_failure_time of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The crl_last_failure_time of this ClientCertAuthority.  # noqa: E501
        :rtype: int
        """
    ...
    def crl_last_failure_time(self, crl_last_failure_time):
        """Sets the crl_last_failure_time of this ClientCertAuthority.

        The timestamp of the last CRL failure. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param crl_last_failure_time: The crl_last_failure_time of this ClientCertAuthority.  # noqa: E501
        :type: int
        """
    ...
    def crl_next_download_time(self):
        """Gets the crl_next_download_time of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The crl_next_download_time of this ClientCertAuthority.  # noqa: E501
        :rtype: int
        """
    ...
    def crl_next_download_time(self, crl_next_download_time):
        """Sets the crl_next_download_time of this ClientCertAuthority.

        The scheduled time of the next CRL download. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param crl_next_download_time: The crl_next_download_time of this ClientCertAuthority.  # noqa: E501
        :type: int
        """
    ...
    def crl_time_list(self):
        """Gets the crl_time_list of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The crl_time_list of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def crl_time_list(self, crl_time_list):
        """Sets the crl_time_list of this ClientCertAuthority.

        The scheduled CRL refresh time(s), specified as \"hourly\" or a comma-separated list of 24-hour times in the form hh:mm, or h:mm. There must be no spaces, and times must be in sorted order from 0:00 to 23:59.  # noqa: E501

        :param crl_time_list: The crl_time_list of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    @property
    def crl_up(self):
        """Gets the crl_up of this ClientCertAuthority.  # noqa: E501

        Indicates whether CRL revocation checking is operationally up.  # noqa: E501

        :return: The crl_up of this ClientCertAuthority.  # noqa: E501
        :rtype: bool
        """
        return self._crl_up
    ...
    def crl_up(self, crl_up):
        """Sets the crl_up of this ClientCertAuthority.

        Indicates whether CRL revocation checking is operationally up.  # noqa: E501

        :param crl_up: The crl_up of this ClientCertAuthority.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def crl_url(self):
        """Gets the crl_url of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The crl_url of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def crl_url(self, crl_url):
        """Sets the crl_url of this ClientCertAuthority.

        The URL for the CRL source. This is a required attribute for CRL to be operational and the URL must be complete with http:// included.  # noqa: E501

        :param crl_url: The crl_url of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def ocsp_last_failure_reason(self):
        """Gets the ocsp_last_failure_reason of this ClientCertAuthority.  # noqa: E501

        The reason for the last OCSP failure.  # noqa: E501

        :return: The ocsp_last_failure_reason of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def ocsp_last_failure_reason(self, ocsp_last_failure_reason):
        """Sets the ocsp_last_failure_reason of this ClientCertAuthority.

        The reason for the last OCSP failure.  # noqa: E501

        :param ocsp_last_failure_reason: The ocsp_last_failure_reason of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def ocsp_last_failure_time(self):
        """Gets the ocsp_last_failure_time of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The ocsp_last_failure_time of this ClientCertAuthority.  # noqa: E501
        :rtype: int
        """
    ...
    def ocsp_last_failure_time(self, ocsp_last_failure_time):
        """Sets the ocsp_last_failure_time of this ClientCertAuthority.

        The timestamp of the last OCSP failure. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param ocsp_last_failure_time: The ocsp_last_failure_time of this ClientCertAuthority.  # noqa: E501
        :type: int
        """
    ...
    def ocsp_last_failure_url(self):
        """Gets the ocsp_last_failure_url of this ClientCertAuthority.  # noqa: E501

        The URL involved in the last OCSP failure.  # noqa: E501

        :return: The ocsp_last_failure_url of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def ocsp_last_failure_url(self, ocsp_last_failure_url):
        """Sets the ocsp_last_failure_url of this ClientCertAuthority.

        The URL involved in the last OCSP failure.  # noqa: E501

        :param ocsp_last_failure_url: The ocsp_last_failure_url of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def ocsp_non_responder_cert_enabled(self):
        """Gets the ocsp_non_responder_cert_enabled of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The ocsp_non_responder_cert_enabled of this ClientCertAuthority.  # noqa: E501
        :rtype: bool
        """
    ...
    def ocsp_non_responder_cert_enabled(self, ocsp_non_responder_cert_enabled):
        """Sets the ocsp_non_responder_cert_enabled of this ClientCertAuthority.

        Indicates whether a non-responder certificate is allowed to sign an OCSP response. Typically used with an OCSP override URL in cases where a single certificate is used to sign client certificates and OCSP responses.  # noqa: E501

        :param ocsp_non_responder_cert_enabled: The ocsp_non_responder_cert_enabled of this ClientCertAuthority.  # noqa: E501
        :type: bool
        """
    ...
    def ocsp_override_url(self):
        """Gets the ocsp_override_url of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The ocsp_override_url of this ClientCertAuthority.  # noqa: E501
        :rtype: str
        """
    ...
    def ocsp_override_url(self, ocsp_override_url):
        """Sets the ocsp_override_url of this ClientCertAuthority.

        The OCSP responder URL to use for overriding the one supplied in the client certificate. The URL must be complete with http:// included.  # noqa: E501

        :param ocsp_override_url: The ocsp_override_url of this ClientCertAuthority.  # noqa: E501
        :type: str
        """
    ...
    def ocsp_timeout(self):
        """Gets the ocsp_timeout of this ClientCertAuthority.  # noqa: E501
        ...
        :return: The ocsp_timeout of this ClientCertAuthority.  # noqa: E501
        :rtype: int
        """
    ...
    def ocsp_timeout(self, ocsp_timeout):
        """Sets the ocsp_timeout of this ClientCertAuthority.

        The timeout in seconds to receive a response from the OCSP responder after sending a request or making the initial connection attempt.  # noqa: E501

        :param ocsp_timeout: The ocsp_timeout of this ClientCertAuthority.  # noqa: E501
        :type: int
        """
    ...
    def revocation_check_enabled(self):
        """Gets the revocation_check_enabled of this ClientCertAuthority.  # noqa: E501

        Indicates whether Certificate Authority revocation checking is enabled.  # noqa: E501

        :return: The revocation_check_enabled of this ClientCertAuthority.  # noqa: E501
        :rtype: bool
        """
    ...
    def revocation_check_enabled(self, revocation_check_enabled):
        """Sets the revocation_check_enabled of this ClientCertAuthority.

        Indicates whether Certificate Authority revocation checking is enabled.  # noqa: E501

        :param revocation_check_enabled: The revocation_check_enabled of this ClientCertAuthority.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClientCertAuthority, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClientCertAuthority):
            return False
