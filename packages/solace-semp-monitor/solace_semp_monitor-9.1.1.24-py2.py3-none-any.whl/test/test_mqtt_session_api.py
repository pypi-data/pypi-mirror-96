...
from solace_semp_monitor.api.mqtt_session_api import MqttSessionApi  # noqa: E501
from solace_semp_monitor.rest import ApiException


class TestMqttSessionApi(unittest.TestCase):
    """MqttSessionApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_monitor.api.mqtt_session_api.MqttSessionApi()  # noqa: E501
