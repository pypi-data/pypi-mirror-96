...
from solace_semp_monitor.api.jndi_api import JndiApi  # noqa: E501
from solace_semp_monitor.rest import ApiException


class TestJndiApi(unittest.TestCase):
    """JndiApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_monitor.api.jndi_api.JndiApi()  # noqa: E501
