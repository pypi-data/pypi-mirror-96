...
from solace_semp_monitor.api.rest_delivery_point_api import RestDeliveryPointApi  # noqa: E501
...
class TestRestDeliveryPointApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = solace_semp_monitor.api.rest_delivery_point_api.RestDeliveryPointApi()  # noqa: E501
