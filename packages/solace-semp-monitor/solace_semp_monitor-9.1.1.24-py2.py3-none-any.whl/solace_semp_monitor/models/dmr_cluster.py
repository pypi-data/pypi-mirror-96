...
class DmrCluster(object):
    ...
    def authentication_basic_enabled(self):
        ...
        Enable or disable basic authentication for Cluster Links.  # noqa: E501
    ...
    def authentication_client_cert_enabled(self):
        ...
        Enable or disable client certificate authentication for Cluster Links.  # noqa: E501
    ...
    def direct_only_enabled(self):
        ...
        Enable or disable direct messaging only. Guaranteed messages will not be transmitted through the cluster.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the Cluster.  # noqa: E501
    ...
    def tls_server_cert_enforce_trusted_common_name_enabled(self):
        ...
        Enable or disable the enforcing of the common-name provided by the remote broker against the list of trusted common-names configured for the Link. If enabled, the server-certificate's common-name must match one of the trusted common-names for the Link to be accepted.  # noqa: E501
    ...
    def tls_server_cert_max_chain_depth(self):
        ...
        The maximum allowed depth of a server-certificate chain. The depth of a chain is defined as the number of signing CA certificates that are present in the chain back to a trusted self-signed root CA certificate.  # noqa: E501
    ...
    def tls_server_cert_validate_date_enabled(self):
        ...
        Enable or disable the validation of the \"Not Before\" and \"Not After\" validity dates in the server-certificate. When disabled, the certificate is accepted even if the certificate is not valid based on these dates.  # noqa: E501
