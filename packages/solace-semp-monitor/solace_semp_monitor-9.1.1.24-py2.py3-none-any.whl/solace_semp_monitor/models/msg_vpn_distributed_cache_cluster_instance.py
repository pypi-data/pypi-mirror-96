...
class MsgVpnDistributedCacheClusterInstance(object):
    ...
    def __init__(self, auto_start_enabled=None, cache_name=None, cluster_name=None, counter=None, enabled=None, instance_name=None, last_registered_time=None, last_rx_heartbeat_time=None, last_rx_set_lost_msg_time=None, last_stopped_reason=None, last_stopped_time=None, last_tx_clear_lost_msg_time=None, memory_usage=None, msg_vpn_name=None, msgs_lost=None, rate=None, state=None, stop_on_lost_msg_enabled=None):  # noqa: E501
    ...
    def state(self):
        ...
        The operational state of the Cache Instance as: up, down, stopped, register, etc.  # noqa: E501
