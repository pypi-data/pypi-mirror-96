...
class MsgVpnBridgeRemoteMsgVpn(object):
    ...
    def tls_enabled(self):
        ...
        Indicates whether TLS encryption is enabled for the remote Message VPN connection.  # noqa: E501
    ...
    def unidirectional_client_profile(self):
        ...
        The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters.  # noqa: E501
