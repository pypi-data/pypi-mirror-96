...
class MsgVpnMqttSession(object):
    ...
    def __init__(self, clean=None, client_name=None, counter=None, created_by_management=None, enabled=None, mqtt_session_client_id=None, mqtt_session_virtual_router=None, msg_vpn_name=None, owner=None, queue_name=None, will=None):  # noqa: E501
