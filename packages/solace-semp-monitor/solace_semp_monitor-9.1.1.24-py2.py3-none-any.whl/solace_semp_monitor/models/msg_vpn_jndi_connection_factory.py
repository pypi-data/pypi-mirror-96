...
class MsgVpnJndiConnectionFactory(object):
    ...
    def dto_receive_subscriber_local_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer) if the messages are published on the local Router that the Subscriber is directly connected to.  # noqa: E501
    ...
    def dto_receive_subscriber_network_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer) if the messages are published on a remote Router.  # noqa: E501
    ...
    def dynamic_endpoint_create_durable_enabled(self):
        ...
        Indicates whether a durable endpoint will be dynamically created on the Router when the client calls \"Session.createDurableSubscriber()\" or \"Session.createQueue()\". The created endpoint respects the message time-to-live (TTL) according to the \"dynamicEndpointRespectTtlEnabled\" property.  # noqa: E501
    ...
    def guaranteed_receive_window_size_ack_threshold(self):
        ...
        The threshold for sending the acknowledgement (ACK) for guaranteed messages received by the Subscriber (Consumer) as a percentage of the \"guaranteedReceiveWindowSize\" value.  # noqa: E501
    ...
    def messaging_default_delivery_mode(self):
        ...
        The default delivery mode for messages sent by the Publisher (Producer). The allowed values and their meaning are:  <pre> \"persistent\" - Router spools messages (persists in the Message Spool) as part of the send operation. \"non-persistent\" - Router does not spool messages (does not persist in the Message Spool) as part of the send operation. </pre>   # noqa: E501
    ...
    def transport_compression_level(self):
        ...
        The ZLIB compression level for the connection to the Router. The value \"0\" means no compression, and the value \"-1\" means the compression level is specified in the JNDI Properties file.  # noqa: E501
    ...
    def transport_connect_retry_count(self):
        ...
        The maximum number of retry attempts to establish an initial connection to the host (Router) or list of hosts (Routers). The value \"0\" means a single attempt (no retries), and the value \"-1\" means to retry forever.  # noqa: E501
    ...
    def transport_connect_retry_per_host_count(self):
        ...
        The maximum number of retry attempts to establish an initial connection to each host (Router) on the list of hosts (Routers). The value \"0\" means a single attempt (no retries), and the value \"-1\" means to retry forever.  # noqa: E501
    ...
    def transport_connect_timeout(self):
        ...
        The timeout for establishing an initial connection to the Router, in milliseconds.  # noqa: E501
    ...
    def transport_direct_transport_enabled(self):
        ...
        Enable or disable usage of the Direct Transport mode for sending non-persistent messages. When disabled, the Guaranteed Transport mode is used.  # noqa: E501
    ...
    def transport_keepalive_count(self):
        ...
        The maximum number of consecutive application-level keepalive messages sent without the Router response before the connection to the Router is closed.  # noqa: E501
    ...
    def transport_port(self):
        ...
        The connection port number on the Router for SMF clients. The value \"-1\" means the port is specified in the JNDI Properties file.  # noqa: E501
    ...
    def transport_read_timeout(self):
        ...
        The timeout for reading a reply from the Router, in milliseconds.  # noqa: E501
    ...
    def transport_reconnect_retry_count(self):
        ...
        The maximum number of attempts to reconnect to the host (Router) or list of hosts (Routers) after the connection has been lost. The value \"-1\" means to retry forever.  # noqa: E501
    ...
    def transport_reconnect_retry_wait(self):
        ...
        The amount of time before making another attempt to connect or reconnect to the host (Router) after the connection has been lost, in milliseconds.  # noqa: E501
