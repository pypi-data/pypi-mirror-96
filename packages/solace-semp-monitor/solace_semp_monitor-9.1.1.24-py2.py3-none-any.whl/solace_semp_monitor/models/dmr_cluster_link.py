...
class DmrClusterLink(object):
    ...
    def enabled(self):
        ...
        Enable or disable the Link. When disabled, subscription sets of this and the remote node are not kept up-to-date, and messages are not exchanged with the remote node. Published guaranteed messages will be queued up for future delivery based on current subscription sets.  # noqa: E501
    ...
    def queue_reject_msg_to_sender_on_discard_behavior(self):
        ...
        The message discard behavior, providing the condition for returning a negative acknowledgement (NACK) to the sender. The allowed values and their meaning are:  <pre> \"always\" - Always return a negative acknowledgment (NACK) to the sending client on message discard. \"when-queue-enabled\" - Only return a negative acknowledgment (NACK) to the sending client on message discard when the Queue is enabled. \"never\" - Never return a negative acknowledgment (NACK) to the sending client on message discard. </pre>   # noqa: E501
    ...
    def transport_compressed_enabled(self):
        ...
        Enable or disable compression on the Link.  # noqa: E501
    ...
    def transport_tls_enabled(self):
        ...
        Enable or disable encryption on the Link.  # noqa: E501
