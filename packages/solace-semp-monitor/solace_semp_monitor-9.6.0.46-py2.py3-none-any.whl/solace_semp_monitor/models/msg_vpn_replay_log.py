...
class MsgVpnReplayLog(object):
    ...
    def egress_enabled(self):
        ...
        Indicates whether the transmission of messages from the Replay Log is enabled.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Indicates whether the reception of messages to the Replay Log is enabled.  # noqa: E501
