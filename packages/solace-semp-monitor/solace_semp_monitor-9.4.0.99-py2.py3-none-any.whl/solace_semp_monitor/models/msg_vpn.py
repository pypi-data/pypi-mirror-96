...
class MsgVpn(object):
    ...
    def semp_over_msg_bus_legacy_show_clear_enabled(self):
        ...
        Indicates whether \"legacy-show-clear\" SEMP over the message bus commands (that is, SEMP show and administration requests published to the topic \"#P2P/[router name]/#client/SEMP\") are enabled for the current Message VPN.  # noqa: E501
