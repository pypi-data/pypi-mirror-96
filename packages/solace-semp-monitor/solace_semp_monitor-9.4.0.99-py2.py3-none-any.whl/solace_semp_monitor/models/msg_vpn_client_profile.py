...
class MsgVpnClientProfile(object):
    ...
    def allow_guaranteed_endpoint_create_enabled(self):
        ...
        Indicates whether clients using the Client Profile are allowed to create topic endpoints or queues.  # noqa: E501
    ...
    def max_subscription_count(self):
        ...
        The maximum number of subscriptions per client using the Client Profile.  # noqa: E501
    ...
    def tcp_max_segment_size(self):
        ...
        The TCP maximum segment size for clients using the Client Profile, in kilobytes. Changes are applied to all existing connections.  # noqa: E501
