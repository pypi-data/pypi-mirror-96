...
class MsgVpn(object):
    ...
    def prefer_ip_version(self):
        ...
        IP version to use if DNS lookup contains both an IPv4 and IPv6 address. The allowed values and their meaning are:  <pre> \"ipv4\" - Use IPv4 address when DNS lookup contains both an IPv4 and IPv6 address. \"ipv6\" - Use IPv6 address when DNS lookup contains both an IPv4 and IPv6 address. </pre>   # noqa: E501
    ...
    def replication_bridge_tls_enabled(self):
        ...
        Indicates whether TLS is enabled for the replication Bridge connection. Available since 2.12.  # noqa: E501
    ...
    def semp_over_msg_bus_legacy_show_clear_enabled(self):
        ...
        Enable or disable \"legacy-show-clear\" SEMP over the message bus commands for the current Message VPN.  # noqa: E501
