...
class ServerTestCase(unittest.TestCase):
    ...
    def test_get_db_missing(self):
        self.assertRaises(client.DatabaseNotFound,
                          lambda: self.server['python-tests'].name)
...
class DatabaseTestCase(unittest.TestCase):
    ...
    def test_doc_revs(self):
        ...
        while self.db.info()['compact_running']:
            pass
        self.assertRaises(client.ResourceNotFound, self.db.get, 'foo', rev=old_rev, strict=True)
