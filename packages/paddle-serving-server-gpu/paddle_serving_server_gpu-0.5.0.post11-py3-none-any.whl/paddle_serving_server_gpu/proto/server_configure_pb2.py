...
_ENGINEDESC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_trt', full_name='baidu.paddle_serving.configure.EngineDesc.use_trt', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_lite', full_name='baidu.paddle_serving.configure.EngineDesc.use_lite', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_xpu', full_name='baidu.paddle_serving.configure.EngineDesc.use_xpu', index=18,
