...
class ConditionOrGroup(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"condition",b"condition",u"conditionOrGroup",b"conditionOrGroup",u"group",b"group"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"condition",b"condition",u"conditionOrGroup",b"conditionOrGroup",u"group",b"group"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"conditionOrGroup",b"conditionOrGroup"]) -> typing_extensions___Literal["condition","group"]: ...
