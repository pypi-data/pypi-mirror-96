...
class taskTypesController(GracieBaseAPI):
    ...
    def list(self, **kwargs):
        ...
        Args:
            orderAsc: (boolean): Return list of task types sorted in ascending order
            orderBy: (string): Sort order of returned task types, one of [NAME}
    ...
    def retrieve(self, id):
        ...
        Args:
            id: (string): Id of task type to retrieve
