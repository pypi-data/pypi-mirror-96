...
class stopWordController(GracieBaseAPI):
    ...
    def add(self, name, **kwargs):
        ...
        Args:
            languageId: (string): Id of new stopword's language, default is caller's language
            name: (string): New stopword text
    ...
    def delete(self, id):
        ...
        Args:
            id: (string): Id of stopword to delete
    ...
    def list(self, **kwargs):
        ...
        Args:
            languageId: (string): Id of language, * for all languages, default is caller's language
            limit: (integer): Limit the number of returned stopwords
            name: (string): Name prefix to match on, case insensitive
            offset: (integer): Start offset of returned list
            orderAsc: (boolean): Sort result in ascending order
            orderBy: (string): Sort order of returned stopwords, one of [NONE, NAME]
    ...
    def retrieve(self, id):
        ...
        Args:
            id: (string): Id of stopword to retrieve
