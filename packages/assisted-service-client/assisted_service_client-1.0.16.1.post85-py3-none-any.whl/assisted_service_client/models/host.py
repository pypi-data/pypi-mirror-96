...
class Host(object):
    ...
    def __init__(self, kind=None, id=None, href=None, cluster_id=None, status=None, status_info=None, validations_info=None, status_updated_at=None, progress=None, stage_started_at=None, stage_updated_at=None, progress_stages=None, connectivity=None, api_vip_connectivity=None, inventory=None, free_addresses=None, ntp_sources=None, role=None, bootstrap=None, logs_collected_at=None, installer_version=None, installation_disk_path=None, updated_at=None, created_at=None, checked_in_at=None, discovery_agent_version=None, requested_hostname=None, user_name=None, deleted_at=None, ignition_config_overrides=None, installer_args=None, machine_config_pool_name=None, images_status=None):  # noqa: E501
