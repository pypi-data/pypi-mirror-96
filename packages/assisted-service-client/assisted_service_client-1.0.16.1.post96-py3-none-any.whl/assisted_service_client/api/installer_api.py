...
class InstallerApi(object):
    ...
    def update_logs_progress(self, cluster_id, logs_type, logs_state, **kwargs):  # noqa: E501
        """update_logs_progress  # noqa: E501

        Update log collection state and progress.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_logs_progress(cluster_id, logs_type, logs_state, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cluster_id: The cluster whose log progress is being updated. (required)
        :param str logs_type: The type of log file. (required)
        :param str logs_state: The state of collecting logs. (required)
        :param str host_id: The host whose log progress is being updated.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_logs_progress_with_http_info(cluster_id, logs_type, logs_state, **kwargs)  # noqa: E501
        else:
            (data) = self.update_logs_progress_with_http_info(cluster_id, logs_type, logs_state, **kwargs)  # noqa: E501
            return data

    def update_logs_progress_with_http_info(self, cluster_id, logs_type, logs_state, **kwargs):  # noqa: E501
        """update_logs_progress  # noqa: E501

        Update log collection state and progress.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_logs_progress_with_http_info(cluster_id, logs_type, logs_state, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cluster_id', 'logs_type', 'logs_state', 'host_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_logs_progress" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_id' is set
        if ('cluster_id' not in params or
                params['cluster_id'] is None):
            raise ValueError("Missing the required parameter `cluster_id` when calling `update_logs_progress`")  # noqa: E501
        # verify the required parameter 'logs_type' is set
        if ('logs_type' not in params or
                params['logs_type'] is None):
            raise ValueError("Missing the required parameter `logs_type` when calling `update_logs_progress`")  # noqa: E501
        # verify the required parameter 'logs_state' is set
        if ('logs_state' not in params or
                params['logs_state'] is None):
            raise ValueError("Missing the required parameter `logs_state` when calling `update_logs_progress`")  # noqa: E501
        ...
        if 'host_id' in params:
            query_params.append(('host_id', params['host_id']))  # noqa: E501
        if 'logs_state' in params:
            query_params.append(('logs_state', params['logs_state']))  # noqa: E501
