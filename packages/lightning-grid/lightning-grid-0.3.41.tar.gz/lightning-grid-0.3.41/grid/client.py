...
"""
    ...
    when your Experiment starts.
        ...
        query = gql("""
        query GetScalarLogs ($experimentId: ID!, $metric: String!, $startIndex: Int) {
        ...
        def decode(x: str, dtype: str):
            buf = zlib.decompress(base64.b64decode(x))
            out = array(dtype)
            out.frombytes(buf)
            return out
    ...
    def list_datastores(self):
        ...
        for row in result["getDatastores"]:
            ...
            size = humanize.naturalsize(row["size"] * (1024**2))
