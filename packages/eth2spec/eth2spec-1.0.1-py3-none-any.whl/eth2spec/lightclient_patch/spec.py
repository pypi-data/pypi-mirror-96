...
TIMELY_HEAD_FLAG = ValidatorFlag(2**0)
TIMELY_SOURCE_FLAG = ValidatorFlag(2**1)
TIMELY_TARGET_FLAG = ValidatorFlag(2**2)
TIMELY_HEAD_NUMERATOR = 12
TIMELY_SOURCE_NUMERATOR = 12
TIMELY_TARGET_NUMERATOR = 32
REWARD_DENOMINATOR = 64
G2_POINT_AT_INFINITY = BLSSignature(b'\xc0' + b'\x00' * 95)
HF1_INACTIVITY_PENALTY_QUOTIENT = uint64(3 * 2**24)
HF1_MIN_SLASHING_PENALTY_QUOTIENT = uint64(2**6)
