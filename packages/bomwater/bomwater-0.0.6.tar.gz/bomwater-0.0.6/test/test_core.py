...
class test_core(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(self):
        if os.path.exists(os.path.join(os.path.dirname(__file__), '../bom_water/cache/waterML_GetCapabilities.json')):
            os.remove(os.path.join(os.path.dirname(__file__), '../bom_water/cache/waterML_GetCapabilities.json'))
