...
from vtorch.common.utils import ensure_list, is_lazy, lazy_groups_of
...
class DataIterator:
    ...
    def __init__(
        ...
        self._fields_with_pretrained_tokenizers = fields_with_pretrained_tokenizers or []

    def __call__(
        self, instances: Iterable[Instance], num_epochs: Optional[int] = None, shuffle: bool = True
