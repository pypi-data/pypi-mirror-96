...
class Vocabulary:
    ...
    def is_padded(self, namespace: str) -> bool:
        ...
        """
        return bool(self._index_to_token[namespace][0] == self.padding_token)
    ...
    def add_token_to_namespace(self, token: str, namespace: str = "tokens") -> int:
        ...
        if token not in self._token_to_index[namespace]:
            ...
            index = self._token_to_index[namespace][token]
        return index
    ...
    def get_index_to_token_vocabulary(self, namespace: str = "tokens") -> Dict[int, str]:
        index_to_token_vocab: Dict[int, str] = self._index_to_token[namespace]
        return index_to_token_vocab

    def get_token_to_index_vocabulary(self, namespace: str = "tokens") -> Dict[str, int]:
        token_to_index_vocab: Dict[str, int] = self._token_to_index[namespace]
    ...
    def get_token_index(self, token: str, namespace: str = "tokens") -> int:
        ...
        if token in self._token_to_index[namespace]:
            ...
            try:
                index = self._token_to_index[namespace][self.oov_token]
            except KeyError:
    ...
    def get_token_from_index(self, index: int, namespace: str = "tokens") -> str:
        token: str = self._index_to_token[namespace][index]
        return token
