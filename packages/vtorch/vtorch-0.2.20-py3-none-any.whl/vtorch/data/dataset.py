...
class Batch(Iterable[Instance]):
    ...
    def as_tensor_dict(
        self, padding_lengths: Dict[str, Dict[str, int]], batch_first: bool = False, verbose: bool = False
        ...
        field_tensors: Dict[str, List[torch.Tensor]] = defaultdict(list)
        if verbose:
    ...
    def print_statistics(self) -> None:
        ...
        sequence_field_lengths: Dict[str, List[int]] = defaultdict(list)
        for instance in self.instances:
