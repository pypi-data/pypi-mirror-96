...
unbound_local = ["I don't see a variable like that around here... -_-",
                 "Try again, bub. There aren't any variables with that name! >:-("]

unicode = [
    "What language is that??? =O",
    "Did you type something wrong? :s"
]
...
zero = [
    "Try a limit next time (-_-+)",
    "What is this, a Numberphile video??? -_-"
]
