...
class MsgVpnClientProfile(object):
    ...
    def reject_msg_to_sender_on_no_subscription_match_enabled(self):
        ...
        Enable or disable sending of a negative acknowledgement (NACK) on the discard of a message because of a message subscription was not found. The default value is `false`.  # noqa: E501
