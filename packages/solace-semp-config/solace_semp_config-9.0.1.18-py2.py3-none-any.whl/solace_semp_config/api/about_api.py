...
class AboutApi(object):
    ...
    def get_about_api(self, **kwargs):  # noqa: E501
        """Gets an API Description object.  # noqa: E501

        Gets an API Description object.  A SEMP client authorized with a minimum access scope/level of \"global/none\" is required to perform this operation.  This has been available since 2.2.  # noqa: E501
    ...
    def get_about_user(self, **kwargs):  # noqa: E501
        """Gets a Current User object.  # noqa: E501

        Gets a Current User object.    A SEMP client authorized with a minimum access scope/level of \"global/none\" is required to perform this operation.  This has been available since 2.2.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_about_user_msg_vpn(self, msg_vpn_name, **kwargs):  # noqa: E501
        """Gets a Current User Message VPN object.  # noqa: E501

        Gets a Current User Message VPN object.   Attribute|Identifying|Write-Only|Deprecated :---|:---:|:---:|:---: msgVpnName|x||    A SEMP client authorized with a minimum access scope/level of \"global/none\" is required to perform this operation.  This has been available since 2.2.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str msg_vpn_name: The msgVpnName of the Current User Message VPN. (required)
        :param list[str] select: Include in the response only selected attributes of the object, or exclude from the response selected attributes of the object. See [Select](#select \"Description of the syntax of the `select` parameter\").
    ...
    def get_about_user_msg_vpns(self, **kwargs):  # noqa: E501
        """Gets a list of Current User Message VPN objects.  # noqa: E501

        Gets a list of Current User Message VPN objects.   Attribute|Identifying|Write-Only|Deprecated :---|:---:|:---:|:---: msgVpnName|x||    A SEMP client authorized with a minimum access scope/level of \"global/none\" is required to perform this operation.  This has been available since 2.2.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
