...
from solace_semp_config.api.client_profile_api import ClientProfileApi  # noqa: E501
from solace_semp_config.rest import ApiException


class TestClientProfileApi(unittest.TestCase):
    """ClientProfileApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_config.api.client_profile_api.ClientProfileApi()  # noqa: E501
