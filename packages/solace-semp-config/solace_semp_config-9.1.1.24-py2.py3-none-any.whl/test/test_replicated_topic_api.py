...
from solace_semp_config.api.replicated_topic_api import ReplicatedTopicApi  # noqa: E501
from solace_semp_config.rest import ApiException


class TestReplicatedTopicApi(unittest.TestCase):
    """ReplicatedTopicApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_config.api.replicated_topic_api.ReplicatedTopicApi()  # noqa: E501
