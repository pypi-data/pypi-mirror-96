...
from solace_semp_config.api.authorization_group_api import AuthorizationGroupApi  # noqa: E501
from solace_semp_config.rest import ApiException


class TestAuthorizationGroupApi(unittest.TestCase):
    """AuthorizationGroupApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_config.api.authorization_group_api.AuthorizationGroupApi()  # noqa: E501
