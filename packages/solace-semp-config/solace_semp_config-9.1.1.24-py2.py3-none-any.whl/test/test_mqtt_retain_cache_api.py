...
from solace_semp_config.api.mqtt_retain_cache_api import MqttRetainCacheApi  # noqa: E501
from solace_semp_config.rest import ApiException


class TestMqttRetainCacheApi(unittest.TestCase):
    """MqttRetainCacheApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_config.api.mqtt_retain_cache_api.MqttRetainCacheApi()  # noqa: E501
