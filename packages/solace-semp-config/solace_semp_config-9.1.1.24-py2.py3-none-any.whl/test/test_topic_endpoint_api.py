...
from solace_semp_config.api.topic_endpoint_api import TopicEndpointApi  # noqa: E501
...
class TestTopicEndpointApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = solace_semp_config.api.topic_endpoint_api.TopicEndpointApi()  # noqa: E501
