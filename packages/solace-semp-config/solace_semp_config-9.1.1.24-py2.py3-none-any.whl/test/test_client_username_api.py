...
from solace_semp_config.api.client_username_api import ClientUsernameApi  # noqa: E501
from solace_semp_config.rest import ApiException


class TestClientUsernameApi(unittest.TestCase):
    """ClientUsernameApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_config.api.client_username_api.ClientUsernameApi()  # noqa: E501
