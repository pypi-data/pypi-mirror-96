...
from solace_semp_config.api.distributed_cache_api import DistributedCacheApi  # noqa: E501
...
class TestDistributedCacheApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = solace_semp_config.api.distributed_cache_api.DistributedCacheApi()  # noqa: E501
