...
class MsgVpnRestDeliveryPointRestConsumer(object):
    ...
    def authentication_client_cert_password(self):
        ...
        The password for the client certificate. The default value is `\"\"`. Available since 2.9.  # noqa: E501
    ...
    def authentication_http_basic_password(self):
        ...
        The password for the username. The default value is `\"\"`.  # noqa: E501
    ...
    def tls_cipher_suite_list(self):
        ...
        The colon-separated list of cipher-suites the REST Consumer uses in its encrypted connection. All supported suites are included by default, from most-secure to least-secure. The REST Consumer should choose the first suite from this list that it supports. The default value is `\"default\"`.  # noqa: E501
    ...
    def tls_enabled(self):
        ...
        Indicates whether TLS for the REST Consumer is enabled. The default value is `false`.  # noqa: E501
