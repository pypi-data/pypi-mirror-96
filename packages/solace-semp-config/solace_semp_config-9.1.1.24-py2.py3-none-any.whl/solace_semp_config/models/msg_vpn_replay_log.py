...
class MsgVpnReplayLog(object):
    ...
    def __init__(self, egress_enabled=None, ingress_enabled=None, max_spool_usage=None, msg_vpn_name=None, replay_log_name=None):  # noqa: E501
    ...
    def egress_enabled(self):
        ...
        Enable or disable the transmission of messages from the Replay Log. The default value is `false`.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the reception of messages to the Replay Log. The default value is `false`.  # noqa: E501
    ...
    def max_spool_usage(self):
        ...
        The maximum spool usage allowed by the Replay Log, in megabytes (MB). If this limit is exceeded, old messages will be trimmed. The default value is `0`.  # noqa: E501
