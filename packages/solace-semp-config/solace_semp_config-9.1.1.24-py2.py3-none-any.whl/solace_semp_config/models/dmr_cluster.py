...
class DmrCluster(object):
    ...
    def authentication_basic_password(self):
        ...
        The password used to authenticate incoming Cluster Links when using basic internal authentication. The same password is also used by outgoing Cluster Links if a per-Link password is not configured. The default is to have no `authenticationBasicPassword`.  # noqa: E501
    ...
    def authentication_client_cert_content(self):
        ...
        The PEM formatted content for the client certificate used to login to the remote node. It must consist of a private key and between one and three certificates comprising the certificate trust chain. The default value is `\"\"`.  # noqa: E501
    ...
    def authentication_client_cert_password(self):
        ...
        The password for the client certificate. The default value is `\"\"`.  # noqa: E501
    ...
    def tls_server_cert_enforce_trusted_common_name_enabled(self):
        ...
        Enable or disable the enforcing of the common-name provided by the remote broker against the list of trusted common-names configured for the Link. If enabled, the server-certificate's common-name must match one of the trusted common-names for the Link to be accepted. The default value is `true`.  # noqa: E501
    ...
    def tls_server_cert_max_chain_depth(self):
        ...
        The maximum allowed depth of a server-certificate chain. The depth of a chain is defined as the number of signing CA certificates that are present in the chain back to a trusted self-signed root CA certificate. The default value is `3`.  # noqa: E501
    ...
    def tls_server_cert_validate_date_enabled(self):
        ...
        Enable or disable the validation of the \"Not Before\" and \"Not After\" validity dates in the server-certificate. When disabled, the certificate is accepted even if the certificate is not valid based on these dates. The default value is `true`.  # noqa: E501
