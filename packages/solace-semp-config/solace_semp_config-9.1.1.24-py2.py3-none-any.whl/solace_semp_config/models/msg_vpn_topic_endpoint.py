...
class MsgVpnTopicEndpoint(object):
    ...
    def __init__(self, access_type=None, consumer_ack_propagation_enabled=None, dead_msg_queue=None, egress_enabled=None, event_bind_count_threshold=None, event_reject_low_priority_msg_limit_threshold=None, event_spool_usage_threshold=None, ingress_enabled=None, max_bind_count=None, max_delivered_unacked_msgs_per_flow=None, max_msg_size=None, max_redelivery_count=None, max_spool_usage=None, max_ttl=None, msg_vpn_name=None, owner=None, permission=None, reject_low_priority_msg_enabled=None, reject_low_priority_msg_limit=None, reject_msg_to_sender_on_discard_behavior=None, respect_msg_priority_enabled=None, respect_ttl_enabled=None, topic_endpoint_name=None):  # noqa: E501
    ...
    def access_type(self):
        ...
        The Topic Endpoint access type of either \"exclusive\" or \"non-exclusive\". The default value is `\"exclusive\"`. The allowed values and their meaning are:  <pre> \"exclusive\" - Exclusive delivery of messages to first bound client. \"non-exclusive\" - Non-exclusive delivery of messages to all bound clients. </pre>  Available since 2.4.  # noqa: E501
    ...
    def consumer_ack_propagation_enabled(self):
        ...
        Enable or disable the propagation of Consumer ACKs received on the active replication Message VPN to the standby replication Message VPN. The default value is `true`.  # noqa: E501
    ...
    def egress_enabled(self):
        ...
        Enable or disable the egress flow of messages from the Topic Endpoint. The default value is `false`.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the ingress flow of messages to the Topic Endpoint. The default value is `false`.  # noqa: E501
    ...
    def max_bind_count(self):
        ...
        The maximum number of simultaneous Consumers of the Topic Endpoint. The default value is `1`. Available since 2.4.  # noqa: E501
    ...
    def max_msg_size(self):
        ...
        The maximum message size allowed in the Topic Endpoint, in bytes. The default value is `10000000`.  # noqa: E501
    ...
    def max_redelivery_count(self):
        ...
        The maximum number of times the Topic Endpoint will attempt redelivery of a given message prior to it being discarded or moved to the DMQ. A value of 0 means to retry forever. The default value is `0`.  # noqa: E501
    ...
    def max_spool_usage(self):
        ...
        The maximum Message Spool usage by the Topic Endpoint (quota), in megabytes. Setting the value to zero enables the \"last-value-queue\" feature and disables quota checking. The default varies by platform. The default varies by platform.  # noqa: E501
    ...
    def max_ttl(self):
        ...
        The maximum number of seconds that a message can stay in the Topic Endpoint when \"respectTtlEnabled\" is \"true\". A message will expire according to the lesser of the TTL in the message (assigned by the Publisher) and the \"maxTtl\" configured on the Topic Endpoint. \"maxTtl\" is a 32-bit integer value from 1 to 4294967295 representing the expiry time in seconds. A \"maxTtl\" of \"0\" disables this feature. The default value is `0`.  # noqa: E501
    ...
    def owner(self):
        ...
        The Client Username which owns the Topic Endpoint. The default value is `\"\"`.  # noqa: E501
    ...
    def reject_low_priority_msg_enabled(self):
        ...
        Enable or disable if low priority messages are subject to \"rejectLowPriorityMsgLimit\" checking. This may only be enabled if \"rejectMsgToSenderOnDiscardBehavior\" does not have a value of \"never\". The default value is `false`.  # noqa: E501
    ...
    def reject_msg_to_sender_on_discard_behavior(self):
        ...
        The circumstances under which a negative acknowledgement (NACK) is sent to the client on discards. Note that NACKs cause the message to not be delivered to any destination and transacted-session commits to fail. This attribute may only have a value of \"never\" if \"rejectLowPriorityMsgEnabled\" is disabled. The default value is `\"never\"`. The allowed values and their meaning are:  <pre> \"always\" - Always return a negative acknowledgment (NACK) to the sending client on message discard. \"when-topic-endpoint-enabled\" - Only return a negative acknowledgment (NACK) to the sending client on message discard when the Topic Endpoint is enabled. \"never\" - Never return a negative acknowledgment (NACK) to the sending client on message discard. </pre>   # noqa: E501
    ...
    def respect_msg_priority_enabled(self):
        ...
        Enable or disable the respecting of message priority. If enabled, messages contained in the Topic Endpoint are delivered in priority order, from 9 (highest) to 0 (lowest). The default value is `false`. Available since 2.8.  # noqa: E501
    ...
    def respect_ttl_enabled(self):
        ...
        Enable or disable the respecting of the time-to-live (TTL). If enabled, messages contained in the Topic Endpoint are checked for expiry. If expired, the message is discarded or moved to the DMQ. The default value is `false`.  # noqa: E501
