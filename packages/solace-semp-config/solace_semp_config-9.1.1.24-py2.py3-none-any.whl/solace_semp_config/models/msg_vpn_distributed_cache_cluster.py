...
class MsgVpnDistributedCacheCluster(object):
    ...
    def deliver_to_one_override_enabled(self):
        ...
        Enable or disable deliver-to-one override for the Cache Cluster. The default value is `true`.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the Cache Cluster. The default value is `false`.  # noqa: E501
    ...
    def global_caching_heartbeat(self):
        ...
        The heartbeat interval, in seconds, used by the Cache Instances to monitor connectivity with the remote Home Cache Clusters. The default value is `3`.  # noqa: E501
    ...
    def global_caching_topic_lifetime(self):
        ...
        The topic lifetime, in seconds. If no client requests are received for a given global topic over the duration of the topic lifetime, then the Cache Instance will remove the subscription and cached messages for that topic. A value of 0 disables aging. The default value is `3600`.  # noqa: E501
    ...
    def max_memory(self):
        ...
        The maximum memory usage, in megabytes (MB), for each Cache Instance in the Cache Cluster. The default value is `2048`.  # noqa: E501
    ...
    def max_msgs_per_topic(self):
        ...
        The maximum number of messages per topic for each Cache Instance in the Cache Cluster. When at the maximum, old messages are removed as new messages arrive. The default value is `1`.  # noqa: E501
    ...
    def max_request_queue_depth(self):
        ...
        The maximum queue depth for cache requests received by the Cache Cluster. The default value is `100000`.  # noqa: E501
    ...
    def max_topic_count(self):
        ...
        The maximum number of topics for each Cache Instance in the Cache Cluster. The default value is `2000000`.  # noqa: E501
    ...
    def msg_lifetime(self):
        ...
        The message lifetime, in seconds. If a message remains cached for the duration of its lifetime, the Cache Instance will remove the message. A lifetime of 0 results in the message being retained indefinitely. The default is to have no `msgLifetime`.  # noqa: E501
    ...
    def new_topic_advertisement_enabled(self):
        ...
        Enable or disable the advertising, onto the message bus, of new topics learned by each Cache Instance in the Cache Cluster. The default value is `false`.  # noqa: E501
