...
class MsgVpnDmrBridge(object):
    ...
    def __init__(self, msg_vpn_name=None, remote_msg_vpn_name=None, remote_node_name=None):  # noqa: E501
    ...
    def remote_msg_vpn_name(self):
        ...
        The remote Message VPN of the DMR Bridge. The default is to have no `remoteMsgVpnName`.  # noqa: E501
