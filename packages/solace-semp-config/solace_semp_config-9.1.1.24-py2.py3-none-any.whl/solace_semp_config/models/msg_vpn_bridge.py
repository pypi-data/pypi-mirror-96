...
class MsgVpnBridge(object):
    ...
    def remote_authentication_basic_password(self):
        ...
        The password for the Client Username. The default is to have no `remoteAuthenticationBasicPassword`.  # noqa: E501
    ...
    def remote_authentication_client_cert_content(self):
        ...
        The PEM formatted content for the client certificate used by the Bridge to login to the remote Message VPN. It must consist of a private key and between one and three certificates comprising the certificate trust chain. The default value is `\"\"`. Available since 2.9.  # noqa: E501
    ...
    def remote_deliver_to_one_priority(self):
        ...
        The priority for deliver-to-one (DTO) messages transmitted from the remote Message VPN. The default value is `\"p1\"`. The allowed values and their meaning are:  <pre> \"p1\" - Priority 1 (highest). \"p2\" - Priority 2. \"p3\" - Priority 3. \"p4\" - Priority 4 (lowest). \"da\" - Deliver Always. </pre>   # noqa: E501
