...
class MsgVpnBridgeRemoteMsgVpn(object):
    ...
    def compressed_data_enabled(self):
        ...
        Enable or disable data compression for the remote Message VPN connection. The default value is `false`.  # noqa: E501
    ...
    def connect_order(self):
        ...
        The preference given to incoming connections from remote Message VPN hosts, from 1 (highest priority) to 4 (lowest priority). The default value is `4`.  # noqa: E501
    ...
    def egress_flow_window_size(self):
        ...
        The number of outstanding guaranteed messages that can be transmitted over the remote Message VPN connection before an acknowledgement is received. The default value is `255`.  # noqa: E501
    ...
    def queue_binding(self):
        ...
        The queue binding of the Bridge in the remote Message VPN. The default value is `\"\"`.  # noqa: E501
    ...
    def remote_msg_vpn_location(self):
        ...
        The location of the remote Message VPN as either an FQDN with port, IP address with port, or virtual router-name (starts with \"v:\").  # noqa: E501
    ...
    def tls_enabled(self):
        ...
        Enable or disable TLS encryption for the remote Message VPN connection. The default value is `false`.  # noqa: E501
    ...
    def unidirectional_client_profile(self):
        ...
        The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters. The default value is `\"#client-profile\"`.  # noqa: E501
