...
class MsgVpnJndiConnectionFactory(object):
    ...
    def dto_receive_subscriber_local_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer) if the messages are published on the local Router that the Subscriber is directly connected to. The default value is `1`.  # noqa: E501
    ...
    def dto_receive_subscriber_network_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer) if the messages are published on a remote Router. The default value is `1`.  # noqa: E501
    ...
    def guaranteed_receive_window_size_ack_threshold(self):
        ...
        The threshold for sending the acknowledgement (ACK) for guaranteed messages received by the Subscriber (Consumer) as a percentage of the \"guaranteedReceiveWindowSize\" value. The default value is `60`.  # noqa: E501
    ...
    def messaging_default_delivery_mode(self):
        ...
        The default delivery mode for messages sent by the Publisher (Producer). The default value is `\"persistent\"`. The allowed values and their meaning are:  <pre> \"persistent\" - Router spools messages (persists in the Message Spool) as part of the send operation. \"non-persistent\" - Router does not spool messages (does not persist in the Message Spool) as part of the send operation. </pre>   # noqa: E501
    ...
    def transport_compression_level(self):
        ...
        The ZLIB compression level for the connection to the Router. The value \"0\" means no compression, and the value \"-1\" means the compression level is specified in the JNDI Properties file. The default value is `-1`.  # noqa: E501
    ...
    def transport_connect_retry_count(self):
        ...
        The maximum number of retry attempts to establish an initial connection to the host (Router) or list of hosts (Routers). The value \"0\" means a single attempt (no retries), and the value \"-1\" means to retry forever. The default value is `0`.  # noqa: E501
    ...
    def transport_connect_retry_per_host_count(self):
        ...
        The maximum number of retry attempts to establish an initial connection to each host (Router) on the list of hosts (Routers). The value \"0\" means a single attempt (no retries), and the value \"-1\" means to retry forever. The default value is `0`.  # noqa: E501
    ...
    def transport_keepalive_enabled(self):
        ...
        Enable or disable usage of application-level keepalive messages to maintain a connection with the Router. The default value is `true`.  # noqa: E501
    ...
    def transport_port(self):
        ...
        The connection port number on the Router for SMF clients. The value \"-1\" means the port is specified in the JNDI Properties file. The default value is `-1`.  # noqa: E501
    ...
    def transport_reconnect_retry_count(self):
        ...
        The maximum number of attempts to reconnect to the host (Router) or list of hosts (Routers) after the connection has been lost. The value \"-1\" means to retry forever. The default value is `3`.  # noqa: E501
    ...
    def transport_reconnect_retry_wait(self):
        ...
        The amount of time before making another attempt to connect or reconnect to the host (Router) after the connection has been lost, in milliseconds. The default value is `3000`.  # noqa: E501
