...
class MsgVpnDistributedCacheClusterInstance(object):
    ...
    def __init__(self, auto_start_enabled=None, cache_name=None, cluster_name=None, enabled=None, instance_name=None, msg_vpn_name=None, stop_on_lost_msg_enabled=None):  # noqa: E501
    ...
    def auto_start_enabled(self):
        ...
        Enable or disable auto-start for the Cache Instance. When enabled, the Cache Instance will automatically attempt to transition from the Stopped operational state to Up whenever it restarts or reconnects to the message broker. The default value is `false`.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the Cache Instance. The default value is `false`.  # noqa: E501
    ...
    def stop_on_lost_msg_enabled(self):
        ...
        Enable or disable stop-on-lost-message for the Cache Instance. When enabled, the Cache Instance will transition to the stopped operational state upon losing a message. When stopped, it cannot accept or respond to cache requests, but continues to cache messages. The default value is `true`.  # noqa: E501
