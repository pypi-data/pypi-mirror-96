...
class MsgVpnMqttSession(object):
    ...
    def owner(self):
        ...
        The owner of the MQTT Session. For externally-created sessions this defaults to the Client Username of the connecting client. For management-created sessions this defaults to empty. Before configuring, the MQTT Session must be disabled. The default value is `\"\"`.  # noqa: E501
