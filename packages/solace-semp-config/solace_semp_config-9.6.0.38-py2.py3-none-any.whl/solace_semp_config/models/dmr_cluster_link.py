...
class DmrClusterLink(object):
    ...
    def queue_max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum number of messages delivered but not acknowledged per flow for the Queue. The default value is `1000000`.  # noqa: E501
    ...
    def transport_tls_enabled(self):
        ...
        Enable or disable encryption (TLS) on the Link. The default value is `false`.  # noqa: E501
