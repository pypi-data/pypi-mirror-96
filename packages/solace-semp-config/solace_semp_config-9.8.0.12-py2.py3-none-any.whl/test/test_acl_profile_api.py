...
from solace_semp_config.api.acl_profile_api import AclProfileApi  # noqa: E501
from solace_semp_config.rest import ApiException


class TestAclProfileApi(unittest.TestCase):
    """AclProfileApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_config.api.acl_profile_api.AclProfileApi()  # noqa: E501
