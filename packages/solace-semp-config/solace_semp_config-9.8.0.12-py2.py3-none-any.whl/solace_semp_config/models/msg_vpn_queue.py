...
class MsgVpnQueue(object):
    ...
    def __init__(self, access_type=None, consumer_ack_propagation_enabled=None, dead_msg_queue=None, delivery_count_enabled=None, egress_enabled=None, event_bind_count_threshold=None, event_msg_spool_usage_threshold=None, event_reject_low_priority_msg_limit_threshold=None, ingress_enabled=None, max_bind_count=None, max_delivered_unacked_msgs_per_flow=None, max_msg_size=None, max_msg_spool_usage=None, max_redelivery_count=None, max_ttl=None, msg_vpn_name=None, owner=None, permission=None, queue_name=None, redelivery_enabled=None, reject_low_priority_msg_enabled=None, reject_low_priority_msg_limit=None, reject_msg_to_sender_on_discard_behavior=None, respect_msg_priority_enabled=None, respect_ttl_enabled=None):  # noqa: E501
    ...
    def max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum number of messages delivered but not acknowledged per flow for the Queue. The default value is `10000`.  # noqa: E501
    ...
    def max_msg_spool_usage(self):
        ...
        The maximum message spool usage allowed by the Queue, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default value is `4000`.  # noqa: E501
