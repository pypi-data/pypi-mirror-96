...
class MsgVpnRestDeliveryPoint(object):
    ...
    def __init__(self, client_profile_name=None, enabled=None, msg_vpn_name=None, rest_delivery_point_name=None, service=None, vendor=None):  # noqa: E501
    ...
    def client_profile_name(self):
        ...
        The Client Profile of the REST Delivery Point. It must exist in the local Message VPN. Its TCP parameters are used for all REST Consumers in this RDP. Its queue properties are used by the RDP client. The Client Profile is used inside the auto-generated Client Username for this RDP. The default value is `\"default\"`.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the REST Delivery Point. When disabled, no connections are initiated or messages delivered to any of the contained REST Consumers. The default value is `false`.  # noqa: E501
    ...
    @property
    def service(self):
        """Gets the service of this MsgVpnRestDeliveryPoint.  # noqa: E501

        The name of the service that this REST Delivery Point connects to. Internally the broker does not use this value; it is informational only. The default value is `\"\"`. Available since 2.19.  # noqa: E501

        :return: The service of this MsgVpnRestDeliveryPoint.  # noqa: E501
        :rtype: str
        """
    ...
    def service(self, service):
        """Sets the service of this MsgVpnRestDeliveryPoint.

        The name of the service that this REST Delivery Point connects to. Internally the broker does not use this value; it is informational only. The default value is `\"\"`. Available since 2.19.  # noqa: E501

        :param service: The service of this MsgVpnRestDeliveryPoint.  # noqa: E501
        :type: str
        """
    ...
    @property
    def vendor(self):
        """Gets the vendor of this MsgVpnRestDeliveryPoint.  # noqa: E501

        The name of the vendor that this REST Delivery Point connects to. Internally the broker does not use this value; it is informational only. The default value is `\"\"`. Available since 2.19.  # noqa: E501

        :return: The vendor of this MsgVpnRestDeliveryPoint.  # noqa: E501
        :rtype: str
        """
        return self._vendor
    ...
    def vendor(self, vendor):
        """Sets the vendor of this MsgVpnRestDeliveryPoint.

        The name of the vendor that this REST Delivery Point connects to. Internally the broker does not use this value; it is informational only. The default value is `\"\"`. Available since 2.19.  # noqa: E501

        :param vendor: The vendor of this MsgVpnRestDeliveryPoint.  # noqa: E501
        :type: str
        """
