...
class MsgVpnTopicEndpoint(object):
    ...
    def __init__(self, access_type=None, consumer_ack_propagation_enabled=None, dead_msg_queue=None, delivery_count_enabled=None, egress_enabled=None, event_bind_count_threshold=None, event_reject_low_priority_msg_limit_threshold=None, event_spool_usage_threshold=None, ingress_enabled=None, max_bind_count=None, max_delivered_unacked_msgs_per_flow=None, max_msg_size=None, max_redelivery_count=None, max_spool_usage=None, max_ttl=None, msg_vpn_name=None, owner=None, permission=None, redelivery_enabled=None, reject_low_priority_msg_enabled=None, reject_low_priority_msg_limit=None, reject_msg_to_sender_on_discard_behavior=None, respect_msg_priority_enabled=None, respect_ttl_enabled=None, topic_endpoint_name=None):  # noqa: E501
    ...
    def dead_msg_queue(self):
        ...
        The name of the Dead Message Queue (DMQ) used by the Topic Endpoint. The default value is `\"#DEAD_MSG_QUEUE\"`.  # noqa: E501
    ...
    def delivery_count_enabled(self):
        """Gets the delivery_count_enabled of this MsgVpnTopicEndpoint.  # noqa: E501

        Enable or disable the ability for client applications to query the message delivery count of messages received from the Topic Endpoint. This is a controlled availability feature. Please contact Solace to find out if this feature is supported for your use case. The default value is `false`. Available since 2.19.  # noqa: E501

        :return: The delivery_count_enabled of this MsgVpnTopicEndpoint.  # noqa: E501
        :rtype: bool
        """
    ...
    def delivery_count_enabled(self, delivery_count_enabled):
        """Sets the delivery_count_enabled of this MsgVpnTopicEndpoint.

        Enable or disable the ability for client applications to query the message delivery count of messages received from the Topic Endpoint. This is a controlled availability feature. Please contact Solace to find out if this feature is supported for your use case. The default value is `false`. Available since 2.19.  # noqa: E501

        :param delivery_count_enabled: The delivery_count_enabled of this MsgVpnTopicEndpoint.  # noqa: E501
        :type: bool
        """
    ...
    def egress_enabled(self):
        ...
        Enable or disable the transmission of messages from the Topic Endpoint. The default value is `false`.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the reception of messages to the Topic Endpoint. The default value is `false`.  # noqa: E501
    ...
    def max_bind_count(self):
        ...
        The maximum number of consumer flows that can bind to the Topic Endpoint. The default value is `1`.  # noqa: E501
    ...
    def max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum number of messages delivered but not acknowledged per flow for the Topic Endpoint. The default value is `10000`.  # noqa: E501
    ...
    def max_msg_size(self):
        ...
        The maximum message size allowed in the Topic Endpoint, in bytes (B). The default value is `10000000`.  # noqa: E501
    ...
    def max_redelivery_count(self):
        ...
        The maximum number of times the Topic Endpoint will attempt redelivery of a message prior to it being discarded or moved to the DMQ. A value of 0 means to retry forever. The default value is `0`.  # noqa: E501
    ...
    def max_spool_usage(self):
        ...
        The maximum message spool usage allowed by the Topic Endpoint, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default value is `4000`.  # noqa: E501
    ...
    def owner(self):
        ...
        The Client Username that owns the Topic Endpoint and has permission equivalent to `\"delete\"`. The default value is `\"\"`.  # noqa: E501
    ...
    def redelivery_enabled(self):
        """Gets the redelivery_enabled of this MsgVpnTopicEndpoint.  # noqa: E501
        ...
        :return: The redelivery_enabled of this MsgVpnTopicEndpoint.  # noqa: E501
        :rtype: bool
        """
    ...
    def redelivery_enabled(self, redelivery_enabled):
        """Sets the redelivery_enabled of this MsgVpnTopicEndpoint.

        Enable or disable message redelivery. When enabled, the number of redelivery attempts is controlled by maxRedeliveryCount. When disabled, the message will never be delivered from the topic-endpoint more than once. The default value is `true`. Available since 2.18.  # noqa: E501

        :param redelivery_enabled: The redelivery_enabled of this MsgVpnTopicEndpoint.  # noqa: E501
        :type: bool
        """
    ...
    def reject_low_priority_msg_limit(self):
        ...
        The number of messages of any priority in the Topic Endpoint above which low priority messages are not admitted but higher priority messages are allowed. The default value is `0`.  # noqa: E501
    ...
    def respect_msg_priority_enabled(self):
        ...
        Enable or disable the respecting of message priority. When enabled, messages contained in the Topic Endpoint are delivered in priority order, from 9 (highest) to 0 (lowest). The default value is `false`. Available since 2.8.  # noqa: E501
    ...
    def respect_ttl_enabled(self):
        ...
        Enable or disable the respecting of the time-to-live (TTL) for messages in the Topic Endpoint. When enabled, expired messages are discarded or moved to the DMQ. The default value is `false`.  # noqa: E501
