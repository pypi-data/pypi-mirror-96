...
class CertAuthority(object):
    ...
    def cert_content(self):
        ...
        The PEM formatted content for the trusted root certificate of a Certificate Authority. The default value is `\"\"`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.  # noqa: E501
    ...
    def crl_url(self):
        ...
        The URL for the CRL source. This is a required attribute for CRL to be operational and the URL must be complete with http:// included. The default value is `\"\"`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.  # noqa: E501
    ...
    def ocsp_override_url(self):
        ...
        The OCSP responder URL to use for overriding the one supplied in the client certificate. The URL must be complete with http:// included. The default value is `\"\"`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.  # noqa: E501
    ...
    def ocsp_timeout(self):
        ...
        The timeout in seconds to receive a response from the OCSP responder after sending a request or making the initial connection attempt. The default value is `5`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.  # noqa: E501
    ...
    def revocation_check_enabled(self):
        ...
        Enable or disable Certificate Authority revocation checking. The default value is `false`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.  # noqa: E501
