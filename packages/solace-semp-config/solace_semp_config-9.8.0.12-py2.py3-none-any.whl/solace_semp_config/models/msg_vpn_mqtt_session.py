...
class MsgVpnMqttSession(object):
    ...
    def queue_max_msg_spool_usage(self):
        ...
        The maximum message spool usage allowed by the MQTT Session Queue, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default value is `4000`. Available since 2.14.  # noqa: E501
