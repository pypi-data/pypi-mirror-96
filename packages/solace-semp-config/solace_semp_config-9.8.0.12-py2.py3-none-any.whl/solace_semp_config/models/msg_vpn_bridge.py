...
class MsgVpnBridge(object):
    ...
    def remote_connection_retry_delay(self):
        ...
        The number of seconds the broker waits for the bridge connection to be established before attempting a new connection. The default value is `3`.  # noqa: E501
