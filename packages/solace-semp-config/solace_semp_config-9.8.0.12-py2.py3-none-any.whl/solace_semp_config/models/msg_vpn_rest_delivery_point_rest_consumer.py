...
class MsgVpnRestDeliveryPointRestConsumer(object):
    ...
    swagger_types = {
        ...
        'authentication_http_header_value': 'str',
        'authentication_oauth_client_id': 'str',
        'authentication_oauth_client_scope': 'str',
        'authentication_oauth_client_secret': 'str',
    ...
    attribute_map = {
        ...
        'authentication_http_header_value': 'authenticationHttpHeaderValue',
        ...
        'authentication_oauth_client_secret': 'authenticationOauthClientSecret',
    ...
    def __init__(self, authentication_client_cert_content=None, authentication_client_cert_password=None, authentication_http_basic_password=None, authentication_http_basic_username=None, authentication_http_header_name=None, authentication_http_header_value=None, authentication_oauth_client_id=None, authentication_oauth_client_scope=None, authentication_oauth_client_secret=None, authentication_oauth_client_token_endpoint=None, authentication_scheme=None, enabled=None, http_method=None, local_interface=None, max_post_wait_time=None, msg_vpn_name=None, outgoing_connection_count=None, remote_host=None, remote_port=None, rest_consumer_name=None, rest_delivery_point_name=None, retry_delay=None, tls_cipher_suite_list=None, tls_enabled=None):  # noqa: E501
        ...
        if authentication_http_basic_password is not None:
            self.authentication_http_basic_password = authentication_http_basic_password
        ...
        if authentication_http_header_value is not None:
            self.authentication_http_header_value = authentication_http_header_value
        ...
        if authentication_oauth_client_secret is not None:
            self.authentication_oauth_client_secret = authentication_oauth_client_secret
    ...
    def authentication_client_cert_content(self):
        """Gets the authentication_client_cert_content of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        ...
        :return: The authentication_client_cert_content of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :rtype: str
        """
    ...
    def authentication_client_cert_content(self, authentication_client_cert_content):
        """Sets the authentication_client_cert_content of this MsgVpnRestDeliveryPointRestConsumer.

        The PEM formatted content for the client certificate that the REST Consumer will present to the REST host. It must consist of a private key and between one and three certificates comprising the certificate trust chain. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Changing this attribute requires an HTTPS connection. The default value is `\"\"`. Available since 2.9.  # noqa: E501

        :param authentication_client_cert_content: The authentication_client_cert_content of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :type: str
        """
    ...
    def authentication_client_cert_password(self):
        """Gets the authentication_client_cert_password of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        ...
        :return: The authentication_client_cert_password of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :rtype: str
        """
    ...
    def authentication_client_cert_password(self, authentication_client_cert_password):
        """Sets the authentication_client_cert_password of this MsgVpnRestDeliveryPointRestConsumer.

        The password for the client certificate. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Changing this attribute requires an HTTPS connection. The default value is `\"\"`. Available since 2.9.  # noqa: E501

        :param authentication_client_cert_password: The authentication_client_cert_password of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :type: str
        """
    ...
    def authentication_http_basic_password(self):
        """Gets the authentication_http_basic_password of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501

        The password for the username. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The default value is `\"\"`.  # noqa: E501

        :return: The authentication_http_basic_password of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :rtype: str
        """
    ...
    def authentication_http_basic_password(self, authentication_http_basic_password):
        ...
        :param authentication_http_basic_password: The authentication_http_basic_password of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :type: str
        """
    ...
    def authentication_http_basic_username(self):
        ...
        The username that the REST Consumer will use to login to the REST host. Normally a username is only configured when basic authentication is selected for the REST Consumer. The default value is `\"\"`.  # noqa: E501
    ...
    def authentication_http_header_name(self):
        ...
        The authentication header name. The default value is `\"\"`. Available since 2.15.  # noqa: E501
    ...
    @property
    def authentication_http_header_value(self):
        """Gets the authentication_http_header_value of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501

        The authentication header value. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The default value is `\"\"`. Available since 2.15.  # noqa: E501

        :return: The authentication_http_header_value of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :rtype: str
        """
        return self._authentication_http_header_value

    @authentication_http_header_value.setter
    def authentication_http_header_value(self, authentication_http_header_value):
        """Sets the authentication_http_header_value of this MsgVpnRestDeliveryPointRestConsumer.

        The authentication header value. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The default value is `\"\"`. Available since 2.15.  # noqa: E501

        :param authentication_http_header_value: The authentication_http_header_value of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :type: str
        """

        self._authentication_http_header_value = authentication_http_header_value
    ...
    def authentication_oauth_client_id(self):
        ...
        The OAuth client ID. The default value is `\"\"`. Available since 2.19.  # noqa: E501
    ...
    def authentication_oauth_client_scope(self):
        ...
        The OAuth scope. The default value is `\"\"`. Available since 2.19.  # noqa: E501
    ...
    @property
    def authentication_oauth_client_secret(self):
        """Gets the authentication_oauth_client_secret of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501

        The OAuth client secret. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The default value is `\"\"`. Available since 2.19.  # noqa: E501

        :return: The authentication_oauth_client_secret of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :rtype: str
        """
        return self._authentication_oauth_client_secret

    @authentication_oauth_client_secret.setter
    def authentication_oauth_client_secret(self, authentication_oauth_client_secret):
        """Sets the authentication_oauth_client_secret of this MsgVpnRestDeliveryPointRestConsumer.

        The OAuth client secret. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The default value is `\"\"`. Available since 2.19.  # noqa: E501

        :param authentication_oauth_client_secret: The authentication_oauth_client_secret of this MsgVpnRestDeliveryPointRestConsumer.  # noqa: E501
        :type: str
        """

        self._authentication_oauth_client_secret = authentication_oauth_client_secret
    ...
    def authentication_oauth_client_token_endpoint(self):
        ...
        The OAuth token endpoint URL that the REST Consumer will use to request a token for login to the REST host. Must begin with \"https\". The default value is `\"\"`. Available since 2.19.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the REST Consumer. When disabled, no connections are initiated or messages delivered to this particular REST Consumer. The default value is `false`.  # noqa: E501
    ...
    def http_method(self):
        ...
        The HTTP method to use (POST or PUT). This is used only when operating in the REST service \"messaging\" mode and is ignored in \"gateway\" mode. The default value is `\"post\"`. The allowed values and their meaning are:  <pre> \"post\" - Use the POST HTTP method. \"put\" - Use the PUT HTTP method. </pre>  Available since 2.17.  # noqa: E501
    ...
    def local_interface(self):
        ...
        The interface that will be used for all outgoing connections associated with the REST Consumer. When unspecified, an interface is automatically chosen. The default value is `\"\"`.  # noqa: E501
    ...
    def max_post_wait_time(self):
        ...
        The maximum amount of time (in seconds) to wait for an HTTP POST response from the REST Consumer. Once this time is exceeded, the TCP connection is reset. The default value is `30`.  # noqa: E501
    ...
    def outgoing_connection_count(self):
        ...
        The number of concurrent TCP connections open to the REST Consumer. The default value is `3`.  # noqa: E501
    ...
    def remote_host(self):
        ...
        The IP address or DNS name to which the broker is to connect to deliver messages for the REST Consumer. A host value must be configured for the REST Consumer to be operationally up. The default value is `\"\"`.  # noqa: E501
    ...
    def remote_port(self):
        ...
        The port associated with the host of the REST Consumer. The default value is `8080`.  # noqa: E501
    ...
    def retry_delay(self):
        ...
        The number of seconds that must pass before retrying the remote REST Consumer connection. The default value is `3`.  # noqa: E501
    ...
    def tls_enabled(self):
        ...
        Enable or disable encryption (TLS) for the REST Consumer. The default value is `false`.  # noqa: E501
