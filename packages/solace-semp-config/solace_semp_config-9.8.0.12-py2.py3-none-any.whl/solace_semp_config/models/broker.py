...
class Broker(object):
    ...
    swagger_types = {
        ...
        'guaranteed_msging_disk_array_wwn': 'str',
        'guaranteed_msging_disk_location': 'str',
        ...
        'guaranteed_msging_virtual_router_when_active_active': 'str',
        ...
        'tls_standard_domain_certificate_authorities_enabled': 'bool',
        'tls_ticket_lifetime': 'int'
    }

    attribute_map = {
        'auth_client_cert_revocation_check_mode': 'authClientCertRevocationCheckMode',
        'guaranteed_msging_disk_array_wwn': 'guaranteedMsgingDiskArrayWwn',
        'guaranteed_msging_disk_location': 'guaranteedMsgingDiskLocation',
        ...
        'guaranteed_msging_virtual_router_when_active_active': 'guaranteedMsgingVirtualRouterWhenActiveActive',
    ...
    def __init__(self, auth_client_cert_revocation_check_mode=None, guaranteed_msging_disk_array_wwn=None, guaranteed_msging_disk_location=None, guaranteed_msging_enabled=None, guaranteed_msging_event_cache_usage_threshold=None, guaranteed_msging_event_delivered_unacked_threshold=None, guaranteed_msging_event_disk_usage_threshold=None, guaranteed_msging_event_egress_flow_count_threshold=None, guaranteed_msging_event_endpoint_count_threshold=None, guaranteed_msging_event_ingress_flow_count_threshold=None, guaranteed_msging_event_msg_count_threshold=None, guaranteed_msging_event_msg_spool_file_count_threshold=None, guaranteed_msging_event_msg_spool_usage_threshold=None, guaranteed_msging_event_transacted_session_count_threshold=None, guaranteed_msging_event_transacted_session_resource_count_threshold=None, guaranteed_msging_event_transaction_count_threshold=None, guaranteed_msging_max_cache_usage=None, guaranteed_msging_max_msg_spool_usage=None, guaranteed_msging_transaction_replication_compatibility_mode=None, guaranteed_msging_virtual_router_when_active_active=None, service_amqp_enabled=None, service_amqp_tls_listen_port=None, service_event_connection_count_threshold=None, service_health_check_enabled=None, service_health_check_listen_port=None, service_mqtt_enabled=None, service_msg_backbone_enabled=None, service_rest_event_outgoing_connection_count_threshold=None, service_rest_incoming_enabled=None, service_rest_outgoing_enabled=None, service_semp_legacy_timeout_enabled=None, service_semp_plain_text_enabled=None, service_semp_plain_text_listen_port=None, service_semp_tls_enabled=None, service_semp_tls_listen_port=None, service_smf_compression_listen_port=None, service_smf_enabled=None, service_smf_event_connection_count_threshold=None, service_smf_plain_text_listen_port=None, service_smf_routing_control_listen_port=None, service_smf_tls_listen_port=None, service_tls_event_connection_count_threshold=None, service_web_transport_enabled=None, service_web_transport_plain_text_listen_port=None, service_web_transport_tls_listen_port=None, service_web_transport_web_url_suffix=None, tls_block_version10_enabled=None, tls_block_version11_enabled=None, tls_cipher_suite_management_list=None, tls_cipher_suite_msg_backbone_list=None, tls_cipher_suite_secure_shell_list=None, tls_crime_exploit_protection_enabled=None, tls_server_cert_content=None, tls_server_cert_password=None, tls_standard_domain_certificate_authorities_enabled=None, tls_ticket_lifetime=None):  # noqa: E501
        ...
        self._guaranteed_msging_virtual_router_when_active_active = None
        ...
        self._tls_standard_domain_certificate_authorities_enabled = None
        ...
        if guaranteed_msging_disk_array_wwn is not None:
            self.guaranteed_msging_disk_array_wwn = guaranteed_msging_disk_array_wwn
        if guaranteed_msging_disk_location is not None:
            self.guaranteed_msging_disk_location = guaranteed_msging_disk_location
        ...
        if guaranteed_msging_virtual_router_when_active_active is not None:
            self.guaranteed_msging_virtual_router_when_active_active = guaranteed_msging_virtual_router_when_active_active
        ...
        if tls_standard_domain_certificate_authorities_enabled is not None:
            self.tls_standard_domain_certificate_authorities_enabled = tls_standard_domain_certificate_authorities_enabled
    ...
    @property
    def guaranteed_msging_disk_array_wwn(self):
        """Gets the guaranteed_msging_disk_array_wwn of this Broker.  # noqa: E501

        The WWN number to use when accessing a LUN on an external disk array. The default value is `\"\"`. Available since 2.18.  # noqa: E501

        :return: The guaranteed_msging_disk_array_wwn of this Broker.  # noqa: E501
        :rtype: str
        """
        return self._guaranteed_msging_disk_array_wwn

    @guaranteed_msging_disk_array_wwn.setter
    def guaranteed_msging_disk_array_wwn(self, guaranteed_msging_disk_array_wwn):
        """Sets the guaranteed_msging_disk_array_wwn of this Broker.

        The WWN number to use when accessing a LUN on an external disk array. The default value is `\"\"`. Available since 2.18.  # noqa: E501

        :param guaranteed_msging_disk_array_wwn: The guaranteed_msging_disk_array_wwn of this Broker.  # noqa: E501
        :type: str
        """

        self._guaranteed_msging_disk_array_wwn = guaranteed_msging_disk_array_wwn

    @property
    def guaranteed_msging_disk_location(self):
        """Gets the guaranteed_msging_disk_location of this Broker.  # noqa: E501

        The disk location for the the guaranteed message spool (required for high availability with guaranteed messaging). When external is chosen the guaranteed message spool is stored on an external disk array attached to the router. If internal storage is currently used, changing to external causes message spooling on the router to stop and messages spooled on the internal storage to be deleted. If internal is chosen the guaranteed message spool is stored on an external disk array attached to the router. If internal storage is currently used, changing to external causes message spooling on the router to stop and messages spooled on the internal storage to be deleted. The default value is `\"external\"`. The allowed values and their meaning are:  <pre> \"external\" - The guaranteed message spool is stored on an external disk array attached to the appliance. \"internal\" - The guaranteed message spool is stored internally on the appliance. </pre>  Available since 2.18.  # noqa: E501

        :return: The guaranteed_msging_disk_location of this Broker.  # noqa: E501
        :rtype: str
        """
        return self._guaranteed_msging_disk_location

    @guaranteed_msging_disk_location.setter
    def guaranteed_msging_disk_location(self, guaranteed_msging_disk_location):
        """Sets the guaranteed_msging_disk_location of this Broker.

        The disk location for the the guaranteed message spool (required for high availability with guaranteed messaging). When external is chosen the guaranteed message spool is stored on an external disk array attached to the router. If internal storage is currently used, changing to external causes message spooling on the router to stop and messages spooled on the internal storage to be deleted. If internal is chosen the guaranteed message spool is stored on an external disk array attached to the router. If internal storage is currently used, changing to external causes message spooling on the router to stop and messages spooled on the internal storage to be deleted. The default value is `\"external\"`. The allowed values and their meaning are:  <pre> \"external\" - The guaranteed message spool is stored on an external disk array attached to the appliance. \"internal\" - The guaranteed message spool is stored internally on the appliance. </pre>  Available since 2.18.  # noqa: E501

        :param guaranteed_msging_disk_location: The guaranteed_msging_disk_location of this Broker.  # noqa: E501
        :type: str
        """
        allowed_values = ["external", "internal"]  # noqa: E501
        if guaranteed_msging_disk_location not in allowed_values:
            raise ValueError(
                "Invalid value for `guaranteed_msging_disk_location` ({0}), must be one of {1}"  # noqa: E501
                .format(guaranteed_msging_disk_location, allowed_values)
            )

        self._guaranteed_msging_disk_location = guaranteed_msging_disk_location
    ...
    @property
    def guaranteed_msging_virtual_router_when_active_active(self):
        """Gets the guaranteed_msging_virtual_router_when_active_active of this Broker.  # noqa: E501

        The High Availability role for this broker if using the legacy Active/Active configuration for high availability (not recommended). Note: for Active/Standby high availability configuration, this setting is ignored. The default value is `\"primary\"`. The allowed values and their meaning are:  <pre> \"primary\" - The primary virtual router. \"backup\" - The backup virtual router. </pre>  Available since 2.18.  # noqa: E501

        :return: The guaranteed_msging_virtual_router_when_active_active of this Broker.  # noqa: E501
        :rtype: str
        """
        return self._guaranteed_msging_virtual_router_when_active_active

    @guaranteed_msging_virtual_router_when_active_active.setter
    def guaranteed_msging_virtual_router_when_active_active(self, guaranteed_msging_virtual_router_when_active_active):
        """Sets the guaranteed_msging_virtual_router_when_active_active of this Broker.

        The High Availability role for this broker if using the legacy Active/Active configuration for high availability (not recommended). Note: for Active/Standby high availability configuration, this setting is ignored. The default value is `\"primary\"`. The allowed values and their meaning are:  <pre> \"primary\" - The primary virtual router. \"backup\" - The backup virtual router. </pre>  Available since 2.18.  # noqa: E501

        :param guaranteed_msging_virtual_router_when_active_active: The guaranteed_msging_virtual_router_when_active_active of this Broker.  # noqa: E501
        :type: str
        """
        allowed_values = ["primary", "backup"]  # noqa: E501
        if guaranteed_msging_virtual_router_when_active_active not in allowed_values:
            raise ValueError(
                "Invalid value for `guaranteed_msging_virtual_router_when_active_active` ({0}), must be one of {1}"  # noqa: E501
                .format(guaranteed_msging_virtual_router_when_active_active, allowed_values)
            )

        self._guaranteed_msging_virtual_router_when_active_active = guaranteed_msging_virtual_router_when_active_active
    ...
    def service_web_transport_plain_text_listen_port(self):
        ...
        The TCP port for plain-text WEB client connections. The default value is `80`. Available since 2.17.  # noqa: E501
    ...
    def service_web_transport_tls_listen_port(self):
        ...
        The TCP port for TLS WEB client connections. The default value is `443`. Available since 2.17.  # noqa: E501
    ...
    @property
    def tls_standard_domain_certificate_authorities_enabled(self):
        """Gets the tls_standard_domain_certificate_authorities_enabled of this Broker.  # noqa: E501

        Enable or disable the standard domain certificate authority list. The default value is `true`. Available since 2.19.  # noqa: E501

        :return: The tls_standard_domain_certificate_authorities_enabled of this Broker.  # noqa: E501
        :rtype: bool
        """
        return self._tls_standard_domain_certificate_authorities_enabled

    @tls_standard_domain_certificate_authorities_enabled.setter
    def tls_standard_domain_certificate_authorities_enabled(self, tls_standard_domain_certificate_authorities_enabled):
        """Sets the tls_standard_domain_certificate_authorities_enabled of this Broker.

        Enable or disable the standard domain certificate authority list. The default value is `true`. Available since 2.19.  # noqa: E501

        :param tls_standard_domain_certificate_authorities_enabled: The tls_standard_domain_certificate_authorities_enabled of this Broker.  # noqa: E501
        :type: bool
        """

        self._tls_standard_domain_certificate_authorities_enabled = tls_standard_domain_certificate_authorities_enabled
