...
class MsgVpnJndiConnectionFactory(object):
    ...
    def allow_duplicate_client_id_enabled(self):
        ...
        Enable or disable whether new JMS connections can use the same Client identifier (ID) as an existing connection. The default value is `false`.  # noqa: E501
    ...
    def guaranteed_receive_reconnect_retry_count(self):
        ...
        The maximum number of attempts to reconnect to the host or list of hosts after the guaranteed  messaging connection has been lost. The value \"-1\" means to retry forever. The default value is `-1`. Available since 2.14.  # noqa: E501
    ...
    def guaranteed_receive_reconnect_retry_wait(self):
        ...
        The amount of time to wait before making another attempt to connect or reconnect to the host after the guaranteed messaging connection has been lost, in milliseconds. The default value is `3000`. Available since 2.14.  # noqa: E501
