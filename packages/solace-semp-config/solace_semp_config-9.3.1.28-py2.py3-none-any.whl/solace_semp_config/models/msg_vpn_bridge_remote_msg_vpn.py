...
class MsgVpnBridgeRemoteMsgVpn(object):
    ...
    def tls_enabled(self):
        ...
        Enable or disable encryption (TLS) for the remote Message VPN connection. The default value is `false`.  # noqa: E501
    ...
    def unidirectional_client_profile(self):
        ...
        The Client Profile for the unidirectional Bridge of the remote Message VPN. The Client Profile must exist in the local Message VPN, and it is used only for the TCP parameters. Note that the default client profile has a TCP maximum window size of 2MB. The default value is `\"#client-profile\"`.  # noqa: E501
