...
class MsgVpnTopicEndpoint(object):
    ...
    def max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum number of messages delivered but not acknowledged per flow for the Topic Endpoint. The default is the maximum value supported by the platform.  # noqa: E501
    ...
    def max_spool_usage(self):
        ...
        The maximum message spool usage allowed by the Topic Endpoint, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default varies by platform.  # noqa: E501
