...
class MsgVpnTopicEndpoint(object):
    ...
    def dead_msg_queue(self):
        ...
        The name of the Dead Message Queue (DMQ) used by the Topic Endpoint. The default value is `\"#DEAD_MSG_QUEUE\"`. Available since 2.2.  # noqa: E501
    ...
    def max_bind_count(self):
        ...
        The maximum number of consumer flows that can bind to the Topic Endpoint. The default value is `1`. Available since 2.4.  # noqa: E501
    ...
    def max_spool_usage(self):
        ...
        The maximum message spool usage allowed by the Topic Endpoint, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default value is `1500`.  # noqa: E501
