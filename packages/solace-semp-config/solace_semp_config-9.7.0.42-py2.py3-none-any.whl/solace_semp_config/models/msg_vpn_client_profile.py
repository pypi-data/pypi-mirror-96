...
class MsgVpnClientProfile(object):
    ...
    def max_egress_flow_count(self):
        ...
        The maximum number of transmit flows that can be created by one client using the Client Profile. The default value is `1000`.  # noqa: E501
    ...
    def max_endpoint_count_per_client_username(self):
        ...
        The maximum number of queues and topic endpoints that can be created by clients with the same Client Username using the Client Profile. The default value is `1000`.  # noqa: E501
    ...
    def max_ingress_flow_count(self):
        ...
        The maximum number of receive flows that can be created by one client using the Client Profile. The default value is `1000`.  # noqa: E501
    ...
    def reject_msg_to_sender_on_no_subscription_match_enabled(self):
        ...
        Enable or disable the sending of a negative acknowledgement (NACK) to a client using the Client Profile when discarding a guaranteed message due to no matching subscription found. The default value is `false`. Available since 2.2.  # noqa: E501
