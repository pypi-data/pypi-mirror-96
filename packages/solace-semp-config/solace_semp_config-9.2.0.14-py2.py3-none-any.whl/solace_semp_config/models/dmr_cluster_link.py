...
class DmrClusterLink(object):
    ...
    def authentication_basic_password(self):
        """Gets the authentication_basic_password of this DmrClusterLink.  # noqa: E501

        The password used to authenticate with the remote node when using basic internal authentication. If this per-Link password is not configured, the Cluster's password is used instead. The default is to have no `authenticationBasicPassword`.  # noqa: E501

        :return: The authentication_basic_password of this DmrClusterLink.  # noqa: E501
        :rtype: str
        """
    ...
    def authentication_basic_password(self, authentication_basic_password):
        """Sets the authentication_basic_password of this DmrClusterLink.

        The password used to authenticate with the remote node when using basic internal authentication. If this per-Link password is not configured, the Cluster's password is used instead. The default is to have no `authenticationBasicPassword`.  # noqa: E501

        :param authentication_basic_password: The authentication_basic_password of this DmrClusterLink.  # noqa: E501
        :type: str
        """
    ...
    def authentication_scheme(self):
        ...
        The authentication scheme to be used by the Link which initiates connections to the remote node. The default value is `\"basic\"`. The allowed values and their meaning are:  <pre> \"basic\" - Basic Authentication Scheme (via username and password). \"client-certificate\" - Client Certificate Authentication Scheme (via certificate file or content). </pre>   # noqa: E501
    ...
    def client_profile_queue_control1_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Control 1\" (C-1) priority queue, regardless of the `clientProfileQueueControl1MaxDepth` value. The default value is `4`.  # noqa: E501
    ...
    def client_profile_queue_direct1_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Direct 1\" (D-1) priority queue, regardless of the `clientProfileQueueDirect1MaxDepth` value. The default value is `4`.  # noqa: E501
    ...
    def client_profile_queue_direct2_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Direct 2\" (D-2) priority queue, regardless of the `clientProfileQueueDirect2MaxDepth` value. The default value is `4`.  # noqa: E501
    ...
    def client_profile_queue_direct3_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Direct 3\" (D-3) priority queue, regardless of the `clientProfileQueueDirect3MaxDepth` value. The default value is `4`.  # noqa: E501
    ...
    def client_profile_queue_guaranteed1_min_msg_burst(self):
        ...
        The number of messages that are always allowed entry into the \"Guaranteed 1\" (G-3) priority queue, regardless of the `clientProfileQueueGuaranteed1MaxDepth` value. The default value is `255`.  # noqa: E501
    ...
    def client_profile_tcp_congestion_window_size(self):
        ...
        The TCP initial congestion window size, in multiples of the TCP Maximum Segment Size (MSS). Changing the value from its default of 2 results in non-compliance with RFC 2581. Contact Solace Support before changing this value. The default value is `2`.  # noqa: E501
    ...
    def client_profile_tcp_keepalive_count(self):
        ...
        The number of TCP keepalive retransmissions to be carried out before declaring that the remote end is not available. The default value is `5`.  # noqa: E501
    ...
    def client_profile_tcp_keepalive_idle_time(self):
        ...
        The amount of time a connection must remain idle before TCP begins sending keepalive probes, in seconds. The default value is `3`.  # noqa: E501
    ...
    def client_profile_tcp_keepalive_interval(self):
        ...
        The amount of time between TCP keepalive retransmissions when no acknowledgement is received, in seconds. The default value is `1`.  # noqa: E501
    ...
    def client_profile_tcp_max_segment_size(self):
        ...
        The TCP maximum segment size, in kilobytes. Changes are applied to all existing connections. The default value is `1460`.  # noqa: E501
    ...
    def client_profile_tcp_max_window_size(self):
        ...
        The TCP maximum window size, in kilobytes. Changes are applied to all existing connections. The default value is `256`.  # noqa: E501
    ...
    def egress_flow_window_size(self):
        ...
        The number of outstanding guaranteed messages that can be sent over the Link before acknowledgement is received by the sender. The default value is `255`.  # noqa: E501
    ...
    def initiator(self):
        ...
        The initiator of the Link's TCP connections. The default value is `\"lexical\"`. The allowed values and their meaning are:  <pre> \"lexical\" - The \"higher\" node-name initiates. \"local\" - The local node initiates. \"remote\" - The remote node initiates. </pre>   # noqa: E501
    ...
    def queue_dead_msg_queue(self):
        ...
        The name of the Dead Message Queue (DMQ) used by the Queue for discarded messages. The default value is `\"#DEAD_MSG_QUEUE\"`.  # noqa: E501
    ...
    def queue_max_msg_spool_usage(self):
        ...
        The maximum message spool usage by the Queue (quota), in megabytes (MB). The default varies by platform.  # noqa: E501
    ...
    def queue_max_ttl(self):
        ...
        The maximum time in seconds a message can stay in the Queue when `queueRespectTtlEnabled` is `true`. A message expires when the lesser of the sender assigned time-to-live (TTL) in the message and the `queueMaxTtl` configured for the Queue, is exceeded. A value of 0 disables expiry. The default value is `0`.  # noqa: E501
    ...
    def queue_reject_msg_to_sender_on_discard_behavior(self):
        ...
        Determines when to return negative acknowledgements (NACKs) to sending clients on message discards. Note that NACKs cause the message to not be delivered to any destination and Transacted Session commits to fail. The default value is `\"always\"`. The allowed values and their meaning are:  <pre> \"always\" - Always return a negative acknowledgment (NACK) to the sending client on message discard. \"when-queue-enabled\" - Only return a negative acknowledgment (NACK) to the sending client on message discard when the Queue is enabled. \"never\" - Never return a negative acknowledgment (NACK) to the sending client on message discard. </pre>   # noqa: E501
    ...
    def span(self):
        ...
        The span of the Link, either internal or external. Internal Links connect nodes within the same Cluster. External Links connect nodes within different Clusters. The default value is `\"external\"`. The allowed values and their meaning are:  <pre> \"internal\" - Link to same cluster. \"external\" - Link to other cluster. </pre>   # noqa: E501
    ...
    def transport_compressed_enabled(self):
        ...
        Enable or disable compression on the Link. The default value is `false`.  # noqa: E501
    ...
    def transport_tls_enabled(self):
        ...
        Enable or disable encryption on the Link. The default value is `false`.  # noqa: E501
