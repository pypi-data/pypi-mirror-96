...
class DmrCluster(object):
    ...
    def authentication_client_cert_content(self):
        ...
        The PEM formatted content for the client certificate used to login to the remote node. It must consist of a private key and between one and three certificates comprising the certificate trust chain. Changing this attribute requires an HTTPS connection. The default value is `\"\"`.  # noqa: E501
    ...
    def authentication_client_cert_password(self):
        ...
        The password for the client certificate. Changing this attribute requires an HTTPS connection. The default value is `\"\"`.  # noqa: E501
