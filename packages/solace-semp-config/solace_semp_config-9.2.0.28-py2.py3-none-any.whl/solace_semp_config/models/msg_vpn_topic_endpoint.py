...
class MsgVpnTopicEndpoint(object):
    ...
    def max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum number of messages delivered but not acknowledged per flow for the Topic Endpoint. The default is the max value supported by the platform.  # noqa: E501
