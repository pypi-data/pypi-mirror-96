...
class MsgVpn(object):
    ...
    def max_connection_count(self):
        ...
        The maximum number of client connections to the Message VPN. The default is the max value supported by the platform.  # noqa: E501
    ...
    def replication_bridge_authentication_basic_password(self):
        ...
        The password for the Client Username. The default is to have no `replicationBridgeAuthenticationBasicPassword`.  # noqa: E501
    ...
    def service_amqp_max_connection_count(self):
        ...
        The maximum number of AMQP client connections that can be simultaneously connected to the Message VPN. This value may be higher than supported by the platform. The default is the max value supported by the platform. Available since 2.2.  # noqa: E501
    ...
    def service_mqtt_max_connection_count(self):
        ...
        The maximum number of MQTT client connections that can be simultaneously connected to the Message VPN. The default is the max value supported by the platform. Available since 2.1.  # noqa: E501
    ...
    def service_rest_incoming_max_connection_count(self):
        ...
        The maximum number of REST incoming client connections that can be simultaneously connected to the Message VPN. This value may be higher than supported by the platform. The default is the max value supported by the platform.  # noqa: E501
    ...
    def service_smf_max_connection_count(self):
        ...
        The maximum number of SMF client connections that can be simultaneously connected to the Message VPN. This value may be higher than supported by the platform. The default is the max value supported by the platform.  # noqa: E501
    ...
    def service_web_max_connection_count(self):
        ...
        The maximum number of Web Transport client connections that can be simultaneously connected to the Message VPN. This value may be higher than supported by the platform. The default is the max value supported by the platform.  # noqa: E501
