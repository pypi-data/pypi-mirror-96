...
class MsgVpnClientProfile(object):
    ...
    def allow_bridge_connections_enabled(self):
        ...
        Allow or deny Bridge clients to connect. Changing this setting does not affect existing Bridge client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_cut_through_forwarding_enabled(self):
        ...
        Allow or deny clients to bind to topic endpoints or queues with the cut-through delivery mode. Changing this setting does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_guaranteed_endpoint_create_enabled(self):
        ...
        Allow or deny clients to create topic endponts or queues. Changing this setting does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_guaranteed_msg_receive_enabled(self):
        ...
        Allow or deny clients to receive guaranteed messages. Changing this setting does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_guaranteed_msg_send_enabled(self):
        ...
        Allow or deny clients to send guaranteed messages. Changing this setting does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_transacted_sessions_enabled(self):
        ...
        Allow or deny clients to establish transacted sessions. Changing this setting does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def api_queue_management_copy_from_on_create_name(self):
        ...
        The name of a Queue to copy settings from when a new Queue is created by an API. The referenced Queue must exist on the Message VPN. The default value is `\"\"`.  # noqa: E501
    ...
    def api_topic_endpoint_management_copy_from_on_create_name(self):
        ...
        The name of a Topic Endpoint to copy settings from when a new Topic Endpoint is created by an API. The referenced Topic Endpoint must exist on the Message VPN. The default value is `\"\"`.  # noqa: E501
    ...
    def client_profile_name(self):
        ...
        The Client Profile name.  # noqa: E501
    ...
    def compression_enabled(self):
        ...
        Enable or disable whether connected clients are allowed to use compression. The default value is `true`. Available since 2.10.  # noqa: E501
    ...
    def eliding_delay(self):
        ...
        The amount of time to delay the delivery of messages to clients after the initial message has been delivered (the eliding delay interval), in milliseconds. Zero value means there is no delay in delivering messages to clients. The default value is `0`.  # noqa: E501
    ...
    def eliding_enabled(self):
        ...
        Enable or disable the Message Eliding. The default value is `false`.  # noqa: E501
    ...
    def eliding_max_topic_count(self):
        ...
        The maximum number of topics tracked for Message Eliding per one Client connection. The default value is `256`.  # noqa: E501
    ...
    def max_connection_count_per_client_username(self):
        ...
        The maximum number of client connections that can be simultaneously connected with the same Client Username. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def max_egress_flow_count(self):
        ...
        The maximum number of egress flows that can be created by one client. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def max_endpoint_count_per_client_username(self):
        ...
        The maximum number of queues and topic endpoints that can be created by clients with the same Client Username. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def max_ingress_flow_count(self):
        ...
        The maximum number of ingress flows that can be created by one client. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def max_subscription_count(self):
        ...
        The maximum number of subscriptions that can be created by one client. The default varies by platform.  # noqa: E501
    ...
    def max_transacted_session_count(self):
        ...
        The maximum number of transacted sessions that can be created by one client. The default value is `10`.  # noqa: E501
    ...
    def max_transaction_count(self):
        ...
        The maximum number of transactions that can be created by one client. The default varies by platform.  # noqa: E501
    ...
    def reject_msg_to_sender_on_no_subscription_match_enabled(self):
        ...
        Enable or disable sending of a negative acknowledgement (NACK) on the discard of a message because of a message subscription was not found. The default value is `false`. Available since 2.2.  # noqa: E501
    ...
    def replication_allow_client_connect_when_standby_enabled(self):
        ...
        Allow or deny clients to connect to the Message VPN if its Replication state is standby. The default value is `false`.  # noqa: E501
    ...
    def service_smf_max_connection_count_per_client_username(self):
        ...
        The maximum number of SMF client connections that can be simultaneously connected with the same Client Username. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def service_web_inactive_timeout(self):
        ...
        The timeout for inactive Web Transport client sessions, in seconds. The default value is `30`.  # noqa: E501
    ...
    def service_web_max_connection_count_per_client_username(self):
        ...
        The maximum number of Web Transport client connections that can be simultaneously connected with the same Client Username. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def service_web_max_payload(self):
        ...
        The maximum Web Transport payload size before its fragmentation occurs, in bytes. The size of the header is not included. The default value is `1000000`.  # noqa: E501
    ...
    def tcp_congestion_window_size(self):
        ...
        The TCP initial congestion window size, in multiple of the TCP Maximum Segment Size (MSS). Changing the value from its default of 2 results in non-compliance with RFC 2581. Contact Solace Support before changing this value. The default value is `2`.  # noqa: E501
    ...
    def tls_allow_downgrade_to_plain_text_enabled(self):
        ...
        Enable or disable allowing a client to downgrade an encrypted connection to plain text. The default value is `true`. Available since 2.8.  # noqa: E501
