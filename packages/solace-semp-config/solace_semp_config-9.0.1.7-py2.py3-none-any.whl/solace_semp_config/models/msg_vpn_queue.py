...
class MsgVpnQueue(object):
    ...
    def dead_msg_queue(self):
        ...
        The name of the Dead Message Queue (DMQ) used by the Queue. The default value is `\"#DEAD_MSG_QUEUE\"`. Available since 2.2.  # noqa: E501
    ...
    def egress_enabled(self):
        ...
        Enable or disable the egress flow of messages from the Queue. The default value is `false`.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the ingress flow of messages to the Queue. The default value is `false`.  # noqa: E501
    ...
    def max_bind_count(self):
        ...
        The maximum number of simultaneous clients that can bind to the Queue. The default value is `1000`.  # noqa: E501
    ...
    def max_ttl(self):
        ...
        The maximum number of seconds that a message can stay in the Queue when \"respectTtlEnabled\" is \"true\". A message will expire according to the lesser of the TTL in the message (assigned by the Publisher) and the \"maxTtl\" configured in the Queue. \"maxTtl\" is a 32-bit integer value from 1 to 4294967295 representing the expiry time in seconds. A \"maxTtl\" of \"0\" disables this feature. The default value is `0`.  # noqa: E501
    ...
    def respect_msg_priority_enabled(self):
        ...
        Enable or disable the respecting of message priority. If enabled, messages contained in the Queue are delivered in priority order, from 9 (highest) to 0 (lowest). MQTT queues do not support enabling message priority. The default value is `false`. Available since 2.8.  # noqa: E501
