...
from solace_semp_config.api.replay_log_api import ReplayLogApi  # noqa: E501
from solace_semp_config.rest import ApiException


class TestReplayLogApi(unittest.TestCase):
    """ReplayLogApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_config.api.replay_log_api.ReplayLogApi()  # noqa: E501
