...
class AboutUserMsgVpn(object):
    ...
    def access_level(self):
        ...
        Message VPN access level of the Current User. The allowed values and their meaning are:  <pre> \"none\" - No access allowed. \"read-only\" - Read only. \"read-write\" - Read and Write. </pre>   # noqa: E501
