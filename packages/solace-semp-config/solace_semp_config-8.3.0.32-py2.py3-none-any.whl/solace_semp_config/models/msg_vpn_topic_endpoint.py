...
class MsgVpnTopicEndpoint(object):
    ...
    def access_type(self):
        ...
        The Topic Endpoint access type of either \"exclusive\" or \"non-exclusive\". The default value is `\"exclusive\"`. The allowed values and their meaning are:  <pre> \"exclusive\" - Exclusive delivery of messages to first bound client. \"non-exclusive\" - Non-exclusive delivery of messages to all bound clients. </pre>  Available since 2.4.0.  # noqa: E501
    ...
    def dead_msg_queue(self):
        ...
        Identifies the name of the queue which should be used as the Topic Endpoint's dead message queue. The default value is \"#DEAD_MSG_QUEUE\". The default value is `\"#DEAD_MSG_QUEUE\"`.  # noqa: E501
    ...
    def egress_enabled(self):
        ...
        Enable or disable the outgoing (egress) flow of messages from the Topic Endpoint. The default value is false. The default value is `false`.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the incoming (ingress) flow of messages to the Topic Endpoint. The default value is `false`.  # noqa: E501
    ...
    def max_bind_count(self):
        ...
        The maximum number of simultaneous Consumers of the Topic Endpoint. The default value is `1`. Available since 2.4.0.  # noqa: E501
