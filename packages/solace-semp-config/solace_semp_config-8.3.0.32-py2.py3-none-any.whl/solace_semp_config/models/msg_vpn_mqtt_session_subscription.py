...
class MsgVpnMqttSessionSubscription(object):
    ...
    def __init__(self, mqtt_session_client_id=None, mqtt_session_virtual_router=None, msg_vpn_name=None, subscription_qos=None, subscription_topic=None):  # noqa: E501
        """MsgVpnMqttSessionSubscription - a model defined in Swagger"""  # noqa: E501
        ...
        if subscription_qos is not None:
    ...
    def mqtt_session_client_id(self):
        """Gets the mqtt_session_client_id of this MsgVpnMqttSessionSubscription.  # noqa: E501

        The client-id of the MQTT Session, which corresponds to the ClientId provided in the MQTT CONNECT packet.  # noqa: E501

        :return: The mqtt_session_client_id of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def mqtt_session_client_id(self, mqtt_session_client_id):
        ...
        :param mqtt_session_client_id: The mqtt_session_client_id of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :type: str
        """
    ...
    def mqtt_session_virtual_router(self):
        """Gets the mqtt_session_virtual_router of this MsgVpnMqttSessionSubscription.  # noqa: E501

        The Virtual Router of the MQTT Session. The allowed values and their meaning are:  <pre> \"primary\" - MQTT Session belongs to the Primary Virtual Router. \"backup\" - MQTT Session belongs to the Backup Virtual Router. </pre>   # noqa: E501

        :return: The mqtt_session_virtual_router of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def mqtt_session_virtual_router(self, mqtt_session_virtual_router):
        ...
        :param mqtt_session_virtual_router: The mqtt_session_virtual_router of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :type: str
        """
    ...
    def msg_vpn_name(self):
        """Gets the msg_vpn_name of this MsgVpnMqttSessionSubscription.  # noqa: E501

        The name of the Message VPN.  # noqa: E501

        :return: The msg_vpn_name of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        ...
        :param msg_vpn_name: The msg_vpn_name of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :type: str
        """
    ...
    def subscription_qos(self):
        """Gets the subscription_qos of this MsgVpnMqttSessionSubscription.  # noqa: E501

        The quality of service for the subscription. The value is either `0` (deliver at most once) or `1` (deliver at least once). The default value is `0`.  # noqa: E501

        :return: The subscription_qos of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :rtype: int
        """
    ...
    def subscription_qos(self, subscription_qos):
        ...
        :param subscription_qos: The subscription_qos of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :type: int
        """
    ...
    def subscription_topic(self):
        """Gets the subscription_topic of this MsgVpnMqttSessionSubscription.  # noqa: E501

        An MQTT topic string.  # noqa: E501

        :return: The subscription_topic of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_topic(self, subscription_topic):
        ...
        :param subscription_topic: The subscription_topic of this MsgVpnMqttSessionSubscription.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnMqttSessionSubscription, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnMqttSessionSubscription):
            return False
