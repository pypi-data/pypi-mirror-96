...
class MsgVpn(object):
    ...
    def authentication_basic_type(self, authentication_basic_type):
        ...
        :type: str
        """
        allowed_values = ["radius", "ldap", "internal", "none"]  # noqa: E501
    ...
    def jndi_enabled(self):
        ...
        Enable or disable JNDI access for clients in the Message VPN. The default value is `false`. Available since 2.2.0.  # noqa: E501
    ...
    def max_egress_flow_count(self):
        ...
        The maximum number of Publisher (egress) flows that can be created in the Message VPN. The default value is `16000`.  # noqa: E501
    ...
    def max_ingress_flow_count(self):
        ...
        The maximum number of Subscriber (ingress) flows that can be created in the Message VPN. The default value is `16000`.  # noqa: E501
    ...
    def replication_bridge_authentication_scheme(self):
        ...
        The Authentication Scheme for the Replication Bridge. The default value is `\"basic\"`. The allowed values and their meaning are:  <pre> \"basic\" - Basic Authentication Scheme (via username and password). \"client-certificate\" - Client Certificate Authentication Scheme (via certificate-file). </pre>   # noqa: E501
    ...
    def replication_bridge_egress_flow_window_size(self):
        ...
        The size of the window used for guaranteed messages on the Replication Bridge, in messages. The default value is `255`.  # noqa: E501
    ...
    def semp_over_msg_bus_legacy_show_clear_enabled(self):
        ...
        Enable or disable \"legacy-show-clear\" SEMP over Message Bus for the current Message VPN. This applies only to SEMPv1. The default value is `false`.  # noqa: E501
    ...
    def service_mqtt_max_connection_count(self):
        ...
        The maximum number of MQTT client connections that can be simultaneously connected to the Message VPN. The default is the max value supported by the hardware. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_plain_text_enabled(self):
        ...
        Enable or disable the plain-text MQTT service in the Message VPN. Disabling causes clients currently connected to be disconnected. The default value is `false`. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_plain_text_listen_port(self):
        ...
        The port number for plain-text MQTT clients that connect to the Message VPN. The default value is `0`. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_tls_enabled(self):
        ...
        Enable or disable the use of TLS for the MQTT service in the Message VPN. Disabling causes clients currently connected over TLS to be disconnected. The default value is `false`. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_tls_listen_port(self):
        ...
        The port number for MQTT clients that connect to the Message VPN over TLS. The default value is `0`. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_tls_web_socket_enabled(self):
        ...
        Enable or disable the use of WebSocket over TLS for the MQTT service in the Message VPN. Disabling causes clients currently connected by WebSocket over TLS to be disconnected. The default value is `false`. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_tls_web_socket_listen_port(self):
        ...
        The port number for MQTT clients that connect to the Message VPN using WebSocket over TLS. The default value is `0`. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_web_socket_enabled(self):
        ...
        Enable or disable the use of WebSocket for the MQTT service in the Message VPN. Disabling causes clients currently connected by WebSocket to be disconnected. The default value is `false`. Available since 2.1.0.  # noqa: E501
    ...
    def service_mqtt_web_socket_listen_port(self):
        ...
        The port number for plain-text MQTT clients that connect to the Message VPN using WebSocket. The default value is `0`. Available since 2.1.0.  # noqa: E501
