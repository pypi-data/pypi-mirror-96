...
class MsgVpnRestDeliveryPointQueueBinding(object):
    ...
    def __init__(self, msg_vpn_name=None, post_request_target=None, queue_binding_name=None, rest_delivery_point_name=None):  # noqa: E501
