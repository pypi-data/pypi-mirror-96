...
class MsgVpnBridgeRemoteSubscription(object):
    ...
    def __init__(self, bridge_name=None, bridge_virtual_router=None, deliver_always_enabled=None, msg_vpn_name=None, remote_subscription_topic=None):  # noqa: E501
        """MsgVpnBridgeRemoteSubscription - a model defined in Swagger"""  # noqa: E501

        self._bridge_name = None
        self._bridge_virtual_router = None
        self._deliver_always_enabled = None
        self._msg_vpn_name = None
        self._remote_subscription_topic = None
        ...
        if deliver_always_enabled is not None:
            self.deliver_always_enabled = deliver_always_enabled
        if msg_vpn_name is not None:
            self.msg_vpn_name = msg_vpn_name
        if remote_subscription_topic is not None:
            self.remote_subscription_topic = remote_subscription_topic

    @property
    def bridge_name(self):
        """Gets the bridge_name of this MsgVpnBridgeRemoteSubscription.  # noqa: E501

        The name of the Message VPN Bridge.  # noqa: E501

        :return: The bridge_name of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def bridge_name(self, bridge_name):
        ...
        :param bridge_name: The bridge_name of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :type: str
        """
    ...
    def bridge_virtual_router(self):
        """Gets the bridge_virtual_router of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        ...
        :return: The bridge_virtual_router of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def bridge_virtual_router(self, bridge_virtual_router):
        ...
        :param bridge_virtual_router: The bridge_virtual_router of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :type: str
        """
    ...
    def deliver_always_enabled(self):
        """Gets the deliver_always_enabled of this MsgVpnBridgeRemoteSubscription.  # noqa: E501

        Flag the topic as deliver-always instead of with the configured deliver-to-one remote-priority value for the bridge. A given topic may be deliver-to-one or deliver-always but not both.  # noqa: E501

        :return: The deliver_always_enabled of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :rtype: bool
        """
    ...
    def deliver_always_enabled(self, deliver_always_enabled):
        ...
        :param deliver_always_enabled: The deliver_always_enabled of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :type: bool
        """
    ...
    def msg_vpn_name(self):
        """Gets the msg_vpn_name of this MsgVpnBridgeRemoteSubscription.  # noqa: E501

        The name of the Message VPN.  # noqa: E501

        :return: The msg_vpn_name of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def msg_vpn_name(self, msg_vpn_name):
        ...
        :param msg_vpn_name: The msg_vpn_name of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :type: str
        """
    ...
    def remote_subscription_topic(self):
        """Gets the remote_subscription_topic of this MsgVpnBridgeRemoteSubscription.  # noqa: E501

        The Topic of the Remote Subscription.  # noqa: E501

        :return: The remote_subscription_topic of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def remote_subscription_topic(self, remote_subscription_topic):
        ...
        :param remote_subscription_topic: The remote_subscription_topic of this MsgVpnBridgeRemoteSubscription.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnBridgeRemoteSubscription, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnBridgeRemoteSubscription):
            return False
