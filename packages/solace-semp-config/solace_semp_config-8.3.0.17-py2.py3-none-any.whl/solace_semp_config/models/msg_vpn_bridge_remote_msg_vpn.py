...
class MsgVpnBridgeRemoteMsgVpn(object):
    ...
    def __init__(self, bridge_name=None, bridge_virtual_router=None, client_username=None, compressed_data_enabled=None, connect_order=None, egress_flow_window_size=None, enabled=None, msg_vpn_name=None, password=None, queue_binding=None, remote_msg_vpn_interface=None, remote_msg_vpn_location=None, remote_msg_vpn_name=None, tls_enabled=None, unidirectional_client_profile=None):  # noqa: E501
    ...
    def bridge_name(self):
        ...
        The name of the Message VPN Bridge.  # noqa: E501
    ...
    def bridge_virtual_router(self):
        ...
        Specify whether the Message VPN Bridge is used for the Primary or Backup Router. The allowed values and their meaning are:  <pre> \"primary\" - The Message VPN Bridge is used for the Primary Router. \"backup\" - The Message VPN Bridge is used for the Backup Router. </pre>   # noqa: E501
    ...
    def client_username(self):
        ...
        The client username the bridge uses to login to the Remote Message VPN. This per Remote Message VPN value overrides the value provided for the bridge overall. The default value is `\"\"`.  # noqa: E501
    ...
    def compressed_data_enabled(self):
        ...
        Enable or disable data compression for the Remote Message VPN. The default value is `false`.  # noqa: E501
    ...
    def connect_order(self):
        ...
        The order in which attempts to connect to different Message VPN hosts are attempted, or the preference given to incoming connections from remote routers, from `1` (highest priority) to `4` (lowest priority). The default value is `4`.  # noqa: E501
    ...
    def egress_flow_window_size(self):
        ...
        The window size indicates how many outstanding guaranteed messages can be sent over the Remote Message VPN connection before acknowledgement is received by the sender. The default value is `255`.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the Remote Message VPN. The default value is `false`.  # noqa: E501
    ...
    @property
    def password(self):
        """Gets the password of this MsgVpnBridgeRemoteMsgVpn.  # noqa: E501

        The password for the client username the bridge uses to login to the Remote Message VPN. The default is to have no `password`.  # noqa: E501

        :return: The password of this MsgVpnBridgeRemoteMsgVpn.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        ...
        :param password: The password of this MsgVpnBridgeRemoteMsgVpn.  # noqa: E501
        :type: str
        """
    ...
    def remote_msg_vpn_interface(self):
        ...
        The interface on the local router through which to access the Remote Message VPN. If not provided (recommended) then an interface will be chosen automatically based on routing tables. If an interface is provided, `remoteMsgVpnLocation` must be either a hostname or IP Address, not a virtual router-name.  # noqa: E501
    ...
    def remote_msg_vpn_location(self):
        ...
        The location of the Remote Message VPN. This may be given as either a hostname (resolvable via DNS), IP Address, or virtual router-name (starts with 'v:'). If specified as a hostname or IP Address, a port must be specified as well.  # noqa: E501
    ...
    def tls_enabled(self):
        ...
        Enable or disable TLS for the Remote Message VPN. The default value is `false`.  # noqa: E501
    ...
    def unidirectional_client_profile(self):
        ...
        The client-profile for the unidirectional bridge for the Remote Message VPN. The client-profile must exist in the local Message VPN, and it is used only for the TCP parameters. The default value is `\"#client-profile\"`.  # noqa: E501
