...
class AboutUser(object):
    ...
    def global_access_level(self):
        ...
        Global access level of the Current User. The allowed values and their meaning are:  <pre> \"admin\" - Administrative access allowed. \"none\" - No access allowed. \"read-only\" - Read only. \"read-write\" - Read and Write. </pre>   # noqa: E501
