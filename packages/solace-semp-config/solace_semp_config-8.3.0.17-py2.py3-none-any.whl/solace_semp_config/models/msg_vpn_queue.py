...
class MsgVpnQueue(object):
    ...
    def access_type(self):
        ...
        The Queue access type of either \"exclusive\" or \"non-exclusive\". The default value is `\"exclusive\"`. The allowed values and their meaning are:  <pre> \"exclusive\" - Exclusive delivery of messages to first bound client. \"non-exclusive\" - Non-exclusive delivery of messages to all bound clients. </pre>   # noqa: E501
    ...
    def dead_msg_queue(self):
        ...
        Identifies the name of the queue which should be used as the queue's dead message queue. The default value is `\"#DEAD_MSG_QUEUE\"`.  # noqa: E501
    ...
    def egress_enabled(self):
        ...
        Enable or disable the outgoing (egress) flow of messages from the Queue. The default value is `false`.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the incoming (ingress) flow of messages to the Queue. The default value is `false`.  # noqa: E501
    ...
    def max_bind_count(self):
        ...
        The maximum number of simultaneous clients bound to the Queue. The default value is `1000`.  # noqa: E501
    ...
    def max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum allowed number of messages delivered but not acknowledged per flow for the Queue. The default is the maximum value supported by the hardware. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def max_msg_size(self):
        ...
        The maximum message size allowed in the Queue, in bytes. The default value is `10000000`.  # noqa: E501
    ...
    def max_msg_spool_usage(self):
        ...
        The maximum Message Spool usage by the Queue (quota), in megabytes. Setting the value to zero enables the \"last-value-queue\" feature and disables quota checking. The default varies by platform. The default varies by platform.  # noqa: E501
    ...
    def max_redelivery_count(self):
        ...
        The maximum number of times the Queue will attempt redelivery of a given message prior to it being discarded or moved to the #DEAD_MSG_QUEUE. A value of 0 means to retry forever. The default value is `0`.  # noqa: E501
    ...
    def max_ttl(self):
        ...
        The maximum number of seconds that a message can stay in the Queue when \"respectTtlEnabled\" is \"true\". A message will expire according to the lesser of the TTL in the message (assigned by the Publisher) and the \"maxTtl\" configured on the Queue. \"maxTtl\" is a 32-bit integer value from 1 to 4294967295 representing the expiry time in seconds. A \"maxTtl\" of \"0\" disables this feature. The default value is `0`.  # noqa: E501
    ...
    def owner(self):
        ...
        The Client Username which owns the Queue. The default value is `\"\"`.  # noqa: E501
    ...
    def respect_ttl_enabled(self):
        ...
        Enable or disable the respecting of the \"time to live\" (TTL). If enabled, then messages contained in the Queue are checked for expiry. If expired, the message is removed from the Queue and either discarded or a copy of the message placed in the #DEAD_MSG_QUEUE. The default value is `false`.  # noqa: E501
