...
class MsgVpnRestDeliveryPoint(object):
    ...
    def __init__(self, client_profile_name=None, enabled=None, msg_vpn_name=None, rest_delivery_point_name=None):  # noqa: E501
