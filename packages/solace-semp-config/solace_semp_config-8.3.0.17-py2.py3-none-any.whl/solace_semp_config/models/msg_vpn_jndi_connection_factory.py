...
class MsgVpnJndiConnectionFactory(object):
    ...
    def allow_duplicate_client_id_enabled(self):
        ...
        Enable or disable whether new JMS connections can use the same Client identifier (ID) as an existing connection. The default value is `false`. Available since 2.3.0.  # noqa: E501
    ...
    def dto_receive_override_enabled(self):
        ...
        Enable or disable overriding by the Subscriber (Consumer) of the deliver-to-one (DTO) property on messages received by it. The default value is `true`.  # noqa: E501
    ...
    def dto_receive_subscriber_local_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer), if the messages are published on the Router that the Subscriber is directly connected to (messages are published locally). The default value is `1`.  # noqa: E501
    ...
    def dto_receive_subscriber_network_priority(self):
        ...
        The priority for receiving deliver-to-one (DTO) messages by the Subscriber (Consumer), if the messages are published on the Router other that the Subscriber is directly connected to (messages are published on a remote router). The default value is `1`.  # noqa: E501
    ...
    def dynamic_endpoint_respect_ttl_enabled(self):
        ...
        Enable or disable whether dynamically created durable and non-durable endpoints respect messages \"time to live\" (TTL) property. The default value is `true`.  # noqa: E501
    ...
    def guaranteed_receive_window_size_ack_threshold(self):
        ...
        The threshold for sending the acknowledgement (ACK) for guaranteed message receives by the Subscriber (Consumer) as percentage of its maximum value of \"guaranteedReceiveWindowSize\". The default value is `60`.  # noqa: E501
    ...
    def guaranteed_send_window_size(self):
        ...
        The size of the window for guaranteed messages sent by the Publisher (Producer), in messages. The default value is `255`.  # noqa: E501
    ...
    def messaging_default_delivery_mode(self):
        ...
        The default delivery mode for messages sent by the Publisher (Producer). The default value is `\"persistent\"`.  # noqa: E501
    ...
    def messaging_jmsx_user_id_enabled(self):
        ...
        Enable or disable adding or replacing of the JMSXUserID property in messages sent by the Publisher (Producer). The default value is `false`.  # noqa: E501
    ...
    def messaging_text_in_xml_payload_enabled(self):
        ...
        Enable or disable encoding of JMS text messages messages sent by the Publisher (Producer) in the message XML payload. When disabled it means that text messages are encoded in binary attachments. The default value is `true`.  # noqa: E501
    ...
    def transport_compression_level(self):
        ...
        The level of the ZLIB compression for the connection to the Router. \"0\" value means no compression, \"-1\" value means the compression level is specified in the JNDI Properties File. The default value is `-1`.  # noqa: E501
    ...
    def transport_connect_retry_count(self):
        ...
        The maximum number of attempts to establish an initial connection to the Router. \"0\" value means a single attempt, \"-1\" value means to retry forever. The default value is `0`.  # noqa: E501
    ...
    def transport_connect_retry_per_host_count(self):
        ...
        The maximum number of attempts to establish an initial connection to one host (Router) on the list of hosts (Routers). \"0\" value means a single attempt, \"-1\" value means to retry forever. The default value is `0`.  # noqa: E501
    ...
    def transport_connect_timeout(self):
        ...
        The timeout for establishing an initial connection to the Router, in milliseconds. The default value is `30000`.  # noqa: E501
    ...
    def transport_direct_transport_enabled(self):
        ...
        Enable or disable usage of the Direct Transport Mode for sending non-persistent messages. Disabled value means that the Guaranteed Transport Mode is used. The default value is `true`.  # noqa: E501
    ...
    def transport_keepalive_count(self):
        ...
        The maximum number of consecutive application-level keepalive messages sent without the Router response before the connection to the Router is closed. The default value is `3`.  # noqa: E501
    ...
    def transport_keepalive_enabled(self):
        ...
        Enable or disable usage of application-level keepalive messages to the Router. The default value is `true`.  # noqa: E501
    ...
    def transport_msg_callback_on_io_thread_enabled(self):
        ...
        Enable or disable delivery of asynchronous messages directly from the I/O thread. The default value is `false`.  # noqa: E501
    ...
    def transport_optimize_direct_enabled(self):
        ...
        Enable or disable optimization for the Direct Transport. If enabled, the application is limited by a single Subscriber (Consumer) and Publisher (Producer) per connection that, when combined with the topic dispatch turned off, improves latency when consuming messages. The default value is `false`.  # noqa: E501
    ...
    def transport_port(self):
        ...
        The connection port number on the Router that is the port number for SMF clients. \"-1\" value means the port is specified in the JNDI Properties File. The default value is `-1`.  # noqa: E501
    ...
    def transport_read_timeout(self):
        ...
        The timeout for reading a reply from the Router, in milliseconds. The default value is `10000`.  # noqa: E501
    ...
    def transport_reconnect_retry_count(self):
        ...
        The maximum number of attempts to reestablish a connection to the Router after it has been lost. \"-1\" value means to retry forever. The default value is `3`.  # noqa: E501
    ...
    def transport_reconnect_retry_wait(self):
        ...
        The amount of time before making another attempt to connect or reconnect to the Router after it has been lost, in milliseconds. The default value is `3000`.  # noqa: E501
    ...
    def transport_tcp_no_delay_enabled(self):
        ...
        Enable or disable the TCP/IP Congestion Control (per RFC 896, the Nagles algorithm) known as \"the TCP_NODELAY option\". The default value is `true`.  # noqa: E501
    ...
    def xa_enabled(self):
        ...
        Specify whether this is the XA Connection Factory. When enabled, the Connection Factory can be cast to \"XAConnectionFactory\", \"XAQueueConnectionFactory\" or \"XATopicConnectionFactory\". The default value is `false`.  # noqa: E501
