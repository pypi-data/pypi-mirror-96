...
class MsgVpnClientProfile(object):
    ...
    def allow_bridge_connections_enabled(self):
        ...
        Allow or deny Bridge connections. The default value is `false`.  # noqa: E501
    ...
    def allow_cut_through_forwarding_enabled(self):
        ...
        Allow or deny clients to use the cut-through delivery mode. Changing this value does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_guaranteed_endpoint_create_enabled(self):
        ...
        Allow or deny clients to create topic endponts or queues. Changing this value does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_guaranteed_msg_receive_enabled(self):
        ...
        Allow or deny clients to receive guaranteed messages. Changing this value does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_guaranteed_msg_send_enabled(self):
        ...
        Allow or deny clients to send guaranteed messages. Changing this value does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def allow_transacted_sessions_enabled(self):
        ...
        Allow or deny clients to establish transacted sessions. Changing this value does not affect existing client connections. The default value is `false`.  # noqa: E501
    ...
    def eliding_max_topic_count(self):
        ...
        The maximum number of topics for Message Eliding per one Client connection. The default value is `256`.  # noqa: E501
    ...
    def max_egress_flow_count(self):
        ...
        The maximum number of outgoing (egress) flows that can be created by one client. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def max_ingress_flow_count(self):
        ...
        The maximum number of incoming (ingress) flows that can be created by one client. The default is the max value supported by the hardware.  # noqa: E501
    ...
    def replication_allow_client_connect_when_standby_enabled(self):
        ...
        Allow to deny clients connection to the Message VPN if its Replication is in the standby state. The default value is `false`.  # noqa: E501
    ...
    def tcp_congestion_window_size(self):
        ...
        The TCP initial congestion window size, in multiple of the TCP Maximum Segment Size (MSS). Changing the value from its default of 2 results in non-compliance with RFC 2581. Contact Solace Support before changing the value. The default value is `2`.  # noqa: E501
    ...
    def tcp_keepalive_count(self):
        ...
        The number of the TCP keepalive packet retransmissions to be carried out before declaring that remote end is not available. The default value is `5`.  # noqa: E501
    ...
    def tcp_keepalive_idle_time(self):
        ...
        The duration between two TCP keepalive transmissions in idle condition, in seconds. The default value is `3`.  # noqa: E501
    ...
    def tcp_keepalive_interval(self):
        ...
        The duration between two successive TCP keepalive retransmissions, if acknowledgement to the previous TCP keepalive transmission is not received, in seconds. The default value is `1`.  # noqa: E501
    ...
    def tcp_max_segment_size(self):
        ...
        The the largest amount of data to receive in a single TCP segment, in kilobytes. The default value is `1460`.  # noqa: E501
