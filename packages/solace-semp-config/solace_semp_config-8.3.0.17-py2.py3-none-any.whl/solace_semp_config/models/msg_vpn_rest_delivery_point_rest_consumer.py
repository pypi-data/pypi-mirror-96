...
class MsgVpnRestDeliveryPointRestConsumer(object):
    ...
    def authentication_http_basic_password(self):
        ...
        The password that the REST Consumer will use to login to the rest-host. The default is to have no `authenticationHttpBasicPassword`.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable this REST Consumer. When disabled, no connections are initiated or messages delivered to this particular REST Consumer. The default value is `false`.  # noqa: E501
    ...
    def local_interface(self):
        ...
        The interface that will be used for all outgoing connections associated with the given REST consumer. The source IP address used for these connections will always be the IP address associated with the AD-enabled virtual-router for the specified interface. When unspecified the router will automatically choose an interface through which the REST consumer is reachable. The default value is `\"\"`.  # noqa: E501
    ...
    def max_post_wait_time(self):
        ...
        The maximum amount of time (in seconds) that the router will wait for a POST response from the REST Consumer. Once a POST operation has been outstanding for this period of time, the request is considered hung and the TCP connection is reset. If this POST is for a non-persistent message, the message is discarded. If this POST is for a persistent message, then message delivery is re-attempted via another available outgoing connection on any available outgoing connection for that RDP, up to the Max-Delivery-Count on the queue. If this count is exceeded, and the message is DMQ-eligible, then this message is moved to the DMQ, otherwise it is discarded. The default value is `30`.  # noqa: E501
    ...
    def outgoing_connection_count(self):
        ...
        The total number of concurrent TCP connections open to this REST Consumer initiated by the router. Multiple connections to a single REST Consumer are typically desirable to increase throughput via concurrency. The more connections, the higher the potential throughput. The default value is `3`.  # noqa: E501
    ...
    def remote_host(self):
        ...
        The IPv4 address or DNS name to which the router is to connect to deliver messages for this REST Consumer. If the REST Consumer is enabled while the host value is not configured then the REST Consumer has an operational Down state due to the empty host configuration until a usable host value is configured. The default value is `\"\"`.  # noqa: E501
    ...
    def remote_port(self):
        ...
        The port associated with the host of the current REST Consumer. The default value is `8080`.  # noqa: E501
    ...
    def rest_consumer_name(self):
        ...
        An RDP-wide unique name for the REST consumer.  # noqa: E501
    ...
    def rest_delivery_point_name(self):
        ...
        A Message VPN-wide unique name for the REST Delivery Point. This name is used to auto-generate a client-username in this Message VPN, which is used by the client for this RDP.  # noqa: E501
    ...
    def retry_delay(self):
        ...
        The number of seconds that must pass before retrying a connection. The default value is `3`.  # noqa: E501
