...
class MsgVpnBridge(object):
    ...
    def __init__(self, bridge_name=None, bridge_virtual_router=None, enabled=None, max_ttl=None, msg_vpn_name=None, remote_authentication_basic_client_username=None, remote_authentication_basic_password=None, remote_authentication_scheme=None, remote_connection_retry_count=None, remote_connection_retry_delay=None, remote_deliver_to_one_priority=None, tls_cipher_suite_list=None):  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the Message VPN Bridge. The default value is `false`.  # noqa: E501
    ...
    def max_ttl(self):
        ...
        The maximum number of hops (intermediate routers through which data must pass between source and destination) that can occur before the message is discarded. When the Message VPN Bridge sends a message to the remote router, the message TTL value is assigned to the lower of the message current TTL or this value. The default value is `8`.  # noqa: E501
    ...
    def remote_authentication_basic_client_username(self):
        ...
        The Client Username the Message VPN Bridge uses to login to the Remote Message VPN. The default value is `\"\"`.  # noqa: E501
    ...
    def remote_authentication_basic_password(self):
        ...
        The password the Message VPN Bridge uses to login to the Remote Message VPN. The default is to have no `remoteAuthenticationBasicPassword`.  # noqa: E501
    ...
    def remote_authentication_scheme(self, remote_authentication_scheme):
        ...
        :type: str
        """
        allowed_values = ["basic", "client-certificate", "not-applicable"]  # noqa: E501
    ...
    def remote_connection_retry_count(self):
        ...
        The maximum number of attempts to establish connection to the Remote Message VPN. The default value is `0`.  # noqa: E501
    ...
    def remote_connection_retry_delay(self):
        ...
        The amount of time before making another attempt to connect to the Remote Message VPN after a failed one, in seconds. The default value is `3`.  # noqa: E501
    ...
    def remote_deliver_to_one_priority(self):
        ...
        The priority for deliver-to-one (DTO) messages sent from the Remote Message VPN to the Message VPN Bridge. The default value is `\"p1\"`. The allowed values and their meaning are:  <pre> \"p1\" - Priority 1 (highest). \"p2\" - Priority 2. \"p3\" - Priority 3. \"p4\" - Priority 4 (lowest). \"da\" - Deliver Always. </pre>   # noqa: E501
