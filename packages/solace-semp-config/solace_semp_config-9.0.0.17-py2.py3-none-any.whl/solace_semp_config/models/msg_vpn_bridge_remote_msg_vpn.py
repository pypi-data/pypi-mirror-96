...
class MsgVpnBridgeRemoteMsgVpn(object):
    ...
    def egress_flow_window_size(self):
        ...
        Indicates how many outstanding guaranteed messages can be sent over the Remote Message VPN connection before acknowledgement is received by the sender. The default value is `255`.  # noqa: E501
    ...
    def password(self):
        ...
        The password for the Client Username that the Bridge uses to login to the Remote Message VPN. The default is to have no `password`.  # noqa: E501
    ...
    def remote_msg_vpn_location(self):
        ...
        The location of the Remote Message VPN. This may be given as either an FQDN (resolvable via DNS), IP Address, or virtual router-name (starts with 'v:'). If specified as a FQDN or IP Address, a port must be specified as well.  # noqa: E501
