...
class CertAuthority(object):
    ...
    def cert_content(self):
        ...
        The PEM formatted content for the trusted root certificate of a Certificate Authority. This attribute is absent from a GET and not updated when absent in a PUT. The default value is `\"\"`.  # noqa: E501
