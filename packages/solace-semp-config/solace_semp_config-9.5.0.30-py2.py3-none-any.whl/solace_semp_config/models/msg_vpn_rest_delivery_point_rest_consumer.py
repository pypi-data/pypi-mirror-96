...
class MsgVpnRestDeliveryPointRestConsumer(object):
    ...
    def __init__(self, authentication_client_cert_content=None, authentication_client_cert_password=None, authentication_http_basic_password=None, authentication_http_basic_username=None, authentication_http_header_name=None, authentication_http_header_value=None, authentication_scheme=None, enabled=None, local_interface=None, max_post_wait_time=None, msg_vpn_name=None, outgoing_connection_count=None, remote_host=None, remote_port=None, rest_consumer_name=None, rest_delivery_point_name=None, retry_delay=None, tls_cipher_suite_list=None, tls_enabled=None):  # noqa: E501
    ...
    def authentication_http_basic_password(self):
        ...
        The password for the username. This attribute is absent from a GET and not updated when absent in a PUT. The default value is `\"\"`.  # noqa: E501
    ...
    def authentication_http_header_value(self):
        ...
        The authentication header value. This attribute is absent from a GET and not updated when absent in a PUT. The default value is `\"\"`. Available since 2.15.  # noqa: E501
