...
class MsgVpnReplayLog(object):
    ...
    def egress_enabled(self):
        ...
        Enable or disable the egress flow of messages from the Replay Log. The default value is `false`.  # noqa: E501
    ...
    def ingress_enabled(self):
        ...
        Enable or disable the ingress flow of messages to the Replay Log. The default value is `false`.  # noqa: E501
    ...
    def max_spool_usage(self):
        ...
        The maximum spool usage in megabytes (MB) allowed by the Replay Log. If this limit is exceeded, old messages will be trimmed. The default value is `0`.  # noqa: E501
