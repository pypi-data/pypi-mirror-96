...
class MsgVpnRestDeliveryPointRestConsumer(object):
    ...
    def authentication_client_cert_content(self):
        ...
        The PEM formatted content for the client certificate that the REST Consumer will present to the REST host. It must consist of a private key and between one and three certificates comprising the certificate trust chain. The default value is `\"\"`. Available since 2.9.  # noqa: E501
    ...
    def authentication_client_cert_password(self):
        ...
        The password for the client certificate that the REST Consumer will present to the REST host. The default value is `\"\"`. Available since 2.9.  # noqa: E501
    ...
    def authentication_http_basic_password(self):
        ...
        The password that the REST Consumer will use to login to the REST host. The default value is `\"\"`.  # noqa: E501
    ...
    def outgoing_connection_count(self):
        ...
        The total number of concurrent TCP connections open to the REST Consumer. Multiple connections to a single REST Consumer increase throughput via concurrency. The default value is `3`.  # noqa: E501
    ...
    def remote_host(self):
        ...
        The IP address or DNS name to which the router is to connect to deliver messages for this REST Consumer. If the REST Consumer is enabled while the host value is not configured then the REST Consumer has an operational Down state due to the empty host configuration until a usable host value is configured. The default value is `\"\"`.  # noqa: E501
    ...
    def remote_port(self):
        ...
        The port associated with the host of the REST Consumer. The port can only be changed when the REST Consumer is disabled. The default value is `8080`.  # noqa: E501
    ...
    def tls_cipher_suite_list(self):
        ...
        The colon-separated list of cipher-suites the REST Consumer uses in its encrypted connection. All supported suites are included by default, from most-secure to least-secure. The REST Consumer should choose the first suite from this list that it supports. The cipher-suite list can only be changed when the REST Consumer is disabled. The default value is `\"default\"`.  # noqa: E501
    ...
    def tls_enabled(self):
        ...
        Enable or disable TLS for the REST Consumer. This may only be done when the REST Consumer is disabled. The default value is `false`.  # noqa: E501
