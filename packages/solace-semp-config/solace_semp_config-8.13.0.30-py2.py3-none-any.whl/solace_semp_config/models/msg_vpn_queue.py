...
class MsgVpnQueue(object):
    ...
    def respect_msg_priority_enabled(self):
        ...
        Enable or disable the respecting of message priority. If enabled, messages contained in the Queue are delivered in priority order, from 9 (highest) to 0 (lowest). The default value is `false`. Available since 2.8.  # noqa: E501
