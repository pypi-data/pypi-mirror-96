...
class MsgVpnClientUsername(object):
    ...
    def client_username(self):
        ...
        The value of the Client Username.  # noqa: E501
    ...
    def enabled(self):
        ...
        Enables or disables the Client Username. When disabled all clients currently connected as the Client Username are disconnected. The default value is `false`.  # noqa: E501
    ...
    def guaranteed_endpoint_permission_override_enabled(self):
        ...
        Enables or disables guaranteed endpoint permission override for the Client Username. When enabled all guaranteed endpoints may be accessed, modified or deleted with the same permission as the owner. The default value is `false`.  # noqa: E501
    ...
    def password(self):
        ...
        The password of this Client Username for internal Authentication. The default is to have no password. The default is to have no `password`.  # noqa: E501
    ...
    def subscription_manager_enabled(self):
        ...
        Enables or disables the subscription management capability of the Client Username. This is the ability to manage subscriptions on behalf of other Client Usernames. The default value is `false`.  # noqa: E501
