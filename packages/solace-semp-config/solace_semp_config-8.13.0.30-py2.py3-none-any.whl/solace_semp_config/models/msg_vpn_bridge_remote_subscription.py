...
class MsgVpnBridgeRemoteSubscription(object):
    ...
    def deliver_always_enabled(self):
        ...
        Flag the Subscription Topic as deliver always instead of with the deliver-to-one remote priority value for the Bridge given by `remoteDeliverToOnePriority`. A given topic may be deliver-to-one or deliver always but not both.  # noqa: E501
