...
class MsgVpnBridge(object):
    ...
    def max_ttl(self):
        ...
        The maximum number of hops (intermediate routers through which data must pass between source and destination) that can occur before the message is discarded. When the Bridge sends a message to the remote router, the message TTL value is assigned to the lower of the message current TTL or this value. The default value is `8`.  # noqa: E501
    ...
    def remote_authentication_basic_client_username(self):
        ...
        The Client Username that the Bridge uses to login to the Remote Message VPN. The default value is `\"\"`.  # noqa: E501
    ...
    def remote_connection_retry_count(self):
        ...
        The maximum number of attempts to establish a connection to the Remote Message VPN. The default value is `0`.  # noqa: E501
