...
class MsgVpnTopicEndpoint(object):
    ...
    def max_delivered_unacked_msgs_per_flow(self):
        ...
        The maximum allowed number of messages delivered but not acknowledged per flow for the Topic Endpoint. The default is the maximum value supported by the hardware. The default value is `10000`.  # noqa: E501
    ...
    def max_redelivery_count(self):
        ...
        The maximum number of times the Topic Endpoint will attempt redelivery of a given message prior to it being discarded or moved to the #DEAD_MSG_QUEUE. A value of 0 means to retry forever. The default value is `0`.  # noqa: E501
