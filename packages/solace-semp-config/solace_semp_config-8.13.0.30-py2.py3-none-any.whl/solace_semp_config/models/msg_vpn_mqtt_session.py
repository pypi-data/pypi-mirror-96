...
class MsgVpnMqttSession(object):
    ...
    def __init__(self, enabled=None, mqtt_session_client_id=None, mqtt_session_virtual_router=None, msg_vpn_name=None, owner=None):  # noqa: E501
    ...
    def enabled(self):
        ...
        Enable or disable the MQTT Session. When disabled a client attempting to connect to this session will be denied, and an existing connection will be closed. QoS 1 subscriptions of an MQTT Session will continue to attract messages while disabled. The default value is `false`.  # noqa: E501
    ...
    def owner(self):
        ...
        The owner of the MQTT Session. For externally-created sessions this will be the Client Username of the connecting client. For management-created sessions this will be empty by default. In either case the owner can be changed by the administrator. The MQTT Session must be disabled to change its owner. The default value is `\"\"`.  # noqa: E501
