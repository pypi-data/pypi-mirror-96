...
class OWColor(widget.OWWidget):
    ...
    def __init__(self):
        ...
        save = gui.button(None, self, i18n.t("common.btn.save"), callback=self.save)
        load = gui.button(None, self, i18n.t("common.btn.load"), callback=self.load)
        reset = gui.button(None, self, i18n.t("common.btn.reset"), callback=self.reset)
