...
class OWMDS(OWDataProjectionWidget, ConcurrentWidgetMixin):
    ...
    def _add_controls_optimization(self):
        ...
        gui.button(hbox, self, i18n.t("common.algorithm.PCA"), callback=self.do_PCA)
        gui.button(hbox, self, i18n.t("common.general.randomize"), callback=self.do_random)
        gui.button(hbox, self, __("btn.jitter"), callback=self.do_jitter)
