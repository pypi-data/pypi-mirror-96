...
class OWEditDomain(widget.OWWidget):
    ...
    def __init__(self):
        ...
        box = QGroupBox(i18n.t("common.general.variable"))
        ...
        self.le_output_name = gui.lineEdit(
            self.mainArea, self, "output_table_name", __("row.le_output_name"),
