# Generated by Django 2.2.18 on 2021-02-18 16:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, height_field='height', null=True, upload_to=lavender.utils.texture_path_handler, width_field='width')),
                ('token', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lavender.Token')),
            ],
        ),
        migrations.CreateModel(
            name='Quenta',
        ...
        migrations.AddIndex(
            model_name='texture',
            index=models.Index(fields=['kind', 'deleted', '-created'], name='lavender_te_kind_c8ab04_idx'),
        ),
    ]
