...
from netcdf_scm.weights import InvalidWeightsError
...
def get_csoilfast_expected_results():
    ...
    exp_scmdf["variable"] = "cSoilFast"
    exp_scmdf["variable_standard_name"] = "fast_soil_pool_carbon_content"
    exp_scmdf["unit"] = "kg m^-2"
...
def test_scm_timeseries_crunching(
    ...
    if invalid_regions is not None:
        for r in invalid_regions:
            error_msg = re.escape("No valid weights for regions: {}".format([r]))
