...
def wrap_call(module, object_path, prepare):
    def _call_wrapper(wrapped, instance, args, kwargs):
        ...
        with ExternalTrace('gRPC', uri, method, span_type=SpanType.Exit.value, span_layer=SpanLayerAtrr.RPC.value):
...
def wrap_next(_wrapped, _instance, _args, _kwargs):
    ...
    try:
        ...
        with ExternalTrace(*_nr_args, span_type=SpanType.Exit.value, span_layer=SpanLayerAtrr.RPC.value) as t:
