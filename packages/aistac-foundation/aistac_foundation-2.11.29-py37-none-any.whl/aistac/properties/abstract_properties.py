...
class AbstractPropertyManager(ABC):
    ...
    def file_pattern(self, name: str, project: str=None, path: [str, list]=None, prefix: str=None, suffix: str=None, file_type: str=None,
                     versioned: bool=None, stamped: str=None) -> str:
