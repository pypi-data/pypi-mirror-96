...
def make_categorical(
    ...
    * `targets`: target variable. Defined as the number of matching entries in
    ...
    population_table["column_01"] = random.randint(0, 10, n_rows_population).astype(
        np.str
    )
    ...
    peripheral_table["column_01"] = random.randint(0, 10, n_rows_peripheral).astype(
        np.str
    )
...
def make_same_units_categorical(
    ...
    * `targets`: target variable. Defined as the number of matching entries in
    ...
    population_table["column_01_population"] = (
        (random.rand(n_rows_population) * 10.0).astype(np.int).astype(np.str)
    )
    ...
    peripheral_table["column_01_peripheral"] = (
        (random.rand(n_rows_peripheral) * 10.0).astype(np.int).astype(np.str)
    )
