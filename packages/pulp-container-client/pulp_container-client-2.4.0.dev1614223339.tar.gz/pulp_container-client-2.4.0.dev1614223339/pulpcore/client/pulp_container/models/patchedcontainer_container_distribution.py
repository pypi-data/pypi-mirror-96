...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository_version=None, repository=None, content_guard=None, name=None, pulp_labels=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
