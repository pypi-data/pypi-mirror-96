...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, repository_version=None, repository=None, pulp_created=None, content_guard=None, name=None, pulp_labels=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
