...
def get_all_conf(path=None):
    ...
    for fn in os.listdir(os.getcwd()):
        if fn.endswith((".yml", ".yaml")):
            conf_dict.update(get_conf(os.path.join(os.getcwd(), fn), "group.apis"))

    return conf_dict.get(path) if path else conf_dict
