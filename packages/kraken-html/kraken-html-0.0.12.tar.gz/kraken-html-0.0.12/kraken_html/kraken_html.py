...
class Kraken_html:
    ...
    def record_detail(self, value):
        ...
        return html_record.record_detail(keys, value)
    ...
    def card(self, title, text, contenturl, url):
        ...
        return html_card.card(title, text, contenturl, url)


    def card_small(self, title, text, contenturl, url):



        html_card = Html_card()

        return html_card.card_small(title, text, contenturl, url)
    ...
    def section(self, title, content, expanded = False):
        ...
        return html_section.section(title, content, expanded)
