...
from openmodule.utils.backend.models import AccessRequest, AccessResponse, CountMessage, MediumAccesses, Access
...
class Backend:
    ...
    * provides method for the backend / auth rpc with the check_backend_access method
    ...
    def rpc_check_access(self, request: AccessRequest, _) -> AccessResponse:
        gate_log_string = f"({request.gateway.gate}/{request.gateway.direction})"
