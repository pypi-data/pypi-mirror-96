...
def _get_subdivided_strata(rhythmic_strata_1, bar_tempo_1, rhythmic_strata_2, bar_tempo_2):
    ...
    subdivided_strata_1 = list(rhythmic_strata_1) + sorted(prime_factor(shared_tempo/smallest_pulse_tempo_1), 
                                                           reverse=True)
    subdivided_strata_2 = list(rhythmic_strata_2) + sorted(prime_factor(shared_tempo/smallest_pulse_tempo_2), 
                                                           reverse=True)
...
def calculate_metric_similarity(rhythmic_strata_away, bar_tempo_away, rhythmic_strata_home, 
                                bar_tempo_home, standard_barlow=True):
