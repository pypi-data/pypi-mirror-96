...
from sixgill.sixgill_request_classes.sixgill_cve_enrich_request import SixgillCVEEnrichRequest
...
class SixgillEnrichClient(SixgillBaseClient):
    ...
    def enrich_cve(self, cve_id):
        ...
        """
        cve_enrich_data = self._send_request(SixgillCVEEnrichRequest(self.channel_id, self._get_access_token(), cve_id))
        return cve_enrich_data
