...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create1  # this is an instance of the class Endpoint
        api_instance.create1()  # this invokes api_instance.create1.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create1.callable or self.callable in this class
