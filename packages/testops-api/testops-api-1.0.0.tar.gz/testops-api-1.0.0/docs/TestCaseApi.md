# testops_api.TestCaseApi

All URIs are relative to *https://testops.katalon.io*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get10**](TestCaseApi.md#get10) | **GET** /api/v1/test-cases/{id} | Returns a Test Case detail.
[**update6**](TestCaseApi.md#update6) | **POST** /api/v1/test-cases/update | Update a Test Case.


# **get10**
> TestCaseResource get10(id)
...
import time
import testops_api
from testops_api.api import test_case_api
...
with testops_api.ApiClient(configuration) as api_client:
    ...
    api_instance = test_case_api.TestCaseApi(api_client)
    id = "id_example" # str | 
    ...
    try:
        ...
        print("Exception when calling TestCaseApi->get10: %s\n" % e)
```
...
# **update6**
> TestCaseResource update6(test_case_resource)
...
with testops_api.ApiClient(configuration) as api_client:
    ...
    test_case_resource = TestCaseResource(
        ...
        test_result_assertion=TestResultAssertionResource(
            ...
            execution_test_result=ExecutionTestResultResource(
                id=1,
                test_case=TestCaseResource(TestCaseResource),
                ...
                test_suite=TestSuiteResource(
                    ...
                    alias="alias_example",
                    last_execution_test_suite=ExecutionTestSuiteResource(
                        status="PASSED",
                        start_time=dateutil_parser('1970-01-01T00:00:00.00Z'),
                        end_time=dateutil_parser('1970-01-01T00:00:00.00Z'),
                        duration=1,
                ...
                execution_test_suite=ExecutionTestSuiteResource(
                    status="PASSED",
                    start_time=dateutil_parser('1970-01-01T00:00:00.00Z'),
                    end_time=dateutil_parser('1970-01-01T00:00:00.00Z'),
                    duration=1,
    ...
    try:
        # Update a Test Case.
        api_response = api_instance.update6(test_case_resource)
        pprint(api_response)
    except testops_api.ApiException as e:
        print("Exception when calling TestCaseApi->update6: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **test_case_resource** | [**TestCaseResource**](TestCaseResource.md)|  |
