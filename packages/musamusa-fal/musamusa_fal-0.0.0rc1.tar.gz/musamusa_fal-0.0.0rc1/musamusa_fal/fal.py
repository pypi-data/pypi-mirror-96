...
class FileAndLine():
    """
        ...
        !!! Beware, line_index is greater or equal to 1 !!!
    """
    #         o source_filename : (str) path to the read source file
    #         o line_index      : (int) the read line (>=1, first read line is line number 1 !)
    source_filename: str = ""
    line_index: str = ""
    ...
    def __repr__(self):
        ...
        """
        res = "{source_filename}#{line_index}"
        return res.format(source_filename=self.source_filename,
