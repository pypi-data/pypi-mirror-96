...
class UCode:
    ...
    def upload_testcases(self, problem_id, testcases: List[TestCase], score=10):
        ...
        for i, testcase in enumerate(testcases):
            t = {
                ...
                "score": 0 if testcase.sample else score,
...
def create_problems_to_lesson_ucode_live():
    base_folder = "D:\\projects\\ucode\\repl_backup\\ThucNguyen1\\pya1-1-lesson-8-9-10-for"

    # base_folder = "D:\\projects\\ucode\\repl_backup\\itteacher-k1\\quiz5.1_list"
    ...
    # D:\projects\ucode\weekly-algorithm-problems\week13
    base_folder = "D:\\projects\\ucode\\repl_backup\\itteacher-k1\\quiz8_dict"
    ...
    # base_folder = "D:\\projects\\ucode\\repl_backup\\intro2"
    # base_folder = "D:\\projects\\ucode\\dsa-problems\\competitions\\hsg_thcs\Thuc\HaNoi2019_new"
    base_folder = "D:\\projects\\ucode\\weekly-algorithm-problems\\week13"
    problems = ProblemService.read_all_problems_v1(base_folder, nested_folder=False, translations=['vi'])
    # problems = ProblemService.read_all_problems(base_folder, nested_folder=False)
