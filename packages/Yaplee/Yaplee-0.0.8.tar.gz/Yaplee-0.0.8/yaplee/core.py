...
class AppStarter:
    def __init__(self, argv):
        ...
        if(self.argv == []):
            ...
            try:
                ...
                print('Permission error to create new page')
                if(os.name != 'nt'):
                    print('Tip: Execute commands with sudo')
    ...
    def RunServer(self):
        ...
        try:
            ...
            subprocess.run(
            'python -m http.server '+str(self.GetApplicationConfig()['DEVELOPMENT_SERVER_PORT'])+' --bind 127.0.0.1 --directory "'+str(os.path.join(self.user_path, 'pages', '.server'))+'"',
            shell=True
            )
    ...
    def NewPage(self, page_name):
        ...
        try:
            ...
            self.RemoveDir(os.path.join(self.user_path, 'pages', str(page_name)))
            print('Permission error to create new page')
            if(os.name != 'nt'):
                print('Tip: Execute commands with sudo')
