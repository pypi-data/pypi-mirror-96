...
如果有找不到优先级的词，该记录会存于./cn_sort/error.log中，显示示例如下：
...
当词组量<500000时，对于万级的词组量排序速度大概能控制在1-2秒，十万级的词组量大概能控制在5-10秒。

当词组量>500000时，对于百万级的词组量，排序速度可控制在15-30秒。
...
同时我也发现，受限于排序算法的稳定性，若词组中大量出现相同或者相近的词，以及词的长度几乎没有什么差别，程序运行的效率会严重下降。
