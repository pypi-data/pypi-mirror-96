...
from widget_functions import (ButtonFunction, IndicatorFunction, GraphFunction,
...
_h_slider = Slider((620, 400), (150, 50),
                   ...
                   dynamic=True, function=SliderFunction(_slider_h_control_func))
_v_slider = Slider((620, 240), (50, 150),
                   min_max=(0, 100), start_value=60,
                   snap_value=.1,
                   label_color1=BLACK, color1=MEDIUM_GRAY, color2=BLUE,
                   dynamic=False, function=SliderFunction(_slider_v_control_func))
_fake_graph = Graph((680, 240), (110, 150), min_max=(-100, 100),
                    quiet=True, function=GraphFunction(fake_data_graph_function))
