...
class ImportanceBlockFooterBuilder:
    ...
    def from_tuple(params):
        return ImportanceBlockFooterBuilder(*params)

    def as_tuple(self):
        return (self.votingEligibleAccountsCount, self.harvestingEligibleAccountsCount, self.totalVotingBalance, self.previousImportanceBlockHash)
