...
class EmbeddedAccountKeyLinkTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedAccountKeyLinkTransactionBuilder:
        ...
        return EmbeddedAccountKeyLinkTransactionBuilder(superObject.signerPublicKey, superObject.version, superObject.network, superObject.type, accountKeyLinkTransactionBody.linkedPublicKey, accountKeyLinkTransactionBody.linkAction)
