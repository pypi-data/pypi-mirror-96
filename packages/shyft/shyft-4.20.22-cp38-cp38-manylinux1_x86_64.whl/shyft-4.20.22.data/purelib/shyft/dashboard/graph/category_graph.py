...
class CategoryGraph(Widget):
    ...
    def __init__(self, height: int, width: int=None, aspect_factor: float=4.5) -> None:
        """
        Composable app which draws a categorical graph of items in a bokeh plot.
        The graph is layout with graphiz and pydot, based on the
        shyft.util.layput_graph pkg.

        The graph objects and graph connections are added with the function
        ...
        width:
            of the figure
        aspect_factor:
            aspect factor between with and height, can be added instead of width default 4.5
        """
        ...
        self.text_names = LabelSetZoomable(dict(x='x', x_units='data', y='y', y_units='data', text='texts',
                                                source=self.ds_names, text_color='black', text_font='monospace',
                                                text_font_style='bold'),
                                           ['0pt', '6pt', '10pt', '11.8pt', '13.4pt'],  # 6
