...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x16protobuf/options.proto\x12\x0egrakn.protocol\"\x8e\x04\n\x07Options\x12\x16\n\x05infer\x18\x01 \x01(\x08H\x00R\x05infer\x12)\n\x0ftrace_inference\x18\x02 \x01(\x08H\x01R\x0etraceInference\x12\x1a\n\x07\x65xplain\x18\x03 \x01(\x08H\x02R\x07\x65xplain\x12\x1f\n\nbatch_size\x18\x04 \x01(\x05H\x03R\tbatchSize\x12\x1c\n\x08prefetch\x18\x05 \x01(\x08H\x04R\x08prefetch\x12?\n\x1bsession_idle_timeout_millis\x18\x06 \x01(\x05H\x05R\x18sessionIdleTimeoutMillis\x12L\n\"schema_lock_acquire_timeout_millis\x18\x07 \x01(\x05H\x06R\x1eschemaLockAcquireTimeoutMillis\x12*\n\x10read_any_replica\x18\x08 \x01(\x08H\x07R\x0ereadAnyReplicaB\x0b\n\tinfer_optB\x15\n\x13trace_inference_optB\r\n\x0b\x65xplain_optB\x10\n\x0e\x62\x61tch_size_optB\x0e\n\x0cprefetch_optB\x1a\n\x18session_idle_timeout_optB!\n\x1fschema_lock_acquire_timeout_optB\x16\n\x14read_any_replica_optB\x1e\n\x0egrakn.protocolB\x0cOptionsProtob\x06proto3')
)
...
_OPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='grakn.protocol.Options.batch_size', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='prefetch', full_name='grakn.protocol.Options.prefetch', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='session_idle_timeout_millis', full_name='grakn.protocol.Options.session_idle_timeout_millis', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='schema_lock_acquire_timeout_millis', full_name='grakn.protocol.Options.schema_lock_acquire_timeout_millis', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='read_any_replica', full_name='grakn.protocol.Options.read_any_replica', index=7,
