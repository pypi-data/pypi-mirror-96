...
class MPSC:
    ...
    def train_loader(self, batch_size=1, *args, **kwargs):
        return DataLoader(dataset=self.trainset, batch_size=batch_size, collate_fn=self.collate_fn, *args, **kwargs)
    
    def test_loader(self, batch_size=1, *args, **kwargs):
        return DataLoader(dataset=self.trainset, batch_size=batch_size, collate_fn=self.collate_fn, *args, **kwargs)
    ...
    def get_datasets(self):
        ...
        print(f'[{self.num_data}/{self.num_data}] Creating datasets... Done', end='\r')
