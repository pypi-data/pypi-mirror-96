...
class CarriersApi(object):
    ...
    def query_carrier(self, carrier, **kwargs):  # noqa: E501
        """queryCarrier  # noqa: E501

        query carrier  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_carrier(carrier, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str carrier: Carrier name, could be empty (required)
        ...
        return self.query_carrier_with_http_info(carrier, **kwargs)  # noqa: E501

    def query_carrier_with_http_info(self, carrier, **kwargs):  # noqa: E501
        """queryCarrier  # noqa: E501

        query carrier  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_carrier_with_http_info(carrier, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('carrier' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `carrier` when calling `query_carrier`")  # noqa: E501
