...
class SessionCommand(object):
    ...
    def __init__(self, id=None, type=None, created_at=None, name=None, params=None, shell=None, shell_command=None, message=None, killed_at=None, finished_at=None, status_code=None, local_vars_configuration=None):  # noqa: E501
