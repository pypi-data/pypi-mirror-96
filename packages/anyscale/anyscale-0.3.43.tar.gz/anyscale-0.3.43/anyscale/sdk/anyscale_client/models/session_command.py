...
class SessionCommand(object):
    ...
    def __init__(self, session_id=None, shell_command=None, id=None, type=None, created_at=None, finished_at=None, status_code=None, killed_at=None, local_vars_configuration=None):  # noqa: E501
