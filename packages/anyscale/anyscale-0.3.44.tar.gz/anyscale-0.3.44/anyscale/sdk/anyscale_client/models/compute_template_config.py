...
class ComputeTemplateConfig(object):
    ...
    def __init__(self, cloud_id=None, region=None, allowed_azs=None, head_node_type=None, worker_node_types=None, aws=None, gcp=None, azure=None, local_vars_configuration=None):  # noqa: E501
