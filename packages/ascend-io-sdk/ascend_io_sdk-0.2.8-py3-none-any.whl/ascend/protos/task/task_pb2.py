...
_SPARK_LIST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='job_configuration', full_name='task.Spark.List.job_configuration', index=4,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='affinity_group_sha', full_name='task.Spark.List.affinity_group_sha', index=5,
...
_SPARK = _descriptor.Descriptor(
  ...
  nested_types=[_SPARK_EXECUTIONCONTEXT, _SPARK_FUNCTION, _SPARK_LIST, _SPARK_QUERY, _SPARK_QUERYTOSTREAM, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SPARKWRITE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='job_configuration', full_name='task.SparkWrite.job_configuration', index=4,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='affinity_group_sha', full_name='task.SparkWrite.affinity_group_sha', index=5,
      number=4, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='part_file_organization', full_name='task.SparkWrite.part_file_organization', index=6,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SPARK_LIST.fields_by_name['job_configuration'].message_type = ascend_dot_protos_dot_external_dot_external__pb2._SPARK_JOBCONFIGURATION
