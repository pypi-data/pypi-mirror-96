    ...
    def evaluate(self):
        ...
        for model in tqdm(all_models):
            ...
            try:
                ...
                print('CRIT switching to CPU training for', str(type(model)), 'due to ResourceExhaustedError.')
                print(ree)
                ...
                print('CRIT switching to CPU training for', str(type(model)), 'due to InternalError.')
                print(ie)
                print('!  (This is not a terminal error.)')
                # backup env variable
                environ_backup_flag = False
        ...
        for model in all_models:
            ...
            if self.enable_window_slicing:
                ...
                try:
                    ...
                    print('CRIT switching to CPU prediction for', str(type(model)), 'due to ResourceExhaustedError.')
                    print(ree)
                    print('!  (This is not a terminal error.)')
                    # backup env variable
                    environ_backup_flag = False
                    ...
                    print('CRIT switching to CPU prediction for', str(type(model)), 'due to InternalError.')
                    print(ie)
                    print('!  (This is not a terminal error.)')
                    # backup env variable
                    environ_backup_flag = False
