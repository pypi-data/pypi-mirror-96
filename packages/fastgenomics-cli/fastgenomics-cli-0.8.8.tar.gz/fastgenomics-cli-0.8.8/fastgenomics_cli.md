...
output
```bash
usage: fg.py [-h] {login,logout,configure-aws,version,lfs,dataset} ...
...
output
```bash
usage: fg.py login [-h] [-v] -u USER -p PASSPHRASE [-m {pat,password}]
                   [--url URL]
...
output
```bash
usage: fg.py dataset [-h] {upload-file,delete} ...
...
```bash
./fg.py dataset upload-file
```


output
```bash
usage: fg.py dataset upload-file [-h] [-v] -id ID
...
```bash
./fg.py dataset delete
```


output
```bash
usage: fg.py dataset delete [-h] [-v] -id ID
...
output
```bash
usage: fg.py lfs [-h] [-v] {create,get-url} ...
...
output
```bash
usage: fg.py lfs create [-h] [-v] [-z [ZIP_FILENAME]] [-P [ZIP_PASSWORD]] -r
...
output
```bash
usage: fg.py lfs get-url [-h] [-v] id access_token
...
```bash
./fg.py configure-aws -h
```


output
```bash
usage: fg.py configure-aws [-h] [-v]
