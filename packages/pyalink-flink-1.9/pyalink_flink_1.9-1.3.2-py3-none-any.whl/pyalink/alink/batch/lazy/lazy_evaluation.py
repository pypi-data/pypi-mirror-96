...
def pipe_j_lazy_to_py_callbacks(j_lazy_collect_f, py_callbacks, converter):
    ...
    # j_array = py_list_to_j_array(get_java_class("java.util.function.Consumer"), 1, [pipe_consumer])
    # j_lazy_collect_f(j_array)
    # # call_java_method(j_lazy_collect_f, [pipe_consumer])
    j_consumers = get_java_class("java.util.ArrayList")()
