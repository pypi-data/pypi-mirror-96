...
import easierSDK.serving.easier_serving_config_map
import easierSDK.serving.easier_serving_deployment
import easierSDK.serving.easier_serving_service 
import easierSDK.serving.easier_serving_ingress 
...
class ServingAPI():
    ...
    def create_model_serving(self, repo_name:str, category:Categories, model_name:str, experimentID:int, namespace=None):
        ...
        with kubernetes.client.ApiClient() as api_client:
            ...
            config_map['data']['category'] = category
