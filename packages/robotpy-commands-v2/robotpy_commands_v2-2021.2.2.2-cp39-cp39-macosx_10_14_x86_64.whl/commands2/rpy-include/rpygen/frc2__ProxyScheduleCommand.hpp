...
using PyBasefrc2__ProxyScheduleCommand = 
    Pyfrc2__CommandBase<
        PyTrampolineBase
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc2__ProxyScheduleCommand : PyBasefrc2__ProxyScheduleCommand<PyTrampolineBase, CxxBase> {
    using PyBasefrc2__ProxyScheduleCommand<PyTrampolineBase, CxxBase>::PyBasefrc2__ProxyScheduleCommand;
