...
using PyBasefrc2__ParallelCommandGroup = 
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc2__ParallelCommandGroup : PyBasefrc2__ParallelCommandGroup<PyTrampolineBase, CxxBase> {
    using PyBasefrc2__ParallelCommandGroup<PyTrampolineBase, CxxBase>::PyBasefrc2__ParallelCommandGroup;
