...
using PyBasefrc2__PerpetualCommand = 
    Pyfrc2__CommandBase<
        PyTrampolineBase
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc2__PerpetualCommand : PyBasefrc2__PerpetualCommand<PyTrampolineBase, CxxBase> {
    using PyBasefrc2__PerpetualCommand<PyTrampolineBase, CxxBase>::PyBasefrc2__PerpetualCommand;
