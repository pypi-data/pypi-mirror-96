...
using PyBasefrc2__ConditionalCommand = 
    Pyfrc2__CommandBase<
        PyTrampolineBase
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc2__ConditionalCommand : PyBasefrc2__ConditionalCommand<PyTrampolineBase, CxxBase> {
    using PyBasefrc2__ConditionalCommand<PyTrampolineBase, CxxBase>::PyBasefrc2__ConditionalCommand;
