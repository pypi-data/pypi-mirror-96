...
using PyBasefrc2__FunctionalCommand = 
    Pyfrc2__CommandBase<
        PyTrampolineBase
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc2__FunctionalCommand : PyBasefrc2__FunctionalCommand<PyTrampolineBase, CxxBase> {
    using PyBasefrc2__FunctionalCommand<PyTrampolineBase, CxxBase>::PyBasefrc2__FunctionalCommand;
