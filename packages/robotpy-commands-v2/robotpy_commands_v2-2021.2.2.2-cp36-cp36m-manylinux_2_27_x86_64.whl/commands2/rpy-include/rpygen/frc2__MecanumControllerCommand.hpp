...
using PyBasefrc2__MecanumControllerCommand = 
    Pyfrc2__CommandBase<
        PyTrampolineBase
...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc2__MecanumControllerCommand : PyBasefrc2__MecanumControllerCommand<PyTrampolineBase, CxxBase> {
    using PyBasefrc2__MecanumControllerCommand<PyTrampolineBase, CxxBase>::PyBasefrc2__MecanumControllerCommand;
