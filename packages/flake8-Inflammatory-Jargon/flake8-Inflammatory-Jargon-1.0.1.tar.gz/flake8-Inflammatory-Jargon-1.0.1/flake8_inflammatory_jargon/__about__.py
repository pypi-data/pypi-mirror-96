...
__license__ = 'MIT'
__copyright__ = 'Copyright 2021 tomgold182'
__keywords__ = ['linter', 'flake8', 'bad', 'jargon', 'slave', 'extension', 'Inflammatory']
__download_url__ = 'https://github.com/tomgold182/flake8-Inflammatory-jargon/archive/v1.0.1.tar.gz'