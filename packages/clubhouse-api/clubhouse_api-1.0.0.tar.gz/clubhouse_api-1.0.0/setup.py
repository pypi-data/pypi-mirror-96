...
long_description = '''Python module for Club House project 
                    management platform (ClubHouse API wrapper)'''
...
setup(
    ...
    download_url='https://github.com/Peopl3s/club-house-api/archive/v{}.zip'.format(
        version
    ),
