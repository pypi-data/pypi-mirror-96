...
- options (dict; default [{}]): An array of options {label: [string|number], value: [string|number]},
...
`value` property.
- value (string | number | list of string | numbers; optional): The value of the input. If `multi` is false
