...
import math3d
from hein_robots.robotics import Location, Twist, Wrench, Units
...
class UR3Arm(robot_arms.RobotArm):
    ...
    def location(self) -> Location:
        return Location.from_matrix(self.pose.array)
    ...
    def move_to_location(self, location: Location,
        ...
        transform = self.robot.csys * math3d.Transform(location.matrix)
