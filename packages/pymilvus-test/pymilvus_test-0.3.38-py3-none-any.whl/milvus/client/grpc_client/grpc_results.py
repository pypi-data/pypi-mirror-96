...
class ItemQueryResult2:
    ...
    def __str__(self):
        return "(distance: {}, score: {}, entity: {})".format(self.distance, self.score, self.entity)
...
class RawQueryResult2(LoopBase):
    ...
    def ids(self):
        ...
        return list([id_ for id_ in self._result.entities.ids[start: start + self._shape[1]] if id_ > -1])
