...
release_notes = {
    '1.56.3': """
    Support for Gridiron mode!
    
    Passing matchcomms-url to Java and C# bots as a command line argument.
    See https://github.com/RLBot/RLBot/wiki/Matchcomms for more information.
    """,
    '1.55.7': """
