...
class MsgVpnBridgeClearEvent(object):
    ...
    def event_name(self):
        ...
        The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  <pre> \"ttl-exceeded\" - Time to live exceeded event. </pre>   # noqa: E501
