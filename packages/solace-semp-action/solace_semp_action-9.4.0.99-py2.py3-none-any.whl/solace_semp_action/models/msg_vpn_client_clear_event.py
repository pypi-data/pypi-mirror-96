...
class MsgVpnClientClearEvent(object):
    ...
    def __init__(self, event_name=None):  # noqa: E501
        """MsgVpnClientClearEvent - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def event_name(self):
        """Gets the event_name of this MsgVpnClientClearEvent.  # noqa: E501

        The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  <pre> \"large-message\" - The Client large message received event. \"max-eliding-topic-count\" - The Client maximum eliding topics reached event. </pre>   # noqa: E501

        :return: The event_name of this MsgVpnClientClearEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def event_name(self, event_name):
        """Sets the event_name of this MsgVpnClientClearEvent.

        The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  <pre> \"large-message\" - The Client large message received event. \"max-eliding-topic-count\" - The Client maximum eliding topics reached event. </pre>   # noqa: E501

        :param event_name: The event_name of this MsgVpnClientClearEvent.  # noqa: E501
        :type: str
        """
        allowed_values = ["large-message", "max-eliding-topic-count"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnClientClearEvent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnClientClearEvent):
            return False
