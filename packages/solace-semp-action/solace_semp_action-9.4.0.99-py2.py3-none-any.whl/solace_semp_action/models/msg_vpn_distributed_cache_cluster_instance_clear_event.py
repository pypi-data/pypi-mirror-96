...
class MsgVpnDistributedCacheClusterInstanceClearEvent(object):
    ...
    def event_name(self):
        ...
        The name of the event. This attribute is absent from a GET and not updated when absent in a PUT. The allowed values and their meaning are:  <pre> \"lost-message\" - Lost message event. </pre>   # noqa: E501
