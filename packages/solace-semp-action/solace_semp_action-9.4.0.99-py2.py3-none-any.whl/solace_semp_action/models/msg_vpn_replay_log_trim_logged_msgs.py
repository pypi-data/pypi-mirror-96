...
class MsgVpnReplayLogTrimLoggedMsgs(object):
    ...
    def older_than_time(self):
        ...
        The time to use for trimming older messages. This attribute is absent from a GET and not updated when absent in a PUT. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501
