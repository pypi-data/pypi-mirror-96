...
class MsgVpnClientClearEvent(object):
    ...
    def event_name(self):
        ...
        The name of the event. The allowed values and their meaning are:  <pre> \"large-message\" - The Client large message received event. \"max-eliding-topic-count\" - The Client maximum eliding topics reached event. </pre>   # noqa: E501
