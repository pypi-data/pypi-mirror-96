...
class GuaranteedMsgingDefragmentMsgSpoolFilesStop(object):
    ...
    def __init__(self):  # noqa: E501
        """GuaranteedMsgingDefragmentMsgSpoolFilesStop - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GuaranteedMsgingDefragmentMsgSpoolFilesStop, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedMsgingDefragmentMsgSpoolFilesStop):
            return False
