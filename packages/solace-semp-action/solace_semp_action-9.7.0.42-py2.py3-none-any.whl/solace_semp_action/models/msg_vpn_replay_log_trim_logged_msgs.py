...
class MsgVpnReplayLogTrimLoggedMsgs(object):
    ...
    attribute_map = {
        'older_than_time': 'olderThanTime'
    }

    def __init__(self, older_than_time=None):  # noqa: E501
        """MsgVpnReplayLogTrimLoggedMsgs - a model defined in Swagger"""  # noqa: E501

        self._older_than_time = None
        self.discriminator = None

        if older_than_time is not None:
            self.older_than_time = older_than_time

    @property
    def older_than_time(self):
        """Gets the older_than_time of this MsgVpnReplayLogTrimLoggedMsgs.  # noqa: E501

        The time to use for trimming older messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :return: The older_than_time of this MsgVpnReplayLogTrimLoggedMsgs.  # noqa: E501
        :rtype: int
        """
        return self._older_than_time

    @older_than_time.setter
    def older_than_time(self, older_than_time):
        """Sets the older_than_time of this MsgVpnReplayLogTrimLoggedMsgs.

        The time to use for trimming older messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param older_than_time: The older_than_time of this MsgVpnReplayLogTrimLoggedMsgs.  # noqa: E501
        :type: int
        """

        self._older_than_time = older_than_time
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnReplayLogTrimLoggedMsgs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnReplayLogTrimLoggedMsgs):
            return False
