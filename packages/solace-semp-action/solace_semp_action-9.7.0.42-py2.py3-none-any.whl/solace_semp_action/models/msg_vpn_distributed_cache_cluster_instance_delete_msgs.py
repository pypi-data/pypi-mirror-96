...
class MsgVpnDistributedCacheClusterInstanceDeleteMsgs(object):
    ...
    def __init__(self, topic=None):  # noqa: E501
        """MsgVpnDistributedCacheClusterInstanceDeleteMsgs - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def topic(self):
        """Gets the topic of this MsgVpnDistributedCacheClusterInstanceDeleteMsgs.  # noqa: E501

        The topic covering the messages to delete. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :return: The topic of this MsgVpnDistributedCacheClusterInstanceDeleteMsgs.  # noqa: E501
        :rtype: str
        """
        return self._topic
    ...
    def topic(self, topic):
        """Sets the topic of this MsgVpnDistributedCacheClusterInstanceDeleteMsgs.

        The topic covering the messages to delete. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :param topic: The topic of this MsgVpnDistributedCacheClusterInstanceDeleteMsgs.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnDistributedCacheClusterInstanceDeleteMsgs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnDistributedCacheClusterInstanceDeleteMsgs):
            return False
