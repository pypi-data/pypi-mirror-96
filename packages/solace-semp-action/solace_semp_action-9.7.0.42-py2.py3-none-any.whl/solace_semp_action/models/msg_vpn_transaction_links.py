...
class MsgVpnTransactionLinks(object):
    ...
    attribute_map = {
        ...
        'rollback_uri': 'rollbackUri',
        'uri': 'uri'
    }

    def __init__(self, commit_uri=None, delete_uri=None, rollback_uri=None, uri=None):  # noqa: E501
        """MsgVpnTransactionLinks - a model defined in Swagger"""  # noqa: E501

        self._commit_uri = None
        self._delete_uri = None
        self._rollback_uri = None
        self._uri = None
        self.discriminator = None

        if commit_uri is not None:
            self.commit_uri = commit_uri
        if delete_uri is not None:
            self.delete_uri = delete_uri
        if rollback_uri is not None:
            self.rollback_uri = rollback_uri
        if uri is not None:
            self.uri = uri

    @property
    def commit_uri(self):
        """Gets the commit_uri of this MsgVpnTransactionLinks.  # noqa: E501

        The URI of this Replicated Local Transaction or XA Transaction's Commit action.  # noqa: E501

        :return: The commit_uri of this MsgVpnTransactionLinks.  # noqa: E501
        :rtype: str
        """
        return self._commit_uri

    @commit_uri.setter
    def commit_uri(self, commit_uri):
        """Sets the commit_uri of this MsgVpnTransactionLinks.

        The URI of this Replicated Local Transaction or XA Transaction's Commit action.  # noqa: E501

        :param commit_uri: The commit_uri of this MsgVpnTransactionLinks.  # noqa: E501
        :type: str
        """

        self._commit_uri = commit_uri

    @property
    def delete_uri(self):
        """Gets the delete_uri of this MsgVpnTransactionLinks.  # noqa: E501

        The URI of this Replicated Local Transaction or XA Transaction's Delete action.  # noqa: E501

        :return: The delete_uri of this MsgVpnTransactionLinks.  # noqa: E501
        :rtype: str
        """
        return self._delete_uri

    @delete_uri.setter
    def delete_uri(self, delete_uri):
        """Sets the delete_uri of this MsgVpnTransactionLinks.

        The URI of this Replicated Local Transaction or XA Transaction's Delete action.  # noqa: E501

        :param delete_uri: The delete_uri of this MsgVpnTransactionLinks.  # noqa: E501
        :type: str
        """
    ...
    def rollback_uri(self):
        """Gets the rollback_uri of this MsgVpnTransactionLinks.  # noqa: E501

        The URI of this Replicated Local Transaction or XA Transaction's Rollback action.  # noqa: E501

        :return: The rollback_uri of this MsgVpnTransactionLinks.  # noqa: E501
        :rtype: str
        """
        return self._rollback_uri

    @rollback_uri.setter
    def rollback_uri(self, rollback_uri):
        """Sets the rollback_uri of this MsgVpnTransactionLinks.

        The URI of this Replicated Local Transaction or XA Transaction's Rollback action.  # noqa: E501

        :param rollback_uri: The rollback_uri of this MsgVpnTransactionLinks.  # noqa: E501
        :type: str
        """

        self._rollback_uri = rollback_uri
