...
class MsgVpnTopicEndpointCancelReplay(object):
    ...
    def __init__(self, force_complete=None):  # noqa: E501
        """MsgVpnTopicEndpointCancelReplay - a model defined in Swagger"""  # noqa: E501
    ...
    def force_complete(self):
        """Gets the force_complete of this MsgVpnTopicEndpointCancelReplay.  # noqa: E501

        Force cancellation to complete without waiting for client unbind ack. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :return: The force_complete of this MsgVpnTopicEndpointCancelReplay.  # noqa: E501
        :rtype: bool
        """
    ...
    def force_complete(self, force_complete):
        """Sets the force_complete of this MsgVpnTopicEndpointCancelReplay.

        Force cancellation to complete without waiting for client unbind ack. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :param force_complete: The force_complete of this MsgVpnTopicEndpointCancelReplay.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnTopicEndpointCancelReplay, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnTopicEndpointCancelReplay):
            return False
