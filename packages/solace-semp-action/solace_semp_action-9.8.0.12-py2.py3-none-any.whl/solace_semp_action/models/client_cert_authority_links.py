...
class ClientCertAuthorityLinks(object):
    ...
    attribute_map = {
        'refresh_crl_uri': 'refreshCrlUri',
        'uri': 'uri'
    }

    def __init__(self, refresh_crl_uri=None, uri=None):  # noqa: E501
        """ClientCertAuthorityLinks - a model defined in Swagger"""  # noqa: E501

        self._refresh_crl_uri = None
        self._uri = None
        self.discriminator = None

        if refresh_crl_uri is not None:
            self.refresh_crl_uri = refresh_crl_uri
        if uri is not None:
            self.uri = uri

    @property
    def refresh_crl_uri(self):
        """Gets the refresh_crl_uri of this ClientCertAuthorityLinks.  # noqa: E501

        The URI of this Client Certificate Authority's Refresh CRL action.  # noqa: E501

        :return: The refresh_crl_uri of this ClientCertAuthorityLinks.  # noqa: E501
        :rtype: str
        """
        return self._refresh_crl_uri

    @refresh_crl_uri.setter
    def refresh_crl_uri(self, refresh_crl_uri):
        """Sets the refresh_crl_uri of this ClientCertAuthorityLinks.

        The URI of this Client Certificate Authority's Refresh CRL action.  # noqa: E501

        :param refresh_crl_uri: The refresh_crl_uri of this ClientCertAuthorityLinks.  # noqa: E501
        :type: str
        """

        self._refresh_crl_uri = refresh_crl_uri
