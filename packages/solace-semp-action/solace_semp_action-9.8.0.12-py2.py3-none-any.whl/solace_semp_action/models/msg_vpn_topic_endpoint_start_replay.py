...
class MsgVpnTopicEndpointStartReplay(object):
    ...
    def __init__(self, from_time=None, replay_log_name=None):  # noqa: E501
        """MsgVpnTopicEndpointStartReplay - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def from_time(self):
        """Gets the from_time of this MsgVpnTopicEndpointStartReplay.  # noqa: E501

        The time to begin replaying messages from. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :return: The from_time of this MsgVpnTopicEndpointStartReplay.  # noqa: E501
        :rtype: int
        """
    ...
    def from_time(self, from_time):
        """Sets the from_time of this MsgVpnTopicEndpointStartReplay.

        The time to begin replaying messages from. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501

        :param from_time: The from_time of this MsgVpnTopicEndpointStartReplay.  # noqa: E501
        :type: int
        """
    ...
    def replay_log_name(self):
        """Gets the replay_log_name of this MsgVpnTopicEndpointStartReplay.  # noqa: E501

        The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :return: The replay_log_name of this MsgVpnTopicEndpointStartReplay.  # noqa: E501
        :rtype: str
        """
    ...
    def replay_log_name(self, replay_log_name):
        """Sets the replay_log_name of this MsgVpnTopicEndpointStartReplay.

        The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :param replay_log_name: The replay_log_name of this MsgVpnTopicEndpointStartReplay.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnTopicEndpointStartReplay, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnTopicEndpointStartReplay):
            return False
