...
class AllApi(object):
    ...
    def do_cert_authority_refresh_crl(self, cert_authority_name, body, **kwargs):  # noqa: E501
        """Refresh the CRL file for the Certificate Authority.  # noqa: E501

        Refresh the CRL file for the Certificate Authority.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been deprecated since 2.19. Replaced by clientCertAuthorities.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_cert_authority_refresh_crl(cert_authority_name, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cert_authority_name: The name of the Certificate Authority. (required)
        :param CertAuthorityRefreshCrl body: The Refresh CRL action's attributes. (required)
        ...
        if kwargs.get('async_req'):
            return self.do_cert_authority_refresh_crl_with_http_info(cert_authority_name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.do_cert_authority_refresh_crl_with_http_info(cert_authority_name, body, **kwargs)  # noqa: E501
            return data

    def do_cert_authority_refresh_crl_with_http_info(self, cert_authority_name, body, **kwargs):  # noqa: E501
        """Refresh the CRL file for the Certificate Authority.  # noqa: E501

        Refresh the CRL file for the Certificate Authority.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been deprecated since 2.19. Replaced by clientCertAuthorities.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_cert_authority_refresh_crl_with_http_info(cert_authority_name, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cert_authority_name', 'body']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method do_cert_authority_refresh_crl" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('cert_authority_name' not in params or
            ...
            raise ValueError("Missing the required parameter `cert_authority_name` when calling `do_cert_authority_refresh_crl`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `do_cert_authority_refresh_crl`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/certAuthorities/{certAuthorityName}/refreshCrl', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def do_client_cert_authority_refresh_crl(self, cert_authority_name, body, **kwargs):  # noqa: E501
        """Refresh the CRL file for the Client Certificate Authority.  # noqa: E501

        Refresh the CRL file for the Client Certificate Authority.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.19.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_client_cert_authority_refresh_crl(cert_authority_name, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cert_authority_name: The name of the Certificate Authority. (required)
        :param ClientCertAuthorityRefreshCrl body: The Refresh CRL action's attributes. (required)
        :return: SempMetaOnlyResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.do_client_cert_authority_refresh_crl_with_http_info(cert_authority_name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.do_client_cert_authority_refresh_crl_with_http_info(cert_authority_name, body, **kwargs)  # noqa: E501
            return data

    def do_client_cert_authority_refresh_crl_with_http_info(self, cert_authority_name, body, **kwargs):  # noqa: E501
        """Refresh the CRL file for the Client Certificate Authority.  # noqa: E501

        Refresh the CRL file for the Client Certificate Authority.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.19.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_client_cert_authority_refresh_crl_with_http_info(cert_authority_name, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method do_client_cert_authority_refresh_crl" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cert_authority_name' is set
        if ('cert_authority_name' not in params or
                params['cert_authority_name'] is None):
            raise ValueError("Missing the required parameter `cert_authority_name` when calling `do_client_cert_authority_refresh_crl`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `do_client_cert_authority_refresh_crl`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/clientCertAuthorities/{certAuthorityName}/refreshCrl', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def do_guaranteed_msging_defragment_msg_spool_files_start(self, body, **kwargs):  # noqa: E501
        """Start a spool file defragmentation run.  # noqa: E501

        Start a spool file defragmentation run.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.18.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_guaranteed_msging_defragment_msg_spool_files_start(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GuaranteedMsgingDefragmentMsgSpoolFilesStart body: The Start Defragmentation action's attributes. (required)
        :return: SempMetaOnlyResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.do_guaranteed_msging_defragment_msg_spool_files_start_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.do_guaranteed_msging_defragment_msg_spool_files_start_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def do_guaranteed_msging_defragment_msg_spool_files_start_with_http_info(self, body, **kwargs):  # noqa: E501
        """Start a spool file defragmentation run.  # noqa: E501

        Start a spool file defragmentation run.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.18.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_guaranteed_msging_defragment_msg_spool_files_start_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method do_guaranteed_msging_defragment_msg_spool_files_start" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `do_guaranteed_msging_defragment_msg_spool_files_start`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/guaranteedMsgingDefragmentMsgSpoolFilesStart', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def do_guaranteed_msging_defragment_msg_spool_files_stop(self, body, **kwargs):  # noqa: E501
        """Stop a spool file defragmentation run.  # noqa: E501

        Stop a spool file defragmentation run.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.18.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_guaranteed_msging_defragment_msg_spool_files_stop(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param GuaranteedMsgingDefragmentMsgSpoolFilesStop body: The Stop Defragmentation action's attributes. (required)
        :return: SempMetaOnlyResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.do_guaranteed_msging_defragment_msg_spool_files_stop_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.do_guaranteed_msging_defragment_msg_spool_files_stop_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def do_guaranteed_msging_defragment_msg_spool_files_stop_with_http_info(self, body, **kwargs):  # noqa: E501
        """Stop a spool file defragmentation run.  # noqa: E501

        Stop a spool file defragmentation run.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.18.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_guaranteed_msging_defragment_msg_spool_files_stop_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method do_guaranteed_msging_defragment_msg_spool_files_stop" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `do_guaranteed_msging_defragment_msg_spool_files_stop`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/guaranteedMsgingDefragmentMsgSpoolFilesStop', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def do_msg_vpn_authentication_oauth_provider_clear_stats(self, msg_vpn_name, oauth_provider_name, body, **kwargs):  # noqa: E501
        """Clear the statistics for the OAuth Provider.  # noqa: E501

        Clear the statistics for the OAuth Provider.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.13.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_msg_vpn_authentication_oauth_provider_clear_stats(msg_vpn_name, oauth_provider_name, body, async_req=True)
        >>> result = thread.get()
        ...
        :param MsgVpnAuthenticationOauthProviderClearStats body: The Clear Stats action's attributes. (required)
        :return: SempMetaOnlyResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.do_msg_vpn_authentication_oauth_provider_clear_stats_with_http_info(msg_vpn_name, oauth_provider_name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.do_msg_vpn_authentication_oauth_provider_clear_stats_with_http_info(msg_vpn_name, oauth_provider_name, body, **kwargs)  # noqa: E501
            return data

    def do_msg_vpn_authentication_oauth_provider_clear_stats_with_http_info(self, msg_vpn_name, oauth_provider_name, body, **kwargs):  # noqa: E501
        """Clear the statistics for the OAuth Provider.  # noqa: E501

        Clear the statistics for the OAuth Provider.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.13.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.do_msg_vpn_authentication_oauth_provider_clear_stats_with_http_info(msg_vpn_name, oauth_provider_name, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['msg_vpn_name', 'oauth_provider_name', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method do_msg_vpn_authentication_oauth_provider_clear_stats" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('msg_vpn_name' not in params or
            ...
            raise ValueError("Missing the required parameter `msg_vpn_name` when calling `do_msg_vpn_authentication_oauth_provider_clear_stats`")  # noqa: E501
        ...
        if ('oauth_provider_name' not in params or
            ...
            raise ValueError("Missing the required parameter `oauth_provider_name` when calling `do_msg_vpn_authentication_oauth_provider_clear_stats`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `do_msg_vpn_authentication_oauth_provider_clear_stats`")  # noqa: E501
    ...
    def do_msg_vpn_bridge_clear_event(self, msg_vpn_name, bridge_name, bridge_virtual_router, body, **kwargs):  # noqa: E501
        ...
        Clear an event for the Bridge so it can be generated anew.   Attribute|Required|Deprecated :---|:---:|:---: eventName|x|    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_bridge_clear_stats(self, msg_vpn_name, bridge_name, bridge_virtual_router, body, **kwargs):  # noqa: E501
        ...
        Clear the statistics for the Bridge.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_bridge_disconnect(self, msg_vpn_name, bridge_name, bridge_virtual_router, body, **kwargs):  # noqa: E501
        ...
        Disconnect the Bridge.    A SEMP client authorized with a minimum access scope/level of \"global/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_clear_msg_spool_stats(self, msg_vpn_name, body, **kwargs):  # noqa: E501
        ...
        Clear the message spool statistics for the Message VPN.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_clear_replication_stats(self, msg_vpn_name, body, **kwargs):  # noqa: E501
        ...
        Clear the replication statistics for the Message VPN.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_clear_service_stats(self, msg_vpn_name, body, **kwargs):  # noqa: E501
        ...
        Clear the service statistics for the Message VPN.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_clear_stats(self, msg_vpn_name, body, **kwargs):  # noqa: E501
        """Clear the client statistics for the Message VPN.  # noqa: E501

        Clear the client statistics for the Message VPN.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_client_clear_event(self, msg_vpn_name, client_name, body, **kwargs):  # noqa: E501
        ...
        Clear an event for the Client so it can be generated anew.   Attribute|Required|Deprecated :---|:---:|:---: eventName|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-only\" is required to perform this operation.  This has been available since 2.12.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_client_clear_stats(self, msg_vpn_name, client_name, body, **kwargs):  # noqa: E501
        ...
        Clear the statistics for the Client.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_client_disconnect(self, msg_vpn_name, client_name, body, **kwargs):  # noqa: E501
        ...
        Disconnect the Client.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_client_transacted_session_delete(self, msg_vpn_name, client_name, session_name, body, **kwargs):  # noqa: E501
        ...
        Delete the Transacted Session.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_backup_cached_msgs(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Backup cached messages of the Cache Instance to disk.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_cancel_backup_cached_msgs(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Cancel the backup of cached messages from the Cache Instance.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_cancel_restore_cached_msgs(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Cancel the restore of cached messages to the Cache Instance.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_clear_event(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Clear an event for the Cache Instance so it can be generated anew.   Attribute|Required|Deprecated :---|:---:|:---: eventName|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_clear_stats(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Clear the statistics for the Cache Instance.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_delete_msgs(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Delete messages covered by the given topic in the Cache Instance.   Attribute|Required|Deprecated :---|:---:|:---: topic|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_restore_cached_msgs(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Restore cached messages for the Cache Instance from disk.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_distributed_cache_cluster_instance_start(self, msg_vpn_name, cache_name, cluster_name, instance_name, body, **kwargs):  # noqa: E501
        ...
        Start the Cache Instance.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_mqtt_session_clear_stats(self, msg_vpn_name, mqtt_session_client_id, mqtt_session_virtual_router, body, **kwargs):  # noqa: E501
        ...
        Clear the statistics for the MQTT Session.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_queue_cancel_replay(self, msg_vpn_name, queue_name, body, **kwargs):  # noqa: E501
        ...
        Cancel the replay of messages to the Queue.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_queue_clear_stats(self, msg_vpn_name, queue_name, body, **kwargs):  # noqa: E501
        ...
        Clear the statistics for the Queue.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_queue_msg_delete(self, msg_vpn_name, queue_name, msg_id, body, **kwargs):  # noqa: E501
        ...
        Delete the Message from the Queue.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_queue_start_replay(self, msg_vpn_name, queue_name, body, **kwargs):  # noqa: E501
        ...
        Start the replay of messages to the Queue.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_replay_log_trim_logged_msgs(self, msg_vpn_name, replay_log_name, body, **kwargs):  # noqa: E501
        ...
        Trim (delete) messages from the Replay Log.   Attribute|Required|Deprecated :---|:---:|:---: olderThanTime|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_rest_delivery_point_rest_consumer_clear_stats(self, msg_vpn_name, rest_delivery_point_name, rest_consumer_name, body, **kwargs):  # noqa: E501
        ...
        Clear the statistics for the REST Consumer.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_topic_endpoint_cancel_replay(self, msg_vpn_name, topic_endpoint_name, body, **kwargs):  # noqa: E501
        ...
        Cancel the replay of messages to the Topic Endpoint.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_topic_endpoint_clear_stats(self, msg_vpn_name, topic_endpoint_name, body, **kwargs):  # noqa: E501
        ...
        Clear the statistics for the Topic Endpoint.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_topic_endpoint_msg_delete(self, msg_vpn_name, topic_endpoint_name, msg_id, body, **kwargs):  # noqa: E501
        ...
        Delete the Message from the Topic Endpoint.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_topic_endpoint_start_replay(self, msg_vpn_name, topic_endpoint_name, body, **kwargs):  # noqa: E501
        ...
        Start the replay of messages to the Topic Endpoint.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_transaction_commit(self, msg_vpn_name, xid, body, **kwargs):  # noqa: E501
        ...
        Commit the Transaction.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.12.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_transaction_delete(self, msg_vpn_name, xid, body, **kwargs):  # noqa: E501
        ...
        Delete the Transaction.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.12.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def do_msg_vpn_transaction_rollback(self, msg_vpn_name, xid, body, **kwargs):  # noqa: E501
        ...
        Rollback the Transaction.    A SEMP client authorized with a minimum access scope/level of \"vpn/read-write\" is required to perform this operation.  This has been available since 2.12.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_broker(self, **kwargs):  # noqa: E501
        ...
        Get a Broker object.  This object contains global configuration for the message broker.    A SEMP client authorized with a minimum access scope/level of \"global/none\" is required to perform this operation.  This has been available since 2.13.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_client_cert_authorities(self, **kwargs):  # noqa: E501
        """Get a list of Client Certificate Authority objects.  # noqa: E501

        Get a list of Client Certificate Authority objects.  Clients can authenticate with the message broker over TLS by presenting a valid client certificate. The message broker authenticates the client certificate by constructing a full certificate chain (from the client certificate to intermediate CAs to a configured root CA). The intermediate CAs in this chain can be provided by the client, or configured in the message broker. The root CA must be configured on the message broker.   Attribute|Identifying|Deprecated :---|:---:|:---: certAuthorityName|x|    A SEMP client authorized with a minimum access scope/level of \"global/read-only\" is required to perform this operation.  This has been available since 2.19.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_cert_authorities(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_client_cert_authorities_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_client_cert_authorities_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_client_cert_authorities_with_http_info(self, **kwargs):  # noqa: E501
        """Get a list of Client Certificate Authority objects.  # noqa: E501

        Get a list of Client Certificate Authority objects.  Clients can authenticate with the message broker over TLS by presenting a valid client certificate. The message broker authenticates the client certificate by constructing a full certificate chain (from the client certificate to intermediate CAs to a configured root CA). The intermediate CAs in this chain can be provided by the client, or configured in the message broker. The root CA must be configured on the message broker.   Attribute|Identifying|Deprecated :---|:---:|:---: certAuthorityName|x|    A SEMP client authorized with a minimum access scope/level of \"global/read-only\" is required to perform this operation.  This has been available since 2.19.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_cert_authorities_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_client_cert_authorities" % key
                )
            params[key] = val
        del params['kwargs']

        if 'count' in params and params['count'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `count` when calling `get_client_cert_authorities`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ClientCertAuthoritiesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_client_cert_authority(self, cert_authority_name, **kwargs):  # noqa: E501
        """Get a Client Certificate Authority object.  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_cert_authority(cert_authority_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_client_cert_authority_with_http_info(cert_authority_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_client_cert_authority_with_http_info(cert_authority_name, **kwargs)  # noqa: E501
            return data

    def get_client_cert_authority_with_http_info(self, cert_authority_name, **kwargs):  # noqa: E501
        """Get a Client Certificate Authority object.  # noqa: E501

        Get a Client Certificate Authority object.  Clients can authenticate with the message broker over TLS by presenting a valid client certificate. The message broker authenticates the client certificate by constructing a full certificate chain (from the client certificate to intermediate CAs to a configured root CA). The intermediate CAs in this chain can be provided by the client, or configured in the message broker. The root CA must be configured on the message broker.   Attribute|Identifying|Deprecated :---|:---:|:---: certAuthorityName|x|    A SEMP client authorized with a minimum access scope/level of \"global/read-only\" is required to perform this operation.  This has been available since 2.19.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_cert_authority_with_http_info(cert_authority_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_client_cert_authority" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cert_authority_name' is set
        if ('cert_authority_name' not in params or
                params['cert_authority_name'] is None):
            raise ValueError("Missing the required parameter `cert_authority_name` when calling `get_client_cert_authority`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ClientCertAuthorityResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_msg_vpn_authentication_oauth_provider(self, msg_vpn_name, oauth_provider_name, **kwargs):  # noqa: E501
        ...
        Get an OAuth Provider object.  OAuth Providers contain information about the issuer of an OAuth token that is needed to validate the token and derive a client username from it.   Attribute|Identifying|Deprecated :---|:---:|:---: msgVpnName|x| oauthProviderName|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-only\" is required to perform this operation.  This has been available since 2.13.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_msg_vpn_queue_msg(self, msg_vpn_name, queue_name, msg_id, **kwargs):  # noqa: E501
        ...
        Get a Queue Message object.  A Queue Message is a packet of information sent from producers to consumers using the Queue.   Attribute|Identifying|Deprecated :---|:---:|:---: msgId|x| msgVpnName|x| queueName|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-only\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_msg_vpn_rest_delivery_point_rest_consumer(self, msg_vpn_name, rest_delivery_point_name, rest_consumer_name, **kwargs):  # noqa: E501
        ...
        Get a REST Consumer object.  REST Consumer objects establish HTTP connectivity to REST consumer applications who wish to receive messages from a broker.   Attribute|Identifying|Deprecated :---|:---:|:---: msgVpnName|x| restConsumerName|x| restDeliveryPointName|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-only\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_msg_vpn_topic_endpoint_msg(self, msg_vpn_name, topic_endpoint_name, msg_id, **kwargs):  # noqa: E501
        ...
        Get a Topic Endpoint Message object.  A Topic Endpoint Message is a packet of information sent from producers to consumers using the Topic Endpoint.   Attribute|Identifying|Deprecated :---|:---:|:---: msgId|x| msgVpnName|x| topicEndpointName|x|    A SEMP client authorized with a minimum access scope/level of \"vpn/read-only\" is required to perform this operation.  This has been available since 2.11.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
