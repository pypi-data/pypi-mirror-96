...
class MsgVpnBridge(object):
    ...
    def __init__(self, bridge_name=None, bridge_virtual_router=None, msg_vpn_name=None):  # noqa: E501
    ...
    def bridge_virtual_router(self):
        ...
        Indicates whether the Bridge is configured for the primary or backup virtual router or auto configured The allowed values and their meaning are:  <pre> \"primary\" - Primary virtual router. \"backup\" - Backup virtual router. \"auto\" - Automatic virtual router. </pre>   # noqa: E501
