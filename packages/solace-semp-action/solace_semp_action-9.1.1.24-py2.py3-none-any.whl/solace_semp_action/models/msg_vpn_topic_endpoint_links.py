...
class MsgVpnTopicEndpointLinks(object):
    ...
    """
    swagger_types = {
        'cancel_replay_uri': 'str',
        'clear_stats_uri': 'str',
        'msgs_uri': 'str',
        'start_replay_uri': 'str',
        'uri': 'str'
    }

    attribute_map = {
        'cancel_replay_uri': 'cancelReplayUri',
        'clear_stats_uri': 'clearStatsUri',
        'msgs_uri': 'msgsUri',
        'start_replay_uri': 'startReplayUri',
        'uri': 'uri'
    }

    def __init__(self, cancel_replay_uri=None, clear_stats_uri=None, msgs_uri=None, start_replay_uri=None, uri=None):  # noqa: E501
        """MsgVpnTopicEndpointLinks - a model defined in Swagger"""  # noqa: E501

        self._cancel_replay_uri = None
        self._clear_stats_uri = None
        self._msgs_uri = None
        self._start_replay_uri = None
        self._uri = None
        self.discriminator = None

        if cancel_replay_uri is not None:
            self.cancel_replay_uri = cancel_replay_uri
        if clear_stats_uri is not None:
            self.clear_stats_uri = clear_stats_uri
        if msgs_uri is not None:
            self.msgs_uri = msgs_uri
        if start_replay_uri is not None:
            self.start_replay_uri = start_replay_uri
        if uri is not None:
            self.uri = uri

    @property
    def cancel_replay_uri(self):
        """Gets the cancel_replay_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501

        The URI of this MsgVpnTopicEndpoint's cancelReplay action.  # noqa: E501

        :return: The cancel_replay_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :rtype: str
        """
        return self._cancel_replay_uri

    @cancel_replay_uri.setter
    def cancel_replay_uri(self, cancel_replay_uri):
        """Sets the cancel_replay_uri of this MsgVpnTopicEndpointLinks.

        The URI of this MsgVpnTopicEndpoint's cancelReplay action.  # noqa: E501

        :param cancel_replay_uri: The cancel_replay_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :type: str
        """

        self._cancel_replay_uri = cancel_replay_uri

    @property
    def clear_stats_uri(self):
        """Gets the clear_stats_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501

        The URI of this MsgVpnTopicEndpoint's clearStats action.  # noqa: E501

        :return: The clear_stats_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :rtype: str
        """
    ...
    def clear_stats_uri(self, clear_stats_uri):
        """Sets the clear_stats_uri of this MsgVpnTopicEndpointLinks.

        The URI of this MsgVpnTopicEndpoint's clearStats action.  # noqa: E501

        :param clear_stats_uri: The clear_stats_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def msgs_uri(self):
        """Gets the msgs_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501

        The URI of this MsgVpnTopicEndpoint's msgs collection.  # noqa: E501

        :return: The msgs_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :rtype: str
        """
        return self._msgs_uri

    @msgs_uri.setter
    def msgs_uri(self, msgs_uri):
        """Sets the msgs_uri of this MsgVpnTopicEndpointLinks.

        The URI of this MsgVpnTopicEndpoint's msgs collection.  # noqa: E501

        :param msgs_uri: The msgs_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :type: str
        """

        self._msgs_uri = msgs_uri

    @property
    def start_replay_uri(self):
        """Gets the start_replay_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501

        The URI of this MsgVpnTopicEndpoint's startReplay action.  # noqa: E501

        :return: The start_replay_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :rtype: str
        """
        return self._start_replay_uri

    @start_replay_uri.setter
    def start_replay_uri(self, start_replay_uri):
        """Sets the start_replay_uri of this MsgVpnTopicEndpointLinks.

        The URI of this MsgVpnTopicEndpoint's startReplay action.  # noqa: E501

        :param start_replay_uri: The start_replay_uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :type: str
        """

        self._start_replay_uri = start_replay_uri

    @property
    def uri(self):
        """Gets the uri of this MsgVpnTopicEndpointLinks.  # noqa: E501

        The URI of this MsgVpnTopicEndpoint object.  # noqa: E501

        :return: The uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :rtype: str
        """
        return self._uri
    ...
    def uri(self, uri):
        ...
        :param uri: The uri of this MsgVpnTopicEndpointLinks.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnTopicEndpointLinks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnTopicEndpointLinks):
            return False
