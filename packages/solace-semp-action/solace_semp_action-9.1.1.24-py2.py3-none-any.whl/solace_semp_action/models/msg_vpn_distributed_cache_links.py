...
class MsgVpnDistributedCacheLinks(object):
    ...
    attribute_map = {
        'clusters_uri': 'clustersUri',
        'uri': 'uri'
    }

    def __init__(self, clusters_uri=None, uri=None):  # noqa: E501
        """MsgVpnDistributedCacheLinks - a model defined in Swagger"""  # noqa: E501

        self._clusters_uri = None
        self._uri = None
        self.discriminator = None

        if clusters_uri is not None:
            self.clusters_uri = clusters_uri
        if uri is not None:
            self.uri = uri

    @property
    def clusters_uri(self):
        """Gets the clusters_uri of this MsgVpnDistributedCacheLinks.  # noqa: E501

        The URI of this MsgVpnDistributedCache's clusters collection.  # noqa: E501

        :return: The clusters_uri of this MsgVpnDistributedCacheLinks.  # noqa: E501
        :rtype: str
        """
        return self._clusters_uri

    @clusters_uri.setter
    def clusters_uri(self, clusters_uri):
        """Sets the clusters_uri of this MsgVpnDistributedCacheLinks.

        The URI of this MsgVpnDistributedCache's clusters collection.  # noqa: E501

        :param clusters_uri: The clusters_uri of this MsgVpnDistributedCacheLinks.  # noqa: E501
        :type: str
        """

        self._clusters_uri = clusters_uri

    @property
    def uri(self):
        """Gets the uri of this MsgVpnDistributedCacheLinks.  # noqa: E501

        The URI of this MsgVpnDistributedCache object.  # noqa: E501

        :return: The uri of this MsgVpnDistributedCacheLinks.  # noqa: E501
        :rtype: str
        """
        return self._uri
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this MsgVpnDistributedCacheLinks.

        The URI of this MsgVpnDistributedCache object.  # noqa: E501

        :param uri: The uri of this MsgVpnDistributedCacheLinks.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnDistributedCacheLinks, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnDistributedCacheLinks):
            return False
