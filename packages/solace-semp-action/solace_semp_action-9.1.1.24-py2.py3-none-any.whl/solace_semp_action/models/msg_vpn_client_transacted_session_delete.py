...
class MsgVpnClientTransactedSessionDelete(object):
    ...
    def __init__(self):  # noqa: E501
        """MsgVpnClientTransactedSessionDelete - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnClientTransactedSessionDelete, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnClientTransactedSessionDelete):
            return False
