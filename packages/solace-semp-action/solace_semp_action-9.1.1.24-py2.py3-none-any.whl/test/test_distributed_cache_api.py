...
from solace_semp_action.api.distributed_cache_api import DistributedCacheApi  # noqa: E501
from solace_semp_action.rest import ApiException


class TestDistributedCacheApi(unittest.TestCase):
    """DistributedCacheApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_action.api.distributed_cache_api.DistributedCacheApi()  # noqa: E501
