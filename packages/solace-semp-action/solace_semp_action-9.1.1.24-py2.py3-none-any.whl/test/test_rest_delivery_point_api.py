...
from solace_semp_action.api.rest_delivery_point_api import RestDeliveryPointApi  # noqa: E501
from solace_semp_action.rest import ApiException


class TestRestDeliveryPointApi(unittest.TestCase):
    """RestDeliveryPointApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_action.api.rest_delivery_point_api.RestDeliveryPointApi()  # noqa: E501
