...
from solace_semp_action.api.topic_endpoint_api import TopicEndpointApi  # noqa: E501
from solace_semp_action.rest import ApiException


class TestTopicEndpointApi(unittest.TestCase):
    """TopicEndpointApi unit test stubs"""

    def setUp(self):
        self.api = solace_semp_action.api.topic_endpoint_api.TopicEndpointApi()  # noqa: E501
