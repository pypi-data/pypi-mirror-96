...
class MsgVpnTopicEndpointStartReplay(object):
    ...
    def from_time(self):
        ...
        The time to begin replaying messages from. This attribute is absent from a GET and not updated when absent in a PUT. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).  # noqa: E501
    ...
    def replay_log_name(self):
        ...
        The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT.  # noqa: E501
