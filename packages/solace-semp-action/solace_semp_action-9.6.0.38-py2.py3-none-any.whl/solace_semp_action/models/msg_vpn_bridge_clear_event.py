...
class MsgVpnBridgeClearEvent(object):
    ...
    def __init__(self, event_name=None):  # noqa: E501
        """MsgVpnBridgeClearEvent - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def event_name(self):
        """Gets the event_name of this MsgVpnBridgeClearEvent.  # noqa: E501

        The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  <pre> \"ttl-exceeded\" - Time to live exceeded event. </pre>   # noqa: E501

        :return: The event_name of this MsgVpnBridgeClearEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def event_name(self, event_name):
        """Sets the event_name of this MsgVpnBridgeClearEvent.

        The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  <pre> \"ttl-exceeded\" - Time to live exceeded event. </pre>   # noqa: E501

        :param event_name: The event_name of this MsgVpnBridgeClearEvent.  # noqa: E501
        :type: str
        """
        allowed_values = ["ttl-exceeded"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnBridgeClearEvent, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnBridgeClearEvent):
            return False
