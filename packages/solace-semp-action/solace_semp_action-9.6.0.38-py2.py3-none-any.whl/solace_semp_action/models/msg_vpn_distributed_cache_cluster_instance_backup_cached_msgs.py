...
class MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs(object):
    ...
    def __init__(self, filename=None):  # noqa: E501
        """MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def filename(self):
        """Gets the filename of this MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs.  # noqa: E501

        The filename for storing the cached messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :return: The filename of this MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs.  # noqa: E501
        :rtype: str
        """
    ...
    def filename(self, filename):
        """Sets the filename of this MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs.

        The filename for storing the cached messages. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.  # noqa: E501

        :param filename: The filename of this MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs):
            return False
