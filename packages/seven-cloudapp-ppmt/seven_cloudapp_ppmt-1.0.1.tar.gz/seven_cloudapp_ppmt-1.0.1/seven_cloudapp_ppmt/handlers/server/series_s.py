...
:LastEditTime: 2021-02-24 10:53:41
...
class SeriesHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        if is_add:
            ...
            # 记录日志
            self.create_operation_log(OperationType.update.value, ip_series.__str__(), "SeriesHandler", self.json_dumps(old_ip_series.__dict__), self.json_dumps(ip_series.__dict__))
