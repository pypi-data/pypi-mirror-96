...
class ADS1x15:
    ...
    def setInput(self, input) :
        ...
        self.__configRegister = (self.__configRegister & 0x8FFF) | inputRegister
        self.writeRegister(self.__address, self.__configRegister)

    # Get input multiplexer configuration
    def getInput(self) :
        return (self.__configRegister & 0x7000) >> 12
    ...
    def setGain(self, gain) :
        ...
        self.__configRegister = (self.__configRegister & 0xF1FF) | gainRegister
        self.writeRegister(self.__address, self.__configRegister)

    # Get programmable gain amplifier configuration
    def getGain(self) :
        return (self.__configRegister & 0x0E00) >> 9
    ...
    def setMode(self, mode) :
        ...
        self.__configRegister = (self.__configRegister & 0xFEFF) | modeRegister
        self.writeRegister(self.__address, self.__configRegister)

    # Get device operating mode configuration
    def getMode(self) :
        return (self.__configRegister & 0x0100) >> 8
    ...
    def setDataRate(self, dataRate) :
        ...
        self.__configRegister = (self.__configRegister & 0xFF1F) | dataRateRegister
        self.writeRegister(self.__address, self.__configRegister)

    # Get data rate configuration
    def getDataRate(self) :
        return (self.__configRegister & 0x00E0) >> 5
    ...
    def setComparatorMode(self, comparatorMode) :
        ...
        self.__configRegister = (self.__configRegister & 0xFFEF) | comparatorModeRegister
        self.writeRegister(self.__address, self.__configRegister)

    # Get comparator mode configuration
    def getComparatorMode(self) :
        return (self.__configRegister & 0x0010) >> 4
    ...
    def setComparatorPolarity(self, comparatorPolarity) :
        ...
        self.__configRegister = (self.__configRegister & 0xFFF7) | comparatorPolarityRegister
        self.writeRegister(self.__address, self.__configRegister)

    # Get comparator polarity configuration
    def getComparatorPolarity(self) :
        return (self.__configRegister & 0x0008) >> 3
    ...
    def setComparatorLatch(self, comparatorLatch) :
        ...
        self.__configRegister = (self.__configRegister & 0xFFFB) | comparatorLatchRegister
        self.writeRegister(self.__address, self.__configRegister)

    # Get comparator polarity configuration
    def getComparatorLatch(self) :
        return (self.__configRegister & 0x0004) >> 2
    ...
    def __requestADC(self, input) :
        ...
        if self.__configRegister & 0x0100 :
            self.writeRegister(CONFIG_REG, self.__configRegister | 0x8000)
    ...
    def getADC(self) :
        ...
        while not self.isReady() and (time.time() - t) < self.__conversionDelay :
            pass
        value = self.readRegister(CONVERSION_REG)
    ...
    def getMaxVoltage(self) :
        if self.__configRegister & 0x0E00 == 0x0000 : return 6.144
        elif self.__configRegister & 0x0E00 == 0x0100 : return 4.096
        elif self.__configRegister & 0x0E00 == 0x0200 : return 2.048
        elif self.__configRegister & 0x0E00 == 0x0400 : return 1.024
        elif self.__configRegister & 0x0E00 == 0x0800 : return 0.512
        else : return 0.256
