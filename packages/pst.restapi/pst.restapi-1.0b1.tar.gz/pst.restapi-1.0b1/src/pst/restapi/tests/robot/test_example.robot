...
#
#  $ bin/test -s pst.restapi -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src pst.restapi.testing.PST_RESTAPI_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/pst/restapi/tests/robot/test_example.robot
#
